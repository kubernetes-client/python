...
from k8sclient.models.v1_container_state_terminated import V1ContainerStateTerminated
...
class TestV1ContainerStateTerminated(unittest.TestCase):
    ...
    def testV1ContainerStateTerminated(self):
        ...
        """
        model = k8sclient.models.v1_container_state_terminated.V1ContainerStateTerminated()
