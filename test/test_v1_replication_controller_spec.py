...
from k8sclient.models.v1_replication_controller_spec import V1ReplicationControllerSpec
...
class TestV1ReplicationControllerSpec(unittest.TestCase):
    ...
    def testV1ReplicationControllerSpec(self):
        ...
        """
        model = k8sclient.models.v1_replication_controller_spec.V1ReplicationControllerSpec()
