...
from k8sclient.models.v1alpha1_role_binding_list import V1alpha1RoleBindingList
...
class TestV1alpha1RoleBindingList(unittest.TestCase):
    ...
    def testV1alpha1RoleBindingList(self):
        ...
        """
        model = k8sclient.models.v1alpha1_role_binding_list.V1alpha1RoleBindingList()
