...
from k8sclient.models.v1_horizontal_pod_autoscaler_status import V1HorizontalPodAutoscalerStatus
...
class TestV1HorizontalPodAutoscalerStatus(unittest.TestCase):
    ...
    def testV1HorizontalPodAutoscalerStatus(self):
        ...
        """
        model = k8sclient.models.v1_horizontal_pod_autoscaler_status.V1HorizontalPodAutoscalerStatus()
