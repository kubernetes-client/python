...
from k8sclient.models.v1_persistent_volume_claim_list import V1PersistentVolumeClaimList
...
class TestV1PersistentVolumeClaimList(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaimList(self):
        ...
        """
        model = k8sclient.models.v1_persistent_volume_claim_list.V1PersistentVolumeClaimList()
