...
from k8sclient.models.unversioned_label_selector_requirement import UnversionedLabelSelectorRequirement
...
class TestUnversionedLabelSelectorRequirement(unittest.TestCase):
    ...
    def testUnversionedLabelSelectorRequirement(self):
        ...
        """
        model = k8sclient.models.unversioned_label_selector_requirement.UnversionedLabelSelectorRequirement()
