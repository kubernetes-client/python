...
v1_mutating_admission_policy_spec_instance = V1MutatingAdmissionPolicySpec.from_json(json)
# print the JSON string representation of the object
print(V1MutatingAdmissionPolicySpec.to_json())

# convert the object into a dict
v1_mutating_admission_policy_spec_dict = v1_mutating_admission_policy_spec_instance.to_dict()
# create an instance of V1MutatingAdmissionPolicySpec from a dict
v1_mutating_admission_policy_spec_from_dict = V1MutatingAdmissionPolicySpec.from_dict(v1_mutating_admission_policy_spec_dict)
```
