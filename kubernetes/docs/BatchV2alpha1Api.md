...
> V2alpha1CronJob create_namespaced_cron_job(namespace, body)
...
from kubernetes.client.api import batch_v2alpha1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = batch_v2alpha1_api.BatchV2alpha1Api(api_client)
...
> V2alpha1CronJobList list_cron_job_for_all_namespaces()
...
> V2alpha1CronJobList list_namespaced_cron_job(namespace)
...
> V2alpha1CronJob patch_namespaced_cron_job(name, namespace, body)
...
> V2alpha1CronJob patch_namespaced_cron_job_status(name, namespace, body)
...
> V2alpha1CronJob read_namespaced_cron_job(name, namespace)
...
> V2alpha1CronJob read_namespaced_cron_job_status(name, namespace)
...
> V2alpha1CronJob replace_namespaced_cron_job(name, namespace, body)
...
> V2alpha1CronJob replace_namespaced_cron_job_status(name, namespace, body)
