...
> V1alpha1PriorityClass create_priority_class(body)
...
from kubernetes.client.api import scheduling_v1alpha1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = scheduling_v1alpha1_api.SchedulingV1alpha1Api(api_client)
...
# **list_priority_class**
> V1alpha1PriorityClassList list_priority_class()
...
> V1alpha1PriorityClass patch_priority_class(name, body)
...
# **read_priority_class**
> V1alpha1PriorityClass read_priority_class(name)
...
> V1alpha1PriorityClass replace_priority_class(name, body)
