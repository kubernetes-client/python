...
from kubernetes.client.api import apiregistration_v1_api
...
# **patch_api_service**
> V1APIService patch_api_service(name, body)
...
> V1APIService patch_api_service_status(name, body)
...
# **replace_api_service**
> V1APIService replace_api_service(name, body)
...
> V1APIService replace_api_service_status(name, body)
