...
json = "{}"
# create an instance of V1MutatingAdmissionPolicyBindingSpec from a JSON string
v1_mutating_admission_policy_binding_spec_instance = V1MutatingAdmissionPolicyBindingSpec.from_json(json)
# print the JSON string representation of the object
print(V1MutatingAdmissionPolicyBindingSpec.to_json())

# convert the object into a dict
v1_mutating_admission_policy_binding_spec_dict = v1_mutating_admission_policy_binding_spec_instance.to_dict()
# create an instance of V1MutatingAdmissionPolicyBindingSpec from a dict
v1_mutating_admission_policy_binding_spec_from_dict = V1MutatingAdmissionPolicyBindingSpec.from_dict(v1_mutating_admission_policy_binding_spec_dict)
```
