...
**spec** | [**V1alpha1RuntimeClassSpec**](V1alpha1RuntimeClassSpec.md) | Specification of the RuntimeClass More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status | 
