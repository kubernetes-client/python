...
json = "{}"
# create an instance of V1beta1DeviceDerivedAttribute from a JSON string
v1beta1_device_derived_attribute_instance = V1beta1DeviceDerivedAttribute.from_json(json)
# print the JSON string representation of the object
print(V1beta1DeviceDerivedAttribute.to_json())

# convert the object into a dict
v1beta1_device_derived_attribute_dict = v1beta1_device_derived_attribute_instance.to_dict()
# create an instance of V1beta1DeviceDerivedAttribute from a dict
v1beta1_device_derived_attribute_from_dict = V1beta1DeviceDerivedAttribute.from_dict(v1beta1_device_derived_attribute_dict)
```
