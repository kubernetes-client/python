...
v2beta1_api_resource_discovery_instance = V2beta1APIResourceDiscovery.from_json(json)
# print the JSON string representation of the object
print(V2beta1APIResourceDiscovery.to_json())

# convert the object into a dict
v2beta1_api_resource_discovery_dict = v2beta1_api_resource_discovery_instance.to_dict()
# create an instance of V2beta1APIResourceDiscovery from a dict
v2beta1_api_resource_discovery_from_dict = V2beta1APIResourceDiscovery.from_dict(v2beta1_api_resource_discovery_dict)
```
