...
json = "{}"
# create an instance of V2beta1APIGroupDiscovery from a JSON string
v2beta1_api_group_discovery_instance = V2beta1APIGroupDiscovery.from_json(json)
# print the JSON string representation of the object
print(V2beta1APIGroupDiscovery.to_json())

# convert the object into a dict
v2beta1_api_group_discovery_dict = v2beta1_api_group_discovery_instance.to_dict()
# create an instance of V2beta1APIGroupDiscovery from a dict
v2beta1_api_group_discovery_from_dict = V2beta1APIGroupDiscovery.from_dict(v2beta1_api_group_discovery_dict)
```
