...
> ExtensionsV1beta1Ingress create_namespaced_ingress(namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = extensions_v1beta1_api.ExtensionsV1beta1Api(api_client)
...
> ExtensionsV1beta1IngressList list_namespaced_ingress(namespace)
...
> ExtensionsV1beta1Ingress patch_namespaced_ingress(name, namespace, body)
...
> ExtensionsV1beta1Ingress patch_namespaced_ingress_status(name, namespace, body)
...
> ExtensionsV1beta1Ingress read_namespaced_ingress(name, namespace)
...
> ExtensionsV1beta1Ingress read_namespaced_ingress_status(name, namespace)
...
> ExtensionsV1beta1Ingress replace_namespaced_ingress(name, namespace, body)
...
> ExtensionsV1beta1Ingress replace_namespaced_ingress_status(name, namespace, body)
