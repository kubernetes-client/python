# kubernetes.client.CoordinationV1alpha1Api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.client.CoordinationV1alpha1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = kubernetes.client.V1alpha1LeaseCandidate() # V1alpha1LeaseCandidate | 
