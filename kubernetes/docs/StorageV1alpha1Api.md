...
> V1alpha1CSIStorageCapacity create_namespaced_csi_storage_capacity(namespace, body)
...
from kubernetes.client.api import storage_v1alpha1_api
from kubernetes.client.model.v1alpha1_csi_storage_capacity import V1alpha1CSIStorageCapacity
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = storage_v1alpha1_api.StorageV1alpha1Api(api_client)
    ...
    try:
        api_response = api_instance.create_namespaced_csi_storage_capacity(namespace, body)
        pprint(api_response)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_csi_storage_capacity(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_namespaced_csi_storage_capacity(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_namespaced_csi_storage_capacity(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1CSIStorageCapacityList list_csi_storage_capacity_for_all_namespaces()
...
import kubernetes.client
from kubernetes.client.api import storage_v1alpha1_api
from kubernetes.client.model.v1alpha1_csi_storage_capacity_list import V1alpha1CSIStorageCapacityList
from pprint import pprint
# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = kubernetes.client.Configuration(
...
> V1alpha1CSIStorageCapacityList list_namespaced_csi_storage_capacity(namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.list_namespaced_csi_storage_capacity(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1CSIStorageCapacity patch_namespaced_csi_storage_capacity(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_csi_storage_capacity(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1CSIStorageCapacity read_namespaced_csi_storage_capacity(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_namespaced_csi_storage_capacity(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1CSIStorageCapacity replace_namespaced_csi_storage_capacity(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_csi_storage_capacity(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
