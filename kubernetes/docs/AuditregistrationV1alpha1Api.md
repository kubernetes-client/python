# kubernetes.client.AuditregistrationV1alpha1Api
...
# **create_audit_sink**
> V1alpha1AuditSink create_audit_sink(body)
...
from kubernetes.client.api import auditregistration_v1alpha1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = auditregistration_v1alpha1_api.AuditregistrationV1alpha1Api(api_client)
    body = V1alpha1AuditSink(
        ...
        spec=V1alpha1AuditSinkSpec(
            ...
            webhook=V1alpha1Webhook(
                kubernetes.client_config=V1alpha1WebhookClientConfig(
                    ca_bundle='YQ==',
    ...
    try:
        api_response = api_instance.create_audit_sink(body)
        pprint(api_response)
...
# **delete_audit_sink**
> V1Status delete_audit_sink(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_audit_sink(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
# **list_audit_sink**
> V1alpha1AuditSinkList list_audit_sink()
...
# **patch_audit_sink**
> V1alpha1AuditSink patch_audit_sink(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_audit_sink(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
# **read_audit_sink**
> V1alpha1AuditSink read_audit_sink(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_audit_sink(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
# **replace_audit_sink**
> V1alpha1AuditSink replace_audit_sink(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_audit_sink(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
