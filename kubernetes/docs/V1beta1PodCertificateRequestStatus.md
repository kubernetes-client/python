...
v1beta1_pod_certificate_request_status_instance = V1beta1PodCertificateRequestStatus.from_json(json)
# print the JSON string representation of the object
print(V1beta1PodCertificateRequestStatus.to_json())

# convert the object into a dict
v1beta1_pod_certificate_request_status_dict = v1beta1_pod_certificate_request_status_instance.to_dict()
# create an instance of V1beta1PodCertificateRequestStatus from a dict
v1beta1_pod_certificate_request_status_from_dict = V1beta1PodCertificateRequestStatus.from_dict(v1beta1_pod_certificate_request_status_dict)
```
