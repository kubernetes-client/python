...
# **create_cluster_role**
> V1beta1ClusterRole create_cluster_role(body)
...
from kubernetes.client.api import rbac_authorization_v1beta1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = rbac_authorization_v1beta1_api.RbacAuthorizationV1beta1Api(api_client)
...
> V1beta1ClusterRoleBinding create_cluster_role_binding(body)
...
> V1beta1Role create_namespaced_role(namespace, body)
...
> V1beta1RoleBinding create_namespaced_role_binding(namespace, body)
...
# **list_cluster_role**
> V1beta1ClusterRoleList list_cluster_role()
...
> V1beta1ClusterRoleBindingList list_cluster_role_binding()
...
> V1beta1RoleBindingList list_namespaced_role_binding(namespace)
...
> V1beta1RoleBindingList list_role_binding_for_all_namespaces()
...
# **patch_cluster_role**
> V1beta1ClusterRole patch_cluster_role(name, body)
...
> V1beta1ClusterRoleBinding patch_cluster_role_binding(name, body)
...
> V1beta1Role patch_namespaced_role(name, namespace, body)
...
> V1beta1RoleBinding patch_namespaced_role_binding(name, namespace, body)
...
# **read_cluster_role**
> V1beta1ClusterRole read_cluster_role(name)
...
> V1beta1ClusterRoleBinding read_cluster_role_binding(name)
...
> V1beta1Role read_namespaced_role(name, namespace)
...
> V1beta1RoleBinding read_namespaced_role_binding(name, namespace)
...
> V1beta1ClusterRole replace_cluster_role(name, body)
...
> V1beta1ClusterRoleBinding replace_cluster_role_binding(name, body)
...
> V1beta1Role replace_namespaced_role(name, namespace, body)
...
> V1beta1RoleBinding replace_namespaced_role_binding(name, namespace, body)
