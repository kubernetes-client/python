# kubernetes.client.FlowcontrolApiserverV1beta1Api
...
from kubernetes.client.api import flowcontrol_apiserver_v1beta1_api
...
# **patch_flow_schema**
> V1beta1FlowSchema patch_flow_schema(name, body)
...
> V1beta1FlowSchema patch_flow_schema_status(name, body)
...
> V1beta1PriorityLevelConfiguration patch_priority_level_configuration(name, body)
...
> V1beta1PriorityLevelConfiguration patch_priority_level_configuration_status(name, body)
...
# **replace_flow_schema**
> V1beta1FlowSchema replace_flow_schema(name, body)
...
> V1beta1FlowSchema replace_flow_schema_status(name, body)
...
> V1beta1PriorityLevelConfiguration replace_priority_level_configuration(name, body)
...
> V1beta1PriorityLevelConfiguration replace_priority_level_configuration_status(name, body)
