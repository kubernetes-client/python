<a name="__pageTop"></a>
# kubernetes.client.apis.tags.admissionregistration_api.AdmissionregistrationApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_api_group**](#get_api_group) | **get** /apis/admissionregistration.k8s.io/ | 
...
from kubernetes.client.apis.tags import admissionregistration_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = admissionregistration_api.AdmissionregistrationApi(api_client)
