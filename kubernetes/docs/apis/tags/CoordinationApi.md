<a name="__pageTop"></a>
# kubernetes.client.apis.tags.coordination_api.CoordinationApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_api_group**](#get_api_group) | **get** /apis/coordination.k8s.io/ | 
...
from kubernetes.client.apis.tags import coordination_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = coordination_api.CoordinationApi(api_client)
