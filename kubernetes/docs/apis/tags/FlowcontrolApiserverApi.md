<a name="__pageTop"></a>
# kubernetes.client.apis.tags.flowcontrol_apiserver_api.FlowcontrolApiserverApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_api_group**](#get_api_group) | **get** /apis/flowcontrol.apiserver.k8s.io/ | 
...
from kubernetes.client.apis.tags import flowcontrol_apiserver_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = flowcontrol_apiserver_api.FlowcontrolApiserverApi(api_client)
