...
> V1beta1PriorityClass create_priority_class(body)
...
from kubernetes.client.api import scheduling_v1beta1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = scheduling_v1beta1_api.SchedulingV1beta1Api(api_client)
    ...
    try:
        api_response = api_instance.create_priority_class(body)
        pprint(api_response)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_priority_class(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
# **list_priority_class**
> V1beta1PriorityClassList list_priority_class()
...
> V1beta1PriorityClass patch_priority_class(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_priority_class(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
# **read_priority_class**
> V1beta1PriorityClass read_priority_class(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_priority_class(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PriorityClass replace_priority_class(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_priority_class(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
