...
**external_admission_hooks** | [**list[V1alpha1ExternalAdmissionHook]**](V1alpha1ExternalAdmissionHook.md) | ExternalAdmissionHooks is a list of external admission webhooks and the affected resources and operations. | [optional] 
