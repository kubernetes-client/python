...
v1_json_patch_instance = V1JSONPatch.from_json(json)
# print the JSON string representation of the object
print(V1JSONPatch.to_json())

# convert the object into a dict
v1_json_patch_dict = v1_json_patch_instance.to_dict()
# create an instance of V1JSONPatch from a dict
v1_json_patch_from_dict = V1JSONPatch.from_dict(v1_json_patch_dict)
```
