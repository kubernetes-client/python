...
**shareable_summary** | [**V1alpha3ShareableSummaryStatus**](V1alpha3ShareableSummaryStatus.md) |  | [optional]
...
v1alpha3_pool_status_instance = V1alpha3PoolStatus.from_json(json)
# print the JSON string representation of the object
print(V1alpha3PoolStatus.to_json())

# convert the object into a dict
v1alpha3_pool_status_dict = v1alpha3_pool_status_instance.to_dict()
# create an instance of V1alpha3PoolStatus from a dict
v1alpha3_pool_status_from_dict = V1alpha3PoolStatus.from_dict(v1alpha3_pool_status_dict)
```
