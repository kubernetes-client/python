...
> EventsV1Event create_namespaced_event(namespace, body)
...
from kubernetes.client.api import events_v1_api
...
> EventsV1EventList list_event_for_all_namespaces()
...
> EventsV1EventList list_namespaced_event(namespace)
...
> EventsV1Event patch_namespaced_event(name, namespace, body)
...
> EventsV1Event read_namespaced_event(name, namespace)
...
> EventsV1Event replace_namespaced_event(name, namespace, body)
