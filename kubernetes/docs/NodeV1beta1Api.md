# kubernetes.client.NodeV1beta1Api
...
api_instance = kubernetes.client.NodeV1beta1Api(kubernetes.client.ApiClient(configuration))
body = kubernetes.client.V1beta1RuntimeClass() # V1beta1RuntimeClass | 
