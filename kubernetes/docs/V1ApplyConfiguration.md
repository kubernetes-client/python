...
v1_apply_configuration_instance = V1ApplyConfiguration.from_json(json)
# print the JSON string representation of the object
print(V1ApplyConfiguration.to_json())

# convert the object into a dict
v1_apply_configuration_dict = v1_apply_configuration_instance.to_dict()
# create an instance of V1ApplyConfiguration from a dict
v1_apply_configuration_from_dict = V1ApplyConfiguration.from_dict(v1_apply_configuration_dict)
```
