...
# **create_cluster_role**
> V1alpha1ClusterRole create_cluster_role(body)
...
from kubernetes.client.api import rbac_authorization_v1alpha1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = rbac_authorization_v1alpha1_api.RbacAuthorizationV1alpha1Api(api_client)
...
> V1alpha1ClusterRoleBinding create_cluster_role_binding(body)
...
> V1alpha1Role create_namespaced_role(namespace, body)
...
> V1alpha1RoleBinding create_namespaced_role_binding(namespace, body)
...
# **delete_cluster_role**
> V1Status delete_cluster_role(name)
...
> V1Status delete_collection_namespaced_role(namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_role(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_collection_namespaced_role_binding(namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_role_binding(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_namespaced_role(name, namespace)
...
> V1Status delete_namespaced_role_binding(name, namespace)
...
# **list_cluster_role**
> V1alpha1ClusterRoleList list_cluster_role()
...
> V1alpha1ClusterRoleBindingList list_cluster_role_binding()
...
> V1alpha1RoleBindingList list_namespaced_role_binding(namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.list_namespaced_role_binding(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1RoleBindingList list_role_binding_for_all_namespaces()
...
# **patch_cluster_role**
> V1alpha1ClusterRole patch_cluster_role(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_cluster_role(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1ClusterRoleBinding patch_cluster_role_binding(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_cluster_role_binding(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1Role patch_namespaced_role(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_role(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1RoleBinding patch_namespaced_role_binding(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_role_binding(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
# **read_cluster_role**
> V1alpha1ClusterRole read_cluster_role(name)
...
> V1alpha1ClusterRoleBinding read_cluster_role_binding(name)
...
> V1alpha1Role read_namespaced_role(name, namespace)
...
> V1alpha1RoleBinding read_namespaced_role_binding(name, namespace)
...
> V1alpha1ClusterRole replace_cluster_role(name, body)
...
> V1alpha1ClusterRoleBinding replace_cluster_role_binding(name, body)
...
> V1alpha1Role replace_namespaced_role(name, namespace, body)
...
> V1alpha1RoleBinding replace_namespaced_role_binding(name, namespace, body)
