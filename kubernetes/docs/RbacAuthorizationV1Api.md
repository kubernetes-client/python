...
# **create_cluster_role**
> V1ClusterRole create_cluster_role(body)
...
from kubernetes.client.api import rbac_authorization_v1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = rbac_authorization_v1_api.RbacAuthorizationV1Api(api_client)
    body = V1ClusterRole(
...
> V1ClusterRoleBinding create_cluster_role_binding(body)
...
> V1Role create_namespaced_role(namespace, body)
...
> V1RoleBinding create_namespaced_role_binding(namespace, body)
...
# **list_cluster_role**
> V1ClusterRoleList list_cluster_role()
...
> V1ClusterRoleBindingList list_cluster_role_binding()
...
> V1RoleList list_namespaced_role(namespace)
...
> V1RoleBindingList list_namespaced_role_binding(namespace)
...
# **patch_cluster_role**
> V1ClusterRole patch_cluster_role(name, body)
...
> V1ClusterRoleBinding patch_cluster_role_binding(name, body)
...
> V1Role patch_namespaced_role(name, namespace, body)
...
> V1RoleBinding patch_namespaced_role_binding(name, namespace, body)
...
# **read_cluster_role**
> V1ClusterRole read_cluster_role(name)
...
> V1ClusterRoleBinding read_cluster_role_binding(name)
...
> V1Role read_namespaced_role(name, namespace)
...
> V1RoleBinding read_namespaced_role_binding(name, namespace)
...
> V1ClusterRole replace_cluster_role(name, body)
...
> V1ClusterRoleBinding replace_cluster_role_binding(name, body)
...
> V1Role replace_namespaced_role(name, namespace, body)
...
> V1RoleBinding replace_namespaced_role_binding(name, namespace, body)
