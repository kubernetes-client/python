...
api_instance = client.CertificatesV1beta1Api(client.ApiClient(configuration))
body = client.V1beta1CertificateSigningRequest() # V1beta1CertificateSigningRequest | 
