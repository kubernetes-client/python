...
> V1CronJob create_namespaced_cron_job(namespace, body)
...
> V1Job create_namespaced_job(namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    body = V1Job(
        ...
        status=V1JobStatus(
            ...
            completion_time=dateutil_parser('1970-01-01T00:00:00.00Z'),
            conditions=[
                V1JobCondition(
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_job(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_namespaced_job(name, namespace)
...
> V1CronJob patch_namespaced_cron_job(name, namespace, body)
...
> V1CronJob patch_namespaced_cron_job_status(name, namespace, body)
...
> V1Job patch_namespaced_job(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_job(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Job patch_namespaced_job_status(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_job_status(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1CronJob read_namespaced_cron_job(name, namespace)
...
> V1CronJob read_namespaced_cron_job_status(name, namespace)
...
# **read_namespaced_job**
> V1Job read_namespaced_job(name, namespace)
...
> V1Job read_namespaced_job_status(name, namespace)
...
> V1CronJob replace_namespaced_cron_job(name, namespace, body)
...
> V1CronJob replace_namespaced_cron_job_status(name, namespace, body)
...
> V1Job replace_namespaced_job(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_job(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Job replace_namespaced_job_status(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_job_status(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
