...
**current_healthy** | **int** | current number of healthy pods | [optional] 
**desired_healthy** | **int** | minimum desired number of healthy pods | [optional] 
...
**disruptions_allowed** | **int** | Number of pod disruptions that are currently allowed. | [optional] 
**expected_pods** | **int** | total number of pods counted by this disruption budget | [optional] 
