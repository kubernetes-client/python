...
> V2HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(namespace, body)
...
from kubernetes.client.api import autoscaling_v2_api
...
> V2HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler(name, namespace, body)
...
> V2HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler_status(name, namespace, body)
...
> V2HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler(name, namespace)
...
> V2HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler_status(name, namespace)
...
> V2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler(name, namespace, body)
...
> V2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler_status(name, namespace, body)
