...
> V1beta1EndpointSlice create_namespaced_endpoint_slice(namespace, body)
...
from kubernetes.client.api import discovery_v1beta1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = discovery_v1beta1_api.DiscoveryV1beta1Api(api_client)
    ...
    try:
        api_response = api_instance.create_namespaced_endpoint_slice(namespace, body)
        pprint(api_response)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_endpoint_slice(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_namespaced_endpoint_slice(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_namespaced_endpoint_slice(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1EndpointSliceList list_endpoint_slice_for_all_namespaces()
...
> V1beta1EndpointSliceList list_namespaced_endpoint_slice(namespace)
...
> V1beta1EndpointSlice patch_namespaced_endpoint_slice(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_endpoint_slice(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1EndpointSlice read_namespaced_endpoint_slice(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_namespaced_endpoint_slice(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1EndpointSlice replace_namespaced_endpoint_slice(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_endpoint_slice(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
