...
from kubernetes.client.api import admissionregistration_v1_api
...
> V1MutatingWebhookConfiguration patch_mutating_webhook_configuration(name, body)
...
> V1ValidatingWebhookConfiguration patch_validating_webhook_configuration(name, body)
...
> V1MutatingWebhookConfiguration replace_mutating_webhook_configuration(name, body)
...
> V1ValidatingWebhookConfiguration replace_validating_webhook_configuration(name, body)
