...
> V1PodDisruptionBudget create_namespaced_pod_disruption_budget(namespace, body)
...
from kubernetes.client.api import policy_v1_api
...
> V1PodDisruptionBudget patch_namespaced_pod_disruption_budget(name, namespace, body)
...
> V1PodDisruptionBudget patch_namespaced_pod_disruption_budget_status(name, namespace, body)
...
> V1PodDisruptionBudget read_namespaced_pod_disruption_budget(name, namespace)
...
> V1PodDisruptionBudget read_namespaced_pod_disruption_budget_status(name, namespace)
...
> V1PodDisruptionBudget replace_namespaced_pod_disruption_budget(name, namespace, body)
...
> V1PodDisruptionBudget replace_namespaced_pod_disruption_budget_status(name, namespace, body)
