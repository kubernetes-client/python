...
> V1beta1PodDisruptionBudget create_namespaced_pod_disruption_budget(namespace, body)
...
from kubernetes.client.api import policy_v1beta1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = policy_v1beta1_api.PolicyV1beta1Api(api_client)
    ...
    try:
        api_response = api_instance.create_namespaced_pod_disruption_budget(namespace, body)
        pprint(api_response)
...
> V1beta1PodSecurityPolicy create_pod_security_policy(body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    body = V1beta1PodSecurityPolicy(
        ...
        spec=V1beta1PodSecurityPolicySpec(
            ...
            allowed_proc_mount_types=[
                "allowed_proc_mount_types_example",
            ],
            allowed_unsafe_sysctls=[
                "allowed_unsafe_sysctls_example",
            ],
            default_add_capabilities=[
                "default_add_capabilities_example",
            ],
            default_allow_privilege_escalation=True,
            forbidden_sysctls=[
                "forbidden_sysctls_example",
            ],
            ...
            required_drop_capabilities=[
                "required_drop_capabilities_example",
            ],
            ...
            runtime_class=V1beta1RuntimeClassStrategyOptions(
                allowed_runtime_class_names=[
                    "allowed_runtime_class_names_example",
                ],
                default_runtime_class_name="default_runtime_class_name_example",
            ),
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.create_pod_security_policy(body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_pod_disruption_budget(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_collection_pod_security_policy()
...
> V1Status delete_namespaced_pod_disruption_budget(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_namespaced_pod_disruption_budget(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodSecurityPolicy delete_pod_security_policy(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_pod_security_policy(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodDisruptionBudgetList list_namespaced_pod_disruption_budget(namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.list_namespaced_pod_disruption_budget(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodDisruptionBudgetList list_pod_disruption_budget_for_all_namespaces()
...
> V1beta1PodSecurityPolicyList list_pod_security_policy()
...
> V1beta1PodDisruptionBudget patch_namespaced_pod_disruption_budget(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_pod_disruption_budget(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodDisruptionBudget patch_namespaced_pod_disruption_budget_status(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_pod_disruption_budget_status(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodSecurityPolicy patch_pod_security_policy(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_pod_security_policy(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodDisruptionBudget read_namespaced_pod_disruption_budget(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_namespaced_pod_disruption_budget(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodDisruptionBudget read_namespaced_pod_disruption_budget_status(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_namespaced_pod_disruption_budget_status(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodSecurityPolicy read_pod_security_policy(name)
...
> V1beta1PodDisruptionBudget replace_namespaced_pod_disruption_budget(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_pod_disruption_budget(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodDisruptionBudget replace_namespaced_pod_disruption_budget_status(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_pod_disruption_budget_status(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1PodSecurityPolicy replace_pod_security_policy(name, body)
