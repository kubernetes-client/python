...
> V1CertificateSigningRequest create_certificate_signing_request(body)
...
from kubernetes.client.api import certificates_v1_api
...
> V1CertificateSigningRequestList list_certificate_signing_request()
...
> V1CertificateSigningRequest patch_certificate_signing_request(name, body)
...
> V1CertificateSigningRequest patch_certificate_signing_request_approval(name, body)
...
> V1CertificateSigningRequest patch_certificate_signing_request_status(name, body)
...
> V1CertificateSigningRequest read_certificate_signing_request(name)
...
> V1CertificateSigningRequest read_certificate_signing_request_approval(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_certificate_signing_request_approval(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1CertificateSigningRequest read_certificate_signing_request_status(name)
...
> V1CertificateSigningRequest replace_certificate_signing_request(name, body)
...
> V1CertificateSigningRequest replace_certificate_signing_request_approval(name, body)
...
> V1CertificateSigningRequest replace_certificate_signing_request_status(name, body)
