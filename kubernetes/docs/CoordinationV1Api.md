...
> V1Lease create_namespaced_lease(namespace, body)
...
from kubernetes.client.api import coordination_v1_api
...
> V1Lease patch_namespaced_lease(name, namespace, body)
...
> V1Lease read_namespaced_lease(name, namespace)
...
> V1Lease replace_namespaced_lease(name, namespace, body)
