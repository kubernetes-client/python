...
> V1EndpointSlice create_namespaced_endpoint_slice(namespace, body)
...
from kubernetes.client.api import discovery_v1_api
...
> V1EndpointSlice patch_namespaced_endpoint_slice(name, namespace, body)
...
> V1EndpointSlice read_namespaced_endpoint_slice(name, namespace)
...
> V1EndpointSlice replace_namespaced_endpoint_slice(name, namespace, body)
