...
from kubernetes.client.api import networking_v1_api
...
> V1Ingress create_namespaced_ingress(namespace, body)
...
> V1NetworkPolicy create_namespaced_network_policy(namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_network_policy(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_namespaced_network_policy(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_namespaced_network_policy(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
# **patch_ingress_class**
> V1IngressClass patch_ingress_class(name, body)
...
> V1Ingress patch_namespaced_ingress(name, namespace, body)
...
> V1Ingress patch_namespaced_ingress_status(name, namespace, body)
...
> V1NetworkPolicy patch_namespaced_network_policy(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_network_policy(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Ingress read_namespaced_ingress(name, namespace)
...
> V1Ingress read_namespaced_ingress_status(name, namespace)
...
> V1NetworkPolicy read_namespaced_network_policy(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_namespaced_network_policy(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1IngressClass replace_ingress_class(name, body)
...
> V1Ingress replace_namespaced_ingress(name, namespace, body)
...
> V1Ingress replace_namespaced_ingress_status(name, namespace, body)
...
> V1NetworkPolicy replace_namespaced_network_policy(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_network_policy(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
