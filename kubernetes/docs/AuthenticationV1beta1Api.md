...
# **create_token_review**
> V1beta1TokenReview create_token_review(body)
...
from kubernetes.client.api import authentication_v1beta1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentication_v1beta1_api.AuthenticationV1beta1Api(api_client)
