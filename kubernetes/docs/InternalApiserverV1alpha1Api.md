...
> V1alpha1StorageVersion create_storage_version(body)
...
from kubernetes.client.api import internal_apiserver_v1alpha1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = internal_apiserver_v1alpha1_api.InternalApiserverV1alpha1Api(api_client)
    body = V1alpha1StorageVersion(
        ...
        status=V1alpha1StorageVersionStatus(
            common_encoding_version="common_encoding_version_example",
            conditions=[
            ...
            storage_versions=[
                V1alpha1ServerStorageVersion(
                    api_server_id="api_server_id_example",
                    decodable_versions=[
                        "decodable_versions_example",
                    ],
                    encoding_version="encoding_version_example",
                ),
            ],
        ),
    ...
    try:
        api_response = api_instance.create_storage_version(body)
        pprint(api_response)
...
> V1Status delete_storage_version(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_storage_version(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1StorageVersion patch_storage_version(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_storage_version(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1StorageVersion patch_storage_version_status(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_storage_version_status(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1StorageVersion read_storage_version(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_storage_version(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1StorageVersion read_storage_version_status(name)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_storage_version_status(name)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1StorageVersion replace_storage_version(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_storage_version(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1alpha1StorageVersion replace_storage_version_status(name, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_storage_version_status(name, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
