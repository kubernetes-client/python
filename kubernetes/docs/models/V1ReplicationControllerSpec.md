# kubernetes.client.model.v1_replication_controller_spec.V1ReplicationControllerSpec
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | ReplicationControllerSpec is the specification of a replication controller. | 
