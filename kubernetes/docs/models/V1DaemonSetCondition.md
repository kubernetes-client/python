# kubernetes.client.model.v1_daemon_set_condition.V1DaemonSetCondition
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | DaemonSetCondition describes the state of a DaemonSet at a certain point. | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**type** | str,  | str,  | Type of DaemonSet condition. | 
