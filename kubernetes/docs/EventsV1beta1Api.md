...
> V1beta1Event create_namespaced_event(namespace, body)
...
from kubernetes.client.api import events_v1beta1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = events_v1beta1_api.EventsV1beta1Api(api_client)
    namespace = "namespace_example" # str | object name and auth scope, such as for teams and projects
    body = V1beta1Event(
        action="action_example",
        api_version="api_version_example",
        deprecated_count=1,
        deprecated_first_timestamp=dateutil_parser('1970-01-01T00:00:00.00Z'),
        deprecated_last_timestamp=dateutil_parser('1970-01-01T00:00:00.00Z'),
        deprecated_source=V1EventSource(
            component="component_example",
            host="host_example",
        ),
        event_time=dateutil_parser('1970-01-01T00:00:00.00Z'),
        kind="kind_example",
        ...
        reporting_controller="reporting_controller_example",
        reporting_instance="reporting_instance_example",
        series=V1beta1EventSeries(
            count=1,
            last_observed_time=dateutil_parser('1970-01-01T00:00:00.00Z'),
            state="state_example",
        ),
        type="type_example",
    ) # V1beta1Event | 
...
> V1Status delete_collection_namespaced_event(namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_collection_namespaced_event(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1Status delete_namespaced_event(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.delete_namespaced_event(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1EventList list_event_for_all_namespaces()
...
> V1beta1EventList list_namespaced_event(namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.list_namespaced_event(namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1Event patch_namespaced_event(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_event(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1Event read_namespaced_event(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_namespaced_event(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1beta1Event replace_namespaced_event(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_event(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
