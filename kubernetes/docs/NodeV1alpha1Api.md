...
> V1alpha1RuntimeClass create_runtime_class(body)
...
from kubernetes.client.api import node_v1alpha1_api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    api_instance = node_v1alpha1_api.NodeV1alpha1Api(api_client)
    body = V1alpha1RuntimeClass(
        ...
        spec=V1alpha1RuntimeClassSpec(
            ...
            runtime_handler="runtime_handler_example",
...
# **patch_runtime_class**
> V1alpha1RuntimeClass patch_runtime_class(name, body)
...
# **read_runtime_class**
> V1alpha1RuntimeClass read_runtime_class(name)
...
> V1alpha1RuntimeClass replace_runtime_class(name, body)
