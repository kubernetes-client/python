# kubernetes.client.NodeV1alpha1Api
...
api_instance = kubernetes.client.NodeV1alpha1Api(kubernetes.client.ApiClient(configuration))
body = kubernetes.client.V1alpha1RuntimeClass() # V1alpha1RuntimeClass | 
...
> V1Status delete_runtime_class(name, pretty=pretty, body=body, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy)
...
try: 
    api_response = api_instance.delete_runtime_class(name, pretty=pretty, body=body, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy)
    pprint(api_response)
except ApiException as e:
