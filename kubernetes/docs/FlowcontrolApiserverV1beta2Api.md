...
from kubernetes.client.api import flowcontrol_apiserver_v1beta2_api
...
# **patch_flow_schema**
> V1beta2FlowSchema patch_flow_schema(name, body)
...
> V1beta2FlowSchema patch_flow_schema_status(name, body)
...
> V1beta2PriorityLevelConfiguration patch_priority_level_configuration(name, body)
...
> V1beta2PriorityLevelConfiguration patch_priority_level_configuration_status(name, body)
...
# **read_flow_schema**
> V1beta2FlowSchema read_flow_schema(name)
...
> V1beta2FlowSchema read_flow_schema_status(name)
...
> V1beta2PriorityLevelConfiguration read_priority_level_configuration(name)
...
> V1beta2PriorityLevelConfiguration read_priority_level_configuration_status(name)
...
# **replace_flow_schema**
> V1beta2FlowSchema replace_flow_schema(name, body)
...
> V1beta2FlowSchema replace_flow_schema_status(name, body)
...
> V1beta2PriorityLevelConfiguration replace_priority_level_configuration(name, body)
...
> V1beta2PriorityLevelConfiguration replace_priority_level_configuration_status(name, body)
