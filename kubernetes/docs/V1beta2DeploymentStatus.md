...
**conditions** | [**list[V1beta2DeploymentCondition]**](V1beta2DeploymentCondition.md) | Represents the latest available observations of a deployment&#39;s current state. | [optional] 
