...
class LifecycleV1alpha1Api:
    ...
    def create_namespaced_eviction(
        self,
        ...
        _param = self._create_namespaced_eviction_serialize(
            namespace=namespace,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    def create_namespaced_eviction_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Tuple[V1alpha1Eviction, int, Any]:
        """create_namespaced_eviction
    ...
    def _create_namespaced_eviction_serialize(
        self,
        namespace,
        body,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def create_namespaced_eviction_request(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        ...
        _param = self._create_namespaced_eviction_request_serialize(
            namespace=namespace,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    def create_namespaced_eviction_request_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Tuple[V1alpha1EvictionRequest, int, Any]:
        """create_namespaced_eviction_request
    ...
    def _create_namespaced_eviction_request_serialize(
        self,
        namespace,
        body,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def delete_collection_namespaced_eviction(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _param = self._delete_collection_namespaced_eviction_serialize(
            namespace=namespace,
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    def delete_collection_namespaced_eviction_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    def _delete_collection_namespaced_eviction_serialize(
        self,
        namespace,
        pretty,
        _continue,
    ...
    @validate_call(config={'defer_build': True})
    def delete_collection_namespaced_eviction_request(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        ...
        _param = self._delete_collection_namespaced_eviction_request_serialize(
            namespace=namespace,
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    def delete_collection_namespaced_eviction_request_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    def _delete_collection_namespaced_eviction_request_serialize(
        self,
        namespace,
        pretty,
        _continue,
    ...
    @validate_call(config={'defer_build': True})
    def delete_namespaced_eviction(
        self,
    ...
    @validate_call(config={'defer_build': True})
    def delete_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _delete_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def delete_namespaced_eviction_request(
        self,
        ...
        _param = self._delete_namespaced_eviction_request_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def _delete_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def list_eviction_for_all_namespaces(
        self,
        ...
        _param = self._list_eviction_for_all_namespaces_serialize(
    ...
    @validate_call(config={'defer_build': True})
    def list_eviction_for_all_namespaces_with_http_info(
        self,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Tuple[V1alpha1EvictionList, int, Any]:
        """list_eviction_for_all_namespaces
    ...
    def _list_eviction_for_all_namespaces_serialize(
        self,
    ...
    def list_eviction_request_for_all_namespaces(
        ...
        _param = self._list_eviction_request_for_all_namespaces_serialize(
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
            field_selector=field_selector,
            label_selector=label_selector,
    ...
    @validate_call(config={'defer_build': True})
    def list_eviction_request_for_all_namespaces_with_http_info(
        self,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Tuple[V1alpha1EvictionRequestList, int, Any]:
        """list_eviction_request_for_all_namespaces
    ...
    def _list_eviction_request_for_all_namespaces_serialize(
        self,
        allow_watch_bookmarks,
        _continue,
        field_selector,
    ...
    def list_namespaced_eviction(
        ...
        _param = self._list_namespaced_eviction_serialize(
            namespace=namespace,
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
    ...
    @validate_call(config={'defer_build': True})
    def list_namespaced_eviction_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
    ...
    def _list_namespaced_eviction_serialize(
        self,
        namespace,
        pretty,
        allow_watch_bookmarks,
    ...
    @validate_call(config={'defer_build': True})
    def list_namespaced_eviction_request(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        ...
        _param = self._list_namespaced_eviction_request_serialize(
            namespace=namespace,
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
    ...
    @validate_call(config={'defer_build': True})
    def list_namespaced_eviction_request_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
    ...
    def _list_namespaced_eviction_request_serialize(
        self,
        namespace,
        pretty,
        allow_watch_bookmarks,
    ...
    def patch_namespaced_eviction(
        ...
        _param = self._patch_namespaced_eviction_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    def patch_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    def _patch_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    def patch_namespaced_eviction_request(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
        ...
        _param = self._patch_namespaced_eviction_request_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    def patch_namespaced_eviction_request_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    def _patch_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    def patch_namespaced_eviction_request_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
        ...
        _param = self._patch_namespaced_eviction_request_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    def patch_namespaced_eviction_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    def _patch_namespaced_eviction_request_status_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    def patch_namespaced_eviction_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
        ...
        _param = self._patch_namespaced_eviction_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    def patch_namespaced_eviction_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    def _patch_namespaced_eviction_status_serialize(
        self,
        name,
        namespace,
        body,
    ...
    def read_namespaced_eviction(
        ...
        _param = self._read_namespaced_eviction_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    @validate_call(config={'defer_build': True})
    def read_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _read_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def read_namespaced_eviction_request(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    def read_namespaced_eviction_request_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _read_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def read_namespaced_eviction_request_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _param = self._read_namespaced_eviction_request_status_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    @validate_call(config={'defer_build': True})
    def read_namespaced_eviction_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _read_namespaced_eviction_request_status_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def read_namespaced_eviction_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _param = self._read_namespaced_eviction_status_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    @validate_call(config={'defer_build': True})
    def read_namespaced_eviction_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _read_namespaced_eviction_status_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    def replace_namespaced_eviction(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
        ...
        _param = self._replace_namespaced_eviction_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    def replace_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
    ...
    def _replace_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    def replace_namespaced_eviction_request(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
    ...
    @validate_call(config={'defer_build': True})
    def replace_namespaced_eviction_request_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
    ...
    def _replace_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        body,
    ...
    def replace_namespaced_eviction_request_status(
        ...
        _param = self._replace_namespaced_eviction_request_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    def _replace_namespaced_eviction_request_status_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    def replace_namespaced_eviction_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
        ...
        _param = self._replace_namespaced_eviction_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    def replace_namespaced_eviction_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
    ...
    def _replace_namespaced_eviction_status_serialize(
        self,
        name,
        namespace,
        body,
