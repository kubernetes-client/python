...
class StorageV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_namespaced_csi_storage_capacity_endpoint = _Endpoint(
            settings={
                'response_type': (V1beta1CSIStorageCapacity,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities',
        ...
        self.delete_namespaced_csi_storage_capacity_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}',
        ...
        self.list_csi_storage_capacity_for_all_namespaces_endpoint = _Endpoint(
            settings={
                'response_type': (V1beta1CSIStorageCapacityList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/storage.k8s.io/v1beta1/csistoragecapacities',
