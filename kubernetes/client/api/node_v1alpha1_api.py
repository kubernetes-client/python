...
class NodeV1alpha1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_runtime_class = _Endpoint(
            settings={
            ...
            callable=__create_runtime_class
        )

        def __delete_collection_runtime_class(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_runtime_class = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_runtime_class
        )

        def __delete_runtime_class(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_runtime_class = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__delete_runtime_class
        )
        ...
        self.list_runtime_class = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_runtime_class
        )

        def __patch_runtime_class(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_runtime_class = _Endpoint(
            settings={
                'response_type': (V1alpha1RuntimeClass,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_runtime_class
        )

        def __read_runtime_class(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_runtime_class = _Endpoint(
            settings={
                'response_type': (V1alpha1RuntimeClass,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_runtime_class
        )

        def __replace_runtime_class(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_runtime_class = _Endpoint(
            settings={
                'response_type': (V1alpha1RuntimeClass,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_runtime_class
        )
