...
class NodeV1alpha1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_runtime_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1alpha1RuntimeClass,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/runtimeclasses',
                'operation_id': 'create_runtime_class',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_collection_runtime_class_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/runtimeclasses',
                'operation_id': 'delete_collection_runtime_class',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.delete_runtime_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}',
                'operation_id': 'delete_runtime_class',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_api_resources_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/',
        ...
        self.list_runtime_class_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/runtimeclasses',
                'operation_id': 'list_runtime_class',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_runtime_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1alpha1RuntimeClass,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}',
                'operation_id': 'patch_runtime_class',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.read_runtime_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1alpha1RuntimeClass,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}',
                'operation_id': 'read_runtime_class',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.replace_runtime_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1alpha1RuntimeClass,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}',
                'operation_id': 'replace_runtime_class',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def create_runtime_class(
        ...
        **kwargs
        ...
        kwargs['body'] = \
            body
        return self.create_runtime_class_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_collection_runtime_class(
        ...
        **kwargs
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.delete_collection_runtime_class_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_runtime_class(
        ...
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.delete_runtime_class_endpoint.call_with_http_info(**kwargs)
    ...
    def list_runtime_class(
        ...
        **kwargs
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_runtime_class_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_runtime_class(
        ...
        **kwargs
        ...
        kwargs['body'] = \
            body
        return self.patch_runtime_class_endpoint.call_with_http_info(**kwargs)
    ...
    def read_runtime_class(
        ...
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.read_runtime_class_endpoint.call_with_http_info(**kwargs)
    ...
    def replace_runtime_class(
        ...
        **kwargs
        ...
        kwargs['body'] = \
            body
        return self.replace_runtime_class_endpoint.call_with_http_info(**kwargs)
