...
class ApiextensionsV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_custom_resource_definition(
            self,
            body,
            **kwargs
        ):
        ...
        self.create_custom_resource_definition = _Endpoint(
            settings={
                'response_type': (V1beta1CustomResourceDefinition,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions',
            ...
            callable=__create_custom_resource_definition
        )

        def __delete_collection_custom_resource_definition(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_custom_resource_definition = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_custom_resource_definition
        )

        def __delete_custom_resource_definition(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_custom_resource_definition = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}',
            ...
            api_client=api_client,
            callable=__delete_custom_resource_definition
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/apiextensions.k8s.io/v1beta1/',
        ...
        def __list_custom_resource_definition(
            self,
            **kwargs
        ):
        ...
        self.list_custom_resource_definition = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_custom_resource_definition
        )

        def __patch_custom_resource_definition(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_custom_resource_definition = _Endpoint(
            settings={
                'response_type': (V1beta1CustomResourceDefinition,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_custom_resource_definition
        )

        def __patch_custom_resource_definition_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_custom_resource_definition_status = _Endpoint(
            settings={
                'response_type': (V1beta1CustomResourceDefinition,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}/status',
            ...
            api_client=api_client,
            callable=__patch_custom_resource_definition_status
        )

        def __read_custom_resource_definition(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_custom_resource_definition = _Endpoint(
            settings={
                'response_type': (V1beta1CustomResourceDefinition,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_custom_resource_definition
        )

        def __read_custom_resource_definition_status(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_custom_resource_definition_status = _Endpoint(
            settings={
                'response_type': (V1beta1CustomResourceDefinition,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_custom_resource_definition_status
        )

        def __replace_custom_resource_definition(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_custom_resource_definition = _Endpoint(
            settings={
                'response_type': (V1beta1CustomResourceDefinition,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_custom_resource_definition
        )

        def __replace_custom_resource_definition_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_custom_resource_definition_status = _Endpoint(
            settings={
                'response_type': (V1beta1CustomResourceDefinition,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_custom_resource_definition_status
        )
