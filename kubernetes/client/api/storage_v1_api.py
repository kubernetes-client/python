...
class StorageV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __patch_volume_attachment_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_volume_attachment_status = _Endpoint(
            settings={
                'response_type': (V1VolumeAttachment,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_volume_attachment_status
        )
        ...
        def __read_volume_attachment_status(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_volume_attachment_status = _Endpoint(
            settings={
                'response_type': (V1VolumeAttachment,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_volume_attachment_status
        )
        ...
        def __replace_volume_attachment_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_volume_attachment_status = _Endpoint(
            settings={
                'response_type': (V1VolumeAttachment,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_volume_attachment_status
        )
