...
class NetworkingV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_namespaced_network_policy(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.create_namespaced_network_policy = _Endpoint(
            settings={
            ...
            callable=__create_namespaced_network_policy
        )

        def __delete_collection_namespaced_network_policy(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_network_policy = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_network_policy
        )

        def __delete_namespaced_network_policy(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_network_policy = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__delete_namespaced_network_policy
        )
        ...
        def __list_namespaced_network_policy(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_network_policy = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_namespaced_network_policy
        )

        def __list_network_policy_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_network_policy_for_all_namespaces = _Endpoint(
            settings={
                'response_type': (V1NetworkPolicyList,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__list_network_policy_for_all_namespaces
        )

        def __patch_namespaced_network_policy(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_network_policy = _Endpoint(
            settings={
                'response_type': (V1NetworkPolicy,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_network_policy
        )

        def __read_namespaced_network_policy(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_network_policy = _Endpoint(
            settings={
                'response_type': (V1NetworkPolicy,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_network_policy
        )

        def __replace_namespaced_network_policy(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_network_policy = _Endpoint(
            settings={
                'response_type': (V1NetworkPolicy,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_network_policy
        )
