...
class DiscoveryV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_namespaced_endpoint_slice(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.create_namespaced_endpoint_slice = _Endpoint(
            settings={
            ...
            callable=__create_namespaced_endpoint_slice
        )

        def __delete_collection_namespaced_endpoint_slice(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_endpoint_slice = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_endpoint_slice
        )

        def __delete_namespaced_endpoint_slice(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_endpoint_slice = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__delete_namespaced_endpoint_slice
        )
        ...
        def __list_endpoint_slice_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_endpoint_slice_for_all_namespaces = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_endpoint_slice_for_all_namespaces
        )

        def __list_namespaced_endpoint_slice(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_endpoint_slice = _Endpoint(
            settings={
                'response_type': (V1beta1EndpointSliceList,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__list_namespaced_endpoint_slice
        )

        def __patch_namespaced_endpoint_slice(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_endpoint_slice = _Endpoint(
            settings={
                'response_type': (V1beta1EndpointSlice,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_endpoint_slice
        )

        def __read_namespaced_endpoint_slice(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_endpoint_slice = _Endpoint(
            settings={
                'response_type': (V1beta1EndpointSlice,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_endpoint_slice
        )

        def __replace_namespaced_endpoint_slice(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_endpoint_slice = _Endpoint(
            settings={
                'response_type': (V1beta1EndpointSlice,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_endpoint_slice
        )
