...
class NetworkingV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ingress_class = _Endpoint(
            settings={
                'response_type': (V1beta1IngressClass,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/ingressclasses',
            ...
            callable=__create_ingress_class
        )

        def __create_namespaced_ingress(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.create_namespaced_ingress = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1Ingress,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses',
            ...
            api_client=api_client,
            callable=__create_namespaced_ingress
        )

        def __delete_collection_ingress_class(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_ingress_class = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_ingress_class
        )

        def __delete_collection_namespaced_ingress(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_ingress = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_ingress
        )

        def __delete_ingress_class(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_ingress_class = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/ingressclasses/{name}',
            ...
            api_client=api_client,
            callable=__delete_ingress_class
        )

        def __delete_namespaced_ingress(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_ingress = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}',
            ...
            api_client=api_client,
            callable=__delete_namespaced_ingress
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/',
        ...
        self.list_ingress_class = _Endpoint(
            settings={
                'response_type': (V1beta1IngressClassList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/ingressclasses',
            ...
            api_client=api_client,
            callable=__list_ingress_class
        )

        def __list_ingress_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_ingress_for_all_namespaces = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1IngressList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/ingresses',
            ...
            api_client=api_client,
            callable=__list_ingress_for_all_namespaces
        )

        def __list_namespaced_ingress(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_ingress = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1IngressList,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__list_namespaced_ingress
        )

        def __patch_ingress_class(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_ingress_class = _Endpoint(
            settings={
                'response_type': (V1beta1IngressClass,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_ingress_class
        )

        def __patch_namespaced_ingress(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_ingress = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1Ingress,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_ingress
        )

        def __patch_namespaced_ingress_status(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_ingress_status = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1Ingress,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status',
            ...
            api_client=api_client,
            callable=__patch_namespaced_ingress_status
        )

        def __read_ingress_class(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_ingress_class = _Endpoint(
            settings={
                'response_type': (V1beta1IngressClass,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_ingress_class
        )

        def __read_namespaced_ingress(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_ingress = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1Ingress,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_ingress
        )

        def __read_namespaced_ingress_status(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_ingress_status = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1Ingress,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_ingress_status
        )

        def __replace_ingress_class(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_ingress_class = _Endpoint(
            settings={
                'response_type': (V1beta1IngressClass,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_ingress_class
        )

        def __replace_namespaced_ingress(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_ingress = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1Ingress,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_ingress
        )

        def __replace_namespaced_ingress_status(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_ingress_status = _Endpoint(
            settings={
                'response_type': (NetworkingV1beta1Ingress,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_ingress_status
        )
