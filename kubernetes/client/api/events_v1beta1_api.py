...
class EventsV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_namespaced_event = _Endpoint(
            settings={
                'response_type': (V1beta1Event,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events',
            ...
            callable=__create_namespaced_event
        )

        def __delete_collection_namespaced_event(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_event = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_event
        )

        def __delete_namespaced_event(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_event = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}',
            ...
            api_client=api_client,
            callable=__delete_namespaced_event
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/events.k8s.io/v1beta1/',
        ...
        def __list_event_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_event_for_all_namespaces = _Endpoint(
            settings={
                'response_type': (V1beta1EventList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/events.k8s.io/v1beta1/events',
            ...
            api_client=api_client,
            callable=__list_event_for_all_namespaces
        )

        def __list_namespaced_event(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_event = _Endpoint(
            settings={
                'response_type': (V1beta1EventList,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__list_namespaced_event
        )

        def __patch_namespaced_event(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_event = _Endpoint(
            settings={
                'response_type': (V1beta1Event,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_event
        )

        def __read_namespaced_event(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_event = _Endpoint(
            settings={
                'response_type': (V1beta1Event,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_event
        )

        def __replace_namespaced_event(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_event = _Endpoint(
            settings={
                'response_type': (V1beta1Event,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_event
        )
