...
class SchedulingV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_priority_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1PriorityClass,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/scheduling.k8s.io/v1/priorityclasses',
        ...
        self.delete_collection_priority_class_endpoint = _Endpoint(
            settings={
        ...
        self.delete_priority_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/scheduling.k8s.io/v1/priorityclasses/{name}',
        ...
        self.get_api_resources_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/scheduling.k8s.io/v1/',
        ...
        self.list_priority_class_endpoint = _Endpoint(
            settings={
        ...
        self.patch_priority_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1PriorityClass,),
                'auth': [
                    'BearerToken'
        ...
        self.read_priority_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1PriorityClass,),
                'auth': [
                    'BearerToken'
        ...
        self.replace_priority_class_endpoint = _Endpoint(
            settings={
                'response_type': (V1PriorityClass,),
                'auth': [
                    'BearerToken'
    ...
    def create_priority_class(
        ...
        **kwargs
        ...
        kwargs['body'] = \
            body
        return self.create_priority_class_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_collection_priority_class(
        ...
        **kwargs
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.delete_collection_priority_class_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_priority_class(
        ...
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.delete_priority_class_endpoint.call_with_http_info(**kwargs)
    ...
    def list_priority_class(
        ...
        **kwargs
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_priority_class_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_priority_class(
        ...
        **kwargs
        ...
        kwargs['body'] = \
            body
        return self.patch_priority_class_endpoint.call_with_http_info(**kwargs)
    ...
    def read_priority_class(
        ...
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.read_priority_class_endpoint.call_with_http_info(**kwargs)
    ...
    def replace_priority_class(
        ...
        **kwargs
        ...
        kwargs['body'] = \
            body
        return self.replace_priority_class_endpoint.call_with_http_info(**kwargs)
