...
class CoordinationV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_namespaced_lease = _Endpoint(
            settings={
                'response_type': (V1beta1Lease,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases',
            ...
            callable=__create_namespaced_lease
        )

        def __delete_collection_namespaced_lease(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_lease = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_lease
        )

        def __delete_namespaced_lease(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_lease = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}',
            ...
            api_client=api_client,
            callable=__delete_namespaced_lease
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/coordination.k8s.io/v1beta1/',
        ...
        def __list_lease_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_lease_for_all_namespaces = _Endpoint(
            settings={
                'response_type': (V1beta1LeaseList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/coordination.k8s.io/v1beta1/leases',
            ...
            api_client=api_client,
            callable=__list_lease_for_all_namespaces
        )

        def __list_namespaced_lease(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_lease = _Endpoint(
            settings={
                'response_type': (V1beta1LeaseList,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__list_namespaced_lease
        )

        def __patch_namespaced_lease(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_lease = _Endpoint(
            settings={
                'response_type': (V1beta1Lease,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_lease
        )

        def __read_namespaced_lease(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_lease = _Endpoint(
            settings={
                'response_type': (V1beta1Lease,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_lease
        )

        def __replace_namespaced_lease(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_lease = _Endpoint(
            settings={
                'response_type': (V1beta1Lease,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_lease
        )
