...
class ApiregistrationV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_api_service = _Endpoint(
            settings={
                'response_type': (V1beta1APIService,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/apiregistration.k8s.io/v1beta1/apiservices',
            ...
            callable=__create_api_service
        )

        def __delete_api_service(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_api_service = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}',
            ...
            api_client=api_client,
            callable=__delete_api_service
        )

        def __delete_collection_api_service(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_api_service = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__delete_collection_api_service
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/apiregistration.k8s.io/v1beta1/',
        ...
        self.list_api_service = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_api_service
        )

        def __patch_api_service(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_api_service = _Endpoint(
            settings={
                'response_type': (V1beta1APIService,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_api_service
        )

        def __patch_api_service_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_api_service_status = _Endpoint(
            settings={
                'response_type': (V1beta1APIService,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status',
            ...
            api_client=api_client,
            callable=__patch_api_service_status
        )

        def __read_api_service(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_api_service = _Endpoint(
            settings={
                'response_type': (V1beta1APIService,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_api_service
        )

        def __read_api_service_status(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_api_service_status = _Endpoint(
            settings={
                'response_type': (V1beta1APIService,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_api_service_status
        )

        def __replace_api_service(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_api_service = _Endpoint(
            settings={
                'response_type': (V1beta1APIService,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_api_service
        )

        def __replace_api_service_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_api_service_status = _Endpoint(
            settings={
                'response_type': (V1beta1APIService,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_api_service_status
        )
