...
class WellKnownApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_service_account_issuer_open_id_configuration_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'BearerToken'
                ...
                'operation_id': 'get_service_account_issuer_open_id_configuration',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_service_account_issuer_open_id_configuration(
        ...
        **kwargs
        ...
        return self.get_service_account_issuer_open_id_configuration_endpoint.call_with_http_info(**kwargs)
