...
class SchedulingV1alpha1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_priority_class = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityClass,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/priorityclasses',
                'operation_id': 'create_priority_class',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__create_priority_class
        )

        def __delete_collection_priority_class(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_priority_class = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/priorityclasses',
                'operation_id': 'delete_collection_priority_class',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_collection_priority_class
        )

        def __delete_priority_class(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_priority_class = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}',
                'operation_id': 'delete_priority_class',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_priority_class
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/',
        ...
        self.list_priority_class = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/priorityclasses',
                'operation_id': 'list_priority_class',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_priority_class
        )

        def __patch_priority_class(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_priority_class = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityClass,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}',
                'operation_id': 'patch_priority_class',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__patch_priority_class
        )

        def __read_priority_class(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_priority_class = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityClass,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}',
                'operation_id': 'read_priority_class',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__read_priority_class
        )

        def __replace_priority_class(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_priority_class = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityClass,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}',
                'operation_id': 'replace_priority_class',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__replace_priority_class
        )
