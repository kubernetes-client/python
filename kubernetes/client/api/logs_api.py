...
class LogsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.log_file_handler = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'BearerToken'
            ...
            callable=__log_file_handler
        )

        def __log_file_list_handler(
            self,
            **kwargs
        ):
        ...
        self.log_file_list_handler = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__log_file_list_handler
        )
