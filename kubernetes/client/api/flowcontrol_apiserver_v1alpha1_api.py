...
class FlowcontrolApiserverV1alpha1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_flow_schema = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchema,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas',
            ...
            callable=__create_flow_schema
        )

        def __create_priority_level_configuration(
            self,
            body,
            **kwargs
        ):
        ...
        self.create_priority_level_configuration = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfiguration,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations',
            ...
            api_client=api_client,
            callable=__create_priority_level_configuration
        )

        def __delete_collection_flow_schema(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_flow_schema = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_flow_schema
        )

        def __delete_collection_priority_level_configuration(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_priority_level_configuration = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__delete_collection_priority_level_configuration
        )

        def __delete_flow_schema(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_flow_schema = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}',
            ...
            api_client=api_client,
            callable=__delete_flow_schema
        )

        def __delete_priority_level_configuration(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_priority_level_configuration = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}',
            ...
            api_client=api_client,
            callable=__delete_priority_level_configuration
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/',
        ...
        self.list_flow_schema = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchemaList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas',
            ...
            api_client=api_client,
            callable=__list_flow_schema
        )

        def __list_priority_level_configuration(
            self,
            **kwargs
        ):
        ...
        self.list_priority_level_configuration = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfigurationList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations',
            ...
            api_client=api_client,
            callable=__list_priority_level_configuration
        )

        def __patch_flow_schema(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_flow_schema = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchema,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_flow_schema
        )

        def __patch_flow_schema_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_flow_schema_status = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchema,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}/status',
            ...
            api_client=api_client,
            callable=__patch_flow_schema_status
        )

        def __patch_priority_level_configuration(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_priority_level_configuration = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfiguration,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_priority_level_configuration
        )

        def __patch_priority_level_configuration_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_priority_level_configuration_status = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfiguration,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}/status',
            ...
            api_client=api_client,
            callable=__patch_priority_level_configuration_status
        )

        def __read_flow_schema(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_flow_schema = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchema,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_flow_schema
        )

        def __read_flow_schema_status(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_flow_schema_status = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchema,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_flow_schema_status
        )

        def __read_priority_level_configuration(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_priority_level_configuration = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfiguration,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_priority_level_configuration
        )

        def __read_priority_level_configuration_status(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_priority_level_configuration_status = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfiguration,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_priority_level_configuration_status
        )

        def __replace_flow_schema(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_flow_schema = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchema,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_flow_schema
        )

        def __replace_flow_schema_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_flow_schema_status = _Endpoint(
            settings={
                'response_type': (V1alpha1FlowSchema,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_flow_schema_status
        )

        def __replace_priority_level_configuration(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_priority_level_configuration = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfiguration,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_priority_level_configuration
        )

        def __replace_priority_level_configuration_status(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_priority_level_configuration_status = _Endpoint(
            settings={
                'response_type': (V1alpha1PriorityLevelConfiguration,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_priority_level_configuration_status
        )
