...
class BatchV2alpha1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_namespaced_cron_job(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.create_namespaced_cron_job = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJob,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs',
            ...
            callable=__create_namespaced_cron_job
        )

        def __delete_collection_namespaced_cron_job(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_cron_job = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_cron_job
        )

        def __delete_namespaced_cron_job(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_cron_job = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}',
            ...
            api_client=api_client,
            callable=__delete_namespaced_cron_job
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/batch/v2alpha1/',
        ...
        def __list_cron_job_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_cron_job_for_all_namespaces = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJobList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/batch/v2alpha1/cronjobs',
            ...
            api_client=api_client,
            callable=__list_cron_job_for_all_namespaces
        )

        def __list_namespaced_cron_job(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_cron_job = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJobList,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__list_namespaced_cron_job
        )

        def __patch_namespaced_cron_job(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_cron_job = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJob,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_cron_job
        )

        def __patch_namespaced_cron_job_status(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_cron_job_status = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJob,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}/status',
            ...
            api_client=api_client,
            callable=__patch_namespaced_cron_job_status
        )

        def __read_namespaced_cron_job(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_cron_job = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJob,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_cron_job
        )

        def __read_namespaced_cron_job_status(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_cron_job_status = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJob,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_cron_job_status
        )

        def __replace_namespaced_cron_job(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_cron_job = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJob,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_cron_job
        )

        def __replace_namespaced_cron_job_status(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_cron_job_status = _Endpoint(
            settings={
                'response_type': (V2alpha1CronJob,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_cron_job_status
        )
