...
class AuditregistrationV1alpha1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_audit_sink = _Endpoint(
            settings={
                'response_type': (V1alpha1AuditSink,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/auditregistration.k8s.io/v1alpha1/auditsinks',
                'operation_id': 'create_audit_sink',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__create_audit_sink
        )

        def __delete_audit_sink(
            self,
            name,
            **kwargs
        ):
        ...
        self.delete_audit_sink = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}',
                'operation_id': 'delete_audit_sink',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_audit_sink
        )

        def __delete_collection_audit_sink(
            self,
            **kwargs
        ):
        ...
        self.delete_collection_audit_sink = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/auditregistration.k8s.io/v1alpha1/auditsinks',
                'operation_id': 'delete_collection_audit_sink',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_collection_audit_sink
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/auditregistration.k8s.io/v1alpha1/',
        ...
        self.list_audit_sink = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_audit_sink
        )

        def __patch_audit_sink(
            self,
            name,
            body,
            **kwargs
        ...
        self.patch_audit_sink = _Endpoint(
            settings={
                'response_type': (V1alpha1AuditSink,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_audit_sink
        )

        def __read_audit_sink(
            self,
            name,
            **kwargs
        ):
        ...
        self.read_audit_sink = _Endpoint(
            settings={
                'response_type': (V1alpha1AuditSink,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_audit_sink
        )

        def __replace_audit_sink(
            self,
            name,
            body,
            **kwargs
        ...
        self.replace_audit_sink = _Endpoint(
            settings={
                'response_type': (V1alpha1AuditSink,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}',
                'operation_id': 'replace_audit_sink',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
