...
class RbacAuthorizationV1Api(object):
    ...
    def delete_collection_cluster_role_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['pretty', 'allow_watch_bookmarks', '_continue', 'dry_run', 'field_selector', 'grace_period_seconds', 'label_selector', 'limit', 'orphan_dependents', 'propagation_policy', 'resource_version', 'timeout_seconds', 'watch', 'v1_delete_options']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
