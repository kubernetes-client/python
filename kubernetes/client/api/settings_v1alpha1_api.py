...
class SettingsV1alpha1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_namespaced_pod_preset(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.create_namespaced_pod_preset = _Endpoint(
            settings={
                'response_type': (V1alpha1PodPreset,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets',
                'operation_id': 'create_namespaced_pod_preset',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__create_namespaced_pod_preset
        )

        def __delete_collection_namespaced_pod_preset(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_pod_preset = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets',
                'operation_id': 'delete_collection_namespaced_pod_preset',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_pod_preset
        )

        def __delete_namespaced_pod_preset(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_pod_preset = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}',
                'operation_id': 'delete_namespaced_pod_preset',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_namespaced_pod_preset
        )
        ...
        self.get_api_resources = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/',
        ...
        def __list_namespaced_pod_preset(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_pod_preset = _Endpoint(
            settings={
                ...
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets',
                'operation_id': 'list_namespaced_pod_preset',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_namespaced_pod_preset
        )

        def __list_pod_preset_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_pod_preset_for_all_namespaces = _Endpoint(
            settings={
                'response_type': (V1alpha1PodPresetList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/podpresets',
                'operation_id': 'list_pod_preset_for_all_namespaces',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_pod_preset_for_all_namespaces
        )

        def __patch_namespaced_pod_preset(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_pod_preset = _Endpoint(
            settings={
                'response_type': (V1alpha1PodPreset,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}',
                'operation_id': 'patch_namespaced_pod_preset',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__patch_namespaced_pod_preset
        )

        def __read_namespaced_pod_preset(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_pod_preset = _Endpoint(
            settings={
                'response_type': (V1alpha1PodPreset,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}',
                'operation_id': 'read_namespaced_pod_preset',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__read_namespaced_pod_preset
        )

        def __replace_namespaced_pod_preset(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_pod_preset = _Endpoint(
            settings={
                'response_type': (V1alpha1PodPreset,),
                'auth': [
                    'BearerToken'
                ...
                'endpoint_path': '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}',
                'operation_id': 'replace_namespaced_pod_preset',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__replace_namespaced_pod_preset
        )
