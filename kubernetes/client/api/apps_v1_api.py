...
class AppsV1Api(object):
    ...
    def delete_collection_namespaced_envoy_filter(self, namespace, **kwargs):  # noqa: E501
        """delete_collection_namespaced_envoy_filter  # noqa: E501

        delete collection of EnvoyFilter  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_collection_namespaced_envoy_filter(namespace, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_collection_namespaced_envoy_filter_with_http_info(namespace, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_collection_namespaced_envoy_filter_with_http_info(namespace, **kwargs)  # noqa: E501
            return data

    def delete_collection_namespaced_envoy_filter_with_http_info(self, namespace, **kwargs):  # noqa: E501
        """delete_collection_namespaced_envoy_filter  # noqa: E501

        delete collection of EnvoyFilter  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_collection_namespaced_envoy_filter_with_http_info(namespace, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_collection_namespaced_envoy_filter" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'namespace' is set
        if ('namespace' not in local_var_params or
                local_var_params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `delete_collection_namespaced_envoy_filter`")  # noqa: E501
