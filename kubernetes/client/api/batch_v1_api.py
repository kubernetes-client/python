...
class BatchV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_namespaced_job = _Endpoint(
            settings={
                'response_type': (V1Job,),
                'auth': [
                    'BearerToken'
            ...
            callable=__create_namespaced_job
        )

        def __delete_collection_namespaced_job(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.delete_collection_namespaced_job = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__delete_collection_namespaced_job
        )

        def __delete_namespaced_job(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.delete_namespaced_job = _Endpoint(
            settings={
                'response_type': (V1Status,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__delete_namespaced_job
        )
        ...
        def __list_job_for_all_namespaces(
            self,
            **kwargs
        ):
        ...
        self.list_job_for_all_namespaces = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_job_for_all_namespaces
        )

        def __list_namespaced_job(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.list_namespaced_job = _Endpoint(
            settings={
                'response_type': (V1JobList,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__list_namespaced_job
        )

        def __patch_namespaced_job(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_job = _Endpoint(
            settings={
                'response_type': (V1Job,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_job
        )

        def __patch_namespaced_job_status(
            self,
            name,
            namespace,
            body,
        ...
        self.patch_namespaced_job_status = _Endpoint(
            settings={
                'response_type': (V1Job,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__patch_namespaced_job_status
        )

        def __read_namespaced_job(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_job = _Endpoint(
            settings={
                'response_type': (V1Job,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_job
        )

        def __read_namespaced_job_status(
            self,
            name,
            namespace,
            **kwargs
        ...
        self.read_namespaced_job_status = _Endpoint(
            settings={
                'response_type': (V1Job,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__read_namespaced_job_status
        )

        def __replace_namespaced_job(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_job = _Endpoint(
            settings={
                'response_type': (V1Job,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_job
        )

        def __replace_namespaced_job_status(
            self,
            name,
            namespace,
            body,
        ...
        self.replace_namespaced_job_status = _Endpoint(
            settings={
                'response_type': (V1Job,),
                'auth': [
                    'BearerToken'
            ...
            api_client=api_client,
            callable=__replace_namespaced_job_status
        )
