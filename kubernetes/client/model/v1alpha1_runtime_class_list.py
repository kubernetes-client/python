...
def lazy_import():
    ...
    globals()['V1alpha1RuntimeClass'] = V1alpha1RuntimeClass


class V1alpha1RuntimeClassList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1RuntimeClass],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1alpha1RuntimeClassList - a model defined in OpenAPI

        Args:
            items ([V1alpha1RuntimeClass]): Items is a list of schema objects.
