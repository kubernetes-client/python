...
def lazy_import():
    ...
    globals()['V1beta2PriorityLevelConfiguration'] = V1beta2PriorityLevelConfiguration


class V1beta2PriorityLevelConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta2PriorityLevelConfiguration],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        ...
        Args:
            items ([V1beta2PriorityLevelConfiguration]): `items` is a list of request-priorities.
