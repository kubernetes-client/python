...
def lazy_import():
    ...
    globals()['V1beta1CertificateSigningRequest'] = V1beta1CertificateSigningRequest


class V1beta1CertificateSigningRequestList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1CertificateSigningRequest],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1CertificateSigningRequestList - a model defined in OpenAPI
