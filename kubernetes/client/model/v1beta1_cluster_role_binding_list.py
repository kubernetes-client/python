...
def lazy_import():
    ...
    globals()['V1beta1ClusterRoleBinding'] = V1beta1ClusterRoleBinding


class V1beta1ClusterRoleBindingList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1ClusterRoleBinding],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1ClusterRoleBindingList - a model defined in OpenAPI

        Args:
            items ([V1beta1ClusterRoleBinding]): Items is a list of ClusterRoleBindings
