...
def lazy_import():
    ...
    globals()['V1alpha1StorageVersionStatus'] = V1alpha1StorageVersionStatus


class V1alpha1StorageVersion(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'status': (V1alpha1StorageVersionStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, spec, status, *args, **kwargs):  # noqa: E501
        """V1alpha1StorageVersion - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, spec, status, *args, **kwargs):  # noqa: E501
        """V1alpha1StorageVersion - a model defined in OpenAPI
