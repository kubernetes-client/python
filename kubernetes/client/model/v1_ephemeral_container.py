...
class V1EphemeralContainer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'target_container_name': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'target_container_name': 'targetContainerName',  # noqa: E501
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """V1EphemeralContainer - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            image (str): Docker image name. More info: https://kubernetes.io/docs/concepts/containers/images. [optional]  # noqa: E501
            ...
            ports ([V1ContainerPort]): Ports are not allowed for ephemeral containers.. [optional]  # noqa: E501
            ...
            target_container_name (str): If set, the name of the container from PodSpec that this ephemeral container targets. The ephemeral container will be run in the namespaces (IPC, PID, etc) of this container. If not set then the ephemeral container uses the namespaces configured in the Pod spec.  The container runtime must implement support for this feature. If the runtime does not support namespace targeting then the result of setting this field is undefined.. [optional]  # noqa: E501
            ...
            volume_mounts ([V1VolumeMount]): Pod volumes to mount into the container's filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated.. [optional]  # noqa: E501
