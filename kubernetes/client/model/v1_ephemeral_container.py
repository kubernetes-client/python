...
class V1EphemeralContainer(ModelNormal):
    ...
    def __init__(self, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            target_container_name (str): If set, the name of the container from PodSpec that this ephemeral container targets. The ephemeral container will be run in the namespaces (IPC, PID, etc) of this container. If not set then the ephemeral container is run in whatever namespaces are shared for the pod. Note that the container runtime must support this feature.. [optional]  # noqa: E501
