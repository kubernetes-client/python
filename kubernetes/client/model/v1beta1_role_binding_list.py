...
def lazy_import():
    ...
    globals()['V1beta1RoleBinding'] = V1beta1RoleBinding


class V1beta1RoleBindingList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1RoleBinding],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1RoleBindingList - a model defined in OpenAPI

        Args:
            items ([V1beta1RoleBinding]): Items is a list of RoleBindings
