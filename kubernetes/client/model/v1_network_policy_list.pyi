        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1NetworkPolicy']:
                        return V1NetworkPolicy
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1NetworkPolicy'], typing.List['V1NetworkPolicy']],
                ...
                def __getitem__(self, i: int) -> 'V1NetworkPolicy':
