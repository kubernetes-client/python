...
class V2beta2ContainerResourceMetricSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, container, name, target, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, container, name, target, *args, **kwargs):  # noqa: E501
        """V2beta2ContainerResourceMetricSource - a model defined in OpenAPI
