...
class V1ReplicationController(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1ReplicationControllerSpec']:
                return V1ReplicationControllerSpec
        
            @staticmethod
            def status() -> typing.Type['V1ReplicationControllerStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1ReplicationControllerSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1ReplicationControllerStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1ReplicationControllerSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1ReplicationControllerStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1ReplicationControllerSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1ReplicationControllerStatus', schemas.Unset] = schemas.unset,
