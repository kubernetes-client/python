...
def lazy_import():
    ...
    globals()['V1alpha1RuntimeClassSpec'] = V1alpha1RuntimeClassSpec


class V1alpha1RuntimeClass(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (V1alpha1RuntimeClassSpec,),  # noqa: E501
    ...
    def __init__(self, spec, *args, **kwargs):  # noqa: E501
        """V1alpha1RuntimeClass - a model defined in OpenAPI
