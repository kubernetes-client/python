...
def lazy_import():
    ...
    globals()['NetworkingV1beta1Ingress'] = NetworkingV1beta1Ingress
    globals()['V1ListMeta'] = V1ListMeta


class NetworkingV1beta1IngressList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([NetworkingV1beta1Ingress],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """NetworkingV1beta1IngressList - a model defined in OpenAPI

        Args:
            items ([NetworkingV1beta1Ingress]): Items is the list of Ingress.
