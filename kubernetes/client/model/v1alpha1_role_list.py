...
def lazy_import():
    ...
    globals()['V1alpha1Role'] = V1alpha1Role


class V1alpha1RoleList(ModelNormal):
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1RoleList - a model defined in OpenAPI

        Args:
            items ([V1alpha1Role]): Items is a list of Roles
