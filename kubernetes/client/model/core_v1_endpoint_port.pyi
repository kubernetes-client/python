...
class CoreV1EndpointPort(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["port", "appProtocol", "name", "protocol", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["port", "appProtocol", "name", "protocol", ], str]):
