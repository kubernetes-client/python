...
def lazy_import():
    ...
    globals()['V1beta1Role'] = V1beta1Role


class V1beta1RoleList(ModelNormal):
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1RoleList - a model defined in OpenAPI

        Args:
            items ([V1beta1Role]): Items is a list of Roles
