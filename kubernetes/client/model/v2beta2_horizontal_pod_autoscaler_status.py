...
def lazy_import():
    ...
    globals()['V2beta2HorizontalPodAutoscalerCondition'] = V2beta2HorizontalPodAutoscalerCondition
    globals()['V2beta2MetricStatus'] = V2beta2MetricStatus


class V2beta2HorizontalPodAutoscalerStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'conditions': ([V2beta2HorizontalPodAutoscalerCondition],),  # noqa: E501
            'current_replicas': (int,),  # noqa: E501
            'desired_replicas': (int,),  # noqa: E501
            'current_metrics': ([V2beta2MetricStatus],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, conditions, current_replicas, desired_replicas, *args, **kwargs):  # noqa: E501
        """V2beta2HorizontalPodAutoscalerStatus - a model defined in OpenAPI

        Args:
            conditions ([V2beta2HorizontalPodAutoscalerCondition]): conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.
        ...
        Keyword Args:
            ...
            current_metrics ([V2beta2MetricStatus]): currentMetrics is the last read state of the metrics used by this autoscaler.. [optional]  # noqa: E501
