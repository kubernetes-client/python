...
class V1NonResourceAttributes(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["path", "verb", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["path", "verb", ], str]):
