...
class V1beta1TokenReviewSpec(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """V1beta1TokenReviewSpec - a model defined in OpenAPI
