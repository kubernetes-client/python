...
class V1Taint(ModelNormal):
    ...
    attribute_map = {
        ...
        'key': 'key',  # noqa: E501
        'time_added': 'timeAdded',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, effect, key, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            time_added (datetime): TimeAdded represents the time at which the taint was added. It is only written for NoExecute taints.. [optional]  # noqa: E501
            value (str): The taint value corresponding to the taint key.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, effect, key, *args, **kwargs):  # noqa: E501
        """V1Taint - a model defined in OpenAPI
