...
def lazy_import():
    ...
    globals()['V1PodDisruptionBudget'] = V1PodDisruptionBudget


class V1PodDisruptionBudgetList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1PodDisruptionBudget],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1PodDisruptionBudgetList - a model defined in OpenAPI
