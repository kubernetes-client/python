...
class V1CephFSVolumeSource(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'secret_ref': (V1LocalObjectReference,),  # noqa: E501
            'user': (str,),  # noqa: E501
        }
    ...
    def __init__(self, monitors, *args, **kwargs):  # noqa: E501
        """V1CephFSVolumeSource - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            secret_ref (V1LocalObjectReference): [optional]  # noqa: E501
