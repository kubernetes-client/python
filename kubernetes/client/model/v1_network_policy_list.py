...
def lazy_import():
    ...
    globals()['V1NetworkPolicy'] = V1NetworkPolicy


class V1NetworkPolicyList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1NetworkPolicy],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1NetworkPolicyList - a model defined in OpenAPI
