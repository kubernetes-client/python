...
def lazy_import():
    ...
    globals()['V1ControllerRevision'] = V1ControllerRevision
    globals()['V1ListMeta'] = V1ListMeta


class V1ControllerRevisionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1ControllerRevision],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1ControllerRevisionList - a model defined in OpenAPI
