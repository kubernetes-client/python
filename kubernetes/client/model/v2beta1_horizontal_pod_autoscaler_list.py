...
def lazy_import():
    ...
    globals()['V2beta1HorizontalPodAutoscaler'] = V2beta1HorizontalPodAutoscaler


class V2beta1HorizontalPodAutoscalerList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V2beta1HorizontalPodAutoscaler],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V2beta1HorizontalPodAutoscalerList - a model defined in OpenAPI

        Args:
            items ([V2beta1HorizontalPodAutoscaler]): items is the list of horizontal pod autoscaler objects.
