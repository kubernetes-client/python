...
def lazy_import():
    ...
    globals()['V1alpha1PriorityClass'] = V1alpha1PriorityClass


class V1alpha1PriorityClassList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1PriorityClass],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1PriorityClassList - a model defined in OpenAPI

        Args:
            items ([V1alpha1PriorityClass]): items is the list of PriorityClasses
