...
class V1RoleRef(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, api_group, kind, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, api_group, kind, name, *args, **kwargs):  # noqa: E501
        """V1RoleRef - a model defined in OpenAPI
