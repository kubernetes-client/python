...
class V1EndpointAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ip", "hostname", "nodeName", "targetRef", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ip", "hostname", "nodeName", "targetRef", ], str]):
