...
def lazy_import():
    ...
    globals()['V1beta1Lease'] = V1beta1Lease


class V1beta1LeaseList(ModelNormal):
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1LeaseList - a model defined in OpenAPI

        Args:
            items ([V1beta1Lease]): Items is a list of schema objects.
