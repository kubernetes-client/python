...
def lazy_import():
    ...
    globals()['V1beta1FlowSchema'] = V1beta1FlowSchema


class V1beta1FlowSchemaList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1FlowSchema],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1FlowSchemaList - a model defined in OpenAPI

        Args:
            items ([V1beta1FlowSchema]): `items` is a list of FlowSchemas.
