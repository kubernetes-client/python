...
class V1GlusterfsPersistentVolumeSource(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            endpointsNamespace = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["endpointsNamespace"]) -> MetaOapg.properties.endpointsNamespace: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endpoints", "path", "endpointsNamespace", "readOnly", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["endpointsNamespace"]) -> typing.Union[MetaOapg.properties.endpointsNamespace, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endpoints", "path", "endpointsNamespace", "readOnly", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        endpointsNamespace: typing.Union[MetaOapg.properties.endpointsNamespace, str, schemas.Unset] = schemas.unset,
