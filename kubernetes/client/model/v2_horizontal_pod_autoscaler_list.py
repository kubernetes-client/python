...
def lazy_import():
    ...
    globals()['V2HorizontalPodAutoscaler'] = V2HorizontalPodAutoscaler


class V2HorizontalPodAutoscalerList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V2HorizontalPodAutoscaler],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V2HorizontalPodAutoscalerList - a model defined in OpenAPI
