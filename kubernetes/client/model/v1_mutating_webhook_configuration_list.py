...
def lazy_import():
    ...
    globals()['V1MutatingWebhookConfiguration'] = V1MutatingWebhookConfiguration


class V1MutatingWebhookConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1MutatingWebhookConfiguration],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        ...
        Args:
            items ([V1MutatingWebhookConfiguration]): List of MutatingWebhookConfiguration.
