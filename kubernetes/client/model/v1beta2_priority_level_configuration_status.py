        ...
        class properties:
            ...
            class conditions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta2PriorityLevelConfigurationCondition']:
                        return V1beta2PriorityLevelConfigurationCondition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1beta2PriorityLevelConfigurationCondition'], typing.List['V1beta2PriorityLevelConfigurationCondition']],
                ...
                def __getitem__(self, i: int) -> 'V1beta2PriorityLevelConfigurationCondition':
