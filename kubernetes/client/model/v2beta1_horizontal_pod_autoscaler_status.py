...
class V2beta1HorizontalPodAutoscalerStatus(ModelNormal):
    ...
    def __init__(self, conditions, current_replicas, desired_replicas, *args, **kwargs):  # noqa: E501
        ...
        Args:
            conditions ([V2beta1HorizontalPodAutoscalerCondition]): conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.
