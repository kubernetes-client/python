...
def lazy_import():
    ...
    globals()['V1beta1SubjectAccessReviewSpec'] = V1beta1SubjectAccessReviewSpec
    globals()['V1beta1SubjectAccessReviewStatus'] = V1beta1SubjectAccessReviewStatus


class V1beta1LocalSubjectAccessReview(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (V1beta1SubjectAccessReviewSpec,),  # noqa: E501
    ...
    def __init__(self, spec, *args, **kwargs):  # noqa: E501
        """V1beta1LocalSubjectAccessReview - a model defined in OpenAPI
