...
def lazy_import():
    ...
    globals()['V1beta1ValidatingWebhookConfiguration'] = V1beta1ValidatingWebhookConfiguration


class V1beta1ValidatingWebhookConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1ValidatingWebhookConfiguration],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1ValidatingWebhookConfigurationList - a model defined in OpenAPI

        Args:
            items ([V1beta1ValidatingWebhookConfiguration]): List of ValidatingWebhookConfiguration.
