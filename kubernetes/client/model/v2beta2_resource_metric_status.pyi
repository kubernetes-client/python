...
class V2beta2ResourceMetricStatus(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current", "name", ], str]):
