...
def lazy_import():
    ...
    globals()['V1EndpointSubset'] = V1EndpointSubset
    globals()['V1ObjectMeta'] = V1ObjectMeta


class V1Endpoints(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'subsets': ([V1EndpointSubset],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            subsets ([V1EndpointSubset]): The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.. [optional]  # noqa: E501
        """
