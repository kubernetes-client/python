...
class V1LoadBalancerIngress(
        ...
        class properties:
            ...
            class ports(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1PortStatus']:
                        return V1PortStatus
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1PortStatus'], typing.List['V1PortStatus']],
                ...
                def __getitem__(self, i: int) -> 'V1PortStatus':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hostname", "ip", "ports", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hostname", "ip", "ports", ], str]):
