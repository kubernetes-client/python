...
class V1NetworkPolicy(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1NetworkPolicySpec']:
                return V1NetworkPolicySpec
        
            @staticmethod
            def status() -> typing.Type['V1NetworkPolicyStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1NetworkPolicySpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1NetworkPolicyStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1NetworkPolicySpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1NetworkPolicyStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1NetworkPolicySpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1NetworkPolicyStatus', schemas.Unset] = schemas.unset,
