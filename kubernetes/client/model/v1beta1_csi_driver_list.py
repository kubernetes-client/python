...
def lazy_import():
    ...
    globals()['V1beta1CSIDriver'] = V1beta1CSIDriver


class V1beta1CSIDriverList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1CSIDriver],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1CSIDriverList - a model defined in OpenAPI

        Args:
            items ([V1beta1CSIDriver]): items is the list of CSIDriver
