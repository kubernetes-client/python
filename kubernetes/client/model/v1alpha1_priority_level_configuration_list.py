...
def lazy_import():
    ...
    globals()['V1alpha1PriorityLevelConfiguration'] = V1alpha1PriorityLevelConfiguration


class V1alpha1PriorityLevelConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1PriorityLevelConfiguration],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1PriorityLevelConfigurationList - a model defined in OpenAPI

        Args:
            items ([V1alpha1PriorityLevelConfiguration]): `items` is a list of request-priorities.
