...
def lazy_import():
    ...
    globals()['V1ReplicationController'] = V1ReplicationController


class V1ReplicationControllerList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1ReplicationController],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1ReplicationControllerList - a model defined in OpenAPI
