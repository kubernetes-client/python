        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1ComponentStatus']:
                        return V1ComponentStatus
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1ComponentStatus'], typing.List['V1ComponentStatus']],
                ...
                def __getitem__(self, i: int) -> 'V1ComponentStatus':
