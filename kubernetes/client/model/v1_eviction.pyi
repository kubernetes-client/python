...
class V1Eviction(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def deleteOptions() -> typing.Type['V1DeleteOptions']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deleteOptions"]) -> 'V1DeleteOptions': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["apiVersion", "deleteOptions", "kind", "metadata", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deleteOptions"]) -> typing.Union['V1DeleteOptions', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["apiVersion", "deleteOptions", "kind", "metadata", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        deleteOptions: typing.Union['V1DeleteOptions', schemas.Unset] = schemas.unset,
