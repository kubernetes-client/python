...
def lazy_import():
    ...
    globals()['V1beta1StorageClass'] = V1beta1StorageClass


class V1beta1StorageClassList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1StorageClass],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1StorageClassList - a model defined in OpenAPI

        Args:
            items ([V1beta1StorageClass]): Items is the list of StorageClasses
