...
class V1JobSpec(ModelNormal):
    ...
    def __init__(self, template, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            active_deadline_seconds (int): Specifies the duration in seconds relative to the startTime that the job may be active before the system tries to terminate it; value must be positive integer. [optional]  # noqa: E501
