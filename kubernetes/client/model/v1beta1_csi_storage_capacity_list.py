...
def lazy_import():
    ...
    globals()['V1beta1CSIStorageCapacity'] = V1beta1CSIStorageCapacity


class V1beta1CSIStorageCapacityList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1CSIStorageCapacity],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1CSIStorageCapacityList - a model defined in OpenAPI

        Args:
            items ([V1beta1CSIStorageCapacity]): Items is the list of CSIStorageCapacity objects.
