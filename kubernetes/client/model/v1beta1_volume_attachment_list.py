...
def lazy_import():
    ...
    globals()['V1beta1VolumeAttachment'] = V1beta1VolumeAttachment


class V1beta1VolumeAttachmentList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1VolumeAttachment],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1VolumeAttachmentList - a model defined in OpenAPI

        Args:
            items ([V1beta1VolumeAttachment]): Items is the list of VolumeAttachments
