...
def lazy_import():
    ...
    globals()['V1alpha1RoleBinding'] = V1alpha1RoleBinding


class V1alpha1RoleBindingList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1RoleBinding],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1RoleBindingList - a model defined in OpenAPI

        Args:
            items ([V1alpha1RoleBinding]): Items is a list of RoleBindings
