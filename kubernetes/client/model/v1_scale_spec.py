...
class V1ScaleSpec(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["replicas", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["replicas", ], str]):
