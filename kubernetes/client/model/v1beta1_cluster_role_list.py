...
def lazy_import():
    ...
    globals()['V1beta1ClusterRole'] = V1beta1ClusterRole


class V1beta1ClusterRoleList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1ClusterRole],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1ClusterRoleList - a model defined in OpenAPI

        Args:
            items ([V1beta1ClusterRole]): Items is a list of ClusterRoles
