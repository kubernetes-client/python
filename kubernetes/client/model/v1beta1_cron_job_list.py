...
def lazy_import():
    ...
    globals()['V1beta1CronJob'] = V1beta1CronJob


class V1beta1CronJobList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1CronJob],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1CronJobList - a model defined in OpenAPI

        Args:
            items ([V1beta1CronJob]): items is the list of CronJobs.
