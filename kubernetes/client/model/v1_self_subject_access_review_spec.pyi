...
class V1SelfSubjectAccessReviewSpec(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nonResourceAttributes", "resourceAttributes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nonResourceAttributes", "resourceAttributes", ], str]):
...
from client.model.v1_non_resource_attributes import V1NonResourceAttributes
from client.model.v1_resource_attributes import V1ResourceAttributes
