...
class V2beta1ResourceMetricStatus(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, current_average_value, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, current_average_value, name, *args, **kwargs):  # noqa: E501
        """V2beta1ResourceMetricStatus - a model defined in OpenAPI
