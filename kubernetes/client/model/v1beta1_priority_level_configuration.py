...
class V1beta1PriorityLevelConfiguration(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1beta1PriorityLevelConfigurationSpec']:
                return V1beta1PriorityLevelConfigurationSpec
        
            @staticmethod
            def status() -> typing.Type['V1beta1PriorityLevelConfigurationStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1beta1PriorityLevelConfigurationSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1beta1PriorityLevelConfigurationStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1beta1PriorityLevelConfigurationSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1beta1PriorityLevelConfigurationStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1beta1PriorityLevelConfigurationSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1beta1PriorityLevelConfigurationStatus', schemas.Unset] = schemas.unset,
