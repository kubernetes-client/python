        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V2HorizontalPodAutoscaler']:
                        return V2HorizontalPodAutoscaler
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V2HorizontalPodAutoscaler'], typing.List['V2HorizontalPodAutoscaler']],
                ...
                def __getitem__(self, i: int) -> 'V2HorizontalPodAutoscaler':
