...
def lazy_import():
    ...
    globals()['V1ConfigMapEnvSource'] = V1ConfigMapEnvSource
    globals()['V1SecretEnvSource'] = V1SecretEnvSource


class V1EnvFromSource(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'config_map_ref': (V1ConfigMapEnvSource,),  # noqa: E501
            'prefix': (str,),  # noqa: E501
            'secret_ref': (V1SecretEnvSource,),  # noqa: E501
        }
