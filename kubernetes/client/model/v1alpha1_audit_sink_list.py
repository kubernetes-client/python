...
def lazy_import():
    ...
    globals()['V1alpha1AuditSink'] = V1alpha1AuditSink


class V1alpha1AuditSinkList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1AuditSink],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1AuditSinkList - a model defined in OpenAPI

        Args:
            items ([V1alpha1AuditSink]): List of audit configurations.
