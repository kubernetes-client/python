        ...
        class properties:
            ...
            class policies(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V2beta2HPAScalingPolicy']:
                        return V2beta2HPAScalingPolicy
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V2beta2HPAScalingPolicy'], typing.List['V2beta2HPAScalingPolicy']],
                ...
                def __getitem__(self, i: int) -> 'V2beta2HPAScalingPolicy':
