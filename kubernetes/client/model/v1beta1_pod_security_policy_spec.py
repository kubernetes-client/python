...
class V1beta1PodSecurityPolicySpec(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fs_group, run_as_user, se_linux, supplemental_groups, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            allowed_flex_volumes ([V1beta1AllowedFlexVolume]): allowedFlexVolumes is an allowlist of Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the \"volumes\" field.. [optional]  # noqa: E501
            allowed_host_paths ([V1beta1AllowedHostPath]): allowedHostPaths is an allowlist of host paths. Empty indicates that all host paths may be used.. [optional]  # noqa: E501
            allowed_proc_mount_types ([str]): AllowedProcMountTypes is an allowlist of allowed ProcMountTypes. Empty or nil indicates that only the DefaultProcMountType may be used. This requires the ProcMountType feature flag to be enabled.. [optional]  # noqa: E501
            ...
            volumes ([str]): volumes is an allowlist of volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use '*'.. [optional]  # noqa: E501
        """
