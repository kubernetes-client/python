...
def lazy_import():
    ...
    globals()['V1beta1CSINode'] = V1beta1CSINode


class V1beta1CSINodeList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1CSINode],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1CSINodeList - a model defined in OpenAPI

        Args:
            items ([V1beta1CSINode]): items is the list of CSINode
