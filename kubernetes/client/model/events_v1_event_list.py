...
def lazy_import():
    ...
    globals()['EventsV1Event'] = EventsV1Event
    globals()['V1ListMeta'] = V1ListMeta


class EventsV1EventList(ModelNormal):
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """EventsV1EventList - a model defined in OpenAPI

        Args:
            items ([EventsV1Event]): items is a list of schema objects.
