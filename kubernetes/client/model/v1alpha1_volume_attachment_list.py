...
def lazy_import():
    ...
    globals()['V1alpha1VolumeAttachment'] = V1alpha1VolumeAttachment


class V1alpha1VolumeAttachmentList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1VolumeAttachment],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1VolumeAttachmentList - a model defined in OpenAPI

        Args:
            items ([V1alpha1VolumeAttachment]): Items is the list of VolumeAttachments
