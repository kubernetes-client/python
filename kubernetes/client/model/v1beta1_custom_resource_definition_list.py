...
def lazy_import():
    ...
    globals()['V1beta1CustomResourceDefinition'] = V1beta1CustomResourceDefinition


class V1beta1CustomResourceDefinitionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1CustomResourceDefinition],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1CustomResourceDefinitionList - a model defined in OpenAPI

        Args:
            items ([V1beta1CustomResourceDefinition]): items list individual CustomResourceDefinition objects
