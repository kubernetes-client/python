...
def lazy_import():
    ...
    globals()['V2alpha1CronJob'] = V2alpha1CronJob


class V2alpha1CronJobList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V2alpha1CronJob],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V2alpha1CronJobList - a model defined in OpenAPI

        Args:
            items ([V2alpha1CronJob]): items is the list of CronJobs.
