...
class V1TopologySelectorLabelRequirement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, values, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, values, *args, **kwargs):  # noqa: E501
        """V1TopologySelectorLabelRequirement - a model defined in OpenAPI
