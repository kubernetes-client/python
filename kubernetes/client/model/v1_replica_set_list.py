...
def lazy_import():
    ...
    globals()['V1ReplicaSet'] = V1ReplicaSet


class V1ReplicaSetList(ModelNormal):
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1ReplicaSetList - a model defined in OpenAPI

        Args:
            items ([V1ReplicaSet]): List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
