...
def lazy_import():
    ...
    globals()['V1ClusterRoleBinding'] = V1ClusterRoleBinding
    globals()['V1ListMeta'] = V1ListMeta


class V1ClusterRoleBindingList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1ClusterRoleBinding],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1ClusterRoleBindingList - a model defined in OpenAPI
