...
class V1ResourceQuota(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1ResourceQuotaSpec']:
                return V1ResourceQuotaSpec
        
            @staticmethod
            def status() -> typing.Type['V1ResourceQuotaStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1ResourceQuotaSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1ResourceQuotaStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1ResourceQuotaSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1ResourceQuotaStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1ResourceQuotaSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1ResourceQuotaStatus', schemas.Unset] = schemas.unset,
