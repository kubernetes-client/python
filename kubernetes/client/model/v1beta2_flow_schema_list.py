...
def lazy_import():
    ...
    globals()['V1beta2FlowSchema'] = V1beta2FlowSchema


class V1beta2FlowSchemaList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta2FlowSchema],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta2FlowSchemaList - a model defined in OpenAPI

        Args:
            items ([V1beta2FlowSchema]): `items` is a list of FlowSchemas.
