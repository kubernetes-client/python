...
class V1HorizontalPodAutoscalerStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'current_cpu_utilization_percentage': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'current_cpu_utilization_percentage': 'currentCPUUtilizationPercentage',  # noqa: E501
    ...
    def _from_openapi_data(cls, current_replicas, desired_replicas, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            current_cpu_utilization_percentage (int): current average CPU utilization over all pods, represented as a percentage of requested CPU, e.g. 70 means that an average pod is using now 70% of its requested CPU.. [optional]  # noqa: E501
            last_scale_time (datetime): last time the HorizontalPodAutoscaler scaled the number of pods; used by the autoscaler to control how often the number of pods is changed.. [optional]  # noqa: E501
            observed_generation (int): most recent generation observed by this autoscaler.. [optional]  # noqa: E501
        """
