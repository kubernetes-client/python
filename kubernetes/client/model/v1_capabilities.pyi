...
class V1Capabilities(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["add", "drop", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["add", "drop", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        drop: typing.Union[MetaOapg.properties.drop, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
