...
def lazy_import():
    ...
    globals()['V1beta1EndpointSlice'] = V1beta1EndpointSlice


class V1beta1EndpointSliceList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1EndpointSlice],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1EndpointSliceList - a model defined in OpenAPI

        Args:
            items ([V1beta1EndpointSlice]): List of endpoint slices
