...
def lazy_import():
    ...
    globals()['V1ComponentStatus'] = V1ComponentStatus
    globals()['V1ListMeta'] = V1ListMeta


class V1ComponentStatusList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1ComponentStatus],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1ComponentStatusList - a model defined in OpenAPI
