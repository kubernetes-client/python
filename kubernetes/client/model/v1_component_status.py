...
class V1ComponentStatus(
        ...
        class properties:
            ...
            class conditions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1ComponentCondition']:
                        return V1ComponentCondition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1ComponentCondition'], typing.List['V1ComponentCondition']],
                ...
                def __getitem__(self, i: int) -> 'V1ComponentCondition':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["apiVersion", "conditions", "kind", "metadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["apiVersion", "conditions", "kind", "metadata", ], str]):
