...
class V2beta1PodsMetricSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metric_name, target_average_value, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, metric_name, target_average_value, *args, **kwargs):  # noqa: E501
        """V2beta1PodsMetricSource - a model defined in OpenAPI
