...
def lazy_import():
    ...
    globals()['V1LimitRange'] = V1LimitRange
    globals()['V1ListMeta'] = V1ListMeta


class V1LimitRangeList(ModelNormal):
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1LimitRangeList - a model defined in OpenAPI

        Args:
            items ([V1LimitRange]): Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
