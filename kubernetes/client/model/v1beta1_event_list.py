...
def lazy_import():
    ...
    globals()['V1beta1Event'] = V1beta1Event


class V1beta1EventList(ModelNormal):
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1EventList - a model defined in OpenAPI

        Args:
            items ([V1beta1Event]): items is a list of schema objects.
