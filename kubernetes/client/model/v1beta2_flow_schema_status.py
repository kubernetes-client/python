        ...
        class properties:
            ...
            class conditions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta2FlowSchemaCondition']:
                        return V1beta2FlowSchemaCondition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1beta2FlowSchemaCondition'], typing.List['V1beta2FlowSchemaCondition']],
                ...
                def __getitem__(self, i: int) -> 'V1beta2FlowSchemaCondition':
