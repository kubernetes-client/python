...
def lazy_import():
    ...
    globals()['V1StatusDetails'] = V1StatusDetails


class V1Status(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'code': (int,),  # noqa: E501
            'details': (V1StatusDetails,),  # noqa: E501
            'kind': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            code (int): Suggested HTTP return code for this status, 0 if not set.. [optional]  # noqa: E501
            details (V1StatusDetails): [optional]  # noqa: E501
            ...
            reason (str): A machine-readable description of why this operation is in the \"Failure\" status. If this value is empty there is no information available. A Reason clarifies an HTTP status code but does not override it.. [optional]  # noqa: E501
            status (str): Status of the operation. One of: \"Success\" or \"Failure\". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status. [optional]  # noqa: E501
        """
