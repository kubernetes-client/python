...
class V1PodDisruptionBudget(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1PodDisruptionBudgetSpec']:
                return V1PodDisruptionBudgetSpec
        
            @staticmethod
            def status() -> typing.Type['V1PodDisruptionBudgetStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1PodDisruptionBudgetSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1PodDisruptionBudgetStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1PodDisruptionBudgetSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1PodDisruptionBudgetStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1PodDisruptionBudgetSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1PodDisruptionBudgetStatus', schemas.Unset] = schemas.unset,
