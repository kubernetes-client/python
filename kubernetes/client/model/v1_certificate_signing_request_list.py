...
def lazy_import():
    ...
    globals()['V1CertificateSigningRequest'] = V1CertificateSigningRequest
    globals()['V1ListMeta'] = V1ListMeta


class V1CertificateSigningRequestList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1CertificateSigningRequest],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1CertificateSigningRequestList - a model defined in OpenAPI
