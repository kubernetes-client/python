...
def lazy_import():
    ...
    globals()['V1beta1MutatingWebhookConfiguration'] = V1beta1MutatingWebhookConfiguration


class V1beta1MutatingWebhookConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1MutatingWebhookConfiguration],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1MutatingWebhookConfigurationList - a model defined in OpenAPI

        Args:
            items ([V1beta1MutatingWebhookConfiguration]): List of MutatingWebhookConfiguration.
