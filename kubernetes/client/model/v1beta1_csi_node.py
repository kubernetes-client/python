...
def lazy_import():
    ...
    globals()['V1beta1CSINodeSpec'] = V1beta1CSINodeSpec


class V1beta1CSINode(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (V1beta1CSINodeSpec,),  # noqa: E501
    ...
    def __init__(self, spec, *args, **kwargs):  # noqa: E501
        """V1beta1CSINode - a model defined in OpenAPI
