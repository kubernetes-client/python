...
class V1SELinuxOptions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["level", "role", "type", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["level", "role", "type", "user", ], str]):
