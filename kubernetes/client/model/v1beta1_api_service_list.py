...
def lazy_import():
    ...
    globals()['V1beta1APIService'] = V1beta1APIService


class V1beta1APIServiceList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1APIService],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1APIServiceList - a model defined in OpenAPI
