...
class V1IngressClassParametersReference(ModelNormal):
    ...
    def _from_openapi_data(cls, kind, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            namespace (str): Namespace is the namespace of the resource being referenced. This field is required when scope is set to \"Namespace\" and must be unset when scope is set to \"Cluster\".. [optional]  # noqa: E501
            scope (str): Scope represents if this refers to a cluster or namespace scoped resource. This may be set to \"Cluster\" (default) or \"Namespace\".. [optional]  # noqa: E501
        """
