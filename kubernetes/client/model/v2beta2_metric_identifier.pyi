...
class V2beta2MetricIdentifier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "selector", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "selector", ], str]):
