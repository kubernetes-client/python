...
def lazy_import():
    ...
    globals()['V1beta1CSIDriverSpec'] = V1beta1CSIDriverSpec


class V1beta1CSIDriver(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (V1beta1CSIDriverSpec,),  # noqa: E501
    ...
    def __init__(self, spec, *args, **kwargs):  # noqa: E501
        """V1beta1CSIDriver - a model defined in OpenAPI
