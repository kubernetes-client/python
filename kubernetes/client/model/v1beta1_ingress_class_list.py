...
def lazy_import():
    ...
    globals()['V1beta1IngressClass'] = V1beta1IngressClass


class V1beta1IngressClassList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1IngressClass],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1IngressClassList - a model defined in OpenAPI

        Args:
            items ([V1beta1IngressClass]): Items is the list of IngressClasses.
