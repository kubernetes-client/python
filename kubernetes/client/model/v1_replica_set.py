...
class V1ReplicaSet(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1ReplicaSetSpec']:
                return V1ReplicaSetSpec
        
            @staticmethod
            def status() -> typing.Type['V1ReplicaSetStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1ReplicaSetSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1ReplicaSetStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1ReplicaSetSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1ReplicaSetStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1ReplicaSetSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1ReplicaSetStatus', schemas.Unset] = schemas.unset,
