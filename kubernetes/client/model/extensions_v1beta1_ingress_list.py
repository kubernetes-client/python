...
def lazy_import():
    ...
    globals()['ExtensionsV1beta1Ingress'] = ExtensionsV1beta1Ingress
    globals()['V1ListMeta'] = V1ListMeta


class ExtensionsV1beta1IngressList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ExtensionsV1beta1Ingress],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """ExtensionsV1beta1IngressList - a model defined in OpenAPI

        Args:
            items ([ExtensionsV1beta1Ingress]): Items is the list of Ingress.
