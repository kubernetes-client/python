...
def lazy_import():
    ...
    globals()['V1SelfSubjectAccessReviewSpec'] = V1SelfSubjectAccessReviewSpec
    globals()['V1SubjectAccessReviewStatus'] = V1SubjectAccessReviewStatus


class V1SelfSubjectAccessReview(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (V1SelfSubjectAccessReviewSpec,),  # noqa: E501
