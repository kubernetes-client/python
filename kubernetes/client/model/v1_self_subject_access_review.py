...
class V1SelfSubjectAccessReview(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1SelfSubjectAccessReviewSpec']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1SelfSubjectAccessReviewSpec': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> 'V1SelfSubjectAccessReviewSpec': ...
