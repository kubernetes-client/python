...
def lazy_import():
    ...
    globals()['V1beta1PodDisruptionBudget'] = V1beta1PodDisruptionBudget


class V1beta1PodDisruptionBudgetList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1PodDisruptionBudget],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1PodDisruptionBudgetList - a model defined in OpenAPI

        Args:
            items ([V1beta1PodDisruptionBudget]): items list individual PodDisruptionBudget objects
