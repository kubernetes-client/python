...
class V1MutatingWebhook(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def objectSelector() -> typing.Type['V1LabelSelector']:
                return V1LabelSelector
            reinvocationPolicy = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reinvocationPolicy"]) -> MetaOapg.properties.reinvocationPolicy: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["admissionReviewVersions", "clientConfig", "name", "sideEffects", "failurePolicy", "matchPolicy", "namespaceSelector", "objectSelector", "reinvocationPolicy", "rules", "timeoutSeconds", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reinvocationPolicy"]) -> typing.Union[MetaOapg.properties.reinvocationPolicy, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["admissionReviewVersions", "clientConfig", "name", "sideEffects", "failurePolicy", "matchPolicy", "namespaceSelector", "objectSelector", "reinvocationPolicy", "rules", "timeoutSeconds", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        reinvocationPolicy: typing.Union[MetaOapg.properties.reinvocationPolicy, str, schemas.Unset] = schemas.unset,
...
from client.model.admissionregistration_v1_webhook_client_config import AdmissionregistrationV1WebhookClientConfig
from client.model.v1_label_selector import V1LabelSelector
from client.model.v1_rule_with_operations import V1RuleWithOperations
