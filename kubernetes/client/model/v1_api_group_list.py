...
def lazy_import():
    ...
    globals()['V1APIGroup'] = V1APIGroup


class V1APIGroupList(ModelNormal):
    ...
    def __init__(self, groups, *args, **kwargs):  # noqa: E501
        """V1APIGroupList - a model defined in OpenAPI

        Args:
            groups ([V1APIGroup]): groups is a list of APIGroup.
