...
def lazy_import():
    ...
    globals()['V1ResourceQuota'] = V1ResourceQuota


class V1ResourceQuotaList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1ResourceQuota],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1ResourceQuotaList - a model defined in OpenAPI
