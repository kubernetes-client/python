        ...
        class properties:
            ...
            class conditions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1ReplicationControllerCondition']:
                        return V1ReplicationControllerCondition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1ReplicationControllerCondition'], typing.List['V1ReplicationControllerCondition']],
                ...
                def __getitem__(self, i: int) -> 'V1ReplicationControllerCondition':
