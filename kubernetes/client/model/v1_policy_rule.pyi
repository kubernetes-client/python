...
class V1PolicyRule(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["nonResourceURLs"]) -> MetaOapg.properties.nonResourceURLs: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["verbs", "apiGroups", "nonResourceURLs", "resourceNames", "resources", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nonResourceURLs"]) -> typing.Union[MetaOapg.properties.nonResourceURLs, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verbs", "apiGroups", "nonResourceURLs", "resourceNames", "resources", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        nonResourceURLs: typing.Union[MetaOapg.properties.nonResourceURLs, list, tuple, schemas.Unset] = schemas.unset,
