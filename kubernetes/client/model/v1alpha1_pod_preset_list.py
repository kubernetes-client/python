...
def lazy_import():
    ...
    globals()['V1alpha1PodPreset'] = V1alpha1PodPreset


class V1alpha1PodPresetList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1PodPreset],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1PodPresetList - a model defined in OpenAPI

        Args:
            items ([V1alpha1PodPreset]): Items is a list of schema objects.
