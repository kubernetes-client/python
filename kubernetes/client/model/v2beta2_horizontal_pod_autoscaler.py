...
class V2beta2HorizontalPodAutoscaler(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V2beta2HorizontalPodAutoscalerSpec']:
                return V2beta2HorizontalPodAutoscalerSpec
        
            @staticmethod
            def status() -> typing.Type['V2beta2HorizontalPodAutoscalerStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V2beta2HorizontalPodAutoscalerSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V2beta2HorizontalPodAutoscalerStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V2beta2HorizontalPodAutoscalerSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V2beta2HorizontalPodAutoscalerStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V2beta2HorizontalPodAutoscalerSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V2beta2HorizontalPodAutoscalerStatus', schemas.Unset] = schemas.unset,
