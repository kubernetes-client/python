...
def lazy_import():
    ...
    globals()['V1PriorityClass'] = V1PriorityClass


class V1PriorityClassList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1PriorityClass],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1PriorityClassList - a model defined in OpenAPI

        Args:
            items ([V1PriorityClass]): items is the list of PriorityClasses
