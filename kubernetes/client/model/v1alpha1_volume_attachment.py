...
def lazy_import():
    ...
    globals()['V1alpha1VolumeAttachmentSpec'] = V1alpha1VolumeAttachmentSpec
    globals()['V1alpha1VolumeAttachmentStatus'] = V1alpha1VolumeAttachmentStatus


class V1alpha1VolumeAttachment(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (V1alpha1VolumeAttachmentSpec,),  # noqa: E501
            'api_version': (str,),  # noqa: E501
            'kind': (str,),  # noqa: E501
            'metadata': (V1ObjectMeta,),  # noqa: E501
            'status': (V1alpha1VolumeAttachmentStatus,),  # noqa: E501
        }
    ...
    def __init__(self, spec, *args, **kwargs):  # noqa: E501
        """V1alpha1VolumeAttachment - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (V1alpha1VolumeAttachmentStatus): [optional]  # noqa: E501
        """
