...
class V1TokenRequestStatus(
    ...
    class MetaOapg:
        ...
        class properties:
            expirationTimestamp = schemas.DateTimeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["expirationTimestamp", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["expirationTimestamp", "token", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        expirationTimestamp: typing.Union[MetaOapg.properties.expirationTimestamp, str, datetime, ],
