...
def lazy_import():
    ...
    globals()['V1beta1RoleRef'] = V1beta1RoleRef
    globals()['V1beta1Subject'] = V1beta1Subject


class V1beta1ClusterRoleBinding(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'role_ref': (V1beta1RoleRef,),  # noqa: E501
    ...
    def __init__(self, role_ref, *args, **kwargs):  # noqa: E501
        """V1beta1ClusterRoleBinding - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            subjects ([V1beta1Subject]): Subjects holds references to the objects the role applies to.. [optional]  # noqa: E501
        """
