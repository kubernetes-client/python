...
class V1HostAlias(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hostnames", "ip", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hostnames", "ip", ], str]):
