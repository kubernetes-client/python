...
class V1beta2FlowSchema(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1beta2FlowSchemaSpec']:
                return V1beta2FlowSchemaSpec
        
            @staticmethod
            def status() -> typing.Type['V1beta2FlowSchemaStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1beta2FlowSchemaSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1beta2FlowSchemaStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1beta2FlowSchemaSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1beta2FlowSchemaStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1beta2FlowSchemaSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1beta2FlowSchemaStatus', schemas.Unset] = schemas.unset,
