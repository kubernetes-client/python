...
class V1StatefulSetCondition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "type", "lastTransitionTime", "message", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "type", "lastTransitionTime", "message", "reason", ], str]):
