...
class V1ScopedResourceSelectorRequirement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, operator, scope_name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            values ([str]): An array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty. This array is replaced during a strategic merge patch.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, operator, scope_name, *args, **kwargs):  # noqa: E501
        """V1ScopedResourceSelectorRequirement - a model defined in OpenAPI
