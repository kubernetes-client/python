...
class V1beta1Subject(ModelNormal):
    ...
    def __init__(self, kind, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            api_group (str): APIGroup holds the API group of the referenced subject. Defaults to \"\" for ServiceAccount subjects. Defaults to \"rbac.authorization.k8s.io\" for User and Group subjects.. [optional]  # noqa: E501
