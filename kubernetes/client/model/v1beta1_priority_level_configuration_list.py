...
def lazy_import():
    ...
    globals()['V1beta1PriorityLevelConfiguration'] = V1beta1PriorityLevelConfiguration


class V1beta1PriorityLevelConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1PriorityLevelConfiguration],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1PriorityLevelConfigurationList - a model defined in OpenAPI

        Args:
            items ([V1beta1PriorityLevelConfiguration]): `items` is a list of request-priorities.
