...
class V1QuobyteVolumeSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, registry, volume, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, registry, volume, *args, **kwargs):  # noqa: E501
        """V1QuobyteVolumeSource - a model defined in OpenAPI
