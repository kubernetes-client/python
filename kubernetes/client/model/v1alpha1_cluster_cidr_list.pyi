        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1alpha1ClusterCIDR']:
                        return V1alpha1ClusterCIDR
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1alpha1ClusterCIDR'], typing.List['V1alpha1ClusterCIDR']],
                ...
                def __getitem__(self, i: int) -> 'V1alpha1ClusterCIDR':
