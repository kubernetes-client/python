...
def lazy_import():
    ...
    globals()['V1VolumeAttachment'] = V1VolumeAttachment


class V1VolumeAttachmentList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1VolumeAttachment],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1VolumeAttachmentList - a model defined in OpenAPI
