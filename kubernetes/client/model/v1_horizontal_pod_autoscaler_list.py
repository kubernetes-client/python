...
def lazy_import():
    ...
    globals()['V1HorizontalPodAutoscaler'] = V1HorizontalPodAutoscaler
    globals()['V1ListMeta'] = V1ListMeta


class V1HorizontalPodAutoscalerList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1HorizontalPodAutoscaler],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1HorizontalPodAutoscalerList - a model defined in OpenAPI

        Args:
            items ([V1HorizontalPodAutoscaler]): list of horizontal pod autoscaler objects.
