...
def lazy_import():
    ...
    globals()['V1alpha1StorageVersion'] = V1alpha1StorageVersion


class V1alpha1StorageVersionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1StorageVersion],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1alpha1StorageVersionList - a model defined in OpenAPI
