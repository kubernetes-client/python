...
class V1NodeSelector(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'node_selector_terms': ([V1NodeSelectorTerm],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, node_selector_terms, *args, **kwargs):  # noqa: E501
        ...
        Args:
            node_selector_terms ([V1NodeSelectorTerm]): Required. A list of node selector terms. The terms are ORed.
