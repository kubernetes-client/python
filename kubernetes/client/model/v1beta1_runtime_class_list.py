...
def lazy_import():
    ...
    globals()['V1beta1RuntimeClass'] = V1beta1RuntimeClass


class V1beta1RuntimeClassList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1RuntimeClass],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1RuntimeClassList - a model defined in OpenAPI

        Args:
            items ([V1beta1RuntimeClass]): Items is a list of schema objects.
