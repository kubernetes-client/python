...
class V1GRPCAction(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["port", "service", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["port", "service", ], str]):
