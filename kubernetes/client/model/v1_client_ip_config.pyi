...
class V1ClientIPConfig(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["timeoutSeconds", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["timeoutSeconds", ], str]):
