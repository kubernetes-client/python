...
class V1GlusterfsPersistentVolumeSource(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'path': (str,),  # noqa: E501
            'endpoints_namespace': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'path': 'path',  # noqa: E501
        'endpoints_namespace': 'endpointsNamespace',  # noqa: E501
    ...
    def _from_openapi_data(cls, endpoints, path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            endpoints_namespace (str): EndpointsNamespace is the namespace that contains Glusterfs endpoint. If this field is empty, the EndpointNamespace defaults to the same namespace as the bound PVC. More info: https://examples.k8s.io/volumes/glusterfs/README.md#create-a-pod. [optional]  # noqa: E501
