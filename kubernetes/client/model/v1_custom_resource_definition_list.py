...
def lazy_import():
    ...
    globals()['V1CustomResourceDefinition'] = V1CustomResourceDefinition
    globals()['V1ListMeta'] = V1ListMeta


class V1CustomResourceDefinitionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1CustomResourceDefinition],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1CustomResourceDefinitionList - a model defined in OpenAPI

        Args:
            items ([V1CustomResourceDefinition]): items list individual CustomResourceDefinition objects
