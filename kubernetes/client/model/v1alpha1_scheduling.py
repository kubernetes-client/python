...
class V1alpha1Scheduling(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1alpha1Scheduling - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            node_selector ({str: (str,)}): nodeSelector lists labels that must be present on nodes that support this RuntimeClass. Pods using this RuntimeClass can only be scheduled to a node matched by this selector. The RuntimeClass nodeSelector is merged with a pod's existing nodeSelector. Any conflicts will cause the pod to be rejected in admission.. [optional]  # noqa: E501
            tolerations ([V1Toleration]): tolerations are appended (excluding duplicates) to pods running with this RuntimeClass during admission, effectively unioning the set of nodes tolerated by the pod and the RuntimeClass.. [optional]  # noqa: E501
        """
