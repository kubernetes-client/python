...
def lazy_import():
    ...
    globals()['V1alpha1ClusterRoleBinding'] = V1alpha1ClusterRoleBinding


class V1alpha1ClusterRoleBindingList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1ClusterRoleBinding],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1ClusterRoleBindingList - a model defined in OpenAPI

        Args:
            items ([V1alpha1ClusterRoleBinding]): Items is a list of ClusterRoleBindings
