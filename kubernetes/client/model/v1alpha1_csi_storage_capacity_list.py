...
def lazy_import():
    ...
    globals()['V1alpha1CSIStorageCapacity'] = V1alpha1CSIStorageCapacity


class V1alpha1CSIStorageCapacityList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1CSIStorageCapacity],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1alpha1CSIStorageCapacityList - a model defined in OpenAPI

        Args:
            items ([V1alpha1CSIStorageCapacity]): Items is the list of CSIStorageCapacity objects.
