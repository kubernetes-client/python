        ...
        class properties:
            ...
            class conditions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1APIServiceCondition']:
                        return V1APIServiceCondition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1APIServiceCondition'], typing.List['V1APIServiceCondition']],
                ...
                def __getitem__(self, i: int) -> 'V1APIServiceCondition':
