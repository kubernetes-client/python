...
class V1APIVersions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, server_address_by_client_cidrs, versions, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, server_address_by_client_cidrs, versions, *args, **kwargs):  # noqa: E501
        """V1APIVersions - a model defined in OpenAPI
