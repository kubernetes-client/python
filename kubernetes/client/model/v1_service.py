...
class V1Service(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1ServiceSpec']:
                return V1ServiceSpec
        
            @staticmethod
            def status() -> typing.Type['V1ServiceStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1ServiceSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1ServiceStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1ServiceSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1ServiceStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1ServiceSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1ServiceStatus', schemas.Unset] = schemas.unset,
