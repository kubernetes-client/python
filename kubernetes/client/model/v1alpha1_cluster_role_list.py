...
def lazy_import():
    ...
    globals()['V1alpha1ClusterRole'] = V1alpha1ClusterRole


class V1alpha1ClusterRoleList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1ClusterRole],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1ClusterRoleList - a model defined in OpenAPI

        Args:
            items ([V1alpha1ClusterRole]): Items is a list of ClusterRoles
