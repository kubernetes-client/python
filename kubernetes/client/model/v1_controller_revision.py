...
class V1ControllerRevision(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, revision, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            data (bool, date, datetime, dict, float, int, list, str, none_type): Data is the serialized representation of the state.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, revision, *args, **kwargs):  # noqa: E501
        """V1ControllerRevision - a model defined in OpenAPI
