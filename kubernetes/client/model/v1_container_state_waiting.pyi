...
class V1ContainerStateWaiting(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "reason", ], str]):
