...
def lazy_import():
    ...
    globals()['V1EndpointSlice'] = V1EndpointSlice
    globals()['V1ListMeta'] = V1ListMeta


class V1EndpointSliceList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1EndpointSlice],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1EndpointSliceList - a model defined in OpenAPI

        Args:
            items ([V1EndpointSlice]): List of endpoint slices
