...
def lazy_import():
    ...
    globals()['V1beta1Endpoint'] = V1beta1Endpoint
    globals()['V1beta1EndpointPort'] = V1beta1EndpointPort


class V1beta1EndpointSlice(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'endpoints': ([V1beta1Endpoint],),  # noqa: E501
            'api_version': (str,),  # noqa: E501
            'kind': (str,),  # noqa: E501
            'metadata': (V1ObjectMeta,),  # noqa: E501
            'ports': ([V1beta1EndpointPort],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address_type, endpoints, *args, **kwargs):  # noqa: E501
        """V1beta1EndpointSlice - a model defined in OpenAPI

        Args:
            address_type (str): addressType specifies the type of address carried by this EndpointSlice. All addresses in this slice must be the same type. This field is immutable after creation. The following address types are currently supported: * IPv4: Represents an IPv4 Address. * IPv6: Represents an IPv6 Address. * FQDN: Represents a Fully Qualified Domain Name.
            endpoints ([V1beta1Endpoint]): endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.
        ...
        Keyword Args:
            ...
            ports ([V1beta1EndpointPort]): ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name. When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it indicates \"all ports\". Each slice may include a maximum of 100 ports.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, address_type, endpoints, *args, **kwargs):  # noqa: E501
        """V1beta1EndpointSlice - a model defined in OpenAPI
