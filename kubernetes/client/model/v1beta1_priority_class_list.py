...
def lazy_import():
    ...
    globals()['V1beta1PriorityClass'] = V1beta1PriorityClass


class V1beta1PriorityClassList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1PriorityClass],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1beta1PriorityClassList - a model defined in OpenAPI

        Args:
            items ([V1beta1PriorityClass]): items is the list of PriorityClasses
