...
def lazy_import():
    ...
    globals()['V2beta2HorizontalPodAutoscaler'] = V2beta2HorizontalPodAutoscaler


class V2beta2HorizontalPodAutoscalerList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V2beta2HorizontalPodAutoscaler],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V2beta2HorizontalPodAutoscalerList - a model defined in OpenAPI

        Args:
            items ([V2beta2HorizontalPodAutoscaler]): items is the list of horizontal pod autoscaler objects.
