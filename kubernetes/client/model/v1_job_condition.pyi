...
class V1JobCondition(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            lastProbeTime = schemas.DateTimeSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lastProbeTime"]) -> MetaOapg.properties.lastProbeTime: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "type", "lastProbeTime", "lastTransitionTime", "message", "reason", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lastProbeTime"]) -> typing.Union[MetaOapg.properties.lastProbeTime, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "type", "lastProbeTime", "lastTransitionTime", "message", "reason", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        lastProbeTime: typing.Union[MetaOapg.properties.lastProbeTime, str, datetime, schemas.Unset] = schemas.unset,
