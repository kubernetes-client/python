...
class V1Binding(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def target() -> typing.Type['V1ObjectReference']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["target"]) -> 'V1ObjectReference': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["target", "apiVersion", "kind", "metadata", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["target"]) -> 'V1ObjectReference': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["target", "apiVersion", "kind", "metadata", ], str]):
