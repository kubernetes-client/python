...
def lazy_import():
    ...
    globals()['V1PersistentVolume'] = V1PersistentVolume


class V1PersistentVolumeList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1PersistentVolume],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1PersistentVolumeList - a model defined in OpenAPI

        Args:
            items ([V1PersistentVolume]): List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes
