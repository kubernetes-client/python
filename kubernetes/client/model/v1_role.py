...
class V1Role(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["apiVersion", "kind", "metadata", "rules", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["apiVersion", "kind", "metadata", "rules", ], str]):
