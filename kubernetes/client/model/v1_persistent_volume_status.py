...
class V1PersistentVolumeStatus(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "phase", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "phase", "reason", ], str]):
