...
def lazy_import():
    ...
    globals()['V1alpha1FlowSchema'] = V1alpha1FlowSchema


class V1alpha1FlowSchemaList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1alpha1FlowSchema],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1alpha1FlowSchemaList - a model defined in OpenAPI

        Args:
            items ([V1alpha1FlowSchema]): `items` is a list of FlowSchemas.
