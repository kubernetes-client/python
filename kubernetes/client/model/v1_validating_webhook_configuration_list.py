...
def lazy_import():
    ...
    globals()['V1ValidatingWebhookConfiguration'] = V1ValidatingWebhookConfiguration


class V1ValidatingWebhookConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1ValidatingWebhookConfiguration],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1ValidatingWebhookConfigurationList - a model defined in OpenAPI

        Args:
            items ([V1ValidatingWebhookConfiguration]): List of ValidatingWebhookConfiguration.
