...
class V1NodeSelectorRequirement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "operator", "values", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "operator", "values", ], str]):
