...
class V2beta2HorizontalPodAutoscalerSpec(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def scaleTargetRef() -> typing.Type['V2beta2CrossVersionObjectReference']:
                return V2beta2CrossVersionObjectReference
        
            @staticmethod
            def behavior() -> typing.Type['V2beta2HorizontalPodAutoscalerBehavior']:
            ...
            class metrics(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V2beta2MetricSpec']:
                        return V2beta2MetricSpec
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V2beta2MetricSpec'], typing.List['V2beta2MetricSpec']],
                ...
                def __getitem__(self, i: int) -> 'V2beta2MetricSpec':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scaleTargetRef"]) -> 'V2beta2CrossVersionObjectReference': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["behavior"]) -> 'V2beta2HorizontalPodAutoscalerBehavior': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scaleTargetRef"]) -> 'V2beta2CrossVersionObjectReference': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["behavior"]) -> typing.Union['V2beta2HorizontalPodAutoscalerBehavior', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        scaleTargetRef: 'V2beta2CrossVersionObjectReference',
        behavior: typing.Union['V2beta2HorizontalPodAutoscalerBehavior', schemas.Unset] = schemas.unset,
