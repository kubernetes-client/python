...
def lazy_import():
    ...
    globals()['V1RoleRef'] = V1RoleRef
    globals()['V1Subject'] = V1Subject


class V1ClusterRoleBinding(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'role_ref': (V1RoleRef,),  # noqa: E501
            'api_version': (str,),  # noqa: E501
            'kind': (str,),  # noqa: E501
            'metadata': (V1ObjectMeta,),  # noqa: E501
            'subjects': ([V1Subject],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, role_ref, *args, **kwargs):  # noqa: E501
        """V1ClusterRoleBinding - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            subjects ([V1Subject]): Subjects holds references to the objects the role applies to.. [optional]  # noqa: E501
        """
