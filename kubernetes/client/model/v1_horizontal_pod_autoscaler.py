...
class V1HorizontalPodAutoscaler(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def spec() -> typing.Type['V1HorizontalPodAutoscalerSpec']:
                return V1HorizontalPodAutoscalerSpec
        
            @staticmethod
            def status() -> typing.Type['V1HorizontalPodAutoscalerStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spec"]) -> 'V1HorizontalPodAutoscalerSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'V1HorizontalPodAutoscalerStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spec"]) -> typing.Union['V1HorizontalPodAutoscalerSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['V1HorizontalPodAutoscalerStatus', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        spec: typing.Union['V1HorizontalPodAutoscalerSpec', schemas.Unset] = schemas.unset,
        status: typing.Union['V1HorizontalPodAutoscalerStatus', schemas.Unset] = schemas.unset,
