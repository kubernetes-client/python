...
def lazy_import():
    ...
    globals()['V1beta1PodSecurityPolicy'] = V1beta1PodSecurityPolicy


class V1beta1PodSecurityPolicyList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1beta1PodSecurityPolicy],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1beta1PodSecurityPolicyList - a model defined in OpenAPI

        Args:
            items ([V1beta1PodSecurityPolicy]): items is a list of schema objects.
