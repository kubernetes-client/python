        ...
        class properties:
            ...
            class webhooks(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1ValidatingWebhook']:
                        return V1ValidatingWebhook
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1ValidatingWebhook'], typing.List['V1ValidatingWebhook']],
                ...
                def __getitem__(self, i: int) -> 'V1ValidatingWebhook':
