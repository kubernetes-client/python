        ...
        class properties:
            ...
            class conditions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta1FlowSchemaCondition']:
                        return V1beta1FlowSchemaCondition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['V1beta1FlowSchemaCondition'], typing.List['V1beta1FlowSchemaCondition']],
                ...
                def __getitem__(self, i: int) -> 'V1beta1FlowSchemaCondition':
