...
def lazy_import():
    ...
    globals()['V1ServiceAccount'] = V1ServiceAccount


class V1ServiceAccountList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1ServiceAccount],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """V1ServiceAccountList - a model defined in OpenAPI
