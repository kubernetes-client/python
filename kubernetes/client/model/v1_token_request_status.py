...
class V1TokenRequestStatus(ModelNormal):
    ...
    attribute_map = {
        'expiration_timestamp': 'expirationTimestamp',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expiration_timestamp, token, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expiration_timestamp, token, *args, **kwargs):  # noqa: E501
        """V1TokenRequestStatus - a model defined in OpenAPI
