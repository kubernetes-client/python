...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdmissionregistrationApi()
        api_instance.get_api_group  # this is an instance of the class Endpoint
        api_instance.get_api_group()  # this invokes api_instance.get_api_group.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_api_group.callable or self.callable in this class
