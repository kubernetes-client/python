...
class V1beta2AllocatedDeviceStatus(BaseModel):
    ...
    network_data: Optional[V1beta2NetworkDeviceData] = Field(default=None, validation_alias=AliasChoices("networkData", "network_data"), serialization_alias="networkData")
