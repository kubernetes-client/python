...
class V1ResourceClaimConsumerReference(BaseModel):
    ...
    """ # noqa: E501
    api_group: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("apiGroup", "api_group"), serialization_alias="apiGroup", description="APIGroup is the group for the resource being referenced. It is empty for the core API. This matches the group in the APIVersion that is used when creating the resources.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "apiGroup" not in obj and "api_group" in obj:
            obj["apiGroup"] = obj["api_group"]
        obj.pop("api_group", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("apiGroup" if serialize else "api_group"): _to_legacy_value(getattr(self, "api_group", None), serialize),
