...
class V1Device(BaseModel):
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        ...
        "name": "str",
        "node_allocatable_resource_mappings": "Dict[str, V1NodeAllocatableResourceMapping]",
        "node_name": "str",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodeAllocatableResourceMappings": dict(
                (_k, V1NodeAllocatableResourceMapping.from_dict(_v))
