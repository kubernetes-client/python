...
class V1beta1MutatingAdmissionPolicyBindingList(BaseModel):
    ...
    items: List[V1beta1MutatingAdmissionPolicyBinding] = Field(description="List of PolicyBinding.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1MutatingAdmissionPolicyBinding.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
