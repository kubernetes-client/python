...
class V1EnvVar(BaseModel):
    ...
    value_from: Optional[V1EnvVarSource] = Field(default=None, validation_alias=AliasChoices("valueFrom", "value_from"), serialization_alias="valueFrom")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "valueFrom" not in obj and "value_from" in obj:
            obj["valueFrom"] = obj["value_from"]
        obj.pop("value_from", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("valueFrom" if serialize else "value_from"): _to_legacy_value(getattr(self, "value_from", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.value_from:
            _dict['valueFrom'] = _to_openapi_value(self.value_from)
        return _dict
