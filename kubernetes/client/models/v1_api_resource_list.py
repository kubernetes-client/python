...
class V1APIResourceList(BaseModel):
    ...
    group_version: StrictStr = Field(validation_alias=AliasChoices("groupVersion", "group_version"), serialization_alias="groupVersion", description="groupVersion is the group and version this APIResourceList is for.")
    ...
    def __preprocess_input_names(
        ...
        if "groupVersion" not in obj and "group_version" in obj:
            obj["groupVersion"] = obj["group_version"]
        obj.pop("group_version", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("groupVersion" if serialize else "group_version"): _to_legacy_value(getattr(self, "group_version", None), serialize),
