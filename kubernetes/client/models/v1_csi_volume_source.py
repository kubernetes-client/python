...
class V1CSIVolumeSource(BaseModel):
    ...
    fs_type: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("fsType", "fs_type"), serialization_alias="fsType", description="fsType to mount. Ex. \"ext4\", \"xfs\", \"ntfs\". If not provided, the empty value is passed to the associated CSI driver which will determine the default filesystem to apply.")
    node_publish_secret_ref: Optional[V1LocalObjectReference] = Field(default=None, validation_alias=AliasChoices("nodePublishSecretRef", "node_publish_secret_ref"), serialization_alias="nodePublishSecretRef")
    read_only: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("readOnly", "read_only"), serialization_alias="readOnly", description="readOnly specifies a read-only configuration for the volume. Defaults to false (read/write).")
    volume_attributes: Optional[Dict[str, StrictStr]] = Field(default=None, validation_alias=AliasChoices("volumeAttributes", "volume_attributes"), serialization_alias="volumeAttributes", description="volumeAttributes stores driver-specific properties that are passed to the CSI driver. Consult your driver's documentation for supported values.")
