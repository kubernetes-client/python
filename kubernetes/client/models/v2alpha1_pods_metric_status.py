...
class V2alpha1PodsMetricStatus(object):
    """
    ...
    def __init__(self, current_average_value=None, metric_name=None):
        """
        V2alpha1PodsMetricStatus - a model defined in Swagger
    ...
    def current_average_value(self):
        """
        Gets the current_average_value of this V2alpha1PodsMetricStatus.
    ...
    def current_average_value(self, current_average_value):
        """
        Sets the current_average_value of this V2alpha1PodsMetricStatus.
        currentAverageValue is the current value of the average of the metric across all relevant pods (as a quantity)
    ...
    def metric_name(self):
        """
        Gets the metric_name of this V2alpha1PodsMetricStatus.
        metricName is the name of the metric in question

        :return: The metric_name of this V2alpha1PodsMetricStatus.
        :rtype: str
        """
    ...
    def metric_name(self, metric_name):
        """
        Sets the metric_name of this V2alpha1PodsMetricStatus.
        metricName is the name of the metric in question

        :param metric_name: The metric_name of this V2alpha1PodsMetricStatus.
        :type: str
        """
