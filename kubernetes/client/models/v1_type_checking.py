...
class V1TypeChecking(BaseModel):
    ...
    """ # noqa: E501
    expression_warnings: Optional[List[V1ExpressionWarning]] = Field(default=None, validation_alias=AliasChoices("expressionWarnings", "expression_warnings"), serialization_alias="expressionWarnings", description="expressionWarnings contains the type checking warnings for each expression.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "expressionWarnings" not in obj and "expression_warnings" in obj:
            obj["expressionWarnings"] = obj["expression_warnings"]
        obj.pop("expression_warnings", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("expressionWarnings" if serialize else "expression_warnings"): _to_legacy_value(getattr(self, "expression_warnings", None), serialize),
        }
