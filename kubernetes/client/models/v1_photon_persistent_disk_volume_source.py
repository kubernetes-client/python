...
class V1PhotonPersistentDiskVolumeSource(BaseModel):
    ...
    pd_id: StrictStr = Field(validation_alias=AliasChoices("pdID", "pd_id"), serialization_alias="pdID", description="pdID is the ID that identifies Photon Controller persistent disk")
    ...
    def __preprocess_input_names(
        ...
        if "pdID" not in obj and "pd_id" in obj:
            obj["pdID"] = obj["pd_id"]
        obj.pop("pd_id", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("pdID" if serialize else "pd_id"): _to_legacy_value(getattr(self, "pd_id", None), serialize),
        }
