...
class V1alpha3PodGroupResourceClaimStatus(BaseModel):
    """
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="name uniquely identifies this resource claim inside the PodGroup. This must match the name of an entry in podgroup.spec.resourceClaims, which implies that the string must be a DNS_LABEL.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3PodGroupResourceClaimStatus):
            return False
