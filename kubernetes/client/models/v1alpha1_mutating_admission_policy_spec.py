...
class V1alpha1MutatingAdmissionPolicySpec(BaseModel):
    ...
    match_conditions: Optional[List[V1alpha1MatchCondition]] = Field(default=None, validation_alias=AliasChoices("matchConditions", "match_conditions"), serialization_alias="matchConditions", description="matchConditions is a list of conditions that must be met for a request to be validated. Match conditions filter requests that have already been matched by the matchConstraints. An empty list of matchConditions matches all requests. There are a maximum of 64 match conditions allowed.  If a parameter object is provided, it can be accessed via the `params` handle in the same manner as validation expressions.  The exact matching logic is (in order):   1. If ANY matchCondition evaluates to FALSE, the policy is skipped.   2. If ALL matchConditions evaluate to TRUE, the policy is evaluated.   3. If any matchCondition evaluates to an error (but none are FALSE):      - If failurePolicy=Fail, reject the request      - If failurePolicy=Ignore, the policy is skipped")
    match_constraints: Optional[V1alpha1MatchResources] = Field(default=None, validation_alias=AliasChoices("matchConstraints", "match_constraints"), serialization_alias="matchConstraints")
    ...
    param_kind: Optional[V1alpha1ParamKind] = Field(default=None, validation_alias=AliasChoices("paramKind", "param_kind"), serialization_alias="paramKind")
