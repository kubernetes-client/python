...
class V1ValidatingAdmissionPolicyStatus(BaseModel):
    ...
    """ # noqa: E501
    conditions: Optional[List[V1Condition]] = Field(default=None, description="conditions represent the latest available observations of a policy's current state.")
    observed_generation: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("observedGeneration", "observed_generation"), serialization_alias="observedGeneration", description="observedGeneration is the generation observed by the controller.")
    type_checking: Optional[V1TypeChecking] = Field(default=None, validation_alias=AliasChoices("typeChecking", "type_checking"), serialization_alias="typeChecking")
    ...
    def __preprocess_input_names(
        ...
        if "typeChecking" not in obj and "type_checking" in obj:
            obj["typeChecking"] = obj["type_checking"]
        obj.pop("type_checking", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("typeChecking" if serialize else "type_checking"): _to_legacy_value(getattr(self, "type_checking", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.type_checking:
            _dict['typeChecking'] = _to_openapi_value(self.type_checking)
        return _dict
