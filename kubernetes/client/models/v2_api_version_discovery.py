...
class V2APIVersionDiscovery(BaseModel):
    """
    ...
    resources: Optional[List[V2APIResourceDiscovery]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": [V2APIResourceDiscovery.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
