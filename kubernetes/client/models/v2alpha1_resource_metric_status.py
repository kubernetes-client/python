...
class V2alpha1ResourceMetricStatus(object):
    """
    ...
    def __init__(self, current_average_utilization=None, current_average_value=None, name=None):
        """
        V2alpha1ResourceMetricStatus - a model defined in Swagger
    ...
    def current_average_utilization(self):
        """
        Gets the current_average_utilization of this V2alpha1ResourceMetricStatus.
        currentAverageUtilization is the current value of the average of the resource metric across all relevant pods, represented as a percentage of the requested value of the resource for the pods.  It will only be present if `targetAverageValue` was set in the corresponding metric specification.

        :return: The current_average_utilization of this V2alpha1ResourceMetricStatus.
        :rtype: int
        """
    ...
    def current_average_utilization(self, current_average_utilization):
        """
        Sets the current_average_utilization of this V2alpha1ResourceMetricStatus.
        currentAverageUtilization is the current value of the average of the resource metric across all relevant pods, represented as a percentage of the requested value of the resource for the pods.  It will only be present if `targetAverageValue` was set in the corresponding metric specification.

        :param current_average_utilization: The current_average_utilization of this V2alpha1ResourceMetricStatus.
        :type: int
        """
    ...
    def current_average_value(self):
        """
        Gets the current_average_value of this V2alpha1ResourceMetricStatus.
    ...
    def current_average_value(self, current_average_value):
        """
        Sets the current_average_value of this V2alpha1ResourceMetricStatus.
        currentAverageValue is the current value of the average of the resource metric across all relevant pods, as a raw value (instead of as a percentage of the request), similar to the \"pods\" metric source type. It will always be set, regardless of the corresponding metric specification.
    ...
    def name(self):
        """
        Gets the name of this V2alpha1ResourceMetricStatus.
        name is the name of the resource in question.

        :return: The name of this V2alpha1ResourceMetricStatus.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this V2alpha1ResourceMetricStatus.
        name is the name of the resource in question.

        :param name: The name of this V2alpha1ResourceMetricStatus.
        :type: str
        """
        if name is None:
