...
class V1alpha3WorkloadPodGroupDisruptionMode(BaseModel):
    """
    ...
    """ # noqa: E501
    all: Optional[Dict[str, Any]] = Field(default=None, description="all specifies that all pods in the group must be disrupted together.")
    single: Optional[Dict[str, Any]] = Field(default=None, description="single specifies that pods can be disrupted independently from each other.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3WorkloadPodGroupDisruptionMode):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("all" if serialize else "all"): _to_legacy_value(getattr(self, "all", None), serialize),
            ("single" if serialize else "single"): _to_legacy_value(getattr(self, "single", None), serialize),
        }
