...
class V1NodeAllocatableResourceClaimStatus(BaseModel):
    ...
    resources: Dict[str, StrictStr] = Field(description="Resources is a map of the node-allocatable resource name to the aggregate quantity allocated to the claim.")
