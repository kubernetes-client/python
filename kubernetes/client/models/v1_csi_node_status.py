...
class V1CSINodeStatus(BaseModel):
    """
    ...
    """ # noqa: E501
    storage_health: Optional[List[V1StorageHealth]] = Field(default=None, validation_alias=AliasChoices("storageHealth", "storage_health"), serialization_alias="storageHealth", description="storageHealth contains backend health reports for CSI drivers registered on the node.")
    openapi_types: ClassVar[Dict[str, str]] = {
        "storage_health": "List[V1StorageHealth]"
    }

    attribute_map: ClassVar[Dict[str, str]] = {
        "storage_health": "storageHealth"
    }
    __properties: ClassVar[List[str]] = ["storageHealth"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "storageHealth" not in obj and "storage_health" in obj:
            obj["storageHealth"] = obj["storage_health"]
        obj.pop("storage_health", None)
        return obj
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1CSINodeStatus):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("storageHealth" if serialize else "storage_health"): _to_legacy_value(getattr(self, "storage_health", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in storage_health (list)
        _items = []
        if self.storage_health:
            for _item_storage_health in self.storage_health:
                _items.append(_to_openapi_value(_item_storage_health) if _item_storage_health is not None else None)
            _dict['storageHealth'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "storageHealth": [V1StorageHealth.from_dict(_item) for _item in obj["storageHealth"]] if obj.get("storageHealth") is not None else None
        })
        return _obj
