...
class V1ResourceClaimList(BaseModel):
    ...
    items: List[ResourceV1ResourceClaim] = Field(description="Items is the list of resource claims.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ResourceV1ResourceClaim.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
