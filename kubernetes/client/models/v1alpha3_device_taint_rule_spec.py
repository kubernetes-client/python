...
class V1alpha3DeviceTaintRuleSpec(BaseModel):
    ...
    """ # noqa: E501
    device_selector: Optional[V1alpha3DeviceTaintSelector] = Field(default=None, validation_alias=AliasChoices("deviceSelector", "device_selector"), serialization_alias="deviceSelector")
