...
class V1beta1IPAddressSpec(BaseModel):
    ...
    """ # noqa: E501
    parent_ref: V1beta1ParentReference = Field(validation_alias=AliasChoices("parentRef", "parent_ref"), serialization_alias="parentRef")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "parentRef" not in obj and "parent_ref" in obj:
            obj["parentRef"] = obj["parent_ref"]
        obj.pop("parent_ref", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("parentRef" if serialize else "parent_ref"): _to_legacy_value(getattr(self, "parent_ref", None), serialize),
        }
