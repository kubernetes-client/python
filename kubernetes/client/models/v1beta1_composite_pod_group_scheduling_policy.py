...
class V1beta1CompositePodGroupSchedulingPolicy(BaseModel):
    """
    ...
    gang: Optional[V1beta1CompositeGangSchedulingPolicy] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1CompositePodGroupSchedulingPolicy):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic": obj.get("basic"),
            "gang": V1beta1CompositeGangSchedulingPolicy.from_dict(obj["gang"]) if obj.get("gang") is not None else None
        })
        return _obj
