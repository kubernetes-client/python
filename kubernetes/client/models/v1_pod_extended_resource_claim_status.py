...
class V1PodExtendedResourceClaimStatus(BaseModel):
    ...
    """ # noqa: E501
    request_mappings: List[V1ContainerExtendedResourceRequest] = Field(validation_alias=AliasChoices("requestMappings", "request_mappings"), serialization_alias="requestMappings", description="RequestMappings identifies the mapping of <container, extended resource backed by DRA> to  device request in the generated ResourceClaim.")
    resource_claim_name: StrictStr = Field(validation_alias=AliasChoices("resourceClaimName", "resource_claim_name"), serialization_alias="resourceClaimName", description="ResourceClaimName is the name of the ResourceClaim that was generated for the Pod in the namespace of the Pod.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "requestMappings" not in obj and "request_mappings" in obj:
            obj["requestMappings"] = obj["request_mappings"]
        obj.pop("request_mappings", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("requestMappings" if serialize else "request_mappings"): _to_legacy_value(getattr(self, "request_mappings", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestMappings": [V1ContainerExtendedResourceRequest.from_dict(_item) for _item in obj["requestMappings"]] if obj.get("requestMappings") is not None else None,
