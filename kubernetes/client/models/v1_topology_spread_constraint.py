...
class V1TopologySpreadConstraint(object):
    ...
    def when_unsatisfiable(self, when_unsatisfiable):
        ...
        if self.local_vars_configuration.client_side_validation and when_unsatisfiable not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `when_unsatisfiable` ({0}), must be one of {1}"  # noqa: E501
