...
class V1beta1PodCertificateRequest(BaseModel):
    """
    ...
    status: Optional[V1beta1PodCertificateRequestStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta1PodCertificateRequestSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1beta1PodCertificateRequestStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
