...
class V1GitRepoVolumeSource(BaseModel):
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("directory" if serialize else "directory"): _to_legacy_value(getattr(self, "directory", None), serialize),
            ("repository" if serialize else "repository"): _to_legacy_value(getattr(self, "repository", None), serialize),
