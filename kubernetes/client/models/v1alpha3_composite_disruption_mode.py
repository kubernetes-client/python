...
class V1alpha3CompositeDisruptionMode(BaseModel):
    """
    ...
    """ # noqa: E501
    all: Optional[Dict[str, Any]] = Field(default=None, description="all specifies that all children groups can only be disrupted together.")
    single: Optional[Dict[str, Any]] = Field(default=None, description="single specifies that children groups can be disrupted independently from each other.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3CompositeDisruptionMode):
            return False
