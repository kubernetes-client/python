...
from pydantic import AliasChoices, BaseModel, ConfigDict, Field, ModelWrapValidatorHandler as _ModelWrapValidatorHandler, StrictInt, StrictStr, model_validator as _model_validator
...
class V1ListMeta(BaseModel):
    ...
    """ # noqa: E501
    var_continue: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("continue", "_continue"), serialization_alias="continue", description="continue may be set if the user set a limit on the number of items returned, and indicates that the server has more data available. The value is opaque and may be used to issue another request to the endpoint that served this list to retrieve the next set of available objects. Continuing a consistent list may not be possible if the server configuration has changed or more than a few minutes have passed. The resourceVersion field returned when using this continue value will be identical to the value in the first response, unless you have received this token from an error message.", alias="_continue")
    remaining_item_count: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("remainingItemCount", "remaining_item_count"), serialization_alias="remainingItemCount", description="remainingItemCount is the number of subsequent items in the list which are not included in this list response. If the list request contained label or field selectors, then the number of remaining items is unknown and the field will be left unset and omitted during serialization. If the list is complete (either because it is not chunking or because this is the last chunk), then there are no more remaining items and this field will be left unset and omitted during serialization. Servers older than v1.15 do not set this field. The intended use of the remainingItemCount is *estimating* the size of a collection. Clients should not rely on the remainingItemCount to be set or to be exact.")
    resource_version: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("resourceVersion", "resource_version"), serialization_alias="resourceVersion", description="String that identifies the server's internal version of this object that can be used by clients to determine when objects have changed. Value must be treated as opaque by clients and passed unmodified back to the server. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency")
    ...
    shard_info: Optional[V1ShardInfo] = Field(default=None, validation_alias=AliasChoices("shardInfo", "shard_info"), serialization_alias="shardInfo")
    ...
    def __preprocess_input_names(
        ...
        if "remainingItemCount" not in obj and "remaining_item_count" in obj:
            obj["remainingItemCount"] = obj["remaining_item_count"]
        obj.pop("remaining_item_count", None)
        ...
        if "shardInfo" not in obj and "shard_info" in obj:
            obj["shardInfo"] = obj["shard_info"]
        obj.pop("shard_info", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("remainingItemCount" if serialize else "remaining_item_count"): _to_legacy_value(getattr(self, "remaining_item_count", None), serialize),
            ...
            ("shardInfo" if serialize else "shard_info"): _to_legacy_value(getattr(self, "shard_info", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.shard_info:
            _dict['shardInfo'] = _to_openapi_value(self.shard_info)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shardInfo": V1ShardInfo.from_dict(obj["shardInfo"]) if obj.get("shardInfo") is not None else None
        })
        return _obj
    ...
    if TYPE_CHECKING:
        ...
        @property
        def _continue(self) -> _V1ListMeta_var_continue_public_type:
            return self.var_continue

        @_continue.setter
        def _continue(self, value: _V1ListMeta_var_continue_public_type) -> None:
            self.var_continue = value


if TYPE_CHECKING:
    _V1ListMeta_var_continue_public_type = Optional[StrictStr]
