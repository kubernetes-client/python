...
class StorageV1TokenRequest(BaseModel):
    ...
    expiration_seconds: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("expirationSeconds", "expiration_seconds"), serialization_alias="expirationSeconds", description="expirationSeconds is the duration of validity of the token in \"TokenRequestSpec\". It has the same default value of \"ExpirationSeconds\" in \"TokenRequestSpec\".")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("audience" if serialize else "audience"): _to_legacy_value(getattr(self, "audience", None), serialize),
