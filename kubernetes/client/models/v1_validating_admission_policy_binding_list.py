...
class V1ValidatingAdmissionPolicyBindingList(BaseModel):
    ...
    items: Optional[List[V1ValidatingAdmissionPolicyBinding]] = Field(default=None, description="List of PolicyBinding.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ValidatingAdmissionPolicyBinding.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
