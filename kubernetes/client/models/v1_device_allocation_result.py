...
class V1DeviceAllocationResult(BaseModel):
    ...
    """ # noqa: E501
    config: Optional[List[V1DeviceAllocationConfiguration]] = Field(default=None, description="This field is a combination of all the claim and class configuration parameters. Drivers can distinguish between those based on a flag.  This includes configuration parameters for drivers which have no allocated devices in the result because it is up to the drivers which configuration parameters they support. They can silently ignore unknown configuration parameters.")
    results: Optional[List[V1DeviceRequestAllocationResult]] = Field(default=None, description="Results lists all allocated devices.")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("results" if serialize else "results"): _to_legacy_value(getattr(self, "results", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": [V1DeviceAllocationConfiguration.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None,
            "results": [V1DeviceRequestAllocationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
