...
class V1alpha1EvictionRequestPodReference(BaseModel):
    """
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="name of the target. This field is required.")
    uid: StrictStr = Field(description="uid of the target. It can be found in .metadata.uid of the target and is a lowercase UUID in 8-4-4-4-12 format. This field is required.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1EvictionRequestPodReference):
            return False
