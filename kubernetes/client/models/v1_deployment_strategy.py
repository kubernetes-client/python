...
class V1DeploymentStrategy(BaseModel):
    ...
    """ # noqa: E501
    rolling_update: Optional[V1RollingUpdateDeployment] = Field(default=None, validation_alias=AliasChoices("rollingUpdate", "rolling_update"), serialization_alias="rollingUpdate")
