...
class V2HorizontalPodAutoscalerSpec(BaseModel):
    ...
    max_replicas: StrictInt = Field(validation_alias=AliasChoices("maxReplicas", "max_replicas"), serialization_alias="maxReplicas", description="maxReplicas is the upper limit for the number of replicas to which the autoscaler can scale up. It cannot be less that minReplicas.")
    ...
    scale_target_ref: V2CrossVersionObjectReference = Field(validation_alias=AliasChoices("scaleTargetRef", "scale_target_ref"), serialization_alias="scaleTargetRef")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("behavior" if serialize else "behavior"): _to_legacy_value(getattr(self, "behavior", None), serialize),
            ("maxReplicas" if serialize else "max_replicas"): _to_legacy_value(getattr(self, "max_replicas", None), serialize),
            ("metrics" if serialize else "metrics"): _to_legacy_value(getattr(self, "metrics", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.behavior:
            _dict['behavior'] = _to_openapi_value(self.behavior)
