...
class V1StorageOSVolumeSource(BaseModel):
    ...
    """ # noqa: E501
    fs_type: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("fsType", "fs_type"), serialization_alias="fsType", description="fsType is the filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified.")
    ...
    volume_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("volumeName", "volume_name"), serialization_alias="volumeName", description="volumeName is the human-readable name of the StorageOS volume.  Volume names are only unique within a namespace.")
    volume_namespace: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("volumeNamespace", "volume_namespace"), serialization_alias="volumeNamespace", description="volumeNamespace specifies the scope of the volume within StorageOS.  If no namespace is specified then the Pod's namespace will be used.  This allows the Kubernetes name scoping to be mirrored within StorageOS for tighter integration. Set VolumeName to any name to override the default behaviour. Set to \"default\" if you are not using namespaces within StorageOS. Namespaces that do not pre-exist within StorageOS will be created.")
    ...
    def __preprocess_input_names(
        ...
        if "volumeNamespace" not in obj and "volume_namespace" in obj:
            obj["volumeNamespace"] = obj["volume_namespace"]
        obj.pop("volume_namespace", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("volumeNamespace" if serialize else "volume_namespace"): _to_legacy_value(getattr(self, "volume_namespace", None), serialize),
        }
