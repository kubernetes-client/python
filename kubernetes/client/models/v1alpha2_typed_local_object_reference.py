...
class V1alpha2TypedLocalObjectReference(BaseModel):
    """
    ...
    """ # noqa: E501
    api_group: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("apiGroup", "api_group"), serialization_alias="apiGroup", description="APIGroup is the group for the resource being referenced. If APIGroup is empty, the specified Kind must be in the core API group. For any other third-party types, setting APIGroup is required. It must be a DNS subdomain.")
