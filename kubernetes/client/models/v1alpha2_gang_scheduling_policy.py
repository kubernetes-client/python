...
class V1alpha2GangSchedulingPolicy(BaseModel):
    """
    ...
    """ # noqa: E501
    min_count: StrictInt = Field(validation_alias=AliasChoices("minCount", "min_count"), serialization_alias="minCount", description="MinCount is the minimum number of pods that must be schedulable or scheduled at the same time for the scheduler to admit the entire group. It must be a positive integer.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "minCount" not in obj and "min_count" in obj:
            obj["minCount"] = obj["min_count"]
        obj.pop("min_count", None)
        return obj
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha2GangSchedulingPolicy):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("minCount" if serialize else "min_count"): _to_legacy_value(getattr(self, "min_count", None), serialize),
        }
