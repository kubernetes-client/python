...
class V1Taint(BaseModel):
    ...
    time_added: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("timeAdded", "time_added"), serialization_alias="timeAdded", description="TimeAdded represents the time at which the taint was added.")
