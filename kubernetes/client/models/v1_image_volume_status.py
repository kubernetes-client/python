...
class V1ImageVolumeStatus(BaseModel):
    """
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "imageRef" not in obj and "image_ref" in obj:
            obj["imageRef"] = obj["image_ref"]
        obj.pop("image_ref", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("imageRef" if serialize else "image_ref"): _to_legacy_value(getattr(self, "image_ref", None), serialize),
        }
