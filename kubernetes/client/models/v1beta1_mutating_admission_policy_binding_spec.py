...
class V1beta1MutatingAdmissionPolicyBindingSpec(BaseModel):
    ...
    """ # noqa: E501
    match_resources: Optional[V1beta1MatchResources] = Field(default=None, validation_alias=AliasChoices("matchResources", "match_resources"), serialization_alias="matchResources")
    param_ref: Optional[V1beta1ParamRef] = Field(default=None, validation_alias=AliasChoices("paramRef", "param_ref"), serialization_alias="paramRef")
