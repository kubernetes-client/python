...
class V1ReplicaSetCondition(BaseModel):
    ...
    """ # noqa: E501
    last_transition_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastTransitionTime", "last_transition_time"), serialization_alias="lastTransitionTime", description="The last time the condition transitioned from one status to another.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of replica set condition.")
