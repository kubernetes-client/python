...
class V1PodSpec(object):
    ...
    def enable_service_links(self):
        ...
        EnableServiceLinks indicates whether information about services should be injected into pod's environment variables, matching the syntax of Docker links.  # noqa: E501
