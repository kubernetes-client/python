...
class V1ValidatingAdmissionPolicyList(BaseModel):
    ...
    items: Optional[List[V1ValidatingAdmissionPolicy]] = Field(default=None, description="List of ValidatingAdmissionPolicy.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ValidatingAdmissionPolicy.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
