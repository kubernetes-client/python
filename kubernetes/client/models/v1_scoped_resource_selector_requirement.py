...
class V1ScopedResourceSelectorRequirement(BaseModel):
    ...
    scope_name: StrictStr = Field(validation_alias=AliasChoices("scopeName", "scope_name"), serialization_alias="scopeName", description="The name of the scope that the selector applies to.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "scopeName" not in obj and "scope_name" in obj:
            obj["scopeName"] = obj["scope_name"]
        obj.pop("scope_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("scopeName" if serialize else "scope_name"): _to_legacy_value(getattr(self, "scope_name", None), serialize),
