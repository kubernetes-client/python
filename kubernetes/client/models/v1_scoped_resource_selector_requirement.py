...
class V1ScopedResourceSelectorRequirement(object):
    ...
    def operator(self):
        ...
        Represents a scope's relationship to a set of values. Valid operators are In, NotIn, Exists, DoesNotExist.  Possible enum values:  - `\"DoesNotExist\"`  - `\"Exists\"`  - `\"In\"`  - `\"NotIn\"`  # noqa: E501
    ...
    def operator(self, operator):
        ...
        allowed_values = ["DoesNotExist", "Exists", "In", "NotIn"]  # noqa: E501
    ...
    def scope_name(self, scope_name):
        ...
        allowed_values = ["BestEffort", "CrossNamespacePodAffinity", "NotBestEffort", "NotTerminating", "PriorityClass", "Terminating"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and scope_name not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `scope_name` ({0}), must be one of {1}"  # noqa: E501
                .format(scope_name, allowed_values)
            )
