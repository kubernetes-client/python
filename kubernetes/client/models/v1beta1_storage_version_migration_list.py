...
class V1beta1StorageVersionMigrationList(BaseModel):
    """
    ...
    items: List[V1beta1StorageVersionMigration] = Field(description="Items is the list of StorageVersionMigration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1StorageVersionMigration.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
