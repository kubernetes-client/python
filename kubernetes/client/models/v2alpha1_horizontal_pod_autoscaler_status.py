...
class V2alpha1HorizontalPodAutoscalerStatus(object):
    ...
    def __init__(self, conditions=None, current_metrics=None, current_replicas=None, desired_replicas=None, last_scale_time=None, observed_generation=None):
        ...
        """
        self.swagger_types = {
            'conditions': 'list[V2alpha1HorizontalPodAutoscalerCondition]',
    ...
    def conditions(self):
        """
        Gets the conditions of this V2alpha1HorizontalPodAutoscalerStatus.
        conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.

        :return: The conditions of this V2alpha1HorizontalPodAutoscalerStatus.
        :rtype: list[V2alpha1HorizontalPodAutoscalerCondition]
        """
    ...
    def conditions(self, conditions):
        """
        Sets the conditions of this V2alpha1HorizontalPodAutoscalerStatus.
        conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.

        :param conditions: The conditions of this V2alpha1HorizontalPodAutoscalerStatus.
        :type: list[V2alpha1HorizontalPodAutoscalerCondition]
        """
