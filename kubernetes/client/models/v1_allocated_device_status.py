...
class V1AllocatedDeviceStatus(BaseModel):
    ...
    network_data: Optional[V1NetworkDeviceData] = Field(default=None, validation_alias=AliasChoices("networkData", "network_data"), serialization_alias="networkData")
    ...
    share_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("shareID", "share_id"), serialization_alias="shareID", description="ShareID uniquely identifies an individual allocation share of the device.")
    ...
    __properties: ClassVar[List[str]] = ["conditions", "data", "device", "driver", "networkData", "pool", "shareID"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "networkData" not in obj and "network_data" in obj:
            obj["networkData"] = obj["network_data"]
        obj.pop("network_data", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("networkData" if serialize else "network_data"): _to_legacy_value(getattr(self, "network_data", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.network_data:
            _dict['networkData'] = _to_openapi_value(self.network_data)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "networkData": V1NetworkDeviceData.from_dict(obj["networkData"]) if obj.get("networkData") is not None else None,
            "pool": obj.get("pool"),
