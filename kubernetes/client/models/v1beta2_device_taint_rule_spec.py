...
class V1beta2DeviceTaintRuleSpec(BaseModel):
    """
    ...
    """ # noqa: E501
    device_selector: Optional[V1beta2DeviceTaintSelector] = Field(default=None, validation_alias=AliasChoices("deviceSelector", "device_selector"), serialization_alias="deviceSelector")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta2DeviceTaintRuleSpec):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deviceSelector": V1beta2DeviceTaintSelector.from_dict(obj["deviceSelector"]) if obj.get("deviceSelector") is not None else None,
            "taint": V1beta2DeviceTaint.from_dict(obj["taint"]) if obj.get("taint") is not None else None
        })
        return _obj
