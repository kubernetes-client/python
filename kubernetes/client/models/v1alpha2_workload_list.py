...
class V1alpha2WorkloadList(BaseModel):
    """
    ...
    items: List[V1alpha2Workload] = Field(description="Items is the list of Workloads.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha2Workload.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
