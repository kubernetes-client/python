...
class V1beta2DeviceTaintRuleList(BaseModel):
    """
    ...
    items: List[V1beta2DeviceTaintRule] = Field(description="Items is the list of DeviceTaintRules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta2DeviceTaintRule.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
