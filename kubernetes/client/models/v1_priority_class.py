...
class V1PriorityClass(BaseModel):
    ...
    global_default: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("globalDefault", "global_default"), serialization_alias="globalDefault", description="globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class. Only one PriorityClass can be marked as `globalDefault`. However, if more than one PriorityClasses exists with their `globalDefault` field set to true, the smallest value of such global default PriorityClasses will be used as the default priority.")
    ...
    value: Optional[StrictInt] = Field(default=None, description="value represents the integer value of this priority class. This is the actual priority that pods receive when they have the name of this class in their pod spec.")
    ...
    def __preprocess_input_names(
        ...
        if "globalDefault" not in obj and "global_default" in obj:
            obj["globalDefault"] = obj["global_default"]
        obj.pop("global_default", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("globalDefault" if serialize else "global_default"): _to_legacy_value(getattr(self, "global_default", None), serialize),
