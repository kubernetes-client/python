...
class V1ConfigMap(BaseModel):
    ...
    def __preprocess_input_names(
        ...
        if "binaryData" not in obj and "binary_data" in obj:
            obj["binaryData"] = obj["binary_data"]
        obj.pop("binary_data", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("binaryData" if serialize else "binary_data"): _to_legacy_value(getattr(self, "binary_data", None), serialize),
