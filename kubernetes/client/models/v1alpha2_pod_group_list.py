...
class V1alpha2PodGroupList(BaseModel):
    """
    ...
    items: List[V1alpha2PodGroup] = Field(description="Items is the list of PodGroups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha2PodGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
