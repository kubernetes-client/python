...
class V1Preconditions(BaseModel):
    ...
    """ # noqa: E501
    resource_version: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("resourceVersion", "resource_version"), serialization_alias="resourceVersion", description="Specifies the target ResourceVersion")
