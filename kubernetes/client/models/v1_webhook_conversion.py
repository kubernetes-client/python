...
class V1WebhookConversion(BaseModel):
    ...
    """ # noqa: E501
    client_config: Optional[ApiextensionsV1WebhookClientConfig] = Field(default=None, validation_alias=AliasChoices("clientConfig", "client_config"), serialization_alias="clientConfig")
    conversion_review_versions: List[StrictStr] = Field(validation_alias=AliasChoices("conversionReviewVersions", "conversion_review_versions"), serialization_alias="conversionReviewVersions", description="conversionReviewVersions is an ordered list of preferred `ConversionReview` versions the Webhook expects. The API server will use the first version in the list which it supports. If none of the versions specified in this list are supported by API server, conversion will fail for the custom resource. If a persisted Webhook configuration specifies allowed versions and does not include any versions known to the API Server, calls to the webhook will fail.")
    ...
    def __preprocess_input_names(
        ...
        if "conversionReviewVersions" not in obj and "conversion_review_versions" in obj:
            obj["conversionReviewVersions"] = obj["conversion_review_versions"]
        obj.pop("conversion_review_versions", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("conversionReviewVersions" if serialize else "conversion_review_versions"): _to_legacy_value(getattr(self, "conversion_review_versions", None), serialize),
        }
