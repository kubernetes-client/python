...
class V1DaemonSetUpdateStrategy(BaseModel):
    ...
    """ # noqa: E501
    rolling_update: Optional[V1RollingUpdateDaemonSet] = Field(default=None, validation_alias=AliasChoices("rollingUpdate", "rolling_update"), serialization_alias="rollingUpdate")
