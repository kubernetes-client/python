...
class V1alpha1EvictionRequestTarget(BaseModel):
    """
    ...
    """ # noqa: E501
    pod: Optional[V1alpha1EvictionRequestPodReference] = None
    ...
    __properties: ClassVar[List[str]] = ["pod"]
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1EvictionRequestTarget):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("pod" if serialize else "pod"): _to_legacy_value(getattr(self, "pod", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.pod:
            _dict['pod'] = _to_openapi_value(self.pod)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pod": V1alpha1EvictionRequestPodReference.from_dict(obj["pod"]) if obj.get("pod") is not None else None
        })
        return _obj
