...
class V1DeviceClassList(BaseModel):
    ...
    items: List[V1DeviceClass] = Field(description="Items is the list of resource classes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1DeviceClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
