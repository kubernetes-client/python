...
class V2MetricStatus(BaseModel):
    ...
    """ # noqa: E501
    container_resource: Optional[V2ContainerResourceMetricStatus] = Field(default=None, validation_alias=AliasChoices("containerResource", "container_resource"), serialization_alias="containerResource")
