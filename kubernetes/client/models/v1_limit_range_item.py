...
class V1LimitRangeItem(object):
    ...
    def type(self):
        ...
        Type of resource that this limit applies to.  Possible enum values:  - `\"Container\"` Limit that applies to all containers in a namespace  - `\"PersistentVolumeClaim\"` Limit that applies to all persistent volume claims in a namespace  - `\"Pod\"` Limit that applies to all pods in a namespace  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["Container", "PersistentVolumeClaim", "Pod"]  # noqa: E501
