...
class V1WeightedPodAffinityTerm(BaseModel):
    ...
    """ # noqa: E501
    pod_affinity_term: V1PodAffinityTerm = Field(validation_alias=AliasChoices("podAffinityTerm", "pod_affinity_term"), serialization_alias="podAffinityTerm")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "podAffinityTerm" not in obj and "pod_affinity_term" in obj:
            obj["podAffinityTerm"] = obj["pod_affinity_term"]
        obj.pop("pod_affinity_term", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("podAffinityTerm" if serialize else "pod_affinity_term"): _to_legacy_value(getattr(self, "pod_affinity_term", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.pod_affinity_term:
            _dict['podAffinityTerm'] = _to_openapi_value(self.pod_affinity_term)
        return _dict
