...
class V1alpha1CertificateSigningRequest(object):
    ...
    def api_version(self):
        """
        Gets the api_version of this V1alpha1CertificateSigningRequest.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#resources

        :return: The api_version of this V1alpha1CertificateSigningRequest.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """
        Sets the api_version of this V1alpha1CertificateSigningRequest.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#resources

        :param api_version: The api_version of this V1alpha1CertificateSigningRequest.
        :type: str
        """
    ...
    def kind(self):
        """
        Gets the kind of this V1alpha1CertificateSigningRequest.
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds

        :return: The kind of this V1alpha1CertificateSigningRequest.
        :rtype: str
        """
        return self._kind
    ...
    def kind(self, kind):
        """
        Sets the kind of this V1alpha1CertificateSigningRequest.
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds

        :param kind: The kind of this V1alpha1CertificateSigningRequest.
        :type: str
        """
