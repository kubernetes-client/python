...
class V1IngressTLS(BaseModel):
    ...
    secret_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("secretName", "secret_name"), serialization_alias="secretName", description="secretName is the name of the secret used to terminate TLS traffic on port 443. Field is left optional to allow TLS routing based on SNI hostname alone. If the SNI host in a listener conflicts with the \"Host\" header field used by an IngressRule, the SNI host is used for termination and value of the \"Host\" header is used for routing.")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("hosts" if serialize else "hosts"): _to_legacy_value(getattr(self, "hosts", None), serialize),
