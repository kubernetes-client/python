...
class V1DeviceAllocationConfiguration(BaseModel):
    ...
    """ # noqa: E501
    opaque: Optional[V1OpaqueDeviceConfiguration] = None
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("opaque" if serialize else "opaque"): _to_legacy_value(getattr(self, "opaque", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.opaque:
            _dict['opaque'] = _to_openapi_value(self.opaque)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "opaque": V1OpaqueDeviceConfiguration.from_dict(obj["opaque"]) if obj.get("opaque") is not None else None,
