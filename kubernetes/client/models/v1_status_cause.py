...
from pydantic import BaseModel, ConfigDict, Field, ModelWrapValidatorHandler as _ModelWrapValidatorHandler, StrictStr, model_validator as _model_validator
...
class V1StatusCause(BaseModel):
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("field" if serialize else "field"): _to_legacy_value(getattr(self, "var_field", None), serialize),
    ...
    if TYPE_CHECKING:
        ...
        @property
        def field(self) -> _V1StatusCause_var_field_public_type:
            return self.var_field

        @field.setter
        def field(self, value: _V1StatusCause_var_field_public_type) -> None:
            self.var_field = value


if TYPE_CHECKING:
    _V1StatusCause_var_field_public_type = Optional[StrictStr]
