...
class V1LinuxContainerUser(BaseModel):
    ...
    supplemental_groups: Optional[List[StrictInt]] = Field(default=None, validation_alias=AliasChoices("supplementalGroups", "supplemental_groups"), serialization_alias="supplementalGroups", description="SupplementalGroups are the supplemental groups initially attached to the first process in the container")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("gid" if serialize else "gid"): _to_legacy_value(getattr(self, "gid", None), serialize),
