...
class V1PodReadinessGate(BaseModel):
    ...
    """ # noqa: E501
    condition_type: StrictStr = Field(validation_alias=AliasChoices("conditionType", "condition_type"), serialization_alias="conditionType", description="ConditionType refers to a condition in the pod's condition list with matching type.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "conditionType" not in obj and "condition_type" in obj:
            obj["conditionType"] = obj["condition_type"]
        obj.pop("condition_type", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("conditionType" if serialize else "condition_type"): _to_legacy_value(getattr(self, "condition_type", None), serialize),
        }
