...
class V1CounterSet(BaseModel):
    ...
    """ # noqa: E501
    counters: Dict[str, V1Counter] = Field(description="Counters defines the set of counters for this CounterSet The name of each counter must be unique in that set and must be a DNS label.  The maximum number of counters is 32.")
