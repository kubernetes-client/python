...
class V1MatchResources(BaseModel):
    ...
    resource_rules: Optional[List[V1NamedRuleWithOperations]] = Field(default=None, validation_alias=AliasChoices("resourceRules", "resource_rules"), serialization_alias="resourceRules", description="resourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy matches. The policy cares about an operation if it matches _any_ Rule.")
