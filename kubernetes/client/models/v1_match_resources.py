...
class V1MatchResources(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "excludeResourceRules": [V1NamedRuleWithOperations.from_dict(_item) for _item in obj.get("excludeResourceRules")] if obj.get("excludeResourceRules") is not None else None,
            ...
            "resourceRules": [V1NamedRuleWithOperations.from_dict(_item) for _item in obj.get("resourceRules")] if obj.get("resourceRules") is not None else None
        })
        return _obj
