...
class V1beta1PodCertificateRequestList(BaseModel):
    """
    ...
    items: List[V1beta1PodCertificateRequest] = Field(description="items is a collection of PodCertificateRequest objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1PodCertificateRequest.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
