...
class V1ContainerResizePolicy(BaseModel):
    ...
    """ # noqa: E501
    resource_name: StrictStr = Field(validation_alias=AliasChoices("resourceName", "resource_name"), serialization_alias="resourceName", description="Name of the resource to which this resource resize policy applies. Supported values: cpu, memory.")
    restart_policy: StrictStr = Field(validation_alias=AliasChoices("restartPolicy", "restart_policy"), serialization_alias="restartPolicy", description="Restart policy to apply when specified resource is resized. If not specified, it defaults to NotRequired.")
