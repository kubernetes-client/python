...
class V1alpha2PodGroupTemplateReference(BaseModel):
    """
    ...
    """ # noqa: E501
    workload: Optional[V1alpha2WorkloadPodGroupTemplateReference] = None
    ...
    __properties: ClassVar[List[str]] = ["workload"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("workload" if serialize else "workload"): _to_legacy_value(getattr(self, "workload", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.workload:
            _dict['workload'] = _to_openapi_value(self.workload)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workload": V1alpha2WorkloadPodGroupTemplateReference.from_dict(obj["workload"]) if obj.get("workload") is not None else None
        })
        return _obj
