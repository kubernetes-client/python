...
class V1DeviceCapacity(BaseModel):
    ...
    """ # noqa: E501
    request_policy: Optional[V1CapacityRequestPolicy] = Field(default=None, validation_alias=AliasChoices("requestPolicy", "request_policy"), serialization_alias="requestPolicy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestPolicy": V1CapacityRequestPolicy.from_dict(obj["requestPolicy"]) if obj.get("requestPolicy") is not None else None,
            "value": obj.get("value")
        })
        return _obj
