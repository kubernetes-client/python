...
class V1NodeDaemonEndpoints(BaseModel):
    ...
    """ # noqa: E501
    kubelet_endpoint: Optional[V1DaemonEndpoint] = Field(default=None, validation_alias=AliasChoices("kubeletEndpoint", "kubelet_endpoint"), serialization_alias="kubeletEndpoint")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "kubeletEndpoint" not in obj and "kubelet_endpoint" in obj:
            obj["kubeletEndpoint"] = obj["kubelet_endpoint"]
        obj.pop("kubelet_endpoint", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("kubeletEndpoint" if serialize else "kubelet_endpoint"): _to_legacy_value(getattr(self, "kubelet_endpoint", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.kubelet_endpoint:
            _dict['kubeletEndpoint'] = _to_openapi_value(self.kubelet_endpoint)
        return _dict
