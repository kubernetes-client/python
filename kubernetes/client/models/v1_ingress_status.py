...
class V1IngressStatus(BaseModel):
    ...
    """ # noqa: E501
    load_balancer: Optional[V1IngressLoadBalancerStatus] = Field(default=None, validation_alias=AliasChoices("loadBalancer", "load_balancer"), serialization_alias="loadBalancer")
