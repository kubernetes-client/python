...
class V1alpha1EvictionRequest(BaseModel):
    """
    ...
    status: Optional[V1alpha1EvictionRequestStatus] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1EvictionRequest):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1EvictionRequestSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1alpha1EvictionRequestStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
