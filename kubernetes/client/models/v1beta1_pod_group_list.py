...
class V1beta1PodGroupList(BaseModel):
    """
    ...
    items: List[V1beta1PodGroup] = Field(description="Items is the list of PodGroups.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1PodGroupList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1PodGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
