...
class V1LabelSelector(BaseModel):
    ...
    """ # noqa: E501
    match_expressions: Optional[List[V1LabelSelectorRequirement]] = Field(default=None, validation_alias=AliasChoices("matchExpressions", "match_expressions"), serialization_alias="matchExpressions", description="matchExpressions is a list of label selector requirements. The requirements are ANDed.")
    match_labels: Optional[Dict[str, StrictStr]] = Field(default=None, validation_alias=AliasChoices("matchLabels", "match_labels"), serialization_alias="matchLabels", description="matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \"key\", the operator is \"In\", and the values array contains only \"value\". The requirements are ANDed.")
    ...
    def __preprocess_input_names(
        ...
        if "matchLabels" not in obj and "match_labels" in obj:
            obj["matchLabels"] = obj["match_labels"]
        obj.pop("match_labels", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("matchLabels" if serialize else "match_labels"): _to_legacy_value(getattr(self, "match_labels", None), serialize),
        }
