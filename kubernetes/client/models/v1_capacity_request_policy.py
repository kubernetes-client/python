...
class V1CapacityRequestPolicy(BaseModel):
    ...
    valid_range: Optional[V1CapacityRequestPolicyRange] = Field(default=None, validation_alias=AliasChoices("validRange", "valid_range"), serialization_alias="validRange")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validRange": V1CapacityRequestPolicyRange.from_dict(obj["validRange"]) if obj.get("validRange") is not None else None,
