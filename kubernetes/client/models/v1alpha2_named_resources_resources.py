...
class V1alpha2NamedResourcesResources(BaseModel):
    ...
    """ # noqa: E501
    instances: List[V1alpha2NamedResourcesInstance] = Field(description="The list of all individual resources instances currently available.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "instances": [V1alpha2NamedResourcesInstance.from_dict(_item) for _item in obj.get("instances")] if obj.get("instances") is not None else None
        })
        return _obj
