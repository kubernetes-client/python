...
class V1beta1DeviceDerivedAttribute(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1DeviceDerivedAttribute):
            return False
