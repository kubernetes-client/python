...
class V1DeviceSelector(BaseModel):
    ...
    """ # noqa: E501
    cel: Optional[V1CELDeviceSelector] = None
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("cel" if serialize else "cel"): _to_legacy_value(getattr(self, "cel", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cel:
            _dict['cel'] = _to_openapi_value(self.cel)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cel": V1CELDeviceSelector.from_dict(obj["cel"]) if obj.get("cel") is not None else None
        })
        return _obj
