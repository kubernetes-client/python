...
class V1NodeSpec(BaseModel):
    ...
    pod_preemption_policy: Optional[V1NodePodPreemptionPolicy] = Field(default=None, validation_alias=AliasChoices("podPreemptionPolicy", "pod_preemption_policy"), serialization_alias="podPreemptionPolicy")
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        ...
        "pod_cidr": "str",
        "pod_cidrs": "List[str]",
        "pod_preemption_policy": "V1NodePodPreemptionPolicy",
        "provider_id": "str",
        "taints": "List[V1Taint]",
        "unschedulable": "bool"
    }
    ...
    def __preprocess_input_names(
        ...
        if "podPreemptionPolicy" not in obj and "pod_preemption_policy" in obj:
            obj["podPreemptionPolicy"] = obj["pod_preemption_policy"]
        obj.pop("pod_preemption_policy", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("podPreemptionPolicy" if serialize else "pod_preemption_policy"): _to_legacy_value(getattr(self, "pod_preemption_policy", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.pod_preemption_policy:
            _dict['podPreemptionPolicy'] = _to_openapi_value(self.pod_preemption_policy)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "podPreemptionPolicy": V1NodePodPreemptionPolicy.from_dict(obj["podPreemptionPolicy"]) if obj.get("podPreemptionPolicy") is not None else None,
