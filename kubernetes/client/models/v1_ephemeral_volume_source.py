...
class V1EphemeralVolumeSource(BaseModel):
    ...
    """ # noqa: E501
    volume_claim_template: Optional[V1PersistentVolumeClaimTemplate] = Field(default=None, validation_alias=AliasChoices("volumeClaimTemplate", "volume_claim_template"), serialization_alias="volumeClaimTemplate")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "volumeClaimTemplate" not in obj and "volume_claim_template" in obj:
            obj["volumeClaimTemplate"] = obj["volume_claim_template"]
        obj.pop("volume_claim_template", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("volumeClaimTemplate" if serialize else "volume_claim_template"): _to_legacy_value(getattr(self, "volume_claim_template", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.volume_claim_template:
            _dict['volumeClaimTemplate'] = _to_openapi_value(self.volume_claim_template)
        return _dict
