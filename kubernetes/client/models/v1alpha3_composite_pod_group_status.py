...
class V1alpha3CompositePodGroupStatus(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3CompositePodGroupStatus):
            return False
