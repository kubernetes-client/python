...
class V2beta1APIGroupDiscovery(BaseModel):
    """
    ...
    versions: Optional[List[V2beta1APIVersionDiscovery]] = None
    ...
    __properties: ClassVar[List[str]] = ["apiVersion", "kind", "metadata", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [V2beta1APIVersionDiscovery.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
