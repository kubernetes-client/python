...
class V2beta1APIVersionDiscovery(BaseModel):
    """
    ...
    """ # noqa: E501
    version: StrictStr = Field(description="version is the name of the version within a group version.")
    resources: Optional[List[V2beta1APIResourceDiscovery]] = None
    freshness: Optional[StrictStr] = Field(default=None, description="freshness marks whether a group version's discovery document is up to date.")
    ...
    __properties: ClassVar[List[str]] = ["version", "resources", "freshness"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("freshness" if serialize else "freshness"): _to_legacy_value(getattr(self, "freshness", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": [V2beta1APIResourceDiscovery.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
