...
class V1PodSchedulingGroup(BaseModel):
    """
    ...
    """ # noqa: E501
    pod_group_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("podGroupName", "pod_group_name"), serialization_alias="podGroupName", description="PodGroupName specifies the name of the standalone PodGroup object that represents the runtime instance of this group. Must be a DNS subdomain.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "podGroupName" not in obj and "pod_group_name" in obj:
            obj["podGroupName"] = obj["pod_group_name"]
        obj.pop("pod_group_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("podGroupName" if serialize else "pod_group_name"): _to_legacy_value(getattr(self, "pod_group_name", None), serialize),
        }
