...
class V1ObjectFieldSelector(BaseModel):
    ...
    """ # noqa: E501
    api_version: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("apiVersion", "api_version"), serialization_alias="apiVersion", description="Version of the schema the FieldPath is written in terms of, defaults to \"v1\".")
    field_path: StrictStr = Field(validation_alias=AliasChoices("fieldPath", "field_path"), serialization_alias="fieldPath", description="Path of the field to select in the specified API version.")
