...
class FlowcontrolV1Subject(BaseModel):
    ...
    service_account: Optional[V1ServiceAccountSubject] = Field(default=None, validation_alias=AliasChoices("serviceAccount", "service_account"), serialization_alias="serviceAccount")
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.group:
            _dict['group'] = _to_openapi_value(self.group)
        # override the default output from pydantic by calling `to_dict()` of service_account
        if self.service_account:
            _dict['serviceAccount'] = _to_openapi_value(self.service_account)
