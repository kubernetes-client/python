...
class V1VsphereVirtualDiskVolumeSource(BaseModel):
    ...
    storage_policy_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("storagePolicyID", "storage_policy_id"), serialization_alias="storagePolicyID", description="storagePolicyID is the storage Policy Based Management (SPBM) profile ID associated with the StoragePolicyName.")
    storage_policy_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("storagePolicyName", "storage_policy_name"), serialization_alias="storagePolicyName", description="storagePolicyName is the storage Policy Based Management (SPBM) profile name.")
    volume_path: StrictStr = Field(validation_alias=AliasChoices("volumePath", "volume_path"), serialization_alias="volumePath", description="volumePath is the path that identifies vSphere volume vmdk")
    ...
    def __preprocess_input_names(
        ...
        if "storagePolicyID" not in obj and "storage_policy_id" in obj:
            obj["storagePolicyID"] = obj["storage_policy_id"]
        obj.pop("storage_policy_id", None)
        if "storagePolicyName" not in obj and "storage_policy_name" in obj:
            obj["storagePolicyName"] = obj["storage_policy_name"]
        obj.pop("storage_policy_name", None)
        if "volumePath" not in obj and "volume_path" in obj:
            obj["volumePath"] = obj["volume_path"]
        obj.pop("volume_path", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("storagePolicyID" if serialize else "storage_policy_id"): _to_legacy_value(getattr(self, "storage_policy_id", None), serialize),
            ("storagePolicyName" if serialize else "storage_policy_name"): _to_legacy_value(getattr(self, "storage_policy_name", None), serialize),
            ("volumePath" if serialize else "volume_path"): _to_legacy_value(getattr(self, "volume_path", None), serialize),
        }
