...
class V1ConfigMapNodeConfigSource(BaseModel):
    ...
    """ # noqa: E501
    kubelet_config_key: StrictStr = Field(validation_alias=AliasChoices("kubeletConfigKey", "kubelet_config_key"), serialization_alias="kubeletConfigKey", description="KubeletConfigKey declares which key of the referenced ConfigMap corresponds to the KubeletConfiguration structure This field is required in all cases.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "kubeletConfigKey" not in obj and "kubelet_config_key" in obj:
            obj["kubeletConfigKey"] = obj["kubelet_config_key"]
        obj.pop("kubelet_config_key", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("kubeletConfigKey" if serialize else "kubelet_config_key"): _to_legacy_value(getattr(self, "kubelet_config_key", None), serialize),
