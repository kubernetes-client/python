...
class V1JobCondition(BaseModel):
    ...
    """ # noqa: E501
    last_probe_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastProbeTime", "last_probe_time"), serialization_alias="lastProbeTime", description="Last time the condition was checked.")
