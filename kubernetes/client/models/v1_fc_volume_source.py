...
class V1FCVolumeSource(BaseModel):
    ...
    target_wwns: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("targetWWNs", "target_wwns"), serialization_alias="targetWWNs", description="targetWWNs is Optional: FC target worldwide names (WWNs)")
    ...
    def __preprocess_input_names(
        ...
        if "targetWWNs" not in obj and "target_wwns" in obj:
            obj["targetWWNs"] = obj["target_wwns"]
        obj.pop("target_wwns", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("targetWWNs" if serialize else "target_wwns"): _to_legacy_value(getattr(self, "target_wwns", None), serialize),
            ("wwids" if serialize else "wwids"): _to_legacy_value(getattr(self, "wwids", None), serialize),
        }
