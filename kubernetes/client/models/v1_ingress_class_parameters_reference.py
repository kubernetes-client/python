...
class V1IngressClassParametersReference(BaseModel):
    ...
    """ # noqa: E501
    api_group: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("apiGroup", "api_group"), serialization_alias="apiGroup", description="apiGroup is the group for the resource being referenced. If APIGroup is not specified, the specified Kind must be in the core API group. For any other third-party types, APIGroup is required.")
