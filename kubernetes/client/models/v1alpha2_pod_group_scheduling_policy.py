...
class V1alpha2PodGroupSchedulingPolicy(BaseModel):
    """
    ...
    """ # noqa: E501
    basic: Optional[Dict[str, Any]] = Field(default=None, description="Basic specifies that the pods in this group should be scheduled using standard Kubernetes scheduling behavior.")
    gang: Optional[V1alpha2GangSchedulingPolicy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic": obj.get("basic"),
            "gang": V1alpha2GangSchedulingPolicy.from_dict(obj["gang"]) if obj.get("gang") is not None else None
        })
        return _obj
