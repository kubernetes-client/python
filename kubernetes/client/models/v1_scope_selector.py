...
class V1ScopeSelector(BaseModel):
    ...
    """ # noqa: E501
    match_expressions: Optional[List[V1ScopedResourceSelectorRequirement]] = Field(default=None, validation_alias=AliasChoices("matchExpressions", "match_expressions"), serialization_alias="matchExpressions", description="A list of scope selector requirements by scope of the resources.")
