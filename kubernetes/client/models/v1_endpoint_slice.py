...
class V1EndpointSlice(BaseModel):
    ...
    """ # noqa: E501
    address_type: StrictStr = Field(validation_alias=AliasChoices("addressType", "address_type"), serialization_alias="addressType", description="addressType specifies the type of address carried by this EndpointSlice. All addresses in this slice must be the same type. This field is immutable after creation. The following address types are currently supported: * IPv4: Represents an IPv4 Address. * IPv6: Represents an IPv6 Address. * FQDN: Represents a Fully Qualified Domain Name. (Deprecated) The EndpointSlice controller only generates, and kube-proxy only processes, slices of addressType \"IPv4\" and \"IPv6\". No semantics are defined for the \"FQDN\" type.")
    ...
    endpoints: Optional[List[V1Endpoint]] = Field(default=None, description="endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "addressType" not in obj and "address_type" in obj:
            obj["addressType"] = obj["address_type"]
        obj.pop("address_type", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("addressType" if serialize else "address_type"): _to_legacy_value(getattr(self, "address_type", None), serialize),
