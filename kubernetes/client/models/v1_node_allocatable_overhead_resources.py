...
class V1NodeAllocatableOverheadResources(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1NodeAllocatableOverheadResources):
            return False
