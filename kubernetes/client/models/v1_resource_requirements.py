...
class V1ResourceRequirements(BaseModel):
    ...
    """ # noqa: E501
    claims: Optional[List[CoreV1ResourceClaim]] = Field(default=None, description="Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.  This field depends on the DynamicResourceAllocation feature gate.  This field is immutable. It can only be set for containers.")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("claims" if serialize else "claims"): _to_legacy_value(getattr(self, "claims", None), serialize),
            ("limits" if serialize else "limits"): _to_legacy_value(getattr(self, "limits", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "claims": [CoreV1ResourceClaim.from_dict(_item) for _item in obj["claims"]] if obj.get("claims") is not None else None,
