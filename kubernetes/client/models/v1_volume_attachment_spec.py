...
class V1VolumeAttachmentSpec(BaseModel):
    ...
    node_name: StrictStr = Field(validation_alias=AliasChoices("nodeName", "node_name"), serialization_alias="nodeName", description="nodeName represents the node that the volume should be attached to.")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("attacher" if serialize else "attacher"): _to_legacy_value(getattr(self, "attacher", None), serialize),
