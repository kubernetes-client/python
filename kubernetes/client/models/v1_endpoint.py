...
class V1Endpoint(BaseModel):
    ...
    deprecated_topology: Optional[Dict[str, StrictStr]] = Field(default=None, validation_alias=AliasChoices("deprecatedTopology", "deprecated_topology"), serialization_alias="deprecatedTopology", description="deprecatedTopology contains topology information part of the v1beta1 API. This field is deprecated, and will be removed when the v1beta1 API is removed (no sooner than kubernetes v1.24).  While this field can hold values, it is not writable through the v1 API, and any attempts to write to it will be silently ignored. Topology information can be found in the zone and nodeName fields instead.")
    ...
    node_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("nodeName", "node_name"), serialization_alias="nodeName", description="nodeName represents the name of the Node hosting this endpoint. This can be used to determine endpoints local to a Node.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "deprecatedTopology" not in obj and "deprecated_topology" in obj:
            obj["deprecatedTopology"] = obj["deprecated_topology"]
        obj.pop("deprecated_topology", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("deprecatedTopology" if serialize else "deprecated_topology"): _to_legacy_value(getattr(self, "deprecated_topology", None), serialize),
            ("hints" if serialize else "hints"): _to_legacy_value(getattr(self, "hints", None), serialize),
            ...
            ("zone" if serialize else "zone"): _to_legacy_value(getattr(self, "zone", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.conditions:
            _dict['conditions'] = _to_openapi_value(self.conditions)
        # override the default output from pydantic by calling `to_dict()` of hints
        if self.hints:
            _dict['hints'] = _to_openapi_value(self.hints)
