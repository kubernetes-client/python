...
class V1StorageHealth(BaseModel):
    """
    ...
    """ # noqa: E501
    health_conditions: Optional[List[V1StorageHealthCondition]] = Field(default=None, validation_alias=AliasChoices("healthConditions", "health_conditions"), serialization_alias="healthConditions", description="healthConditions are the adverse storage backend conditions reported by the CSI driver. At most 16 conditions may be reported.")
    name: StrictStr = Field(description="name is the CSI driver name, matching CSINodeDriver.name.")
    openapi_types: ClassVar[Dict[str, str]] = {
        "health_conditions": "List[V1StorageHealthCondition]",
        "name": "str"
    }
    ...
    __properties: ClassVar[List[str]] = ["healthConditions", "name"]
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1StorageHealth):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "healthConditions": [V1StorageHealthCondition.from_dict(_item) for _item in obj["healthConditions"]] if obj.get("healthConditions") is not None else None,
            "name": obj.get("name")
        })
        return _obj
