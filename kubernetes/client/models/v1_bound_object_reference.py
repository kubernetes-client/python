...
class V1BoundObjectReference(BaseModel):
    ...
    """ # noqa: E501
    api_version: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("apiVersion", "api_version"), serialization_alias="apiVersion", description="apiVersion is API version of the referent.")
    kind: Optional[StrictStr] = Field(default=None, description="kind of the referent. Valid kinds are 'Pod', 'Secret', 'Node', 'ValidatingWebhookConfiguration', and 'MutatingWebhookConfiguration'.")
