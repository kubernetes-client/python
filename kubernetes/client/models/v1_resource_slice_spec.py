...
class V1ResourceSliceSpec(BaseModel):
    ...
    attribute_map: ClassVar[Dict[str, str]] = {
        ...
        "partition_type_attribute": "partitionTypeAttribute",
        "per_device_node_selection": "perDeviceNodeSelection",
        "pool": "pool",
        "shared_counters": "sharedCounters",
        "skip_node_operations": "skipNodeOperations"
    }
    __properties: ClassVar[List[str]] = ["allNodes", "devices", "driver", "nodeName", "nodeSelector", "partitionTypeAttribute", "perDeviceNodeSelection", "pool", "sharedCounters", "skipNodeOperations"]
    ...
    def __preprocess_input_names(
        ...
        if "partitionTypeAttribute" not in obj and "partition_type_attribute" in obj:
            obj["partitionTypeAttribute"] = obj["partition_type_attribute"]
        obj.pop("partition_type_attribute", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("partitionTypeAttribute" if serialize else "partition_type_attribute"): _to_legacy_value(getattr(self, "partition_type_attribute", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partitionTypeAttribute": obj.get("partitionTypeAttribute"),
