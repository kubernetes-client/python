...
class V1GroupVersionForDiscovery(BaseModel):
    ...
    """ # noqa: E501
    group_version: StrictStr = Field(validation_alias=AliasChoices("groupVersion", "group_version"), serialization_alias="groupVersion", description="groupVersion specifies the API group and version in the form \"group/version\"")
