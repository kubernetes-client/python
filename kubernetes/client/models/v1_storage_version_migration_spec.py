...
class V1StorageVersionMigrationSpec(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1StorageVersionMigrationSpec):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource": V1GroupResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None
        })
        return _obj
