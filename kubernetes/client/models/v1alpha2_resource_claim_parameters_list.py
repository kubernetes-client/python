...
class V1alpha2ResourceClaimParametersList(BaseModel):
    ...
    items: List[V1alpha2ResourceClaimParameters] = Field(description="Items is the list of node resource capacity objects.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha2ResourceClaimParameters.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
