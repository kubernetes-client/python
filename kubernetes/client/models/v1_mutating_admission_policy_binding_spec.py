...
class V1MutatingAdmissionPolicyBindingSpec(BaseModel):
    """
    ...
    policy_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("policyName", "policy_name"), serialization_alias="policyName", description="policyName references a MutatingAdmissionPolicy name which the MutatingAdmissionPolicyBinding binds to. If the referenced resource does not exist, this binding is considered invalid and will be ignored Required.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1MutatingAdmissionPolicyBindingSpec):
            return False
