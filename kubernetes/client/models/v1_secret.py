...
from pydantic import AliasChoices, BaseModel, ConfigDict, Field, StrictBool, StrictStr, field_validator
...
class V1Secret(BaseModel):
    ...
    string_data: Optional[Dict[str, StrictStr]] = Field(default=None, validation_alias=AliasChoices("stringData", "string_data"), serialization_alias="stringData", description="stringData allows specifying non-binary secret data in string form. It is provided as a write-only input field for convenience. All keys and values are merged into the data field on write, overwriting any existing values. The stringData field is never output when reading from the API.")
    ...
    def __preprocess_input_names(
        ...
        if "stringData" not in obj and "string_data" in obj:
            obj["stringData"] = obj["string_data"]
        obj.pop("string_data", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("immutable" if serialize else "immutable"): _to_legacy_value(getattr(self, "immutable", None), serialize),
            ...
            ("stringData" if serialize else "string_data"): _to_legacy_value(getattr(self, "string_data", None), serialize),
