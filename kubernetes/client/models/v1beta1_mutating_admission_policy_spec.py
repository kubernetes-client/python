...
class V1beta1MutatingAdmissionPolicySpec(BaseModel):
    ...
    match_conditions: Optional[List[V1beta1MatchCondition]] = Field(default=None, validation_alias=AliasChoices("matchConditions", "match_conditions"), serialization_alias="matchConditions", description="matchConditions is a list of conditions that must be met for a request to be validated. Match conditions filter requests that have already been matched by the matchConstraints. An empty list of matchConditions matches all requests. There are a maximum of 64 match conditions allowed.  If a parameter object is provided, it can be accessed via the `params` handle in the same manner as validation expressions.  The exact matching logic is (in order):   1. If ANY matchCondition evaluates to FALSE, the policy is skipped.   2. If ALL matchConditions evaluate to TRUE, the policy is evaluated.   3. If any matchCondition evaluates to an error (but none are FALSE):      - If failurePolicy=Fail, reject the request      - If failurePolicy=Ignore, the policy is skipped")
    match_constraints: Optional[V1beta1MatchResources] = Field(default=None, validation_alias=AliasChoices("matchConstraints", "match_constraints"), serialization_alias="matchConstraints")
    mutations: Optional[List[V1beta1Mutation]] = Field(default=None, description="mutations contain operations to perform on matching objects. mutations may not be empty; a minimum of one mutation is required. mutations are evaluated in order, and are reinvoked according to the reinvocationPolicy. The mutations of a policy are invoked for each binding of this policy and reinvocation of mutations occurs on a per binding basis.")
    param_kind: Optional[V1beta1ParamKind] = Field(default=None, validation_alias=AliasChoices("paramKind", "param_kind"), serialization_alias="paramKind")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mutations": [V1beta1Mutation.from_dict(_item) for _item in obj["mutations"]] if obj.get("mutations") is not None else None,
