...
class AdmissionregistrationV1ServiceReference(BaseModel):
    ...
    port: Optional[StrictInt] = Field(default=None, description="port is the port on the service that hosts the webhook. Default to 443 for backward compatibility. `port` should be a valid port number (1-65535, inclusive).")
