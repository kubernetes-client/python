...
class V1DeviceRequestAllocationResult(BaseModel):
    ...
    """ # noqa: E501
    admin_access: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("adminAccess", "admin_access"), serialization_alias="adminAccess", description="AdminAccess indicates that this device was allocated for administrative access. See the corresponding request field for a definition of mode.  Admin access is disabled if this field is unset or set to false, otherwise it is enabled.")
    ...
    attribute_map: ClassVar[Dict[str, str]] = {
        ...
        "request": "request",
        "share_id": "shareID",
        "skip_node_operations": "skipNodeOperations",
        "tolerations": "tolerations"
    }
    __properties: ClassVar[List[str]] = ["adminAccess", "bindingConditions", "bindingFailureConditions", "consumedCapacity", "device", "driver", "pool", "request", "shareID", "skipNodeOperations", "tolerations"]
    ...
    def __preprocess_input_names(
        ...
        if "skipNodeOperations" not in obj and "skip_node_operations" in obj:
            obj["skipNodeOperations"] = obj["skip_node_operations"]
        obj.pop("skip_node_operations", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("skipNodeOperations" if serialize else "skip_node_operations"): _to_legacy_value(getattr(self, "skip_node_operations", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skipNodeOperations": obj.get("skipNodeOperations"),
            "tolerations": [V1DeviceToleration.from_dict(_item) for _item in obj["tolerations"]] if obj.get("tolerations") is not None else None
        })
        return _obj
