...
class V1OwnerReference(BaseModel):
    ...
    """ # noqa: E501
    api_version: StrictStr = Field(validation_alias=AliasChoices("apiVersion", "api_version"), serialization_alias="apiVersion", description="API version of the referent.")
    block_owner_deletion: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("blockOwnerDeletion", "block_owner_deletion"), serialization_alias="blockOwnerDeletion", description="If true, AND if the owner has the \"foregroundDeletion\" finalizer, then the owner cannot be deleted from the key-value store until this reference is removed. See https://kubernetes.io/docs/concepts/architecture/garbage-collection/#foreground-deletion for how the garbage collector interacts with this field and enforces the foreground deletion. Defaults to false. To set this field, a user needs \"delete\" permission of the owner, otherwise 422 (Unprocessable Entity) will be returned.")
    ...
    def __preprocess_input_names(
        ...
        if "blockOwnerDeletion" not in obj and "block_owner_deletion" in obj:
            obj["blockOwnerDeletion"] = obj["block_owner_deletion"]
        obj.pop("block_owner_deletion", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("blockOwnerDeletion" if serialize else "block_owner_deletion"): _to_legacy_value(getattr(self, "block_owner_deletion", None), serialize),
            ("controller" if serialize else "controller"): _to_legacy_value(getattr(self, "controller", None), serialize),
