...
class V1PodDNSConfig(BaseModel):
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("nameservers" if serialize else "nameservers"): _to_legacy_value(getattr(self, "nameservers", None), serialize),
            ("options" if serialize else "options"): _to_legacy_value(getattr(self, "options", None), serialize),
            ("searches" if serialize else "searches"): _to_legacy_value(getattr(self, "searches", None), serialize),
        }
