...
class V1alpha1Eviction(BaseModel):
    """
    ...
    status: Optional[V1alpha1EvictionStatus] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1Eviction):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1EvictionSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1alpha1EvictionStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
