...
class V1alpha1EvictionRequestList(BaseModel):
    """
    ...
    items: List[V1alpha1EvictionRequest] = Field(description="items is the list of EvictionRequests.")
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        "api_version": "str",
        "items": "List[V1alpha1EvictionRequest]",
        "kind": "str",
        "metadata": "V1ListMeta"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1EvictionRequestList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha1EvictionRequest.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
