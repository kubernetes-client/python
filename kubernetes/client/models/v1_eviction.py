...
class V1Eviction(BaseModel):
    ...
    delete_options: Optional[V1DeleteOptions] = Field(default=None, validation_alias=AliasChoices("deleteOptions", "delete_options"), serialization_alias="deleteOptions")
    ...
    def __preprocess_input_names(
        ...
        if "deleteOptions" not in obj and "delete_options" in obj:
            obj["deleteOptions"] = obj["delete_options"]
        obj.pop("delete_options", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("deleteOptions" if serialize else "delete_options"): _to_legacy_value(getattr(self, "delete_options", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.delete_options:
            _dict['deleteOptions'] = _to_openapi_value(self.delete_options)
