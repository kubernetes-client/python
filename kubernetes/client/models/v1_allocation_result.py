...
class V1AllocationResult(BaseModel):
    ...
    """ # noqa: E501
    allocation_timestamp: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("allocationTimestamp", "allocation_timestamp"), serialization_alias="allocationTimestamp", description="AllocationTimestamp stores the time when the resources were allocated. This field is not guaranteed to be set, in which case that time is unknown.  This is a beta field and requires enabling the DRADeviceBindingConditions and DRAResourceClaimDeviceStatus feature gate.")
    devices: Optional[V1DeviceAllocationResult] = None
    ...
    __properties: ClassVar[List[str]] = ["allocationTimestamp", "devices", "nodeSelector"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "allocationTimestamp" not in obj and "allocation_timestamp" in obj:
            obj["allocationTimestamp"] = obj["allocation_timestamp"]
        obj.pop("allocation_timestamp", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("allocationTimestamp" if serialize else "allocation_timestamp"): _to_legacy_value(getattr(self, "allocation_timestamp", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.devices:
            _dict['devices'] = _to_openapi_value(self.devices)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "devices": V1DeviceAllocationResult.from_dict(obj["devices"]) if obj.get("devices") is not None else None,
