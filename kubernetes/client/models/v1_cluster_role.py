...
class V1ClusterRole(BaseModel):
    ...
    """ # noqa: E501
    aggregation_rule: Optional[V1AggregationRule] = Field(default=None, validation_alias=AliasChoices("aggregationRule", "aggregation_rule"), serialization_alias="aggregationRule")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "aggregationRule" not in obj and "aggregation_rule" in obj:
            obj["aggregationRule"] = obj["aggregation_rule"]
        obj.pop("aggregation_rule", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("aggregationRule" if serialize else "aggregation_rule"): _to_legacy_value(getattr(self, "aggregation_rule", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.aggregation_rule:
            _dict['aggregationRule'] = _to_openapi_value(self.aggregation_rule)
