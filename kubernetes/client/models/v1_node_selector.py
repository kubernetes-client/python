...
class V1NodeSelector(BaseModel):
    ...
    """ # noqa: E501
    node_selector_terms: List[V1NodeSelectorTerm] = Field(validation_alias=AliasChoices("nodeSelectorTerms", "node_selector_terms"), serialization_alias="nodeSelectorTerms", description="Required. A list of node selector terms. The terms are ORed.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "nodeSelectorTerms" not in obj and "node_selector_terms" in obj:
            obj["nodeSelectorTerms"] = obj["node_selector_terms"]
        obj.pop("node_selector_terms", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("nodeSelectorTerms" if serialize else "node_selector_terms"): _to_legacy_value(getattr(self, "node_selector_terms", None), serialize),
        }
