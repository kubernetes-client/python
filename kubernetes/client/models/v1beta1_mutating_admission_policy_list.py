...
class V1beta1MutatingAdmissionPolicyList(BaseModel):
    ...
    items: List[V1beta1MutatingAdmissionPolicy] = Field(description="List of ValidatingAdmissionPolicy.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1MutatingAdmissionPolicy.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
