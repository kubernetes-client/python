...
class V1Overhead(BaseModel):
    ...
    """ # noqa: E501
    pod_fixed: Optional[Dict[str, StrictStr]] = Field(default=None, validation_alias=AliasChoices("podFixed", "pod_fixed"), serialization_alias="podFixed", description="podFixed represents the fixed resource overhead associated with running a pod.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "podFixed" not in obj and "pod_fixed" in obj:
            obj["podFixed"] = obj["pod_fixed"]
        obj.pop("pod_fixed", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("podFixed" if serialize else "pod_fixed"): _to_legacy_value(getattr(self, "pod_fixed", None), serialize),
        }
