...
class V1StatefulSetUpdateStrategy(BaseModel):
    ...
    """ # noqa: E501
    rolling_update: Optional[V1RollingUpdateStatefulSetStrategy] = Field(default=None, validation_alias=AliasChoices("rollingUpdate", "rolling_update"), serialization_alias="rollingUpdate")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "rollingUpdate" not in obj and "rolling_update" in obj:
            obj["rollingUpdate"] = obj["rolling_update"]
        obj.pop("rolling_update", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("rollingUpdate" if serialize else "rolling_update"): _to_legacy_value(getattr(self, "rolling_update", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.rolling_update:
            _dict['rollingUpdate'] = _to_openapi_value(self.rolling_update)
        return _dict
