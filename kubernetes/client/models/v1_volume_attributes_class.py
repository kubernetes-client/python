...
class V1VolumeAttributesClass(BaseModel):
    ...
    driver_name: StrictStr = Field(validation_alias=AliasChoices("driverName", "driver_name"), serialization_alias="driverName", description="Name of the CSI driver This field is immutable.")
