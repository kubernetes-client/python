...
class V1VolumeStatus(BaseModel):
    """
    ...
    """ # noqa: E501
    image: Optional[V1ImageVolumeStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": V1ImageVolumeStatus.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
