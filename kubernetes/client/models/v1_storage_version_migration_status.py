...
class V1StorageVersionMigrationStatus(BaseModel):
    """
    ...
    """ # noqa: E501
    conditions: Optional[List[V1Condition]] = Field(default=None, description="The latest available observations of the migration's current state.")
    resource_version: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("resourceVersion", "resource_version"), serialization_alias="resourceVersion", description="ResourceVersion to compare with the GC cache for performing the migration. This is the current resource version of given group, version and resource when kube-controller-manager first observes this StorageVersionMigration resource.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1StorageVersionMigrationStatus):
            return False
