...
class V1VolumeMountStatus(BaseModel):
    ...
    """ # noqa: E501
    mount_path: StrictStr = Field(validation_alias=AliasChoices("mountPath", "mount_path"), serialization_alias="mountPath", description="MountPath corresponds to the original VolumeMount.")
    name: StrictStr = Field(description="Name corresponds to the name of the original VolumeMount.")
    read_only: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("readOnly", "read_only"), serialization_alias="readOnly", description="ReadOnly corresponds to the original VolumeMount.")
    recursive_read_only: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("recursiveReadOnly", "recursive_read_only"), serialization_alias="recursiveReadOnly", description="RecursiveReadOnly must be set to Disabled, Enabled, or unspecified (for non-readonly mounts). An IfPossible value in the original VolumeMount must be translated to Disabled or Enabled, depending on the mount result.")
    volume_status: Optional[V1VolumeStatus] = Field(default=None, validation_alias=AliasChoices("volumeStatus", "volume_status"), serialization_alias="volumeStatus")
    ...
    def __preprocess_input_names(
        ...
        if "volumeStatus" not in obj and "volume_status" in obj:
            obj["volumeStatus"] = obj["volume_status"]
        obj.pop("volume_status", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("volumeStatus" if serialize else "volume_status"): _to_legacy_value(getattr(self, "volume_status", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.volume_status:
            _dict['volumeStatus'] = _to_openapi_value(self.volume_status)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volumeStatus": V1VolumeStatus.from_dict(obj["volumeStatus"]) if obj.get("volumeStatus") is not None else None
        })
        return _obj
