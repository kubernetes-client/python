...
class V1alpha1Mutation(BaseModel):
    ...
    """ # noqa: E501
    apply_configuration: Optional[V1alpha1ApplyConfiguration] = Field(default=None, validation_alias=AliasChoices("applyConfiguration", "apply_configuration"), serialization_alias="applyConfiguration")
    json_patch: Optional[V1alpha1JSONPatch] = Field(default=None, validation_alias=AliasChoices("jsonPatch", "json_patch"), serialization_alias="jsonPatch")
