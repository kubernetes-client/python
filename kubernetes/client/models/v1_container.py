...
class V1Container(BaseModel):
    ...
    resize_policy: Optional[List[V1ContainerResizePolicy]] = Field(default=None, validation_alias=AliasChoices("resizePolicy", "resize_policy"), serialization_alias="resizePolicy", description="Resources resize policy for the container. This field cannot be set on ephemeral containers.")
    ...
    volume_mounts: Optional[List[V1VolumeMount]] = Field(default=None, validation_alias=AliasChoices("volumeMounts", "volume_mounts"), serialization_alias="volumeMounts", description="Pod volumes to mount into the container's filesystem. Cannot be updated.")
