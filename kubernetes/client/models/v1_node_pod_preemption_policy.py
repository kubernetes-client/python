...
class V1NodePodPreemptionPolicy(BaseModel):
    """
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "disableResizePreemption" not in obj and "disable_resize_preemption" in obj:
            obj["disableResizePreemption"] = obj["disable_resize_preemption"]
        obj.pop("disable_resize_preemption", None)
        return obj
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1NodePodPreemptionPolicy):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("disableResizePreemption" if serialize else "disable_resize_preemption"): _to_legacy_value(getattr(self, "disable_resize_preemption", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "disableResizePreemption": obj.get("disableResizePreemption")
        })
        return _obj
