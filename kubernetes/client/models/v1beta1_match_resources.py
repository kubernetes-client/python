...
class V1beta1MatchResources(BaseModel):
    ...
    """ # noqa: E501
    exclude_resource_rules: Optional[List[V1beta1NamedRuleWithOperations]] = Field(default=None, validation_alias=AliasChoices("excludeResourceRules", "exclude_resource_rules"), serialization_alias="excludeResourceRules", description="excludeResourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy should not care about. The exclude rules take precedence over include rules (if a resource matches both, it is excluded)")
    ...
    resource_rules: Optional[List[V1beta1NamedRuleWithOperations]] = Field(default=None, validation_alias=AliasChoices("resourceRules", "resource_rules"), serialization_alias="resourceRules", description="resourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy matches. The policy cares about an operation if it matches _any_ Rule.")
