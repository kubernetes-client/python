...
class V1beta2NodeAllocatableResourceMapping(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allocationMultiplier", "capacityKey"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "allocationMultiplier" not in obj and "allocation_multiplier" in obj:
            obj["allocationMultiplier"] = obj["allocation_multiplier"]
        obj.pop("allocation_multiplier", None)
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta2NodeAllocatableResourceMapping):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("allocationMultiplier" if serialize else "allocation_multiplier"): _to_legacy_value(getattr(self, "allocation_multiplier", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allocationMultiplier": obj.get("allocationMultiplier"),
