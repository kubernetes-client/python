...
class ResourceV1ResourceClaim(BaseModel):
    ...
    spec: Optional[V1ResourceClaimSpec] = None
    status: Optional[V1ResourceClaimStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1ResourceClaimSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1ResourceClaimStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
