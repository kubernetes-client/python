...
class V1UserInfo(BaseModel):
    ...
    """ # noqa: E501
    extra: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="extra is any additional information provided by the authenticator.")
    groups: Optional[List[StrictStr]] = Field(default=None, description="groups is the names of groups this user is a part of.")
    uid: Optional[StrictStr] = Field(default=None, description="uid is a unique value that identifies this user across time. If this user is deleted and another user by the same name is added, they will have different UIDs.")
    username: Optional[StrictStr] = Field(default=None, description="username is the name that uniquely identifies this user among all active users.")
