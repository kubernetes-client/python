...
class V1alpha1EvictionTarget(BaseModel):
    """
    ...
    """ # noqa: E501
    pod: Optional[V1alpha1EvictionPodReference] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1EvictionTarget):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pod": V1alpha1EvictionPodReference.from_dict(obj["pod"]) if obj.get("pod") is not None else None
        })
        return _obj
