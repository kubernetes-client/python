...
class V1beta2NodeAllocatableOverhead(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["perContainer", "perPod"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "perContainer" not in obj and "per_container" in obj:
            obj["perContainer"] = obj["per_container"]
        obj.pop("per_container", None)
        if "perPod" not in obj and "per_pod" in obj:
            obj["perPod"] = obj["per_pod"]
        obj.pop("per_pod", None)
        return obj
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta2NodeAllocatableOverhead):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("perContainer" if serialize else "per_container"): _to_legacy_value(getattr(self, "per_container", None), serialize),
            ("perPod" if serialize else "per_pod"): _to_legacy_value(getattr(self, "per_pod", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "perContainer": obj.get("perContainer"),
            "perPod": obj.get("perPod")
        })
        return _obj
