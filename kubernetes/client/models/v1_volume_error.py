...
class V1VolumeError(BaseModel):
    ...
    """ # noqa: E501
    error_code: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("errorCode", "error_code"), serialization_alias="errorCode", description="errorCode is a numeric gRPC code representing the error encountered during Attach or Detach operations.  This field requires the MutableCSINodeAllocatableCount feature gate being enabled to be set.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "errorCode" not in obj and "error_code" in obj:
            obj["errorCode"] = obj["error_code"]
        obj.pop("error_code", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("errorCode" if serialize else "error_code"): _to_legacy_value(getattr(self, "error_code", None), serialize),
