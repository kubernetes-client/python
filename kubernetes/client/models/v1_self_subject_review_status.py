...
class V1SelfSubjectReviewStatus(BaseModel):
    ...
    """ # noqa: E501
    user_info: Optional[V1UserInfo] = Field(default=None, validation_alias=AliasChoices("userInfo", "user_info"), serialization_alias="userInfo")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "userInfo" not in obj and "user_info" in obj:
            obj["userInfo"] = obj["user_info"]
        obj.pop("user_info", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("userInfo" if serialize else "user_info"): _to_legacy_value(getattr(self, "user_info", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.user_info:
            _dict['userInfo'] = _to_openapi_value(self.user_info)
        return _dict
