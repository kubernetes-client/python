...
class V2MetricValueStatus(BaseModel):
    ...
    average_value: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("averageValue", "average_value"), serialization_alias="averageValue", description="averageValue is the current value of the average of the metric across all relevant pods (as a quantity)")
