...
class V1ClusterTrustBundleList(BaseModel):
    """
    ...
    items: List[V1ClusterTrustBundle] = Field(description="items is a collection of ClusterTrustBundle objects")
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        "api_version": "str",
        "items": "List[V1ClusterTrustBundle]",
        "kind": "str",
        "metadata": "V1ListMeta"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1ClusterTrustBundleList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ClusterTrustBundle.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
