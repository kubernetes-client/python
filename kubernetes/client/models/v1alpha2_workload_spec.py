...
class V1alpha2WorkloadSpec(BaseModel):
    """
    ...
    """ # noqa: E501
    controller_ref: Optional[V1alpha2TypedLocalObjectReference] = Field(default=None, validation_alias=AliasChoices("controllerRef", "controller_ref"), serialization_alias="controllerRef")
    pod_group_templates: List[V1alpha2PodGroupTemplate] = Field(validation_alias=AliasChoices("podGroupTemplates", "pod_group_templates"), serialization_alias="podGroupTemplates", description="PodGroupTemplates is the list of templates that make up the Workload. The maximum number of templates is 8. This field is immutable.")
    ...
    __properties: ClassVar[List[str]] = ["controllerRef", "podGroupTemplates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "controllerRef": V1alpha2TypedLocalObjectReference.from_dict(obj["controllerRef"]) if obj.get("controllerRef") is not None else None,
            "podGroupTemplates": [V1alpha2PodGroupTemplate.from_dict(_item) for _item in obj["podGroupTemplates"]] if obj.get("podGroupTemplates") is not None else None
        })
        return _obj
