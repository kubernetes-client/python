...
class V1CustomResourceValidation(BaseModel):
    ...
    """ # noqa: E501
    open_apiv3_schema: Optional[V1JSONSchemaProps] = Field(default=None, validation_alias=AliasChoices("openAPIV3Schema", "open_apiv3_schema"), serialization_alias="openAPIV3Schema")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "openAPIV3Schema" not in obj and "open_apiv3_schema" in obj:
            obj["openAPIV3Schema"] = obj["open_apiv3_schema"]
        obj.pop("open_apiv3_schema", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("openAPIV3Schema" if serialize else "open_apiv3_schema"): _to_legacy_value(getattr(self, "open_apiv3_schema", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.open_apiv3_schema:
            _dict['openAPIV3Schema'] = _to_openapi_value(self.open_apiv3_schema)
        return _dict
