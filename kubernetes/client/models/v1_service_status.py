...
class V1ServiceStatus(BaseModel):
    ...
    load_balancer: Optional[V1LoadBalancerStatus] = Field(default=None, validation_alias=AliasChoices("loadBalancer", "load_balancer"), serialization_alias="loadBalancer")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "loadBalancer" not in obj and "load_balancer" in obj:
            obj["loadBalancer"] = obj["load_balancer"]
        obj.pop("load_balancer", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("loadBalancer" if serialize else "load_balancer"): _to_legacy_value(getattr(self, "load_balancer", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.load_balancer:
            _dict['loadBalancer'] = _to_openapi_value(self.load_balancer)
        return _dict
