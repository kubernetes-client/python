...
class V1beta1AllocatedDeviceStatus(BaseModel):
    ...
    network_data: Optional[V1beta1NetworkDeviceData] = Field(default=None, validation_alias=AliasChoices("networkData", "network_data"), serialization_alias="networkData")
