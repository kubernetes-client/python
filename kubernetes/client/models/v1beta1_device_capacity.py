...
class V1beta1DeviceCapacity(BaseModel):
    ...
    """ # noqa: E501
    request_policy: Optional[V1beta1CapacityRequestPolicy] = Field(default=None, validation_alias=AliasChoices("requestPolicy", "request_policy"), serialization_alias="requestPolicy")
    value: StrictStr = Field(description="Value defines how much of a certain capacity that device has.  This field reflects the fixed total capacity and does not change. The consumed amount is tracked separately by scheduler and does not affect this value.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "requestPolicy" not in obj and "request_policy" in obj:
            obj["requestPolicy"] = obj["request_policy"]
        obj.pop("request_policy", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("requestPolicy" if serialize else "request_policy"): _to_legacy_value(getattr(self, "request_policy", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.request_policy:
            _dict['requestPolicy'] = _to_openapi_value(self.request_policy)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestPolicy": V1beta1CapacityRequestPolicy.from_dict(obj["requestPolicy"]) if obj.get("requestPolicy") is not None else None,
            "value": obj.get("value")
        })
        return _obj
