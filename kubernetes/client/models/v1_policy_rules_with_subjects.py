...
class V1PolicyRulesWithSubjects(BaseModel):
    ...
    """ # noqa: E501
    non_resource_rules: Optional[List[V1NonResourcePolicyRule]] = Field(default=None, validation_alias=AliasChoices("nonResourceRules", "non_resource_rules"), serialization_alias="nonResourceRules", description="`nonResourceRules` is a list of NonResourcePolicyRules that identify matching requests according to their verb and the target non-resource URL.")
    resource_rules: Optional[List[V1ResourcePolicyRule]] = Field(default=None, validation_alias=AliasChoices("resourceRules", "resource_rules"), serialization_alias="resourceRules", description="`resourceRules` is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty.")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("subjects" if serialize else "subjects"): _to_legacy_value(getattr(self, "subjects", None), serialize),
        }
