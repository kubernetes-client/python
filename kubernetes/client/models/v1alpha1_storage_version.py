...
class V1alpha1StorageVersion(BaseModel):
    ...
    spec: Optional[Dict[str, Any]] = Field(default=None, description="spec is an empty spec. It is here to comply with Kubernetes API style.")
    status: Optional[V1alpha1StorageVersionStatus] = None
