...
class V1beta2DeviceTaintRule(BaseModel):
    """
    ...
    status: Optional[V1beta2DeviceTaintRuleStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta2DeviceTaintRuleSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1beta2DeviceTaintRuleStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
