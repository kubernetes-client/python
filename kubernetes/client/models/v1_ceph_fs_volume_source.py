...
class V1CephFSVolumeSource(BaseModel):
    ...
    secret_file: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("secretFile", "secret_file"), serialization_alias="secretFile", description="secretFile is Optional: SecretFile is the path to key ring for User, default is /etc/ceph/user.secret More info: https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it")
    ...
    def __preprocess_input_names(
        ...
        if "secretFile" not in obj and "secret_file" in obj:
            obj["secretFile"] = obj["secret_file"]
        obj.pop("secret_file", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("secretFile" if serialize else "secret_file"): _to_legacy_value(getattr(self, "secret_file", None), serialize),
