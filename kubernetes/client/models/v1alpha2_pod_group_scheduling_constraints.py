...
class V1alpha2PodGroupSchedulingConstraints(BaseModel):
    """
    ...
    """ # noqa: E501
    topology: Optional[List[V1alpha2TopologyConstraint]] = Field(default=None, description="Topology defines the topology constraints for the pod group. Currently only a single topology constraint can be specified. This may change in the future.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "topology": [V1alpha2TopologyConstraint.from_dict(_item) for _item in obj["topology"]] if obj.get("topology") is not None else None
        })
        return _obj
