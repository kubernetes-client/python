...
class V1alpha3WorkloadReference(BaseModel):
    """
    ...
    """ # noqa: E501
    template_name: StrictStr = Field(validation_alias=AliasChoices("templateName", "template_name"), serialization_alias="templateName", description="templateName is the name of a template within the Workload object that was used to create a pod group. It must be a DNS label. This field is required.")
    workload_name: StrictStr = Field(validation_alias=AliasChoices("workloadName", "workload_name"), serialization_alias="workloadName", description="workloadName is the name of the Workload object that contains a template that was used when creating a pod group. It must be a DNS name. This field is required.")
    ...
    __properties: ClassVar[List[str]] = ["templateName", "workloadName"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "templateName" not in obj and "template_name" in obj:
            obj["templateName"] = obj["template_name"]
        obj.pop("template_name", None)
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3WorkloadReference):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("templateName" if serialize else "template_name"): _to_legacy_value(getattr(self, "template_name", None), serialize),
