...
class V1TopologySelectorTerm(BaseModel):
    ...
    """ # noqa: E501
    match_label_expressions: Optional[List[V1TopologySelectorLabelRequirement]] = Field(default=None, validation_alias=AliasChoices("matchLabelExpressions", "match_label_expressions"), serialization_alias="matchLabelExpressions", description="A list of topology selector requirements by labels.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "matchLabelExpressions" not in obj and "match_label_expressions" in obj:
            obj["matchLabelExpressions"] = obj["match_label_expressions"]
        obj.pop("match_label_expressions", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("matchLabelExpressions" if serialize else "match_label_expressions"): _to_legacy_value(getattr(self, "match_label_expressions", None), serialize),
        }
