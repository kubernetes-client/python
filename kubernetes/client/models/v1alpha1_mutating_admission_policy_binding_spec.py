...
class V1alpha1MutatingAdmissionPolicyBindingSpec(BaseModel):
    ...
    """ # noqa: E501
    match_resources: Optional[V1alpha1MatchResources] = Field(default=None, validation_alias=AliasChoices("matchResources", "match_resources"), serialization_alias="matchResources")
    param_ref: Optional[V1alpha1ParamRef] = Field(default=None, validation_alias=AliasChoices("paramRef", "param_ref"), serialization_alias="paramRef")
