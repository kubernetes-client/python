...
class V1ResourceSliceList(BaseModel):
    ...
    items: List[V1ResourceSlice] = Field(description="Items is the list of resource ResourceSlices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ResourceSlice.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
