...
class V1NodeAffinity(BaseModel):
    ...
    """ # noqa: E501
    preferred_during_scheduling_ignored_during_execution: Optional[List[V1PreferredSchedulingTerm]] = Field(default=None, validation_alias=AliasChoices("preferredDuringSchedulingIgnoredDuringExecution", "preferred_during_scheduling_ignored_during_execution"), serialization_alias="preferredDuringSchedulingIgnoredDuringExecution", description="The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \"weight\" to the sum if the node matches the corresponding matchExpressions; the node(s) with the highest sum are the most preferred.")
    required_during_scheduling_ignored_during_execution: Optional[V1NodeSelector] = Field(default=None, validation_alias=AliasChoices("requiredDuringSchedulingIgnoredDuringExecution", "required_during_scheduling_ignored_during_execution"), serialization_alias="requiredDuringSchedulingIgnoredDuringExecution")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "preferredDuringSchedulingIgnoredDuringExecution" not in obj and "preferred_during_scheduling_ignored_during_execution" in obj:
            obj["preferredDuringSchedulingIgnoredDuringExecution"] = obj["preferred_during_scheduling_ignored_during_execution"]
        obj.pop("preferred_during_scheduling_ignored_during_execution", None)
        if "requiredDuringSchedulingIgnoredDuringExecution" not in obj and "required_during_scheduling_ignored_during_execution" in obj:
            obj["requiredDuringSchedulingIgnoredDuringExecution"] = obj["required_during_scheduling_ignored_during_execution"]
        obj.pop("required_during_scheduling_ignored_during_execution", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("preferredDuringSchedulingIgnoredDuringExecution" if serialize else "preferred_during_scheduling_ignored_during_execution"): _to_legacy_value(getattr(self, "preferred_during_scheduling_ignored_during_execution", None), serialize),
            ("requiredDuringSchedulingIgnoredDuringExecution" if serialize else "required_during_scheduling_ignored_during_execution"): _to_legacy_value(getattr(self, "required_during_scheduling_ignored_during_execution", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.required_during_scheduling_ignored_during_execution:
            _dict['requiredDuringSchedulingIgnoredDuringExecution'] = _to_openapi_value(self.required_during_scheduling_ignored_during_execution)
        return _dict
