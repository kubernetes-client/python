...
class V1alpha3CompositePodGroupList(BaseModel):
    """
    ...
    items: List[V1alpha3CompositePodGroup] = Field(description="Items is the list of CompositePodGroups.")
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        "api_version": "str",
        "items": "List[V1alpha3CompositePodGroup]",
        "kind": "str",
        "metadata": "V1ListMeta"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3CompositePodGroupList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha3CompositePodGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
