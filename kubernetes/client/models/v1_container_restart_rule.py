...
class V1ContainerRestartRule(BaseModel):
    ...
    exit_codes: Optional[V1ContainerRestartRuleOnExitCodes] = Field(default=None, validation_alias=AliasChoices("exitCodes", "exit_codes"), serialization_alias="exitCodes")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "exitCodes" not in obj and "exit_codes" in obj:
            obj["exitCodes"] = obj["exit_codes"]
        obj.pop("exit_codes", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("exitCodes" if serialize else "exit_codes"): _to_legacy_value(getattr(self, "exit_codes", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.exit_codes:
            _dict['exitCodes'] = _to_openapi_value(self.exit_codes)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exitCodes": V1ContainerRestartRuleOnExitCodes.from_dict(obj["exitCodes"]) if obj.get("exitCodes") is not None else None
        })
        return _obj
