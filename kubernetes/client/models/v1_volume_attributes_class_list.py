...
class V1VolumeAttributesClassList(BaseModel):
    ...
    items: List[V1VolumeAttributesClass] = Field(description="items is the list of VolumeAttributesClass objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1VolumeAttributesClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
