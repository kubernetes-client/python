...
class V1ClusterRoleBinding(BaseModel):
    ...
    role_ref: V1RoleRef = Field(validation_alias=AliasChoices("roleRef", "role_ref"), serialization_alias="roleRef")
    ...
    def __preprocess_input_names(
        ...
        if "roleRef" not in obj and "role_ref" in obj:
            obj["roleRef"] = obj["role_ref"]
        obj.pop("role_ref", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("roleRef" if serialize else "role_ref"): _to_legacy_value(getattr(self, "role_ref", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.role_ref:
            _dict['roleRef'] = _to_openapi_value(self.role_ref)
