...
class V1alpha2PodGroupSpec(BaseModel):
    """
    ...
    pod_group_template_ref: Optional[V1alpha2PodGroupTemplateReference] = Field(default=None, validation_alias=AliasChoices("podGroupTemplateRef", "pod_group_template_ref"), serialization_alias="podGroupTemplateRef")
    ...
    __properties: ClassVar[List[str]] = ["disruptionMode", "podGroupTemplateRef", "priority", "priorityClassName", "resourceClaims", "schedulingConstraints", "schedulingPolicy"]
    ...
    def __preprocess_input_names(
        ...
        if "podGroupTemplateRef" not in obj and "pod_group_template_ref" in obj:
            obj["podGroupTemplateRef"] = obj["pod_group_template_ref"]
        obj.pop("pod_group_template_ref", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("podGroupTemplateRef" if serialize else "pod_group_template_ref"): _to_legacy_value(getattr(self, "pod_group_template_ref", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pod_group_template_ref
        if self.pod_group_template_ref:
            _dict['podGroupTemplateRef'] = _to_openapi_value(self.pod_group_template_ref)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "podGroupTemplateRef": V1alpha2PodGroupTemplateReference.from_dict(obj["podGroupTemplateRef"]) if obj.get("podGroupTemplateRef") is not None else None,
