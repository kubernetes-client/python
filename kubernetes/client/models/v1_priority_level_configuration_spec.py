...
class V1PriorityLevelConfigurationSpec(BaseModel):
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("exempt" if serialize else "exempt"): _to_legacy_value(getattr(self, "exempt", None), serialize),
            ("limited" if serialize else "limited"): _to_legacy_value(getattr(self, "limited", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.exempt:
            _dict['exempt'] = _to_openapi_value(self.exempt)
        # override the default output from pydantic by calling `to_dict()` of limited
        if self.limited:
            _dict['limited'] = _to_openapi_value(self.limited)
        return _dict
