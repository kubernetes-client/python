...
class V2APIGroupDiscovery(BaseModel):
    """
    ...
    versions: Optional[List[V2APIVersionDiscovery]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [V2APIVersionDiscovery.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
