...
class V1alpha3CompositePodGroupSchedulingPolicy(BaseModel):
    """
    ...
    """ # noqa: E501
    basic: Optional[Dict[str, Any]] = Field(default=None, description="basic specifies that the groups of this composite group should be scheduled independently. This field is immutable.")
    gang: Optional[V1alpha3CompositeGangSchedulingPolicy] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3CompositePodGroupSchedulingPolicy):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic": obj.get("basic"),
            "gang": V1alpha3CompositeGangSchedulingPolicy.from_dict(obj["gang"]) if obj.get("gang") is not None else None
        })
        return _obj
