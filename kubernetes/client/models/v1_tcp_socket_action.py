...
class V1TCPSocketAction(BaseModel):
    ...
    port: StrictInt | StrictStr = Field(description="Number or name of the port to access on the container. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME.")
