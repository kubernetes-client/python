...
class V1ResourceClaimTemplateList(BaseModel):
    ...
    items: List[V1ResourceClaimTemplate] = Field(description="Items is the list of resource claim templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ResourceClaimTemplate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
