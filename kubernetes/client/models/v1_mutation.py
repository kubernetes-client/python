...
class V1Mutation(BaseModel):
    ...
    """ # noqa: E501
    apply_configuration: Optional[V1ApplyConfiguration] = Field(default=None, validation_alias=AliasChoices("applyConfiguration", "apply_configuration"), serialization_alias="applyConfiguration")
    json_patch: Optional[V1JSONPatch] = Field(default=None, validation_alias=AliasChoices("jsonPatch", "json_patch"), serialization_alias="jsonPatch")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1Mutation):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applyConfiguration": V1ApplyConfiguration.from_dict(obj["applyConfiguration"]) if obj.get("applyConfiguration") is not None else None,
            "jsonPatch": V1JSONPatch.from_dict(obj["jsonPatch"]) if obj.get("jsonPatch") is not None else None,
