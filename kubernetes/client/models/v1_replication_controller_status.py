...
class V1ReplicationControllerStatus(BaseModel):
    ...
    """ # noqa: E501
    available_replicas: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("availableReplicas", "available_replicas"), serialization_alias="availableReplicas", description="The number of available replicas (ready for at least minReadySeconds) for this replication controller.")
    ...
    fully_labeled_replicas: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("fullyLabeledReplicas", "fully_labeled_replicas"), serialization_alias="fullyLabeledReplicas", description="The number of pods that have labels matching the labels of the pod template of the replication controller.")
    observed_generation: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("observedGeneration", "observed_generation"), serialization_alias="observedGeneration", description="ObservedGeneration reflects the generation of the most recently observed replication controller.")
    ready_replicas: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("readyReplicas", "ready_replicas"), serialization_alias="readyReplicas", description="The number of ready replicas for this replication controller.")
