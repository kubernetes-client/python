...
class V1beta1WorkloadList(BaseModel):
    """
    ...
    items: List[V1beta1Workload] = Field(description="items is the list of Workloads.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1WorkloadList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1Workload.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
