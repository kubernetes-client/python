...
class V1ClusterTrustBundleProjection(BaseModel):
    ...
    signer_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("signerName", "signer_name"), serialization_alias="signerName", description="Select all ClusterTrustBundles that match this signer name. Mutually-exclusive with name.  The contents of all selected ClusterTrustBundles will be unified and deduplicated.")
