...
from client.model.v1_job_list import V1JobList
...
SchemaFor200ResponseBodyApplicationJson = V1JobList
SchemaFor200ResponseBodyApplicationYaml = V1JobList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1JobList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1JobList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1JobList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_job_for_all_namespaces_oapg(
        self,
...
class ListJobForAllNamespaces(BaseApi):
    ...
    def list_job_for_all_namespaces(
        ...
        return self._list_job_for_all_namespaces_oapg(
