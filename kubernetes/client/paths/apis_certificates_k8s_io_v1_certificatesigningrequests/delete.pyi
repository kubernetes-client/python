...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_certificate_signing_request_oapg(
        self,
...
class DeleteCollectionCertificateSigningRequest(BaseApi):
    ...
    def delete_collection_certificate_signing_request(
        ...
        return self._delete_collection_certificate_signing_request_oapg(
            body=body,
