...
from client.model.v1beta1_csi_storage_capacity import V1beta1CSIStorageCapacity
...
# body param
SchemaForRequestBody = V1beta1CSIStorageCapacity
...
SchemaFor200ResponseBodyApplicationJson = V1beta1CSIStorageCapacity
SchemaFor200ResponseBodyApplicationYaml = V1beta1CSIStorageCapacity
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1beta1CSIStorageCapacity
...
SchemaFor201ResponseBodyApplicationJson = V1beta1CSIStorageCapacity
SchemaFor201ResponseBodyApplicationYaml = V1beta1CSIStorageCapacity
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1beta1CSIStorageCapacity
...
SchemaFor202ResponseBodyApplicationJson = V1beta1CSIStorageCapacity
SchemaFor202ResponseBodyApplicationYaml = V1beta1CSIStorageCapacity
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1beta1CSIStorageCapacity
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_csi_storage_capacity_oapg(
        self,
...
class CreateNamespacedCsiStorageCapacity(BaseApi):
    ...
    def create_namespaced_csi_storage_capacity(
        ...
        return self._create_namespaced_csi_storage_capacity_oapg(
            body=body,
