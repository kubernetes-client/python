...
from client.model.v1alpha1_cluster_cidr import V1alpha1ClusterCIDR
...
# body param
SchemaForRequestBody = V1alpha1ClusterCIDR
...
SchemaFor200ResponseBodyApplicationJson = V1alpha1ClusterCIDR
SchemaFor200ResponseBodyApplicationYaml = V1alpha1ClusterCIDR
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1alpha1ClusterCIDR
...
SchemaFor201ResponseBodyApplicationJson = V1alpha1ClusterCIDR
SchemaFor201ResponseBodyApplicationYaml = V1alpha1ClusterCIDR
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1alpha1ClusterCIDR
...
SchemaFor202ResponseBodyApplicationJson = V1alpha1ClusterCIDR
SchemaFor202ResponseBodyApplicationYaml = V1alpha1ClusterCIDR
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1alpha1ClusterCIDR
...
class CreateClusterCidr(BaseApi):
    ...
    def create_cluster_cidr(
        ...
        return self._create_cluster_cidr_oapg(
            body=body,
