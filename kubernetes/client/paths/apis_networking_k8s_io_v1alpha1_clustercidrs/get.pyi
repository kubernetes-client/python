...
from client.model.v1alpha1_cluster_cidr_list import V1alpha1ClusterCIDRList
...
SchemaFor200ResponseBodyApplicationJson = V1alpha1ClusterCIDRList
SchemaFor200ResponseBodyApplicationYaml = V1alpha1ClusterCIDRList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1alpha1ClusterCIDRList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1alpha1ClusterCIDRList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1alpha1ClusterCIDRList
...
class ListClusterCidr(BaseApi):
    ...
    def list_cluster_cidr(
        ...
        return self._list_cluster_cidr_oapg(
