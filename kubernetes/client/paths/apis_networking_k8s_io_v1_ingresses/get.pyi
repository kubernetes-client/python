...
from client.model.v1_ingress_list import V1IngressList
...
SchemaFor200ResponseBodyApplicationJson = V1IngressList
SchemaFor200ResponseBodyApplicationYaml = V1IngressList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1IngressList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1IngressList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1IngressList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_ingress_for_all_namespaces_oapg(
        self,
...
class ListIngressForAllNamespaces(BaseApi):
    ...
    def list_ingress_for_all_namespaces(
        ...
        return self._list_ingress_for_all_namespaces_oapg(
