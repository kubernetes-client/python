...
from client.model.v1_binding import V1Binding
...
# body param
SchemaForRequestBody = V1Binding
...
SchemaFor200ResponseBodyApplicationJson = V1Binding
SchemaFor200ResponseBodyApplicationYaml = V1Binding
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Binding
...
SchemaFor201ResponseBodyApplicationJson = V1Binding
SchemaFor201ResponseBodyApplicationYaml = V1Binding
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Binding
...
SchemaFor202ResponseBodyApplicationJson = V1Binding
SchemaFor202ResponseBodyApplicationYaml = V1Binding
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Binding
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_pod_binding_oapg(
        self,
...
class CreateNamespacedPodBinding(BaseApi):
    ...
    def create_namespaced_pod_binding(
        ...
        return self._create_namespaced_pod_binding_oapg(
            body=body,
