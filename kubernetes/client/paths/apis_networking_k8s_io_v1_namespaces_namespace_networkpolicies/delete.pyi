...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_network_policy_oapg(
        self,
...
class DeleteCollectionNamespacedNetworkPolicy(BaseApi):
    ...
    def delete_collection_namespaced_network_policy(
        ...
        return self._delete_collection_namespaced_network_policy_oapg(
            body=body,
