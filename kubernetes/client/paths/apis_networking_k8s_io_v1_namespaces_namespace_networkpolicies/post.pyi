...
from client.model.v1_network_policy import V1NetworkPolicy
...
# body param
SchemaForRequestBody = V1NetworkPolicy
...
SchemaFor200ResponseBodyApplicationJson = V1NetworkPolicy
SchemaFor200ResponseBodyApplicationYaml = V1NetworkPolicy
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1NetworkPolicy
...
SchemaFor201ResponseBodyApplicationJson = V1NetworkPolicy
SchemaFor201ResponseBodyApplicationYaml = V1NetworkPolicy
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1NetworkPolicy
...
SchemaFor202ResponseBodyApplicationJson = V1NetworkPolicy
SchemaFor202ResponseBodyApplicationYaml = V1NetworkPolicy
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1NetworkPolicy
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_network_policy_oapg(
        self,
...
class CreateNamespacedNetworkPolicy(BaseApi):
    ...
    def create_namespaced_network_policy(
        ...
        return self._create_namespaced_network_policy_oapg(
            body=body,
