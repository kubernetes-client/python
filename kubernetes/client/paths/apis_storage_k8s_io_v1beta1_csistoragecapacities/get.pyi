...
from client.model.v1beta1_csi_storage_capacity_list import V1beta1CSIStorageCapacityList
...
SchemaFor200ResponseBodyApplicationJson = V1beta1CSIStorageCapacityList
SchemaFor200ResponseBodyApplicationYaml = V1beta1CSIStorageCapacityList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1beta1CSIStorageCapacityList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1beta1CSIStorageCapacityList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1beta1CSIStorageCapacityList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_csi_storage_capacity_for_all_namespaces_oapg(
        self,
...
class ListCsiStorageCapacityForAllNamespaces(BaseApi):
    ...
    def list_csi_storage_capacity_for_all_namespaces(
        ...
        return self._list_csi_storage_capacity_for_all_namespaces_oapg(
