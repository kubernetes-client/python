...
from client.model.v1_pod_disruption_budget_list import V1PodDisruptionBudgetList
...
SchemaFor200ResponseBodyApplicationJson = V1PodDisruptionBudgetList
SchemaFor200ResponseBodyApplicationYaml = V1PodDisruptionBudgetList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PodDisruptionBudgetList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1PodDisruptionBudgetList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1PodDisruptionBudgetList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_pod_disruption_budget_for_all_namespaces_oapg(
        self,
...
class ListPodDisruptionBudgetForAllNamespaces(BaseApi):
    ...
    def list_pod_disruption_budget_for_all_namespaces(
        ...
        return self._list_pod_disruption_budget_for_all_namespaces_oapg(
