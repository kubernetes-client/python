...
from client.model.v1_token_review import V1TokenReview
...
# body param
SchemaForRequestBody = V1TokenReview
...
SchemaFor200ResponseBodyApplicationJson = V1TokenReview
SchemaFor200ResponseBodyApplicationYaml = V1TokenReview
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1TokenReview
...
SchemaFor201ResponseBodyApplicationJson = V1TokenReview
SchemaFor201ResponseBodyApplicationYaml = V1TokenReview
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1TokenReview
...
SchemaFor202ResponseBodyApplicationJson = V1TokenReview
SchemaFor202ResponseBodyApplicationYaml = V1TokenReview
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1TokenReview
...
class CreateTokenReview(BaseApi):
    ...
    def create_token_review(
        ...
        return self._create_token_review_oapg(
            body=body,
