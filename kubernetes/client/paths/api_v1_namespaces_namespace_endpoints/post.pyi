...
from client.model.v1_endpoints import V1Endpoints
...
# body param
SchemaForRequestBody = V1Endpoints
...
SchemaFor200ResponseBodyApplicationJson = V1Endpoints
SchemaFor200ResponseBodyApplicationYaml = V1Endpoints
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Endpoints
...
SchemaFor201ResponseBodyApplicationJson = V1Endpoints
SchemaFor201ResponseBodyApplicationYaml = V1Endpoints
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Endpoints
...
SchemaFor202ResponseBodyApplicationJson = V1Endpoints
SchemaFor202ResponseBodyApplicationYaml = V1Endpoints
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Endpoints
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_endpoints_oapg(
        self,
...
class CreateNamespacedEndpoints(BaseApi):
    ...
    def create_namespaced_endpoints(
        ...
        return self._create_namespaced_endpoints_oapg(
            body=body,
