...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_endpoints_oapg(
        self,
...
class DeleteCollectionNamespacedEndpoints(BaseApi):
    ...
    def delete_collection_namespaced_endpoints(
        ...
        return self._delete_collection_namespaced_endpoints_oapg(
            body=body,
