...
from client.model.v1_component_status import V1ComponentStatus
...
SchemaFor200ResponseBodyApplicationJson = V1ComponentStatus
SchemaFor200ResponseBodyApplicationYaml = V1ComponentStatus
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ComponentStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_component_status_oapg(
        self,
...
class ReadComponentStatus(BaseApi):
    ...
    def read_component_status(
        ...
        return self._read_component_status_oapg(
