...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_certificate_signing_request_status_oapg(
        self,
...
class PatchCertificateSigningRequestStatus(BaseApi):
    ...
    def patch_certificate_signing_request_status(
        ...
        return self._patch_certificate_signing_request_status_oapg(
            body=body,
