...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_certificate_signing_request_status_oapg(
        self,
...
class ReadCertificateSigningRequestStatus(BaseApi):
    ...
    def read_certificate_signing_request_status(
        ...
        return self._read_certificate_signing_request_status_oapg(
