...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_certificate_signing_request_status_oapg(
        self,
...
class ReplaceCertificateSigningRequestStatus(BaseApi):
    ...
    def replace_certificate_signing_request_status(
        ...
        return self._replace_certificate_signing_request_status_oapg(
            body=body,
