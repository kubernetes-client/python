...
# body param
SchemaForRequestBody = V1RuntimeClass
...
SchemaFor200ResponseBodyApplicationJson = V1RuntimeClass
SchemaFor200ResponseBodyApplicationYaml = V1RuntimeClass
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1RuntimeClass
...
SchemaFor201ResponseBodyApplicationJson = V1RuntimeClass
SchemaFor201ResponseBodyApplicationYaml = V1RuntimeClass
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1RuntimeClass
...
SchemaFor202ResponseBodyApplicationJson = V1RuntimeClass
SchemaFor202ResponseBodyApplicationYaml = V1RuntimeClass
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1RuntimeClass
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_runtime_class_oapg(
        self,
...
class CreateRuntimeClass(BaseApi):
    ...
    def create_runtime_class(
        ...
        return self._create_runtime_class_oapg(
            body=body,
