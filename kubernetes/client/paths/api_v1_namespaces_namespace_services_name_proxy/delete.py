...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_delete_namespaced_service_proxy_oapg(
        self,
...
class ConnectDeleteNamespacedServiceProxy(BaseApi):
    ...
    def connect_delete_namespaced_service_proxy(
        ...
        return self._connect_delete_namespaced_service_proxy_oapg(
