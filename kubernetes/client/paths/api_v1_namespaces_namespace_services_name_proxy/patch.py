...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_patch_namespaced_service_proxy_oapg(
        self,
...
class ConnectPatchNamespacedServiceProxy(BaseApi):
    ...
    def connect_patch_namespaced_service_proxy(
        ...
        return self._connect_patch_namespaced_service_proxy_oapg(
