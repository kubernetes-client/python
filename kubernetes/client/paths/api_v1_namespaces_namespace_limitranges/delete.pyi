...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_limit_range_oapg(
        self,
...
class DeleteCollectionNamespacedLimitRange(BaseApi):
    ...
    def delete_collection_namespaced_limit_range(
        ...
        return self._delete_collection_namespaced_limit_range_oapg(
            body=body,
