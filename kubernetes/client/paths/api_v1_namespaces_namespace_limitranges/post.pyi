...
from client.model.v1_limit_range import V1LimitRange
...
# body param
SchemaForRequestBody = V1LimitRange
...
SchemaFor200ResponseBodyApplicationJson = V1LimitRange
SchemaFor200ResponseBodyApplicationYaml = V1LimitRange
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1LimitRange
...
SchemaFor201ResponseBodyApplicationJson = V1LimitRange
SchemaFor201ResponseBodyApplicationYaml = V1LimitRange
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1LimitRange
...
SchemaFor202ResponseBodyApplicationJson = V1LimitRange
SchemaFor202ResponseBodyApplicationYaml = V1LimitRange
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1LimitRange
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_limit_range_oapg(
        self,
...
class CreateNamespacedLimitRange(BaseApi):
    ...
    def create_namespaced_limit_range(
        ...
        return self._create_namespaced_limit_range_oapg(
            body=body,
