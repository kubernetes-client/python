...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_pod_disruption_budget_status_oapg(
        self,
...
class PatchNamespacedPodDisruptionBudgetStatus(BaseApi):
    ...
    def patch_namespaced_pod_disruption_budget_status(
        ...
        return self._patch_namespaced_pod_disruption_budget_status_oapg(
            body=body,
