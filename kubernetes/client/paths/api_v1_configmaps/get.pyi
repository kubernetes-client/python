...
from client.model.v1_config_map_list import V1ConfigMapList
...
SchemaFor200ResponseBodyApplicationJson = V1ConfigMapList
SchemaFor200ResponseBodyApplicationYaml = V1ConfigMapList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ConfigMapList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1ConfigMapList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1ConfigMapList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_config_map_for_all_namespaces_oapg(
        self,
...
class ListConfigMapForAllNamespaces(BaseApi):
    ...
    def list_config_map_for_all_namespaces(
        ...
        return self._list_config_map_for_all_namespaces_oapg(
