...
from client.model.v1_service_list import V1ServiceList
...
SchemaFor200ResponseBodyApplicationJson = V1ServiceList
SchemaFor200ResponseBodyApplicationYaml = V1ServiceList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ServiceList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1ServiceList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1ServiceList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_service_for_all_namespaces_oapg(
        self,
...
class ListServiceForAllNamespaces(BaseApi):
    ...
    def list_service_for_all_namespaces(
        ...
        return self._list_service_for_all_namespaces_oapg(
