...
from client.model.v1_service_account import V1ServiceAccount
...
# body param
SchemaForRequestBody = V1ServiceAccount
...
SchemaFor200ResponseBodyApplicationJson = V1ServiceAccount
SchemaFor200ResponseBodyApplicationYaml = V1ServiceAccount
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ServiceAccount
...
SchemaFor201ResponseBodyApplicationJson = V1ServiceAccount
SchemaFor201ResponseBodyApplicationYaml = V1ServiceAccount
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1ServiceAccount
...
SchemaFor202ResponseBodyApplicationJson = V1ServiceAccount
SchemaFor202ResponseBodyApplicationYaml = V1ServiceAccount
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1ServiceAccount
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_service_account_oapg(
        self,
...
class CreateNamespacedServiceAccount(BaseApi):
    ...
    def create_namespaced_service_account(
        ...
        return self._create_namespaced_service_account_oapg(
            body=body,
