...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_service_account_oapg(
        self,
...
class DeleteCollectionNamespacedServiceAccount(BaseApi):
    ...
    def delete_collection_namespaced_service_account(
        ...
        return self._delete_collection_namespaced_service_account_oapg(
            body=body,
