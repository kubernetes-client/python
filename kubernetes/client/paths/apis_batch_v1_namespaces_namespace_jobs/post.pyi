...
from client.model.v1_job import V1Job
...
SchemaFor200ResponseBodyApplicationJson = V1Job
SchemaFor200ResponseBodyApplicationYaml = V1Job
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Job
...
SchemaFor201ResponseBodyApplicationJson = V1Job
SchemaFor201ResponseBodyApplicationYaml = V1Job
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Job
...
SchemaFor202ResponseBodyApplicationJson = V1Job
SchemaFor202ResponseBodyApplicationYaml = V1Job
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Job
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_job_oapg(
        self,
...
class CreateNamespacedJob(BaseApi):
    ...
    def create_namespaced_job(
        ...
        return self._create_namespaced_job_oapg(
            body=body,
