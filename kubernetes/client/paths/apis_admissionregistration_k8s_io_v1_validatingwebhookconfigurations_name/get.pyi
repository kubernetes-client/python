...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_validating_webhook_configuration_oapg(
        self,
...
class ReadValidatingWebhookConfiguration(BaseApi):
    ...
    def read_validating_webhook_configuration(
        ...
        return self._read_validating_webhook_configuration_oapg(
