...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_validating_webhook_configuration_oapg(
        self,
...
class PatchValidatingWebhookConfiguration(BaseApi):
    ...
    def patch_validating_webhook_configuration(
        ...
        return self._patch_validating_webhook_configuration_oapg(
            body=body,
