...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_validating_webhook_configuration_oapg(
        self,
...
class ReplaceValidatingWebhookConfiguration(BaseApi):
    ...
    def replace_validating_webhook_configuration(
        ...
        return self._replace_validating_webhook_configuration_oapg(
            body=body,
