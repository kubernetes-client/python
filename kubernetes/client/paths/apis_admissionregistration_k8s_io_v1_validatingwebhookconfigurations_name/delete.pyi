...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_validating_webhook_configuration_oapg(
        self,
...
class DeleteValidatingWebhookConfiguration(BaseApi):
    ...
    def delete_validating_webhook_configuration(
        ...
        return self._delete_validating_webhook_configuration_oapg(
            body=body,
