...
from client.model.v2beta2_horizontal_pod_autoscaler_list import V2beta2HorizontalPodAutoscalerList
...
SchemaFor200ResponseBodyApplicationJson = V2beta2HorizontalPodAutoscalerList
SchemaFor200ResponseBodyApplicationYaml = V2beta2HorizontalPodAutoscalerList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V2beta2HorizontalPodAutoscalerList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V2beta2HorizontalPodAutoscalerList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V2beta2HorizontalPodAutoscalerList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_horizontal_pod_autoscaler_for_all_namespaces_oapg(
        self,
...
class ListHorizontalPodAutoscalerForAllNamespaces(BaseApi):
    ...
    def list_horizontal_pod_autoscaler_for_all_namespaces(
        ...
        return self._list_horizontal_pod_autoscaler_for_all_namespaces_oapg(
