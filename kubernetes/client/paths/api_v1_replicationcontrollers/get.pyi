...
from client.model.v1_replication_controller_list import V1ReplicationControllerList
...
SchemaFor200ResponseBodyApplicationJson = V1ReplicationControllerList
SchemaFor200ResponseBodyApplicationYaml = V1ReplicationControllerList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicationControllerList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1ReplicationControllerList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1ReplicationControllerList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_replication_controller_for_all_namespaces_oapg(
        self,
...
class ListReplicationControllerForAllNamespaces(BaseApi):
    ...
    def list_replication_controller_for_all_namespaces(
        ...
        return self._list_replication_controller_for_all_namespaces_oapg(
