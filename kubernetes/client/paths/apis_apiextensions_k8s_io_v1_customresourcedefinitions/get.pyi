...
from client.model.v1_custom_resource_definition_list import V1CustomResourceDefinitionList
...
SchemaFor200ResponseBodyApplicationJson = V1CustomResourceDefinitionList
SchemaFor200ResponseBodyApplicationYaml = V1CustomResourceDefinitionList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1CustomResourceDefinitionList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1CustomResourceDefinitionList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1CustomResourceDefinitionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_custom_resource_definition_oapg(
        self,
...
class ListCustomResourceDefinition(BaseApi):
    ...
    def list_custom_resource_definition(
        ...
        return self._list_custom_resource_definition_oapg(
