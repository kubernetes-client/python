...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_custom_resource_definition_oapg(
        self,
...
class DeleteCollectionCustomResourceDefinition(BaseApi):
    ...
    def delete_collection_custom_resource_definition(
        ...
        return self._delete_collection_custom_resource_definition_oapg(
            body=body,
