...
from client.model.v1_custom_resource_definition import V1CustomResourceDefinition
...
# body param
SchemaForRequestBody = V1CustomResourceDefinition
...
SchemaFor200ResponseBodyApplicationJson = V1CustomResourceDefinition
SchemaFor200ResponseBodyApplicationYaml = V1CustomResourceDefinition
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1CustomResourceDefinition
...
SchemaFor201ResponseBodyApplicationJson = V1CustomResourceDefinition
SchemaFor201ResponseBodyApplicationYaml = V1CustomResourceDefinition
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1CustomResourceDefinition
...
SchemaFor202ResponseBodyApplicationJson = V1CustomResourceDefinition
SchemaFor202ResponseBodyApplicationYaml = V1CustomResourceDefinition
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1CustomResourceDefinition
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_custom_resource_definition_oapg(
        self,
...
class CreateCustomResourceDefinition(BaseApi):
    ...
    def create_custom_resource_definition(
        ...
        return self._create_custom_resource_definition_oapg(
            body=body,
