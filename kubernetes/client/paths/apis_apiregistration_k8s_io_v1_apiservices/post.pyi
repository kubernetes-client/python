...
from client.model.v1_api_service import V1APIService
...
# body param
SchemaForRequestBody = V1APIService
...
SchemaFor200ResponseBodyApplicationJson = V1APIService
SchemaFor200ResponseBodyApplicationYaml = V1APIService
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1APIService
...
SchemaFor201ResponseBodyApplicationJson = V1APIService
SchemaFor201ResponseBodyApplicationYaml = V1APIService
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1APIService
...
SchemaFor202ResponseBodyApplicationJson = V1APIService
SchemaFor202ResponseBodyApplicationYaml = V1APIService
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1APIService
...
class CreateApiService(BaseApi):
    ...
    def create_api_service(
        ...
        return self._create_api_service_oapg(
            body=body,
