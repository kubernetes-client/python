...
from client.model.v1_api_service_list import V1APIServiceList
...
SchemaFor200ResponseBodyApplicationJson = V1APIServiceList
SchemaFor200ResponseBodyApplicationYaml = V1APIServiceList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1APIServiceList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1APIServiceList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1APIServiceList
...
class ListApiService(BaseApi):
    ...
    def list_api_service(
        ...
        return self._list_api_service_oapg(
