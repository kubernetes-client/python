...
from client.model.v1_csi_driver import V1CSIDriver
...
# body param
SchemaForRequestBody = V1CSIDriver
...
SchemaFor200ResponseBodyApplicationJson = V1CSIDriver
SchemaFor200ResponseBodyApplicationYaml = V1CSIDriver
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1CSIDriver
...
SchemaFor201ResponseBodyApplicationJson = V1CSIDriver
SchemaFor201ResponseBodyApplicationYaml = V1CSIDriver
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1CSIDriver
...
SchemaFor202ResponseBodyApplicationJson = V1CSIDriver
SchemaFor202ResponseBodyApplicationYaml = V1CSIDriver
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1CSIDriver
...
class CreateCsiDriver(BaseApi):
    ...
    def create_csi_driver(
        ...
        return self._create_csi_driver_oapg(
            body=body,
