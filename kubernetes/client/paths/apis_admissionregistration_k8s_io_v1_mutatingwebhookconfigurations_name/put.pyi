...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_mutating_webhook_configuration_oapg(
        self,
...
class ReplaceMutatingWebhookConfiguration(BaseApi):
    ...
    def replace_mutating_webhook_configuration(
        ...
        return self._replace_mutating_webhook_configuration_oapg(
            body=body,
