...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_mutating_webhook_configuration_oapg(
        self,
...
class DeleteMutatingWebhookConfiguration(BaseApi):
    ...
    def delete_mutating_webhook_configuration(
        ...
        return self._delete_mutating_webhook_configuration_oapg(
            body=body,
