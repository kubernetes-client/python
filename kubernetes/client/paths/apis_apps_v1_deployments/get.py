...
SchemaFor200ResponseBodyApplicationJson = V1DeploymentList
SchemaFor200ResponseBodyApplicationYaml = V1DeploymentList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1DeploymentList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1DeploymentList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1DeploymentList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_deployment_for_all_namespaces_oapg(
        self,
...
class ListDeploymentForAllNamespaces(BaseApi):
    ...
    def list_deployment_for_all_namespaces(
        ...
        return self._list_deployment_for_all_namespaces_oapg(
