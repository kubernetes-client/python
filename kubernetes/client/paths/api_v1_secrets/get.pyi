...
from client.model.v1_secret_list import V1SecretList
...
SchemaFor200ResponseBodyApplicationJson = V1SecretList
SchemaFor200ResponseBodyApplicationYaml = V1SecretList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1SecretList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1SecretList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1SecretList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_secret_for_all_namespaces_oapg(
        self,
...
class ListSecretForAllNamespaces(BaseApi):
    ...
    def list_secret_for_all_namespaces(
        ...
        return self._list_secret_for_all_namespaces_oapg(
