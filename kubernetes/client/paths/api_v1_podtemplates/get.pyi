...
from client.model.v1_pod_template_list import V1PodTemplateList
...
SchemaFor200ResponseBodyApplicationJson = V1PodTemplateList
SchemaFor200ResponseBodyApplicationYaml = V1PodTemplateList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PodTemplateList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1PodTemplateList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1PodTemplateList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_pod_template_for_all_namespaces_oapg(
        self,
...
class ListPodTemplateForAllNamespaces(BaseApi):
    ...
    def list_pod_template_for_all_namespaces(
        ...
        return self._list_pod_template_for_all_namespaces_oapg(
