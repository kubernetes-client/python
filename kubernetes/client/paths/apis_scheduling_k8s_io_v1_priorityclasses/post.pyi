...
from client.model.v1_priority_class import V1PriorityClass
...
# body param
SchemaForRequestBody = V1PriorityClass
...
SchemaFor200ResponseBodyApplicationJson = V1PriorityClass
SchemaFor200ResponseBodyApplicationYaml = V1PriorityClass
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PriorityClass
...
SchemaFor201ResponseBodyApplicationJson = V1PriorityClass
SchemaFor201ResponseBodyApplicationYaml = V1PriorityClass
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1PriorityClass
...
SchemaFor202ResponseBodyApplicationJson = V1PriorityClass
SchemaFor202ResponseBodyApplicationYaml = V1PriorityClass
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1PriorityClass
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_priority_class_oapg(
        self,
...
class CreatePriorityClass(BaseApi):
    ...
    def create_priority_class(
        ...
        return self._create_priority_class_oapg(
            body=body,
