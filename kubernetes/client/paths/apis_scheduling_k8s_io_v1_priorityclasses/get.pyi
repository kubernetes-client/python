...
from client.model.v1_priority_class_list import V1PriorityClassList
...
SchemaFor200ResponseBodyApplicationJson = V1PriorityClassList
SchemaFor200ResponseBodyApplicationYaml = V1PriorityClassList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PriorityClassList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1PriorityClassList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1PriorityClassList
...
class ListPriorityClass(BaseApi):
    ...
    def list_priority_class(
        ...
        return self._list_priority_class_oapg(
