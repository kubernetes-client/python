...
from client.model.v1_ingress_class import V1IngressClass
...
# body param
SchemaForRequestBody = V1IngressClass
...
SchemaFor200ResponseBodyApplicationJson = V1IngressClass
SchemaFor200ResponseBodyApplicationYaml = V1IngressClass
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1IngressClass
...
SchemaFor201ResponseBodyApplicationJson = V1IngressClass
SchemaFor201ResponseBodyApplicationYaml = V1IngressClass
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1IngressClass
...
SchemaFor202ResponseBodyApplicationJson = V1IngressClass
SchemaFor202ResponseBodyApplicationYaml = V1IngressClass
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1IngressClass
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_ingress_class_oapg(
        self,
...
class CreateIngressClass(BaseApi):
    ...
    def create_ingress_class(
        ...
        return self._create_ingress_class_oapg(
            body=body,
