...
from client.model.v1_ingress import V1Ingress
...
# body param
SchemaForRequestBody = V1Ingress
...
SchemaFor200ResponseBodyApplicationJson = V1Ingress
SchemaFor200ResponseBodyApplicationYaml = V1Ingress
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Ingress
...
SchemaFor201ResponseBodyApplicationJson = V1Ingress
SchemaFor201ResponseBodyApplicationYaml = V1Ingress
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Ingress
...
SchemaFor202ResponseBodyApplicationJson = V1Ingress
SchemaFor202ResponseBodyApplicationYaml = V1Ingress
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Ingress
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_ingress_oapg(
        self,
...
class CreateNamespacedIngress(BaseApi):
    ...
    def create_namespaced_ingress(
        ...
        return self._create_namespaced_ingress_oapg(
            body=body,
