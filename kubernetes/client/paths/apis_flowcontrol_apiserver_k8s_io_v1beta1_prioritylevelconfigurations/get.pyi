...
from client.model.v1beta1_priority_level_configuration_list import V1beta1PriorityLevelConfigurationList
...
SchemaFor200ResponseBodyApplicationJson = V1beta1PriorityLevelConfigurationList
SchemaFor200ResponseBodyApplicationYaml = V1beta1PriorityLevelConfigurationList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1beta1PriorityLevelConfigurationList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1beta1PriorityLevelConfigurationList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1beta1PriorityLevelConfigurationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_priority_level_configuration_oapg(
        self,
...
class ListPriorityLevelConfiguration(BaseApi):
    ...
    def list_priority_level_configuration(
        ...
        return self._list_priority_level_configuration_oapg(
