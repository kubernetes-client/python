...
from client.model.v1_limit_range_list import V1LimitRangeList
...
SchemaFor200ResponseBodyApplicationJson = V1LimitRangeList
SchemaFor200ResponseBodyApplicationYaml = V1LimitRangeList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1LimitRangeList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1LimitRangeList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1LimitRangeList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_limit_range_for_all_namespaces_oapg(
        self,
...
class ListLimitRangeForAllNamespaces(BaseApi):
    ...
    def list_limit_range_for_all_namespaces(
        ...
        return self._list_limit_range_for_all_namespaces_oapg(
