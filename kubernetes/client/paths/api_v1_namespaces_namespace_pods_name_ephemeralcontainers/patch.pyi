...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_pod_ephemeralcontainers_oapg(
        self,
...
class PatchNamespacedPodEphemeralcontainers(BaseApi):
    ...
    def patch_namespaced_pod_ephemeralcontainers(
        ...
        return self._patch_namespaced_pod_ephemeralcontainers_oapg(
            body=body,
