...
# body param
SchemaForRequestBody = V1StatefulSet
...
SchemaFor200ResponseBodyApplicationJson = V1StatefulSet
SchemaFor200ResponseBodyApplicationYaml = V1StatefulSet
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1StatefulSet
...
SchemaFor201ResponseBodyApplicationJson = V1StatefulSet
SchemaFor201ResponseBodyApplicationYaml = V1StatefulSet
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1StatefulSet
...
SchemaFor202ResponseBodyApplicationJson = V1StatefulSet
SchemaFor202ResponseBodyApplicationYaml = V1StatefulSet
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1StatefulSet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_stateful_set_oapg(
        self,
...
class CreateNamespacedStatefulSet(BaseApi):
    ...
    def create_namespaced_stateful_set(
        ...
        return self._create_namespaced_stateful_set_oapg(
            body=body,
