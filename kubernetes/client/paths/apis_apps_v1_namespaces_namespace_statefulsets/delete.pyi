...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_stateful_set_oapg(
        self,
...
class DeleteCollectionNamespacedStatefulSet(BaseApi):
    ...
    def delete_collection_namespaced_stateful_set(
        ...
        return self._delete_collection_namespaced_stateful_set_oapg(
            body=body,
