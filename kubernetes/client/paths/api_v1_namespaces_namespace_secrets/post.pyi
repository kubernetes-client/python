...
from client.model.v1_secret import V1Secret
...
SchemaFor200ResponseBodyApplicationJson = V1Secret
SchemaFor200ResponseBodyApplicationYaml = V1Secret
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Secret
...
SchemaFor201ResponseBodyApplicationJson = V1Secret
SchemaFor201ResponseBodyApplicationYaml = V1Secret
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Secret
...
SchemaFor202ResponseBodyApplicationJson = V1Secret
SchemaFor202ResponseBodyApplicationYaml = V1Secret
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Secret
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_secret_oapg(
        self,
...
class CreateNamespacedSecret(BaseApi):
    ...
    def create_namespaced_secret(
        ...
        return self._create_namespaced_secret_oapg(
            body=body,
