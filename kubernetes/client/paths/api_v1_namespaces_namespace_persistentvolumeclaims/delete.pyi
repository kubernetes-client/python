...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_persistent_volume_claim_oapg(
        self,
...
class DeleteCollectionNamespacedPersistentVolumeClaim(BaseApi):
    ...
    def delete_collection_namespaced_persistent_volume_claim(
        ...
        return self._delete_collection_namespaced_persistent_volume_claim_oapg(
            body=body,
