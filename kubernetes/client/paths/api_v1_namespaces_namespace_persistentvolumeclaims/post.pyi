...
# body param
SchemaForRequestBody = V1PersistentVolumeClaim
...
SchemaFor200ResponseBodyApplicationJson = V1PersistentVolumeClaim
SchemaFor200ResponseBodyApplicationYaml = V1PersistentVolumeClaim
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PersistentVolumeClaim
...
SchemaFor201ResponseBodyApplicationJson = V1PersistentVolumeClaim
SchemaFor201ResponseBodyApplicationYaml = V1PersistentVolumeClaim
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1PersistentVolumeClaim
...
SchemaFor202ResponseBodyApplicationJson = V1PersistentVolumeClaim
SchemaFor202ResponseBodyApplicationYaml = V1PersistentVolumeClaim
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1PersistentVolumeClaim
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_persistent_volume_claim_oapg(
        self,
...
class CreateNamespacedPersistentVolumeClaim(BaseApi):
    ...
    def create_namespaced_persistent_volume_claim(
        ...
        return self._create_namespaced_persistent_volume_claim_oapg(
            body=body,
