...
from client.model.v1_persistent_volume_claim_list import V1PersistentVolumeClaimList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_namespaced_persistent_volume_claim_oapg(
        self,
...
class ListNamespacedPersistentVolumeClaim(BaseApi):
    ...
    def list_namespaced_persistent_volume_claim(
        ...
        return self._list_namespaced_persistent_volume_claim_oapg(
