...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_horizontal_pod_autoscaler_oapg(
        self,
...
class DeleteCollectionNamespacedHorizontalPodAutoscaler(BaseApi):
    ...
    def delete_collection_namespaced_horizontal_pod_autoscaler(
        ...
        return self._delete_collection_namespaced_horizontal_pod_autoscaler_oapg(
            body=body,
