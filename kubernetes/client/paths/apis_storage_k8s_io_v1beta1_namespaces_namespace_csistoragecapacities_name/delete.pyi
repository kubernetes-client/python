...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_namespaced_csi_storage_capacity_oapg(
        self,
...
class DeleteNamespacedCsiStorageCapacity(BaseApi):
    ...
    def delete_namespaced_csi_storage_capacity(
        ...
        return self._delete_namespaced_csi_storage_capacity_oapg(
            body=body,
