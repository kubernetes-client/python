...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_namespaced_pod_disruption_budget_oapg(
        self,
...
class DeleteNamespacedPodDisruptionBudget(BaseApi):
    ...
    def delete_namespaced_pod_disruption_budget(
        ...
        return self._delete_namespaced_pod_disruption_budget_oapg(
            body=body,
