...
from client.model.v1_endpoints_list import V1EndpointsList
...
SchemaFor200ResponseBodyApplicationJson = V1EndpointsList
SchemaFor200ResponseBodyApplicationYaml = V1EndpointsList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1EndpointsList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1EndpointsList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1EndpointsList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_endpoints_for_all_namespaces_oapg(
        self,
...
class ListEndpointsForAllNamespaces(BaseApi):
    ...
    def list_endpoints_for_all_namespaces(
        ...
        return self._list_endpoints_for_all_namespaces_oapg(
