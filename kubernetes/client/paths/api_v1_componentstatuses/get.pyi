...
from client.model.v1_component_status_list import V1ComponentStatusList
...
SchemaFor200ResponseBodyApplicationJson = V1ComponentStatusList
SchemaFor200ResponseBodyApplicationYaml = V1ComponentStatusList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ComponentStatusList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1ComponentStatusList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1ComponentStatusList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_component_status_oapg(
        self,
...
class ListComponentStatus(BaseApi):
    ...
    def list_component_status(
        ...
        return self._list_component_status_oapg(
