...
SchemaFor201ResponseBodyApplicationYaml = schemas.DictSchema
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = schemas.DictSchema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_custom_object_status_oapg(
        self,
        body: typing.Union[SchemaForRequestBody,dict, frozendict.frozendict, ],
...
class ReplaceNamespacedCustomObjectStatus(BaseApi):
    ...
    def replace_namespaced_custom_object_status(
        ...
        return self._replace_namespaced_custom_object_status_oapg(
            body=body,
