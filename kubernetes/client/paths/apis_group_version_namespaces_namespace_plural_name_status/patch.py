...
SchemaFor200ResponseBodyApplicationYaml = schemas.DictSchema
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = schemas.DictSchema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_custom_object_status_oapg(
        self,
    ...
    def _patch_namespaced_custom_object_status_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson,dict, frozendict.frozendict, SchemaForRequestBodyApplicationMergePatchjson,dict, frozendict.frozendict, SchemaForRequestBodyApplicationApplyPatchyaml,dict, frozendict.frozendict, ],
        content_type: str = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class PatchNamespacedCustomObjectStatus(BaseApi):
    ...
    def patch_namespaced_custom_object_status(
        ...
        return self._patch_namespaced_custom_object_status_oapg(
            body=body,
