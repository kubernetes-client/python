...
from client.model.v1_lease_list import V1LeaseList
...
SchemaFor200ResponseBodyApplicationJson = V1LeaseList
SchemaFor200ResponseBodyApplicationYaml = V1LeaseList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1LeaseList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1LeaseList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1LeaseList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_lease_for_all_namespaces_oapg(
        self,
...
class ListLeaseForAllNamespaces(BaseApi):
    ...
    def list_lease_for_all_namespaces(
        ...
        return self._list_lease_for_all_namespaces_oapg(
