...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_config_map_oapg(
        self,
...
class DeleteCollectionNamespacedConfigMap(BaseApi):
    ...
    def delete_collection_namespaced_config_map(
        ...
        return self._delete_collection_namespaced_config_map_oapg(
            body=body,
