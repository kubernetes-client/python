...
from client.model.v1_config_map import V1ConfigMap
...
# body param
SchemaForRequestBody = V1ConfigMap
...
SchemaFor200ResponseBodyApplicationJson = V1ConfigMap
SchemaFor200ResponseBodyApplicationYaml = V1ConfigMap
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ConfigMap
...
SchemaFor201ResponseBodyApplicationJson = V1ConfigMap
SchemaFor201ResponseBodyApplicationYaml = V1ConfigMap
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1ConfigMap
...
SchemaFor202ResponseBodyApplicationJson = V1ConfigMap
SchemaFor202ResponseBodyApplicationYaml = V1ConfigMap
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1ConfigMap
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_config_map_oapg(
        self,
...
class CreateNamespacedConfigMap(BaseApi):
    ...
    def create_namespaced_config_map(
        ...
        return self._create_namespaced_config_map_oapg(
            body=body,
