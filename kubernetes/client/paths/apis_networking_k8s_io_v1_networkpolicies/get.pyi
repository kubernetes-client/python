...
from client.model.v1_network_policy_list import V1NetworkPolicyList
...
SchemaFor200ResponseBodyApplicationJson = V1NetworkPolicyList
SchemaFor200ResponseBodyApplicationYaml = V1NetworkPolicyList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1NetworkPolicyList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1NetworkPolicyList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1NetworkPolicyList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_network_policy_for_all_namespaces_oapg(
        self,
...
class ListNetworkPolicyForAllNamespaces(BaseApi):
    ...
    def list_network_policy_for_all_namespaces(
        ...
        return self._list_network_policy_for_all_namespaces_oapg(
