...
from client.model.v1_resource_quota import V1ResourceQuota
...
# body param
SchemaForRequestBody = V1ResourceQuota
...
SchemaFor200ResponseBodyApplicationJson = V1ResourceQuota
SchemaFor200ResponseBodyApplicationYaml = V1ResourceQuota
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ResourceQuota
...
SchemaFor201ResponseBodyApplicationJson = V1ResourceQuota
SchemaFor201ResponseBodyApplicationYaml = V1ResourceQuota
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1ResourceQuota
...
SchemaFor202ResponseBodyApplicationJson = V1ResourceQuota
SchemaFor202ResponseBodyApplicationYaml = V1ResourceQuota
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1ResourceQuota
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_resource_quota_oapg(
        self,
...
class CreateNamespacedResourceQuota(BaseApi):
    ...
    def create_namespaced_resource_quota(
        ...
        return self._create_namespaced_resource_quota_oapg(
            body=body,
