...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_put_namespaced_pod_proxy_with_path_oapg(
        self,
...
class ConnectPutNamespacedPodProxyWithPath(BaseApi):
    ...
    def connect_put_namespaced_pod_proxy_with_path(
        ...
        return self._connect_put_namespaced_pod_proxy_with_path_oapg(
