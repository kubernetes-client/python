...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_patch_namespaced_pod_proxy_with_path_oapg(
        self,
...
class ConnectPatchNamespacedPodProxyWithPath(BaseApi):
    ...
    def connect_patch_namespaced_pod_proxy_with_path(
        ...
        return self._connect_patch_namespaced_pod_proxy_with_path_oapg(
