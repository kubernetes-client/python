...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_get_namespaced_pod_proxy_with_path_oapg(
        self,
...
class ConnectGetNamespacedPodProxyWithPath(BaseApi):
    ...
    def connect_get_namespaced_pod_proxy_with_path(
        ...
        return self._connect_get_namespaced_pod_proxy_with_path_oapg(
