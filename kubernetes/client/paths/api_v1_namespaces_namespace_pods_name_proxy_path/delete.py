...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_delete_namespaced_pod_proxy_with_path_oapg(
        self,
...
class ConnectDeleteNamespacedPodProxyWithPath(BaseApi):
    ...
    def connect_delete_namespaced_pod_proxy_with_path(
        ...
        return self._connect_delete_namespaced_pod_proxy_with_path_oapg(
