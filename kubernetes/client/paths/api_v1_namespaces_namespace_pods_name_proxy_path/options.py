...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_options_namespaced_pod_proxy_with_path_oapg(
        self,
...
class ConnectOptionsNamespacedPodProxyWithPath(BaseApi):
    ...
    def connect_options_namespaced_pod_proxy_with_path(
        ...
        return self._connect_options_namespaced_pod_proxy_with_path_oapg(
