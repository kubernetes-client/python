...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_head_namespaced_pod_proxy_with_path_oapg(
        self,
...
class ConnectHeadNamespacedPodProxyWithPath(BaseApi):
    ...
    def connect_head_namespaced_pod_proxy_with_path(
        ...
        return self._connect_head_namespaced_pod_proxy_with_path_oapg(
