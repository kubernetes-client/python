...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_mutating_webhook_configuration_oapg(
        self,
...
class DeleteCollectionMutatingWebhookConfiguration(BaseApi):
    ...
    def delete_collection_mutating_webhook_configuration(
        ...
        return self._delete_collection_mutating_webhook_configuration_oapg(
            body=body,
