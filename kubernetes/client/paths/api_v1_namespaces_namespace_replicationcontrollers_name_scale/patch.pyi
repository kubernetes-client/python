...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_replication_controller_scale_oapg(
        self,
...
class PatchNamespacedReplicationControllerScale(BaseApi):
    ...
    def patch_namespaced_replication_controller_scale(
        ...
        return self._patch_namespaced_replication_controller_scale_oapg(
            body=body,
