...
from client.model.v1_scale import V1Scale
...
SchemaFor200ResponseBodyApplicationJson = V1Scale
SchemaFor200ResponseBodyApplicationYaml = V1Scale
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Scale
...
SchemaFor201ResponseBodyApplicationJson = V1Scale
SchemaFor201ResponseBodyApplicationYaml = V1Scale
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Scale
...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_replication_controller_scale_oapg(
        self,
...
class ReplaceNamespacedReplicationControllerScale(BaseApi):
    ...
    def replace_namespaced_replication_controller_scale(
        ...
        return self._replace_namespaced_replication_controller_scale_oapg(
            body=body,
