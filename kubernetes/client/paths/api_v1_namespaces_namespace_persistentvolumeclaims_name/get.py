...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_namespaced_persistent_volume_claim_oapg(
        self,
...
class ReadNamespacedPersistentVolumeClaim(BaseApi):
    ...
    def read_namespaced_persistent_volume_claim(
        ...
        return self._read_namespaced_persistent_volume_claim_oapg(
