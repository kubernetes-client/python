...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_persistent_volume_claim_oapg(
        self,
...
class PatchNamespacedPersistentVolumeClaim(BaseApi):
    ...
    def patch_namespaced_persistent_volume_claim(
        ...
        return self._patch_namespaced_persistent_volume_claim_oapg(
            body=body,
