...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_namespaced_persistent_volume_claim_oapg(
        self,
...
class DeleteNamespacedPersistentVolumeClaim(BaseApi):
    ...
    def delete_namespaced_persistent_volume_claim(
        ...
        return self._delete_namespaced_persistent_volume_claim_oapg(
            body=body,
