...
SchemaFor200ResponseBodyApplicationJson = V1ReplicaSetList
SchemaFor200ResponseBodyApplicationYaml = V1ReplicaSetList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicaSetList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1ReplicaSetList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1ReplicaSetList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_replica_set_for_all_namespaces_oapg(
        self,
...
class ListReplicaSetForAllNamespaces(BaseApi):
    ...
    def list_replica_set_for_all_namespaces(
        ...
        return self._list_replica_set_for_all_namespaces_oapg(
