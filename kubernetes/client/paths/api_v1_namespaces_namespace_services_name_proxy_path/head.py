...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_head_namespaced_service_proxy_with_path_oapg(
        self,
...
class ConnectHeadNamespacedServiceProxyWithPath(BaseApi):
    ...
    def connect_head_namespaced_service_proxy_with_path(
        ...
        return self._connect_head_namespaced_service_proxy_with_path_oapg(
