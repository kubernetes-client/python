...
class BaseApi(api_client.Api):
    @typing.overload
    def _connect_options_namespaced_service_proxy_with_path_oapg(
        self,
...
class ConnectOptionsNamespacedServiceProxyWithPath(BaseApi):
    ...
    def connect_options_namespaced_service_proxy_with_path(
        ...
        return self._connect_options_namespaced_service_proxy_with_path_oapg(
