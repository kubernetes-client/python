...
from client.model.v1_eviction import V1Eviction
...
# body param
SchemaForRequestBody = V1Eviction
...
SchemaFor200ResponseBodyApplicationJson = V1Eviction
SchemaFor200ResponseBodyApplicationYaml = V1Eviction
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Eviction
...
SchemaFor201ResponseBodyApplicationJson = V1Eviction
SchemaFor201ResponseBodyApplicationYaml = V1Eviction
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Eviction
...
SchemaFor202ResponseBodyApplicationJson = V1Eviction
SchemaFor202ResponseBodyApplicationYaml = V1Eviction
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Eviction
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_pod_eviction_oapg(
        self,
...
class CreateNamespacedPodEviction(BaseApi):
    ...
    def create_namespaced_pod_eviction(
        ...
        return self._create_namespaced_pod_eviction_oapg(
            body=body,
