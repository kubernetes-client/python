...
from client.model.v1_endpoint_slice import V1EndpointSlice
...
# body param
SchemaForRequestBody = V1EndpointSlice
...
SchemaFor200ResponseBodyApplicationJson = V1EndpointSlice
SchemaFor200ResponseBodyApplicationYaml = V1EndpointSlice
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1EndpointSlice
...
SchemaFor201ResponseBodyApplicationJson = V1EndpointSlice
SchemaFor201ResponseBodyApplicationYaml = V1EndpointSlice
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1EndpointSlice
...
SchemaFor202ResponseBodyApplicationJson = V1EndpointSlice
SchemaFor202ResponseBodyApplicationYaml = V1EndpointSlice
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1EndpointSlice
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_endpoint_slice_oapg(
        self,
...
class CreateNamespacedEndpointSlice(BaseApi):
    ...
    def create_namespaced_endpoint_slice(
        ...
        return self._create_namespaced_endpoint_slice_oapg(
            body=body,
