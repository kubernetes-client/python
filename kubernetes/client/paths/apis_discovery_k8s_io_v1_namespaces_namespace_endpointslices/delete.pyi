...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_endpoint_slice_oapg(
        self,
...
class DeleteCollectionNamespacedEndpointSlice(BaseApi):
    ...
    def delete_collection_namespaced_endpoint_slice(
        ...
        return self._delete_collection_namespaced_endpoint_slice_oapg(
            body=body,
