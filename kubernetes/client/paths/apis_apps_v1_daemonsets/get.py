...
SchemaFor200ResponseBodyApplicationJson = V1DaemonSetList
SchemaFor200ResponseBodyApplicationYaml = V1DaemonSetList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1DaemonSetList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1DaemonSetList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1DaemonSetList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_daemon_set_for_all_namespaces_oapg(
        self,
...
class ListDaemonSetForAllNamespaces(BaseApi):
    ...
    def list_daemon_set_for_all_namespaces(
        ...
        return self._list_daemon_set_for_all_namespaces_oapg(
