...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_custom_object_scale_oapg(
        self,
...
class ReplaceNamespacedCustomObjectScale(BaseApi):
    ...
    def replace_namespaced_custom_object_scale(
        ...
        return self._replace_namespaced_custom_object_scale_oapg(
            body=body,
