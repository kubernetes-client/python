...
from client.model.v1_service import V1Service
...
# body param
SchemaForRequestBody = V1Service
...
SchemaFor200ResponseBodyApplicationJson = V1Service
SchemaFor200ResponseBodyApplicationYaml = V1Service
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Service
...
SchemaFor201ResponseBodyApplicationJson = V1Service
SchemaFor201ResponseBodyApplicationYaml = V1Service
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Service
...
SchemaFor202ResponseBodyApplicationJson = V1Service
SchemaFor202ResponseBodyApplicationYaml = V1Service
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Service
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_service_oapg(
        self,
...
class CreateNamespacedService(BaseApi):
    ...
    def create_namespaced_service(
        ...
        return self._create_namespaced_service_oapg(
            body=body,
