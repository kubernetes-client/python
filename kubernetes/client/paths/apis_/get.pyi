...
from client.model.v1_api_group_list import V1APIGroupList

SchemaFor200ResponseBodyApplicationJson = V1APIGroupList
SchemaFor200ResponseBodyApplicationYaml = V1APIGroupList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1APIGroupList
...
class GetApiVersions(BaseApi):
    ...
    def get_api_versions(
        ...
        return self._get_api_versions_oapg(
