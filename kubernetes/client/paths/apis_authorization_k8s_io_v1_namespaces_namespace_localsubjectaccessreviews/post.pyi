...
from client.model.v1_local_subject_access_review import V1LocalSubjectAccessReview
...
# body param
SchemaForRequestBody = V1LocalSubjectAccessReview
...
SchemaFor200ResponseBodyApplicationJson = V1LocalSubjectAccessReview
SchemaFor200ResponseBodyApplicationYaml = V1LocalSubjectAccessReview
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1LocalSubjectAccessReview
...
SchemaFor201ResponseBodyApplicationJson = V1LocalSubjectAccessReview
SchemaFor201ResponseBodyApplicationYaml = V1LocalSubjectAccessReview
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1LocalSubjectAccessReview
...
SchemaFor202ResponseBodyApplicationJson = V1LocalSubjectAccessReview
SchemaFor202ResponseBodyApplicationYaml = V1LocalSubjectAccessReview
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1LocalSubjectAccessReview
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_local_subject_access_review_oapg(
        self,
...
class CreateNamespacedLocalSubjectAccessReview(BaseApi):
    ...
    def create_namespaced_local_subject_access_review(
        ...
        return self._create_namespaced_local_subject_access_review_oapg(
            body=body,
