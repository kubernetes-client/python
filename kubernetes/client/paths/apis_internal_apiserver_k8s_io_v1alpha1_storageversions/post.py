...
# body param
SchemaForRequestBody = V1alpha1StorageVersion
...
SchemaFor200ResponseBodyApplicationJson = V1alpha1StorageVersion
SchemaFor200ResponseBodyApplicationYaml = V1alpha1StorageVersion
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1alpha1StorageVersion
...
SchemaFor201ResponseBodyApplicationJson = V1alpha1StorageVersion
SchemaFor201ResponseBodyApplicationYaml = V1alpha1StorageVersion
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1alpha1StorageVersion
...
SchemaFor202ResponseBodyApplicationJson = V1alpha1StorageVersion
SchemaFor202ResponseBodyApplicationYaml = V1alpha1StorageVersion
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1alpha1StorageVersion
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_storage_version_oapg(
        self,
...
class CreateStorageVersion(BaseApi):
    ...
    def create_storage_version(
        ...
        return self._create_storage_version_oapg(
            body=body,
