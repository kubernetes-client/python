...
from client.model.v1_service_account_list import V1ServiceAccountList
...
SchemaFor200ResponseBodyApplicationJson = V1ServiceAccountList
SchemaFor200ResponseBodyApplicationYaml = V1ServiceAccountList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ServiceAccountList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1ServiceAccountList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1ServiceAccountList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_service_account_for_all_namespaces_oapg(
        self,
...
class ListServiceAccountForAllNamespaces(BaseApi):
    ...
    def list_service_account_for_all_namespaces(
        ...
        return self._list_service_account_for_all_namespaces_oapg(
