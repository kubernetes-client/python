...
from client.model.v1_resource_quota_list import V1ResourceQuotaList
...
SchemaFor200ResponseBodyApplicationJson = V1ResourceQuotaList
SchemaFor200ResponseBodyApplicationYaml = V1ResourceQuotaList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ResourceQuotaList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1ResourceQuotaList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1ResourceQuotaList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_resource_quota_for_all_namespaces_oapg(
        self,
...
class ListResourceQuotaForAllNamespaces(BaseApi):
    ...
    def list_resource_quota_for_all_namespaces(
        ...
        return self._list_resource_quota_for_all_namespaces_oapg(
