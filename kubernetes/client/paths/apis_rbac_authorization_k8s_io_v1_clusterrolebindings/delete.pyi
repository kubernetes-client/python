...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_cluster_role_binding_oapg(
        self,
...
class DeleteCollectionClusterRoleBinding(BaseApi):
    ...
    def delete_collection_cluster_role_binding(
        ...
        return self._delete_collection_cluster_role_binding_oapg(
            body=body,
