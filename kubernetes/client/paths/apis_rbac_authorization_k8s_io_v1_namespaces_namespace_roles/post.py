...
SchemaFor200ResponseBodyApplicationJson = V1Role
SchemaFor200ResponseBodyApplicationYaml = V1Role
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Role
...
SchemaFor201ResponseBodyApplicationJson = V1Role
SchemaFor201ResponseBodyApplicationYaml = V1Role
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Role
...
SchemaFor202ResponseBodyApplicationJson = V1Role
SchemaFor202ResponseBodyApplicationYaml = V1Role
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Role
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_role_oapg(
        self,
...
class CreateNamespacedRole(BaseApi):
    ...
    def create_namespaced_role(
        ...
        return self._create_namespaced_role_oapg(
            body=body,
