...
# body param
SchemaForRequestBody = EventsV1Event
...
SchemaFor200ResponseBodyApplicationJson = EventsV1Event
SchemaFor200ResponseBodyApplicationYaml = EventsV1Event
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = EventsV1Event
...
SchemaFor201ResponseBodyApplicationJson = EventsV1Event
SchemaFor201ResponseBodyApplicationYaml = EventsV1Event
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = EventsV1Event
...
SchemaFor202ResponseBodyApplicationJson = EventsV1Event
SchemaFor202ResponseBodyApplicationYaml = EventsV1Event
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = EventsV1Event
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_event_oapg(
        self,
...
class CreateNamespacedEvent(BaseApi):
    ...
    def create_namespaced_event(
        ...
        return self._create_namespaced_event_oapg(
            body=body,
