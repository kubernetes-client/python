...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_controller_revision_oapg(
        self,
...
class DeleteCollectionNamespacedControllerRevision(BaseApi):
    ...
    def delete_collection_namespaced_controller_revision(
        ...
        return self._delete_collection_namespaced_controller_revision_oapg(
            body=body,
