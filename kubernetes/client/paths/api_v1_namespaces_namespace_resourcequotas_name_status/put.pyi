...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_resource_quota_status_oapg(
        self,
...
class ReplaceNamespacedResourceQuotaStatus(BaseApi):
    ...
    def replace_namespaced_resource_quota_status(
        ...
        return self._replace_namespaced_resource_quota_status_oapg(
            body=body,
