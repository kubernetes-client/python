...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_network_policy_status_oapg(
        self,
...
class PatchNamespacedNetworkPolicyStatus(BaseApi):
    ...
    def patch_namespaced_network_policy_status(
        ...
        return self._patch_namespaced_network_policy_status_oapg(
            body=body,
