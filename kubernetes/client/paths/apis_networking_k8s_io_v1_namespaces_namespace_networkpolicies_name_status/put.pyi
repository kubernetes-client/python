...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_network_policy_status_oapg(
        self,
...
class ReplaceNamespacedNetworkPolicyStatus(BaseApi):
    ...
    def replace_namespaced_network_policy_status(
        ...
        return self._replace_namespaced_network_policy_status_oapg(
            body=body,
