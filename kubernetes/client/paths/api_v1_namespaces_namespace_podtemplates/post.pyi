...
from client.model.v1_pod_template import V1PodTemplate
...
# body param
SchemaForRequestBody = V1PodTemplate
...
SchemaFor200ResponseBodyApplicationJson = V1PodTemplate
SchemaFor200ResponseBodyApplicationYaml = V1PodTemplate
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PodTemplate
...
SchemaFor201ResponseBodyApplicationJson = V1PodTemplate
SchemaFor201ResponseBodyApplicationYaml = V1PodTemplate
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1PodTemplate
...
SchemaFor202ResponseBodyApplicationJson = V1PodTemplate
SchemaFor202ResponseBodyApplicationYaml = V1PodTemplate
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1PodTemplate
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_pod_template_oapg(
        self,
...
class CreateNamespacedPodTemplate(BaseApi):
    ...
    def create_namespaced_pod_template(
        ...
        return self._create_namespaced_pod_template_oapg(
            body=body,
