...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_pod_template_oapg(
        self,
...
class DeleteCollectionNamespacedPodTemplate(BaseApi):
    ...
    def delete_collection_namespaced_pod_template(
        ...
        return self._delete_collection_namespaced_pod_template_oapg(
            body=body,
