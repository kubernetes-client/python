...
# body param
SchemaForRequestBody = V1Deployment
...
SchemaFor200ResponseBodyApplicationJson = V1Deployment
SchemaFor200ResponseBodyApplicationYaml = V1Deployment
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Deployment
...
SchemaFor201ResponseBodyApplicationJson = V1Deployment
SchemaFor201ResponseBodyApplicationYaml = V1Deployment
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Deployment
...
SchemaFor202ResponseBodyApplicationJson = V1Deployment
SchemaFor202ResponseBodyApplicationYaml = V1Deployment
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Deployment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_deployment_oapg(
        self,
...
class CreateNamespacedDeployment(BaseApi):
    ...
    def create_namespaced_deployment(
        ...
        return self._create_namespaced_deployment_oapg(
            body=body,
