...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_deployment_oapg(
        self,
...
class DeleteCollectionNamespacedDeployment(BaseApi):
    ...
    def delete_collection_namespaced_deployment(
        ...
        return self._delete_collection_namespaced_deployment_oapg(
            body=body,
