...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_priority_level_configuration_status_oapg(
        self,
...
class ReplacePriorityLevelConfigurationStatus(BaseApi):
    ...
    def replace_priority_level_configuration_status(
        ...
        return self._replace_priority_level_configuration_status_oapg(
            body=body,
