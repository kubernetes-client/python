...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_priority_level_configuration_status_oapg(
        self,
...
class ReadPriorityLevelConfigurationStatus(BaseApi):
    ...
    def read_priority_level_configuration_status(
        ...
        return self._read_priority_level_configuration_status_oapg(
