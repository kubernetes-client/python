...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_priority_level_configuration_status_oapg(
        self,
...
class PatchPriorityLevelConfigurationStatus(BaseApi):
    ...
    def patch_priority_level_configuration_status(
        ...
        return self._patch_priority_level_configuration_status_oapg(
            body=body,
