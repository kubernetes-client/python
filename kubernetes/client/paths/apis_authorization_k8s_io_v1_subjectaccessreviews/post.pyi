...
from client.model.v1_subject_access_review import V1SubjectAccessReview
...
# body param
SchemaForRequestBody = V1SubjectAccessReview
...
SchemaFor200ResponseBodyApplicationJson = V1SubjectAccessReview
SchemaFor200ResponseBodyApplicationYaml = V1SubjectAccessReview
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1SubjectAccessReview
...
SchemaFor201ResponseBodyApplicationJson = V1SubjectAccessReview
SchemaFor201ResponseBodyApplicationYaml = V1SubjectAccessReview
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1SubjectAccessReview
...
SchemaFor202ResponseBodyApplicationJson = V1SubjectAccessReview
SchemaFor202ResponseBodyApplicationYaml = V1SubjectAccessReview
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1SubjectAccessReview
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_subject_access_review_oapg(
        self,
...
class CreateSubjectAccessReview(BaseApi):
    ...
    def create_subject_access_review(
        ...
        return self._create_subject_access_review_oapg(
            body=body,
