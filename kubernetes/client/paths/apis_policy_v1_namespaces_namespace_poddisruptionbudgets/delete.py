...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_pod_disruption_budget_oapg(
        self,
...
class DeleteCollectionNamespacedPodDisruptionBudget(BaseApi):
    ...
    def delete_collection_namespaced_pod_disruption_budget(
        ...
        return self._delete_collection_namespaced_pod_disruption_budget_oapg(
            body=body,
