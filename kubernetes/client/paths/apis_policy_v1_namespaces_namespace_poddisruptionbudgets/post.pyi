...
from client.model.v1_pod_disruption_budget import V1PodDisruptionBudget
...
# body param
SchemaForRequestBody = V1PodDisruptionBudget
...
SchemaFor200ResponseBodyApplicationJson = V1PodDisruptionBudget
SchemaFor200ResponseBodyApplicationYaml = V1PodDisruptionBudget
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PodDisruptionBudget
...
SchemaFor201ResponseBodyApplicationJson = V1PodDisruptionBudget
SchemaFor201ResponseBodyApplicationYaml = V1PodDisruptionBudget
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1PodDisruptionBudget
...
SchemaFor202ResponseBodyApplicationJson = V1PodDisruptionBudget
SchemaFor202ResponseBodyApplicationYaml = V1PodDisruptionBudget
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1PodDisruptionBudget
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_pod_disruption_budget_oapg(
        self,
...
class CreateNamespacedPodDisruptionBudget(BaseApi):
    ...
    def create_namespaced_pod_disruption_budget(
        ...
        return self._create_namespaced_pod_disruption_budget_oapg(
            body=body,
