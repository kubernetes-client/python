...
SchemaFor200ResponseBodyApplicationJson = V1APIGroup
SchemaFor200ResponseBodyApplicationYaml = V1APIGroup
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1APIGroup
...
class GetApiGroup(BaseApi):
    ...
    def get_api_group(
        ...
        return self._get_api_group_oapg(
