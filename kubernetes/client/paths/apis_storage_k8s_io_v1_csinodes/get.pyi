...
from client.model.v1_csi_node_list import V1CSINodeList
...
SchemaFor200ResponseBodyApplicationJson = V1CSINodeList
SchemaFor200ResponseBodyApplicationYaml = V1CSINodeList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1CSINodeList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1CSINodeList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1CSINodeList
...
class ListCsiNode(BaseApi):
    ...
    def list_csi_node(
        ...
        return self._list_csi_node_oapg(
