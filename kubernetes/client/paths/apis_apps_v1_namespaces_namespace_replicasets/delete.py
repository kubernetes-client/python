...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_replica_set_oapg(
        self,
...
class DeleteCollectionNamespacedReplicaSet(BaseApi):
    ...
    def delete_collection_namespaced_replica_set(
        ...
        return self._delete_collection_namespaced_replica_set_oapg(
            body=body,
