...
# body param
SchemaForRequestBody = V1ReplicaSet
...
SchemaFor200ResponseBodyApplicationJson = V1ReplicaSet
SchemaFor200ResponseBodyApplicationYaml = V1ReplicaSet
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicaSet
...
SchemaFor201ResponseBodyApplicationJson = V1ReplicaSet
SchemaFor201ResponseBodyApplicationYaml = V1ReplicaSet
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicaSet
...
SchemaFor202ResponseBodyApplicationJson = V1ReplicaSet
SchemaFor202ResponseBodyApplicationYaml = V1ReplicaSet
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicaSet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_replica_set_oapg(
        self,
...
class CreateNamespacedReplicaSet(BaseApi):
    ...
    def create_namespaced_replica_set(
        ...
        return self._create_namespaced_replica_set_oapg(
            body=body,
