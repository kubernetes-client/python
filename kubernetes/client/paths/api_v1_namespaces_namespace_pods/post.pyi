...
from client.model.v1_pod import V1Pod
...
SchemaFor200ResponseBodyApplicationJson = V1Pod
SchemaFor200ResponseBodyApplicationYaml = V1Pod
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Pod
...
SchemaFor201ResponseBodyApplicationJson = V1Pod
SchemaFor201ResponseBodyApplicationYaml = V1Pod
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Pod
...
SchemaFor202ResponseBodyApplicationJson = V1Pod
SchemaFor202ResponseBodyApplicationYaml = V1Pod
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Pod
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_pod_oapg(
        self,
...
class CreateNamespacedPod(BaseApi):
    ...
    def create_namespaced_pod(
        ...
        return self._create_namespaced_pod_oapg(
            body=body,
