...
from client.model.v1_pod_list import V1PodList
...
SchemaFor200ResponseBodyApplicationJson = V1PodList
SchemaFor200ResponseBodyApplicationYaml = V1PodList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PodList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1PodList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1PodList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_pod_for_all_namespaces_oapg(
        self,
...
class ListPodForAllNamespaces(BaseApi):
    ...
    def list_pod_for_all_namespaces(
        ...
        return self._list_pod_for_all_namespaces_oapg(
