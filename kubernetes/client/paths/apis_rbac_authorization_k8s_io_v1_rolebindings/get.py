...
SchemaFor200ResponseBodyApplicationJson = V1RoleBindingList
SchemaFor200ResponseBodyApplicationYaml = V1RoleBindingList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1RoleBindingList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1RoleBindingList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1RoleBindingList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_role_binding_for_all_namespaces_oapg(
        self,
...
class ListRoleBindingForAllNamespaces(BaseApi):
    ...
    def list_role_binding_for_all_namespaces(
        ...
        return self._list_role_binding_for_all_namespaces_oapg(
