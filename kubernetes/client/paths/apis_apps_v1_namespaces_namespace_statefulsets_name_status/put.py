...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_stateful_set_status_oapg(
        self,
...
class ReplaceNamespacedStatefulSetStatus(BaseApi):
    ...
    def replace_namespaced_stateful_set_status(
        ...
        return self._replace_namespaced_stateful_set_status_oapg(
            body=body,
