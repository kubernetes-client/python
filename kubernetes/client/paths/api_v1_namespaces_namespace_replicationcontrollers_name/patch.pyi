...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_replication_controller_oapg(
        self,
...
class PatchNamespacedReplicationController(BaseApi):
    ...
    def patch_namespaced_replication_controller(
        ...
        return self._patch_namespaced_replication_controller_oapg(
            body=body,
