...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_namespaced_replication_controller_oapg(
        self,
...
class DeleteNamespacedReplicationController(BaseApi):
    ...
    def delete_namespaced_replication_controller(
        ...
        return self._delete_namespaced_replication_controller_oapg(
            body=body,
