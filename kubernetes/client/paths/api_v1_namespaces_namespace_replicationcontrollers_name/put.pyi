...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_replication_controller_oapg(
        self,
...
class ReplaceNamespacedReplicationController(BaseApi):
    ...
    def replace_namespaced_replication_controller(
        ...
        return self._replace_namespaced_replication_controller_oapg(
            body=body,
