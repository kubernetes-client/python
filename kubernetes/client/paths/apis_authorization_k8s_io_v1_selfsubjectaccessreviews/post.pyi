...
from client.model.v1_self_subject_access_review import V1SelfSubjectAccessReview
...
# body param
SchemaForRequestBody = V1SelfSubjectAccessReview
...
SchemaFor200ResponseBodyApplicationJson = V1SelfSubjectAccessReview
SchemaFor200ResponseBodyApplicationYaml = V1SelfSubjectAccessReview
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1SelfSubjectAccessReview
...
SchemaFor201ResponseBodyApplicationJson = V1SelfSubjectAccessReview
SchemaFor201ResponseBodyApplicationYaml = V1SelfSubjectAccessReview
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1SelfSubjectAccessReview
...
SchemaFor202ResponseBodyApplicationJson = V1SelfSubjectAccessReview
SchemaFor202ResponseBodyApplicationYaml = V1SelfSubjectAccessReview
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1SelfSubjectAccessReview
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_self_subject_access_review_oapg(
        self,
...
class CreateSelfSubjectAccessReview(BaseApi):
    ...
    def create_self_subject_access_review(
        ...
        return self._create_self_subject_access_review_oapg(
            body=body,
