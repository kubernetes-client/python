...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_validating_webhook_configuration_oapg(
        self,
...
class DeleteCollectionValidatingWebhookConfiguration(BaseApi):
    ...
    def delete_collection_validating_webhook_configuration(
        ...
        return self._delete_collection_validating_webhook_configuration_oapg(
            body=body,
