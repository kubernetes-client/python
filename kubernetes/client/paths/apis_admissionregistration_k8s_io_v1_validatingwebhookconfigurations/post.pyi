...
from client.model.v1_validating_webhook_configuration import V1ValidatingWebhookConfiguration
...
# body param
SchemaForRequestBody = V1ValidatingWebhookConfiguration
...
SchemaFor200ResponseBodyApplicationJson = V1ValidatingWebhookConfiguration
SchemaFor200ResponseBodyApplicationYaml = V1ValidatingWebhookConfiguration
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ValidatingWebhookConfiguration
...
SchemaFor201ResponseBodyApplicationJson = V1ValidatingWebhookConfiguration
SchemaFor201ResponseBodyApplicationYaml = V1ValidatingWebhookConfiguration
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1ValidatingWebhookConfiguration
...
SchemaFor202ResponseBodyApplicationJson = V1ValidatingWebhookConfiguration
SchemaFor202ResponseBodyApplicationYaml = V1ValidatingWebhookConfiguration
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1ValidatingWebhookConfiguration
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_validating_webhook_configuration_oapg(
        self,
...
class CreateValidatingWebhookConfiguration(BaseApi):
    ...
    def create_validating_webhook_configuration(
        ...
        return self._create_validating_webhook_configuration_oapg(
            body=body,
