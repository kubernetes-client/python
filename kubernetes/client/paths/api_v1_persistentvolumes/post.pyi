...
from client.model.v1_persistent_volume import V1PersistentVolume
...
# body param
SchemaForRequestBody = V1PersistentVolume
...
SchemaFor200ResponseBodyApplicationJson = V1PersistentVolume
SchemaFor200ResponseBodyApplicationYaml = V1PersistentVolume
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PersistentVolume
...
SchemaFor201ResponseBodyApplicationJson = V1PersistentVolume
SchemaFor201ResponseBodyApplicationYaml = V1PersistentVolume
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1PersistentVolume
...
SchemaFor202ResponseBodyApplicationJson = V1PersistentVolume
SchemaFor202ResponseBodyApplicationYaml = V1PersistentVolume
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1PersistentVolume
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_persistent_volume_oapg(
        self,
...
class CreatePersistentVolume(BaseApi):
    ...
    def create_persistent_volume(
        ...
        return self._create_persistent_volume_oapg(
            body=body,
