...
from client.model.v1_persistent_volume_list import V1PersistentVolumeList
...
SchemaFor200ResponseBodyApplicationJson = V1PersistentVolumeList
SchemaFor200ResponseBodyApplicationYaml = V1PersistentVolumeList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1PersistentVolumeList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1PersistentVolumeList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1PersistentVolumeList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_persistent_volume_oapg(
        self,
...
class ListPersistentVolume(BaseApi):
    ...
    def list_persistent_volume(
        ...
        return self._list_persistent_volume_oapg(
