...
from client.model.v1_storage_class import V1StorageClass
...
# body param
SchemaForRequestBody = V1StorageClass
...
SchemaFor200ResponseBodyApplicationJson = V1StorageClass
SchemaFor200ResponseBodyApplicationYaml = V1StorageClass
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1StorageClass
...
SchemaFor201ResponseBodyApplicationJson = V1StorageClass
SchemaFor201ResponseBodyApplicationYaml = V1StorageClass
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1StorageClass
...
SchemaFor202ResponseBodyApplicationJson = V1StorageClass
SchemaFor202ResponseBodyApplicationYaml = V1StorageClass
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1StorageClass
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_storage_class_oapg(
        self,
...
class CreateStorageClass(BaseApi):
    ...
    def create_storage_class(
        ...
        return self._create_storage_class_oapg(
            body=body,
