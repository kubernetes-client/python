...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_custom_resource_definition_status_oapg(
        self,
...
class PatchCustomResourceDefinitionStatus(BaseApi):
    ...
    def patch_custom_resource_definition_status(
        ...
        return self._patch_custom_resource_definition_status_oapg(
            body=body,
