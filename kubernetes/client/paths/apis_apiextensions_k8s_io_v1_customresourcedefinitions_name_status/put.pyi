...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_custom_resource_definition_status_oapg(
        self,
...
class ReplaceCustomResourceDefinitionStatus(BaseApi):
    ...
    def replace_custom_resource_definition_status(
        ...
        return self._replace_custom_resource_definition_status_oapg(
            body=body,
