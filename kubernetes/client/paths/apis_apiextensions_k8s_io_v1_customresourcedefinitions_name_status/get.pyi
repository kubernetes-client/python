...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_custom_resource_definition_status_oapg(
        self,
...
class ReadCustomResourceDefinitionStatus(BaseApi):
    ...
    def read_custom_resource_definition_status(
        ...
        return self._read_custom_resource_definition_status_oapg(
