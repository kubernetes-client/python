...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_namespaced_controller_revision_oapg(
        self,
...
class DeleteNamespacedControllerRevision(BaseApi):
    ...
    def delete_namespaced_controller_revision(
        ...
        return self._delete_namespaced_controller_revision_oapg(
            body=body,
