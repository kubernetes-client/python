...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_controller_revision_oapg(
        self,
...
class ReplaceNamespacedControllerRevision(BaseApi):
    ...
    def replace_namespaced_controller_revision(
        ...
        return self._replace_namespaced_controller_revision_oapg(
            body=body,
