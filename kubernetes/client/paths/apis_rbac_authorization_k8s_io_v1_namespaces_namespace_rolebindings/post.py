...
# body param
SchemaForRequestBody = V1RoleBinding
...
SchemaFor200ResponseBodyApplicationJson = V1RoleBinding
SchemaFor200ResponseBodyApplicationYaml = V1RoleBinding
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1RoleBinding
...
SchemaFor201ResponseBodyApplicationJson = V1RoleBinding
SchemaFor201ResponseBodyApplicationYaml = V1RoleBinding
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1RoleBinding
...
SchemaFor202ResponseBodyApplicationJson = V1RoleBinding
SchemaFor202ResponseBodyApplicationYaml = V1RoleBinding
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1RoleBinding
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_role_binding_oapg(
        self,
...
class CreateNamespacedRoleBinding(BaseApi):
    ...
    def create_namespaced_role_binding(
        ...
        return self._create_namespaced_role_binding_oapg(
            body=body,
