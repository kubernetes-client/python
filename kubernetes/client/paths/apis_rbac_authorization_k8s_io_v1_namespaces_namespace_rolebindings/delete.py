...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_role_binding_oapg(
        self,
...
class DeleteCollectionNamespacedRoleBinding(BaseApi):
    ...
    def delete_collection_namespaced_role_binding(
        ...
        return self._delete_collection_namespaced_role_binding_oapg(
            body=body,
