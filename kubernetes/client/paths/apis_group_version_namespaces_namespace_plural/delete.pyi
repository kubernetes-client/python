...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_custom_object_oapg(
        self,
...
class DeleteCollectionNamespacedCustomObject(BaseApi):
    ...
    def delete_collection_namespaced_custom_object(
        ...
        return self._delete_collection_namespaced_custom_object_oapg(
            body=body,
