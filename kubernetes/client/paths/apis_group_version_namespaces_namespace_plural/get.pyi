...
SchemaFor200ResponseBodyApplicationJsonstreamwatch = schemas.DictSchema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_namespaced_custom_object_oapg(
        self,
...
class ListNamespacedCustomObject(BaseApi):
    ...
    def list_namespaced_custom_object(
        ...
        return self._list_namespaced_custom_object_oapg(
