...
from client.model.v1_volume_attachment_list import V1VolumeAttachmentList
...
SchemaFor200ResponseBodyApplicationJson = V1VolumeAttachmentList
SchemaFor200ResponseBodyApplicationYaml = V1VolumeAttachmentList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1VolumeAttachmentList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1VolumeAttachmentList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1VolumeAttachmentList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_volume_attachment_oapg(
        self,
...
class ListVolumeAttachment(BaseApi):
    ...
    def list_volume_attachment(
        ...
        return self._list_volume_attachment_oapg(
