...
SchemaFor202ResponseBodyApplicationJson = V1VolumeAttachment
SchemaFor202ResponseBodyApplicationYaml = V1VolumeAttachment
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1VolumeAttachment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_volume_attachment_oapg(
        self,
...
class CreateVolumeAttachment(BaseApi):
    ...
    def create_volume_attachment(
        ...
        return self._create_volume_attachment_oapg(
            body=body,
