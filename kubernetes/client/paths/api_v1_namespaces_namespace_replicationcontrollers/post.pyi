...
from client.model.v1_replication_controller import V1ReplicationController
...
# body param
SchemaForRequestBody = V1ReplicationController
...
SchemaFor200ResponseBodyApplicationJson = V1ReplicationController
SchemaFor200ResponseBodyApplicationYaml = V1ReplicationController
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicationController
...
SchemaFor201ResponseBodyApplicationJson = V1ReplicationController
SchemaFor201ResponseBodyApplicationYaml = V1ReplicationController
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicationController
...
SchemaFor202ResponseBodyApplicationJson = V1ReplicationController
SchemaFor202ResponseBodyApplicationYaml = V1ReplicationController
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1ReplicationController
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_replication_controller_oapg(
        self,
...
class CreateNamespacedReplicationController(BaseApi):
    ...
    def create_namespaced_replication_controller(
        ...
        return self._create_namespaced_replication_controller_oapg(
            body=body,
