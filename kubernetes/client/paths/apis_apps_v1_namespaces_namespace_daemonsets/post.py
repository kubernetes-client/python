...
# body param
SchemaForRequestBody = V1DaemonSet
...
SchemaFor200ResponseBodyApplicationJson = V1DaemonSet
SchemaFor200ResponseBodyApplicationYaml = V1DaemonSet
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1DaemonSet
...
SchemaFor201ResponseBodyApplicationJson = V1DaemonSet
SchemaFor201ResponseBodyApplicationYaml = V1DaemonSet
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1DaemonSet
...
SchemaFor202ResponseBodyApplicationJson = V1DaemonSet
SchemaFor202ResponseBodyApplicationYaml = V1DaemonSet
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1DaemonSet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_daemon_set_oapg(
        self,
...
class CreateNamespacedDaemonSet(BaseApi):
    ...
    def create_namespaced_daemon_set(
        ...
        return self._create_namespaced_daemon_set_oapg(
            body=body,
