...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_namespaced_daemon_set_oapg(
        self,
...
class DeleteCollectionNamespacedDaemonSet(BaseApi):
    ...
    def delete_collection_namespaced_daemon_set(
        ...
        return self._delete_collection_namespaced_daemon_set_oapg(
            body=body,
