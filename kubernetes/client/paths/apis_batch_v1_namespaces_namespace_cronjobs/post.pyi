...
from client.model.v1_cron_job import V1CronJob
...
# body param
SchemaForRequestBody = V1CronJob
...
SchemaFor202ResponseBodyApplicationJson = V1CronJob
SchemaFor202ResponseBodyApplicationYaml = V1CronJob
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1CronJob
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_cron_job_oapg(
        self,
...
class CreateNamespacedCronJob(BaseApi):
    ...
    def create_namespaced_cron_job(
        ...
        return self._create_namespaced_cron_job_oapg(
            body=body,
