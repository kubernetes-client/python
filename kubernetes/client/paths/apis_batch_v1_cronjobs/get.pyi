...
from client.model.v1_cron_job_list import V1CronJobList
...
SchemaFor200ResponseBodyApplicationJson = V1CronJobList
SchemaFor200ResponseBodyApplicationYaml = V1CronJobList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1CronJobList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1CronJobList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1CronJobList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_cron_job_for_all_namespaces_oapg(
        self,
...
class ListCronJobForAllNamespaces(BaseApi):
    ...
    def list_cron_job_for_all_namespaces(
        ...
        return self._list_cron_job_for_all_namespaces_oapg(
