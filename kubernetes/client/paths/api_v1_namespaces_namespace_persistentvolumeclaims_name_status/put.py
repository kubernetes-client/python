...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_namespaced_persistent_volume_claim_status_oapg(
        self,
...
class ReplaceNamespacedPersistentVolumeClaimStatus(BaseApi):
    ...
    def replace_namespaced_persistent_volume_claim_status(
        ...
        return self._replace_namespaced_persistent_volume_claim_status_oapg(
            body=body,
