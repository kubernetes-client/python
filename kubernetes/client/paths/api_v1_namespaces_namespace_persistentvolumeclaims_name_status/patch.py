...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_namespaced_persistent_volume_claim_status_oapg(
        self,
...
class PatchNamespacedPersistentVolumeClaimStatus(BaseApi):
    ...
    def patch_namespaced_persistent_volume_claim_status(
        ...
        return self._patch_namespaced_persistent_volume_claim_status_oapg(
            body=body,
