...
from client.model.v1_endpoint_slice_list import V1EndpointSliceList
...
SchemaFor200ResponseBodyApplicationJson = V1EndpointSliceList
SchemaFor200ResponseBodyApplicationYaml = V1EndpointSliceList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1EndpointSliceList
SchemaFor200ResponseBodyApplicationJsonstreamwatch = V1EndpointSliceList
SchemaFor200ResponseBodyApplicationVndKubernetesProtobufstreamwatch = V1EndpointSliceList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_endpoint_slice_for_all_namespaces_oapg(
        self,
...
class ListEndpointSliceForAllNamespaces(BaseApi):
    ...
    def list_endpoint_slice_for_all_namespaces(
        ...
        return self._list_endpoint_slice_for_all_namespaces_oapg(
