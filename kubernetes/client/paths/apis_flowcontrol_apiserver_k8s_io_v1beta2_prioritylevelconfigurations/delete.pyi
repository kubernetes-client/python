...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_collection_priority_level_configuration_oapg(
        self,
...
class DeleteCollectionPriorityLevelConfiguration(BaseApi):
    ...
    def delete_collection_priority_level_configuration(
        ...
        return self._delete_collection_priority_level_configuration_oapg(
            body=body,
