...
from client.model.v1_self_subject_rules_review import V1SelfSubjectRulesReview
...
# body param
SchemaForRequestBody = V1SelfSubjectRulesReview
...
SchemaFor200ResponseBodyApplicationJson = V1SelfSubjectRulesReview
SchemaFor200ResponseBodyApplicationYaml = V1SelfSubjectRulesReview
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1SelfSubjectRulesReview
...
SchemaFor201ResponseBodyApplicationJson = V1SelfSubjectRulesReview
SchemaFor201ResponseBodyApplicationYaml = V1SelfSubjectRulesReview
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1SelfSubjectRulesReview
...
SchemaFor202ResponseBodyApplicationJson = V1SelfSubjectRulesReview
SchemaFor202ResponseBodyApplicationYaml = V1SelfSubjectRulesReview
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1SelfSubjectRulesReview
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_self_subject_rules_review_oapg(
        self,
...
class CreateSelfSubjectRulesReview(BaseApi):
    ...
    def create_self_subject_rules_review(
        ...
        return self._create_self_subject_rules_review_oapg(
            body=body,
