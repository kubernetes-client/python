...
from client.model.v1_lease import V1Lease
...
SchemaFor200ResponseBodyApplicationJson = V1Lease
SchemaFor200ResponseBodyApplicationYaml = V1Lease
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V1Lease
...
SchemaFor201ResponseBodyApplicationJson = V1Lease
SchemaFor201ResponseBodyApplicationYaml = V1Lease
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V1Lease
...
SchemaFor202ResponseBodyApplicationJson = V1Lease
SchemaFor202ResponseBodyApplicationYaml = V1Lease
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V1Lease
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_lease_oapg(
        self,
...
class CreateNamespacedLease(BaseApi):
    ...
    def create_namespaced_lease(
        ...
        return self._create_namespaced_lease_oapg(
            body=body,
