...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_namespaced_horizontal_pod_autoscaler_oapg(
        self,
...
class DeleteNamespacedHorizontalPodAutoscaler(BaseApi):
    ...
    def delete_namespaced_horizontal_pod_autoscaler(
        ...
        return self._delete_namespaced_horizontal_pod_autoscaler_oapg(
            body=body,
