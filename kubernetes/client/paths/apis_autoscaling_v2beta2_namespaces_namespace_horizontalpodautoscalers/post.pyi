...
from client.model.v2beta2_horizontal_pod_autoscaler import V2beta2HorizontalPodAutoscaler
...
# body param
SchemaForRequestBody = V2beta2HorizontalPodAutoscaler
...
SchemaFor200ResponseBodyApplicationJson = V2beta2HorizontalPodAutoscaler
SchemaFor200ResponseBodyApplicationYaml = V2beta2HorizontalPodAutoscaler
SchemaFor200ResponseBodyApplicationVndKubernetesProtobuf = V2beta2HorizontalPodAutoscaler
...
SchemaFor201ResponseBodyApplicationJson = V2beta2HorizontalPodAutoscaler
SchemaFor201ResponseBodyApplicationYaml = V2beta2HorizontalPodAutoscaler
SchemaFor201ResponseBodyApplicationVndKubernetesProtobuf = V2beta2HorizontalPodAutoscaler
...
SchemaFor202ResponseBodyApplicationJson = V2beta2HorizontalPodAutoscaler
SchemaFor202ResponseBodyApplicationYaml = V2beta2HorizontalPodAutoscaler
SchemaFor202ResponseBodyApplicationVndKubernetesProtobuf = V2beta2HorizontalPodAutoscaler
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_namespaced_horizontal_pod_autoscaler_oapg(
        self,
...
class CreateNamespacedHorizontalPodAutoscaler(BaseApi):
    ...
    def create_namespaced_horizontal_pod_autoscaler(
        ...
        return self._create_namespaced_horizontal_pod_autoscaler_oapg(
            body=body,
