...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_certificate_signing_request_approval_oapg(
        self,
...
class ReadCertificateSigningRequestApproval(BaseApi):
    ...
    def read_certificate_signing_request_approval(
        ...
        return self._read_certificate_signing_request_approval_oapg(
