...
class BaseApi(api_client.Api):
    @typing.overload
    def _replace_certificate_signing_request_approval_oapg(
        self,
...
class ReplaceCertificateSigningRequestApproval(BaseApi):
    ...
    def replace_certificate_signing_request_approval(
        ...
        return self._replace_certificate_signing_request_approval_oapg(
            body=body,
