...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_certificate_signing_request_approval_oapg(
        self,
...
class PatchCertificateSigningRequestApproval(BaseApi):
    ...
    def patch_certificate_signing_request_approval(
        ...
        return self._patch_certificate_signing_request_approval_oapg(
            body=body,
