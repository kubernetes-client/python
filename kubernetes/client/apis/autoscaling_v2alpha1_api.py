...
class AutoscalingV2alpha1Api(object):
    ...
    def create_namespaced_horizontal_pod_autoscaler_with_http_info(self, namespace, body, **kwargs):
        ...
        resource_path = '/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_namespaced_horizontal_pod_autoscaler_with_http_info(self, name, namespace, body, **kwargs):
        ...
        resource_path = '/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
    ...
    def list_horizontal_pod_autoscaler_for_all_namespaces_with_http_info(self, **kwargs):
        ...
        resource_path = '/apis/autoscaling/v2alpha1/horizontalpodautoscalers'.replace('{format}', 'json')
        path_params = {}
    ...
    def patch_namespaced_horizontal_pod_autoscaler_status_with_http_info(self, name, namespace, body, **kwargs):
        ...
        resource_path = '/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
