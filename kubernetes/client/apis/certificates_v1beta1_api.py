...
class CertificatesV1beta1Api(object):
    ...
    def replace_certificate_signing_request_approval_with_http_info(self, name, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.replace_certificate_signing_request_approval_with_http_info(name, body, callback=callback_function)
    ...
    def replace_certificate_signing_request_status(self, name, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.replace_certificate_signing_request_status(name, body, callback=callback_function)
    ...
    def replace_certificate_signing_request_status_with_http_info(self, name, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.replace_certificate_signing_request_status_with_http_info(name, body, callback=callback_function)
