    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return V1beta1MutatingWebhookConfigurationList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.v1beta1/mutating_webhook_configuration.v1beta1.MutatingWebhookConfiguration(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            uid = '0', ), 
                        webhooks = [
                            kubernetes.client.models.v1beta1/mutating_webhook.v1beta1.MutatingWebhook(
