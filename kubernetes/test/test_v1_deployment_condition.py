...
import client
from client.models.v1_deployment_condition import V1DeploymentCondition  # noqa: E501
...
class TestV1DeploymentCondition(unittest.TestCase):
    ...
    def testV1DeploymentCondition(self):
        ...
        # model = client.models.v1_deployment_condition.V1DeploymentCondition()  # noqa: E501
        pass
