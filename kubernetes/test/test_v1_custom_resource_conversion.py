...
import client
from client.models.v1_custom_resource_conversion import V1CustomResourceConversion  # noqa: E501
...
class TestV1CustomResourceConversion(unittest.TestCase):
    ...
    def testV1CustomResourceConversion(self):
        ...
        # model = client.models.v1_custom_resource_conversion.V1CustomResourceConversion()  # noqa: E501
        pass
