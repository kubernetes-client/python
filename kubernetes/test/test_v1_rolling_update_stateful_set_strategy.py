...
import client
from client.models.v1_rolling_update_stateful_set_strategy import V1RollingUpdateStatefulSetStrategy  # noqa: E501
...
class TestV1RollingUpdateStatefulSetStrategy(unittest.TestCase):
    ...
    def testV1RollingUpdateStatefulSetStrategy(self):
        ...
        # model = client.models.v1_rolling_update_stateful_set_strategy.V1RollingUpdateStatefulSetStrategy()  # noqa: E501
        pass
