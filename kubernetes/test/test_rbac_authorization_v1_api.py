...
import client
from client.api.rbac_authorization_v1_api import RbacAuthorizationV1Api  # noqa: E501
...
class TestRbacAuthorizationV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = client.api.rbac_authorization_v1_api.RbacAuthorizationV1Api()  # noqa: E501
