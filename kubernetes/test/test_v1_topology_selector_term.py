...
import client
from client.models.v1_topology_selector_term import V1TopologySelectorTerm  # noqa: E501
...
class TestV1TopologySelectorTerm(unittest.TestCase):
    ...
    def testV1TopologySelectorTerm(self):
        ...
        # model = client.models.v1_topology_selector_term.V1TopologySelectorTerm()  # noqa: E501
        pass
