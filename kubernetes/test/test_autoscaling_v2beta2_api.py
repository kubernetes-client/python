...
from kubernetes.client.apis.autoscaling_v2beta2_api import AutoscalingV2beta2Api
...
class TestAutoscalingV2beta2Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.apis.autoscaling_v2beta2_api.AutoscalingV2beta2Api()
