...
import client
from client.api.autoscaling_v2beta2_api import AutoscalingV2beta2Api  # noqa: E501
...
class TestAutoscalingV2beta2Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = client.api.autoscaling_v2beta2_api.AutoscalingV2beta2Api()  # noqa: E501
