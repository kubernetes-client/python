...
from kubernetes.client.apis.scheduling_v1beta1_api import SchedulingV1beta1Api
...
class TestSchedulingV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.apis.scheduling_v1beta1_api.SchedulingV1beta1Api()
