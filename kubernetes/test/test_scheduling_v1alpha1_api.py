...
import client
from client.api.scheduling_v1alpha1_api import SchedulingV1alpha1Api  # noqa: E501
...
class TestSchedulingV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = client.api.scheduling_v1alpha1_api.SchedulingV1alpha1Api()  # noqa: E501
