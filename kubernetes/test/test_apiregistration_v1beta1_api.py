...
from kubernetes.client.apis.apiregistration_v1beta1_api import ApiregistrationV1beta1Api
...
class TestApiregistrationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.apis.apiregistration_v1beta1_api.ApiregistrationV1beta1Api()
