...
from kubernetes.client.apis.coordination_v1beta1_api import CoordinationV1beta1Api
...
class TestCoordinationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.apis.coordination_v1beta1_api.CoordinationV1beta1Api()
