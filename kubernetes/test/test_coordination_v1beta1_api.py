...
import client
from client.api.coordination_v1beta1_api import CoordinationV1beta1Api  # noqa: E501
...
class TestCoordinationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = client.api.coordination_v1beta1_api.CoordinationV1beta1Api()  # noqa: E501
