...
import client
from client.models.v1_topology_spread_constraint import V1TopologySpreadConstraint  # noqa: E501
...
class TestV1TopologySpreadConstraint(unittest.TestCase):
    ...
    def testV1TopologySpreadConstraint(self):
        ...
        # model = client.models.v1_topology_spread_constraint.V1TopologySpreadConstraint()  # noqa: E501
        pass
