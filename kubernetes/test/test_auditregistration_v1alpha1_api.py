...
import client
from client.api.auditregistration_v1alpha1_api import AuditregistrationV1alpha1Api  # noqa: E501
...
class TestAuditregistrationV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = client.api.auditregistration_v1alpha1_api.AuditregistrationV1alpha1Api()  # noqa: E501
