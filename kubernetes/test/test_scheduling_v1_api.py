...
from kubernetes.client.api.scheduling_v1_api import SchedulingV1Api  # noqa: E501
...
class TestSchedulingV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.scheduling_v1_api.SchedulingV1Api()  # noqa: E501
