...
from kubernetes.client.api.coordination_v1_api import CoordinationV1Api  # noqa: E501
...
class TestCoordinationV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.coordination_v1_api.CoordinationV1Api()  # noqa: E501
