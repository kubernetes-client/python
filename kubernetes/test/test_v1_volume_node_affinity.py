...
import client
from client.models.v1_volume_node_affinity import V1VolumeNodeAffinity  # noqa: E501
...
class TestV1VolumeNodeAffinity(unittest.TestCase):
    ...
    def testV1VolumeNodeAffinity(self):
        ...
        # model = client.models.v1_volume_node_affinity.V1VolumeNodeAffinity()  # noqa: E501
        pass
