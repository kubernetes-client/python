...
import client
from client.models.v1_custom_resource_validation import V1CustomResourceValidation  # noqa: E501
...
class TestV1CustomResourceValidation(unittest.TestCase):
    ...
    def testV1CustomResourceValidation(self):
        ...
        # model = client.models.v1_custom_resource_validation.V1CustomResourceValidation()  # noqa: E501
        pass
