    ...
    def make_instance(self, include_optional) -> V1ValidatingAdmissionPolicyList:
        ...
        if include_optional:
            return V1ValidatingAdmissionPolicyList(
                api_version = '',
                items = [
                    kubernetes.client.models.v1/validating_admission_policy.v1.ValidatingAdmissionPolicy(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes.client.models.v1/validating_admission_policy_spec.v1.ValidatingAdmissionPolicySpec(
                            audit_annotations = [
                        ...
                        status = kubernetes.client.models.v1/validating_admission_policy_status.v1.ValidatingAdmissionPolicyStatus(
                            conditions = [
