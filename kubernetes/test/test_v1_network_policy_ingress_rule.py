...
import client
from client.models.v1_network_policy_ingress_rule import V1NetworkPolicyIngressRule  # noqa: E501
...
class TestV1NetworkPolicyIngressRule(unittest.TestCase):
    ...
    def testV1NetworkPolicyIngressRule(self):
        ...
        # model = client.models.v1_network_policy_ingress_rule.V1NetworkPolicyIngressRule()  # noqa: E501
        pass
