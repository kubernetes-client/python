...
import client
from client.models.v1_token_request_status import V1TokenRequestStatus  # noqa: E501
...
class TestV1TokenRequestStatus(unittest.TestCase):
    ...
    def testV1TokenRequestStatus(self):
        ...
        # model = client.models.v1_token_request_status.V1TokenRequestStatus()  # noqa: E501
        pass
