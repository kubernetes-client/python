...
import client
from client.models.v1_volume_attachment_source import V1VolumeAttachmentSource  # noqa: E501
...
class TestV1VolumeAttachmentSource(unittest.TestCase):
    ...
    def testV1VolumeAttachmentSource(self):
        ...
        # model = client.models.v1_volume_attachment_source.V1VolumeAttachmentSource()  # noqa: E501
        pass
