...
from kubernetes.client.apis.networking_v1beta1_api import NetworkingV1beta1Api
...
class TestNetworkingV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.apis.networking_v1beta1_api.NetworkingV1beta1Api()
