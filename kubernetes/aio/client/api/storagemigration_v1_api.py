...
class StoragemigrationV1Api:
    ...
    async def create_storage_version_migration(
        ...
        :param body: (required)
        :type body: V1StorageVersionMigration
        ...
        _param = await self._create_storage_version_migration_serialize(
            body=body,
            pretty=pretty,
            dry_run=dry_run,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '201': "V1StorageVersionMigration",
            '202': "V1StorageVersionMigration",
            '401': None,
        }
    ...
    async def create_storage_version_migration_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1StorageVersionMigration]:
        """create_storage_version_migration
    ...
    async def _create_storage_version_migration_serialize(
        self,
        body,
        pretty,
        dry_run,
        ...
        return await self.api_client.param_serialize(
            method='POST',
            resource_path='/apis/storagemigration.k8s.io/v1/storageversionmigrations',
    ...
    async def delete_collection_storage_version_migration(
        ...
        _param = await self._delete_collection_storage_version_migration_serialize(
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    async def _delete_collection_storage_version_migration_serialize(
        self,
        pretty,
        _continue,
        dry_run,
    ...
    async def _delete_storage_version_migration_serialize(
        self,
        name,
        pretty,
        dry_run,
        ...
        return await self.api_client.param_serialize(
            method='DELETE',
            resource_path='/apis/storagemigration.k8s.io/v1/storageversionmigrations/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def _get_api_resources_serialize(
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/apis/storagemigration.k8s.io/v1/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def list_storage_version_migration(
        ...
        _param = await self._list_storage_version_migration_serialize(
            pretty=pretty,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1StorageVersionMigrationList",
            '401': None,
        }
        response_data = await self.api_client.call_api(
            *_param,
    ...
    async def list_storage_version_migration_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1StorageVersionMigrationList]:
        """list_storage_version_migration
    ...
    async def _list_storage_version_migration_serialize(
        self,
        pretty,
    ...
    async def patch_storage_version_migration(
        ...
        _param = await self._patch_storage_version_migration_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _patch_storage_version_migration_serialize(
        self,
        name,
        body,
        pretty,
    ...
    async def patch_storage_version_migration_status(
        ...
        _param = await self._patch_storage_version_migration_status_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _patch_storage_version_migration_status_serialize(
        self,
        name,
        body,
        pretty,
        ...
        return await self.api_client.param_serialize(
            method='PATCH',
            resource_path='/apis/storagemigration.k8s.io/v1/storageversionmigrations/{name}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def read_storage_version_migration(
        ...
        _param = await self._read_storage_version_migration_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def _read_storage_version_migration_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    async def read_storage_version_migration_status(
        ...
        _param = await self._read_storage_version_migration_status_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def _read_storage_version_migration_status_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    async def replace_storage_version_migration(
        ...
        _param = await self._replace_storage_version_migration_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _replace_storage_version_migration_serialize(
        self,
        name,
        body,
        pretty,
    ...
    async def replace_storage_version_migration_status(
        ...
        _param = await self._replace_storage_version_migration_status_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _replace_storage_version_migration_status_serialize(
        self,
        name,
        body,
        pretty,
