...
class LogsApi:
    ...
    async def log_file_handler(
        ...
        _param = await self._log_file_handler_serialize(
            logpath=logpath,
    ...
    async def _log_file_handler_serialize(
        self,
        logpath,
        _request_auth,
        _content_type,
    ...
    async def log_file_list_handler(
        ...
        _param = await self._log_file_list_handler_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    async def _log_file_list_handler_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
