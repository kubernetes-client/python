...
class DiscoveryV1Api:
    ...
    async def create_namespaced_endpoint_slice(
        ...
        _param = await self._create_namespaced_endpoint_slice_serialize(
            namespace=namespace,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _create_namespaced_endpoint_slice_serialize(
        self,
        namespace,
        body,
        pretty,
    ...
    async def delete_collection_namespaced_endpoint_slice(
        ...
        _param = await self._delete_collection_namespaced_endpoint_slice_serialize(
            namespace=namespace,
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    async def _delete_collection_namespaced_endpoint_slice_serialize(
        self,
        namespace,
        pretty,
        _continue,
    ...
    async def delete_namespaced_endpoint_slice(
        ...
        _param = await self._delete_namespaced_endpoint_slice_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _delete_namespaced_endpoint_slice_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    async def list_endpoint_slice_for_all_namespaces(
        ...
        _param = await self._list_endpoint_slice_for_all_namespaces_serialize(
    ...
    async def _list_endpoint_slice_for_all_namespaces_serialize(
        self,
    ...
    async def list_namespaced_endpoint_slice(
        ...
        _param = await self._list_namespaced_endpoint_slice_serialize(
            namespace=namespace,
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
    ...
    async def _list_namespaced_endpoint_slice_serialize(
        self,
        namespace,
        pretty,
        allow_watch_bookmarks,
    ...
    async def patch_namespaced_endpoint_slice(
        ...
        _param = await self._patch_namespaced_endpoint_slice_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    async def _patch_namespaced_endpoint_slice_serialize(
        self,
        name,
        namespace,
        body,
    ...
    async def read_namespaced_endpoint_slice(
        ...
        _param = await self._read_namespaced_endpoint_slice_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    async def _read_namespaced_endpoint_slice_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    async def replace_namespaced_endpoint_slice(
        ...
        _param = await self._replace_namespaced_endpoint_slice_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    async def _replace_namespaced_endpoint_slice_serialize(
        self,
        name,
        namespace,
        body,
