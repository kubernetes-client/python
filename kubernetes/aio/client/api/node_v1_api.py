...
class NodeV1Api:
    ...
    async def create_runtime_class(
        ...
        _param = await self._create_runtime_class_serialize(
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _create_runtime_class_serialize(
        self,
        body,
        pretty,
        dry_run,
    ...
    async def delete_collection_runtime_class(
        ...
        _param = await self._delete_collection_runtime_class_serialize(
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    async def _delete_collection_runtime_class_serialize(
        self,
        pretty,
        _continue,
        dry_run,
    ...
    async def delete_runtime_class(
        ...
        _param = await self._delete_runtime_class_serialize(
            name=name,
            pretty=pretty,
            dry_run=dry_run,
            grace_period_seconds=grace_period_seconds,
    ...
    async def _delete_runtime_class_serialize(
        self,
        name,
        pretty,
        dry_run,
    ...
    async def list_runtime_class(
        ...
        _param = await self._list_runtime_class_serialize(
            pretty=pretty,
    ...
    async def _list_runtime_class_serialize(
        self,
        pretty,
    ...
    async def patch_runtime_class(
        ...
        _param = await self._patch_runtime_class_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _patch_runtime_class_serialize(
        self,
        name,
        body,
        pretty,
    ...
    async def read_runtime_class(
        ...
        _param = await self._read_runtime_class_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def _read_runtime_class_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    async def replace_runtime_class(
        ...
        _param = await self._replace_runtime_class_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _replace_runtime_class_serialize(
        self,
        name,
        body,
        pretty,
