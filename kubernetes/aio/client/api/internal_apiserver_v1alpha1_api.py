...
class InternalApiserverV1alpha1Api:
    ...
    async def create_storage_version(
        ...
        _param = await self._create_storage_version_serialize(
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _create_storage_version_serialize(
        self,
        body,
        pretty,
        dry_run,
    ...
    async def delete_collection_storage_version(
        ...
        _param = await self._delete_collection_storage_version_serialize(
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    async def _delete_collection_storage_version_serialize(
        self,
        pretty,
        _continue,
        dry_run,
    ...
    async def delete_storage_version(
        ...
        _param = await self._delete_storage_version_serialize(
            name=name,
            pretty=pretty,
            dry_run=dry_run,
            grace_period_seconds=grace_period_seconds,
    ...
    async def _delete_storage_version_serialize(
        self,
        name,
        pretty,
        dry_run,
    ...
    async def list_storage_version(
        ...
        _param = await self._list_storage_version_serialize(
            pretty=pretty,
    ...
    async def _list_storage_version_serialize(
        self,
        pretty,
    ...
    async def patch_storage_version(
        ...
        _param = await self._patch_storage_version_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _patch_storage_version_serialize(
        self,
        name,
        body,
        pretty,
    ...
    async def patch_storage_version_status(
        ...
        _param = await self._patch_storage_version_status_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _patch_storage_version_status_serialize(
        self,
        name,
        body,
        pretty,
    ...
    async def read_storage_version(
        ...
        _param = await self._read_storage_version_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def _read_storage_version_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    async def read_storage_version_status(
        ...
        _param = await self._read_storage_version_status_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def _read_storage_version_status_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    async def replace_storage_version(
        ...
        _param = await self._replace_storage_version_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _replace_storage_version_serialize(
        self,
        name,
        body,
        pretty,
    ...
    async def replace_storage_version_status(
        ...
        _param = await self._replace_storage_version_status_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _replace_storage_version_status_serialize(
        self,
        name,
        body,
        pretty,
