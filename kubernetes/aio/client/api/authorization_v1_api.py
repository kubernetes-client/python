...
class AuthorizationV1Api:
    ...
    async def create_namespaced_local_subject_access_review(
        ...
        _param = await self._create_namespaced_local_subject_access_review_serialize(
            namespace=namespace,
            body=body,
            dry_run=dry_run,
    ...
    async def _create_namespaced_local_subject_access_review_serialize(
        self,
        namespace,
        body,
        dry_run,
    ...
    async def create_self_subject_access_review(
        ...
        _param = await self._create_self_subject_access_review_serialize(
            body=body,
            dry_run=dry_run,
            field_manager=field_manager,
            field_validation=field_validation,
    ...
    async def _create_self_subject_access_review_serialize(
        self,
        body,
        dry_run,
        field_manager,
    ...
    async def create_self_subject_rules_review(
        ...
        _param = await self._create_self_subject_rules_review_serialize(
            body=body,
            dry_run=dry_run,
            field_manager=field_manager,
            field_validation=field_validation,
    ...
    async def _create_self_subject_rules_review_serialize(
        self,
        body,
        dry_run,
        field_manager,
    ...
    async def create_subject_access_review(
        ...
        _param = await self._create_subject_access_review_serialize(
            body=body,
            dry_run=dry_run,
            field_manager=field_manager,
            field_validation=field_validation,
    ...
    async def _create_subject_access_review_serialize(
        self,
        body,
        dry_run,
        field_manager,
