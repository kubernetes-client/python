...
class AuthenticationV1Api:
    ...
    async def create_self_subject_review(
        ...
        _param = await self._create_self_subject_review_serialize(
            body=body,
            dry_run=dry_run,
    ...
    async def _create_self_subject_review_serialize(
        self,
        body,
        dry_run,
        field_manager,
    ...
    async def create_token_review(
        ...
        _param = await self._create_token_review_serialize(
            body=body,
            dry_run=dry_run,
            field_manager=field_manager,
            field_validation=field_validation,
    ...
    async def _create_token_review_serialize(
        self,
        body,
        dry_run,
        field_manager,
