...
class StorageV1beta1Api:
    ...
    async def create_volume_attributes_class(
        ...
        _param = await self._create_volume_attributes_class_serialize(
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _create_volume_attributes_class_serialize(
        self,
        body,
        pretty,
        dry_run,
    ...
    async def delete_collection_volume_attributes_class(
        ...
        _param = await self._delete_collection_volume_attributes_class_serialize(
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    async def _delete_collection_volume_attributes_class_serialize(
        self,
        pretty,
        _continue,
        dry_run,
    ...
    async def delete_volume_attributes_class(
        ...
        _param = await self._delete_volume_attributes_class_serialize(
            name=name,
            pretty=pretty,
            dry_run=dry_run,
            grace_period_seconds=grace_period_seconds,
    ...
    async def _delete_volume_attributes_class_serialize(
        self,
        name,
        pretty,
        dry_run,
    ...
    async def list_volume_attributes_class(
        ...
        _param = await self._list_volume_attributes_class_serialize(
            pretty=pretty,
    ...
    async def _list_volume_attributes_class_serialize(
        self,
        pretty,
    ...
    async def patch_volume_attributes_class(
        ...
        _param = await self._patch_volume_attributes_class_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _patch_volume_attributes_class_serialize(
        self,
        name,
        body,
        pretty,
    ...
    async def read_volume_attributes_class(
        ...
        _param = await self._read_volume_attributes_class_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def _read_volume_attributes_class_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    async def replace_volume_attributes_class(
        ...
        _param = await self._replace_volume_attributes_class_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    async def _replace_volume_attributes_class_serialize(
        self,
        name,
        body,
        pretty,
