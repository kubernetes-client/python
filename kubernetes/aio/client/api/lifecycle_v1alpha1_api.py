...
import warnings
from pydantic import BaseModel, validate_call, Field, StrictFloat, StrictStr, StrictInt
...
class LifecycleV1alpha1Api:
    ...
    async def create_namespaced_eviction(
        self,
        ...
        _param = await self._create_namespaced_eviction_serialize(
            namespace=namespace,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1alpha1Eviction",
            '201': "V1alpha1Eviction",
            '202': "V1alpha1Eviction",
            '401': None,
        }
    ...
    @validate_call(config={'defer_build': True})
    async def create_namespaced_eviction_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def create_namespaced_eviction_without_preload_content(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _create_namespaced_eviction_serialize(
        self,
        namespace,
        body,
        pretty,
        ...
        return await self.api_client.param_serialize(
            method='POST',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/namespaces/{namespace}/evictions',
    ...
    @validate_call(config={'defer_build': True})
    async def create_namespaced_eviction_request(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        ...
        :type namespace: str
        :param body: (required)
        :type body: V1alpha1EvictionRequest
        :param pretty: If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
        :type pretty: str
        :param dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :type dry_run: str
        ...
        _param = await self._create_namespaced_eviction_request_serialize(
            namespace=namespace,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1alpha1EvictionRequest",
            '201': "V1alpha1EvictionRequest",
            '202': "V1alpha1EvictionRequest",
            '401': None,
        }
        response_data = await self.api_client.call_api(
            *_param,
    ...
    @validate_call(config={'defer_build': True})
    async def create_namespaced_eviction_request_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alpha1EvictionRequest]:
        """create_namespaced_eviction_request
    ...
    @validate_call(config={'defer_build': True})
    async def create_namespaced_eviction_request_without_preload_content(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _create_namespaced_eviction_request_serialize(
        self,
        namespace,
        body,
        pretty,
        ...
        return await self.api_client.param_serialize(
            method='POST',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/namespaces/{namespace}/evictionrequests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_collection_namespaced_eviction(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
        ...
        _param = await self._delete_collection_namespaced_eviction_serialize(
            namespace=namespace,
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_collection_namespaced_eviction_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_collection_namespaced_eviction_without_preload_content(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    async def _delete_collection_namespaced_eviction_serialize(
        self,
        namespace,
        pretty,
        _continue,
        ...
        if _continue is not None:
            ...
            _query_params.append(('continue', _continue))
        ...
        if shard_selector is not None:
            ...
            _query_params.append(('shardSelector', shard_selector))
    ...
    @validate_call(config={'defer_build': True})
    async def delete_collection_namespaced_eviction_request(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        ...
        _param = await self._delete_collection_namespaced_eviction_request_serialize(
            namespace=namespace,
            pretty=pretty,
            _continue=_continue,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_collection_namespaced_eviction_request_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_collection_namespaced_eviction_request_without_preload_content(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    async def _delete_collection_namespaced_eviction_request_serialize(
        self,
        namespace,
        pretty,
        _continue,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_namespaced_eviction(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
        grace_period_seconds: Annotated[Optional[StrictInt], Field(description="The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.")] = None,
        ...
        _param = await self._delete_namespaced_eviction_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_namespaced_eviction_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _delete_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        pretty,
        ...
        return await self.api_client.param_serialize(
            method='DELETE',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/namespaces/{namespace}/evictions/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_namespaced_eviction_request(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
        grace_period_seconds: Annotated[Optional[StrictInt], Field(description="The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.")] = None,
        ...
        :param name: name of the EvictionRequest (required)
        :type name: str
        :param namespace: object name and auth scope, such as for teams and projects (required)
        :type namespace: str
        :param pretty: If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
        ...
        _param = await self._delete_namespaced_eviction_request_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_namespaced_eviction_request_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def delete_namespaced_eviction_request_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _delete_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        pretty,
        ...
        return await self.api_client.param_serialize(
            method='DELETE',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/namespaces/{namespace}/evictionrequests/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_api_resources(
        ...
        _param = await self._get_api_resources_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    async def _get_api_resources_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call(config={'defer_build': True})
    async def list_eviction_for_all_namespaces(
        self,
        ...
        _param = await self._list_eviction_for_all_namespaces_serialize(
    ...
    @validate_call(config={'defer_build': True})
    async def list_eviction_for_all_namespaces_with_http_info(
        self,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alpha1EvictionList]:
        """list_eviction_for_all_namespaces
    ...
    @validate_call(config={'defer_build': True})
    async def list_eviction_for_all_namespaces_without_preload_content(
        self,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
    ...
    async def _list_eviction_for_all_namespaces_serialize(
        self,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/evictions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call(config={'defer_build': True})
    async def list_eviction_request_for_all_namespaces(
        self,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
        ...
        _param = await self._list_eviction_request_for_all_namespaces_serialize(
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
            field_selector=field_selector,
            label_selector=label_selector,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1alpha1EvictionRequestList",
            '401': None,
        }
        response_data = await self.api_client.call_api(
            *_param,
    ...
    @validate_call(config={'defer_build': True})
    async def list_eviction_request_for_all_namespaces_with_http_info(
        self,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alpha1EvictionRequestList]:
        """list_eviction_request_for_all_namespaces
    ...
    @validate_call(config={'defer_build': True})
    async def list_eviction_request_for_all_namespaces_without_preload_content(
        self,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        _continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
    ...
    async def _list_eviction_request_for_all_namespaces_serialize(
        self,
        allow_watch_bookmarks,
        _continue,
        field_selector,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/evictionrequests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call(config={'defer_build': True})
    async def list_namespaced_eviction(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        ...
        _param = await self._list_namespaced_eviction_serialize(
            namespace=namespace,
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
    ...
    @validate_call(config={'defer_build': True})
    async def list_namespaced_eviction_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def list_namespaced_eviction_without_preload_content(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
    ...
    async def _list_namespaced_eviction_serialize(
        self,
        namespace,
        pretty,
        allow_watch_bookmarks,
    ...
    @validate_call(config={'defer_build': True})
    async def list_namespaced_eviction_request(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        ...
        _param = await self._list_namespaced_eviction_request_serialize(
            namespace=namespace,
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
    ...
    @validate_call(config={'defer_build': True})
    async def list_namespaced_eviction_request_with_http_info(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def list_namespaced_eviction_request_without_preload_content(
        self,
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
    ...
    async def _list_namespaced_eviction_request_serialize(
        self,
        namespace,
        pretty,
        allow_watch_bookmarks,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        ...
        _param = await self._patch_namespaced_eviction_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    async def _patch_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_request(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
        ...
        _param = await self._patch_namespaced_eviction_request_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_request_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_request_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    async def _patch_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_request_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
        ...
        _param = await self._patch_namespaced_eviction_request_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_request_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    async def _patch_namespaced_eviction_request_status_serialize(
        self,
        name,
        namespace,
        body,
        ...
        return await self.api_client.param_serialize(
            method='PATCH',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/namespaces/{namespace}/evictionrequests/{name}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
        ...
        _param = await self._patch_namespaced_eviction_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    @validate_call(config={'defer_build': True})
    async def patch_namespaced_eviction_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: Union[Dict[str, Any], List[Dict[str, Any]], BaseModel],
    ...
    async def _patch_namespaced_eviction_status_serialize(
        self,
        name,
        namespace,
        body,
        ...
        return await self.api_client.param_serialize(
            method='PATCH',
            resource_path='/apis/lifecycle.k8s.io/v1alpha1/namespaces/{namespace}/evictions/{name}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _param = await self._read_namespaced_eviction_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _read_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_request(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _param = await self._read_namespaced_eviction_request_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_request_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_request_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _read_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_request_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _param = await self._read_namespaced_eviction_request_status_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_request_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _read_namespaced_eviction_request_status_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        ...
        _param = await self._read_namespaced_eviction_status_serialize(
            name=name,
            namespace=namespace,
            pretty=pretty,
            _request_auth=_request_auth,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call(config={'defer_build': True})
    async def read_namespaced_eviction_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    async def _read_namespaced_eviction_status_serialize(
        self,
        name,
        namespace,
        pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
        ...
        _param = await self._replace_namespaced_eviction_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
    ...
    async def _replace_namespaced_eviction_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_request(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
        ...
        _param = await self._replace_namespaced_eviction_request_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_request_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_request_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
    ...
    async def _replace_namespaced_eviction_request_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_request_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
        ...
        _param = await self._replace_namespaced_eviction_request_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_request_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the EvictionRequest")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1EvictionRequest,
    ...
    async def _replace_namespaced_eviction_request_status_serialize(
        self,
        name,
        namespace,
        body,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_status(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
        ...
        _param = await self._replace_namespaced_eviction_status_serialize(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
    ...
    @validate_call(config={'defer_build': True})
    async def replace_namespaced_eviction_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the Eviction")],
        namespace: Annotated[StrictStr, Field(description="object name and auth scope, such as for teams and projects")],
        body: V1alpha1Eviction,
    ...
    async def _replace_namespaced_eviction_status_serialize(
        self,
        name,
        namespace,
        body,
