...
class V1PodResourceClaim(BaseModel):
    ...
    def __preprocess_input_names(
        ...
        if "resourceClaimTemplateName" not in obj and "resource_claim_template_name" in obj:
            obj["resourceClaimTemplateName"] = obj["resource_claim_template_name"]
        obj.pop("resource_claim_template_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("resourceClaimTemplateName" if serialize else "resource_claim_template_name"): _to_legacy_value(getattr(self, "resource_claim_template_name", None), serialize),
        }
