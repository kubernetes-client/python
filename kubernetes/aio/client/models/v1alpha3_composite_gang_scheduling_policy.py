...
class V1alpha3CompositeGangSchedulingPolicy(BaseModel):
    """
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "minGroupCount" not in obj and "min_group_count" in obj:
            obj["minGroupCount"] = obj["min_group_count"]
        obj.pop("min_group_count", None)
        return obj
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3CompositeGangSchedulingPolicy):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("minGroupCount" if serialize else "min_group_count"): _to_legacy_value(getattr(self, "min_group_count", None), serialize),
        }
