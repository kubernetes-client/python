...
class V1ResourceRule(BaseModel):
    ...
    """ # noqa: E501
    api_groups: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("apiGroups", "api_groups"), serialization_alias="apiGroups", description="apiGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one of the enumerated resources in any API group will be allowed.  \"*\" means all.")
    resource_names: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("resourceNames", "resource_names"), serialization_alias="resourceNames", description="resourceNames is an optional white list of names that the rule applies to.  An empty set means that everything is allowed.  \"*\" means all.")
    ...
    verbs: List[StrictStr] = Field(description="verbs is a list of kubernetes resource API verbs, like: get, list, watch, create, update, delete, proxy.  \"*\" means all.")
