...
class V1Capabilities(BaseModel):
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("add" if serialize else "add"): _to_legacy_value(getattr(self, "add", None), serialize),
            ("drop" if serialize else "drop"): _to_legacy_value(getattr(self, "drop", None), serialize),
        }
