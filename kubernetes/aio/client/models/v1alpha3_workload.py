...
class V1alpha3Workload(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3Workload):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha3WorkloadSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
