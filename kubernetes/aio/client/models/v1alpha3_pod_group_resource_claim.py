...
class V1alpha3PodGroupResourceClaim(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3PodGroupResourceClaim):
            return False
