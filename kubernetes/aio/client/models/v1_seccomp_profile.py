...
class V1SeccompProfile(BaseModel):
    ...
    """ # noqa: E501
    localhost_profile: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("localhostProfile", "localhost_profile"), serialization_alias="localhostProfile", description="localhostProfile indicates a profile defined in a file on the node should be used. The profile must be preconfigured on the node to work. Must be a descending path, relative to the kubelet's configured seccomp profile location. Must be set if type is \"Localhost\". Must NOT be set for any other type.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "localhostProfile" not in obj and "localhost_profile" in obj:
            obj["localhostProfile"] = obj["localhost_profile"]
        obj.pop("localhost_profile", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("localhostProfile" if serialize else "localhost_profile"): _to_legacy_value(getattr(self, "localhost_profile", None), serialize),
