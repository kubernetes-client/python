...
class V1ModifyVolumeStatus(BaseModel):
    ...
    target_volume_attributes_class_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("targetVolumeAttributesClassName", "target_volume_attributes_class_name"), serialization_alias="targetVolumeAttributesClassName", description="targetVolumeAttributesClassName is the name of the VolumeAttributesClass the PVC currently being reconciled")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "targetVolumeAttributesClassName" not in obj and "target_volume_attributes_class_name" in obj:
            obj["targetVolumeAttributesClassName"] = obj["target_volume_attributes_class_name"]
        obj.pop("target_volume_attributes_class_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("targetVolumeAttributesClassName" if serialize else "target_volume_attributes_class_name"): _to_legacy_value(getattr(self, "target_volume_attributes_class_name", None), serialize),
        }
