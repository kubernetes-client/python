...
class V1ResourceFieldSelector(BaseModel):
    ...
    """ # noqa: E501
    container_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("containerName", "container_name"), serialization_alias="containerName", description="Container name: required for volumes, optional for env vars")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("divisor" if serialize else "divisor"): _to_legacy_value(getattr(self, "divisor", None), serialize),
