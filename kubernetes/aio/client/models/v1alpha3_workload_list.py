...
class V1alpha3WorkloadList(BaseModel):
    """
    ...
    items: List[V1alpha3Workload] = Field(description="Items is the list of Workloads.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3WorkloadList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha3Workload.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
