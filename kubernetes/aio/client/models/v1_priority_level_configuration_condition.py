...
class V1PriorityLevelConfigurationCondition(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="`status` is the status of the condition. Should be specified and set to one of True, False, Unknown.")
    type: StrictStr = Field(description="`type` is the type of the condition. Required.")
