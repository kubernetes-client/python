...
class V1beta1PodGroup(BaseModel):
    """
    ...
    status: Optional[V1beta1PodGroupStatus] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1PodGroup):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta1PodGroupSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1beta1PodGroupStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
