...
class V1ExactDeviceRequest(BaseModel):
    ...
    capacity: Optional[V1CapacityRequirements] = None
    ...
    selectors: Optional[List[V1DeviceSelector]] = Field(default=None, description="Selectors define criteria which must be satisfied by a specific device in order for that device to be considered for this request. All selectors must be satisfied for a device to be considered.")
    tolerations: Optional[List[V1DeviceToleration]] = Field(default=None, description="If specified, the request's tolerations.  Tolerations for NoSchedule are required to allocate a device which has a taint with that effect. The same applies to NoExecute.  In addition, should any of the allocated devices get tainted with NoExecute after allocation and that effect is not tolerated, then all pods consuming the ResourceClaim get deleted to evict them. The scheduler will not let new pods reserve the claim while it has these tainted devices. Once all pods are evicted, the claim will get deallocated.  The maximum number of tolerations is 16.  This is a beta field and requires enabling the DRADeviceTaints feature gate.")
    openapi_types: ClassVar[Dict[str, str]] = {
        "admin_access": "bool",
        "allocation_mode": "str",
        "capacity": "V1CapacityRequirements",
        "count": "int",
        "derived_attributes": "List[V1DeviceDerivedAttribute]",
    ...
    __properties: ClassVar[List[str]] = ["adminAccess", "allocationMode", "capacity", "count", "derivedAttributes", "deviceClassName", "selectors", "tolerations"]
    ...
    def __preprocess_input_names(
        ...
        if "derivedAttributes" not in obj and "derived_attributes" in obj:
            obj["derivedAttributes"] = obj["derived_attributes"]
        obj.pop("derived_attributes", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("derivedAttributes" if serialize else "derived_attributes"): _to_legacy_value(getattr(self, "derived_attributes", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in derived_attributes (list)
        _items = []
        if self.derived_attributes:
            for _item_derived_attributes in self.derived_attributes:
                _items.append(_to_openapi_value(_item_derived_attributes) if _item_derived_attributes is not None else None)
            _dict['derivedAttributes'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "capacity": V1CapacityRequirements.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            "count": obj.get("count"),
            "derivedAttributes": [V1DeviceDerivedAttribute.from_dict(_item) for _item in obj["derivedAttributes"]] if obj.get("derivedAttributes") is not None else None,
