...
class V1beta1DeviceCounterConsumption(BaseModel):
    ...
    counters: Dict[str, V1beta1Counter] = Field(description="Counters defines the counters that will be consumed by the device.  The maximum number of counters is 32.")
