...
class V1PodCertificateRequestList(BaseModel):
    """
    ...
    items: List[V1PodCertificateRequest] = Field(description="items is a collection of PodCertificateRequest objects")
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        "api_version": "str",
        "items": "List[V1PodCertificateRequest]",
        "kind": "str",
        "metadata": "V1ListMeta"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1PodCertificateRequestList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1PodCertificateRequest.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
