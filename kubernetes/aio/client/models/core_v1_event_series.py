...
class CoreV1EventSeries(BaseModel):
    ...
    last_observed_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastObservedTime", "last_observed_time"), serialization_alias="lastObservedTime", description="Time of the last occurrence observed")
