...
class V1beta2ResourceSliceSpec(BaseModel):
    ...
    devices: Optional[List[V1beta2Device]] = Field(default=None, description="Devices lists some or all of the devices in this pool.  Must not have more than 128 entries. If any device uses taints or consumes counters the limit is 64.  Only one of Devices and SharedCounters can be set in a ResourceSlice.")
