...
class V1beta2NodeAllocatableResource(BaseModel):
    """
    ...
    """ # noqa: E501
    mapping: Optional[V1beta2NodeAllocatableMapping] = None
    overhead: Optional[V1beta2NodeAllocatableOverhead] = None
    ...
    __properties: ClassVar[List[str]] = ["mapping", "overhead"]
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta2NodeAllocatableResource):
            return False
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.mapping:
            _dict['mapping'] = _to_openapi_value(self.mapping)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mapping": V1beta2NodeAllocatableMapping.from_dict(obj["mapping"]) if obj.get("mapping") is not None else None,
            "overhead": V1beta2NodeAllocatableOverhead.from_dict(obj["overhead"]) if obj.get("overhead") is not None else None
        })
        return _obj
