...
class V1beta1PodGroupSchedulingPolicy(BaseModel):
    """
    ...
    gang: Optional[V1beta1GangSchedulingPolicy] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1PodGroupSchedulingPolicy):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic": obj.get("basic"),
            "gang": V1beta1GangSchedulingPolicy.from_dict(obj["gang"]) if obj.get("gang") is not None else None
        })
        return _obj
