...
class V2HPAScalingPolicy(BaseModel):
    ...
    """ # noqa: E501
    period_seconds: StrictInt = Field(validation_alias=AliasChoices("periodSeconds", "period_seconds"), serialization_alias="periodSeconds", description="periodSeconds specifies the window of time for which the policy should hold true. PeriodSeconds must be greater than zero and less than or equal to 1800 (30 min).")
