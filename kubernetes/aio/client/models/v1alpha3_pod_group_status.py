...
class V1alpha3PodGroupStatus(BaseModel):
    """
    ...
    """ # noqa: E501
    conditions: Optional[List[V1Condition]] = Field(default=None, description="conditions represent the latest observations of the PodGroup's state.  Known condition types: - \"PodGroupInitiallyScheduled\": Indicates whether the scheduling requirement has been satisfied. Once this condition transitions to True, it serves as a terminal state and will never revert to False, even if pods are subsequently evicted and group constraints are no longer met. - \"DisruptionTarget\": Indicates whether the PodGroup is about to be terminated   due to disruption such as preemption.  Known reasons for the PodGroupInitiallyScheduled condition: - \"Unschedulable\": The PodGroup cannot be scheduled due to resource constraints,   affinity/anti-affinity rules, or insufficient capacity for the gang. - \"SchedulerError\": The PodGroup cannot be scheduled due to some internal error   that happened during scheduling, for example due to nodeAffinity parsing errors.  Known reasons for the DisruptionTarget condition: - \"PreemptionByScheduler\": The PodGroup was preempted by the scheduler to make room for   higher-priority PodGroups or Pods.")
    resource_claim_statuses: Optional[List[V1alpha3PodGroupResourceClaimStatus]] = Field(default=None, validation_alias=AliasChoices("resourceClaimStatuses", "resource_claim_statuses"), serialization_alias="resourceClaimStatuses", description="resourceClaimStatuses is status of resource claims.")
    openapi_types: ClassVar[Dict[str, str]] = {
        "conditions": "List[V1Condition]",
        "resource_claim_statuses": "List[V1alpha3PodGroupResourceClaimStatus]"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3PodGroupStatus):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resourceClaimStatuses": [V1alpha3PodGroupResourceClaimStatus.from_dict(_item) for _item in obj["resourceClaimStatuses"]] if obj.get("resourceClaimStatuses") is not None else None
        })
        return _obj
