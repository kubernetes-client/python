...
class V1VolumeAttributesClass(BaseModel):
    """
    ...
    driver_name: StrictStr = Field(validation_alias=AliasChoices("driverName", "driver_name"), serialization_alias="driverName", description="driverName is the name of the CSI driver This field is immutable.")
    ...
    def __preprocess_input_names(
        ...
        if "driverName" not in obj and "driver_name" in obj:
            obj["driverName"] = obj["driver_name"]
        obj.pop("driver_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("driverName" if serialize else "driver_name"): _to_legacy_value(getattr(self, "driver_name", None), serialize),
