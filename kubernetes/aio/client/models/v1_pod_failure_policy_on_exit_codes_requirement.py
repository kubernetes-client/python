...
class V1PodFailurePolicyOnExitCodesRequirement(BaseModel):
    ...
    """ # noqa: E501
    container_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("containerName", "container_name"), serialization_alias="containerName", description="Restricts the check for exit codes to the container with the specified name. When null, the rule applies to all containers. When specified, it should match one the container or initContainer names in the pod template.")
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("values" if serialize else "values"): _to_legacy_value(getattr(self, "values", None), serialize),
        }
