...
class V1DeviceTaintRuleList(BaseModel):
    """
    ...
    items: List[V1DeviceTaintRule] = Field(description="Items is the list of DeviceTaintRules.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1DeviceTaintRuleList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1DeviceTaintRule.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
