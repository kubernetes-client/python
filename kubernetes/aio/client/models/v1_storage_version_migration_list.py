...
class V1StorageVersionMigrationList(BaseModel):
    """
    ...
    items: List[V1StorageVersionMigration] = Field(description="Items is the list of StorageVersionMigration")
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        "api_version": "str",
        "items": "List[V1StorageVersionMigration]",
        "kind": "str",
        "metadata": "V1ListMeta"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1StorageVersionMigrationList):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1StorageVersionMigration.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
