...
class V1TokenRequestSpec(BaseModel):
    ...
    bound_object_ref: Optional[V1BoundObjectReference] = Field(default=None, validation_alias=AliasChoices("boundObjectRef", "bound_object_ref"), serialization_alias="boundObjectRef")
    ...
    __properties: ClassVar[List[str]] = ["attestations", "audiences", "boundObjectRef", "expirationSeconds"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "boundObjectRef" not in obj and "bound_object_ref" in obj:
            obj["boundObjectRef"] = obj["bound_object_ref"]
        obj.pop("bound_object_ref", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("attestations" if serialize else "attestations"): _to_legacy_value(getattr(self, "attestations", None), serialize),
            ("audiences" if serialize else "audiences"): _to_legacy_value(getattr(self, "audiences", None), serialize),
            ("boundObjectRef" if serialize else "bound_object_ref"): _to_legacy_value(getattr(self, "bound_object_ref", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.bound_object_ref:
            _dict['boundObjectRef'] = _to_openapi_value(self.bound_object_ref)
        return _dict
