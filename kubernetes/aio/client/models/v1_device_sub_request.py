...
class V1DeviceSubRequest(BaseModel):
    ...
    selectors: Optional[List[V1DeviceSelector]] = Field(default=None, description="Selectors define criteria which must be satisfied by a specific device in order for that device to be considered for this subrequest. All selectors must be satisfied for a device to be considered.")
    ...
    __properties: ClassVar[List[str]] = ["allocationMode", "capacity", "count", "derivedAttributes", "deviceClassName", "name", "selectors", "tolerations"]
