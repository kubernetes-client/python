...
class V1beta1PodGroupSchedulingConstraints(BaseModel):
    """
    ...
    """ # noqa: E501
    topology: Optional[List[V1beta1TopologyConstraint]] = Field(default=None, description="topology defines the topology constraints for the pod group. Currently only a single topology constraint can be specified. This may change in the future.")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1PodGroupSchedulingConstraints):
            return False
