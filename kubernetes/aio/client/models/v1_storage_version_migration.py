...
class V1StorageVersionMigration(BaseModel):
    """
    ...
    spec: Optional[V1StorageVersionMigrationSpec] = None
    status: Optional[V1StorageVersionMigrationStatus] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1StorageVersionMigration):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1StorageVersionMigrationSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1StorageVersionMigrationStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
