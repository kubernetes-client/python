...
class V1beta2ExactDeviceRequest(BaseModel):
    ...
    openapi_types: ClassVar[Dict[str, str]] = {
        ...
        "count": "int",
        "derived_attributes": "List[V1beta2DeviceDerivedAttribute]",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "derivedAttributes": [V1beta2DeviceDerivedAttribute.from_dict(_item) for _item in obj["derivedAttributes"]] if obj.get("derivedAttributes") is not None else None,
