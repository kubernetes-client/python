...
class V1DeploymentCondition(BaseModel):
    ...
    last_update_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastUpdateTime", "last_update_time"), serialization_alias="lastUpdateTime", description="The last time this condition was updated.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of deployment condition.")
