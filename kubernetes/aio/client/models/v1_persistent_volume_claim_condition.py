...
class V1PersistentVolumeClaimCondition(BaseModel):
    ...
    """ # noqa: E501
    last_probe_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastProbeTime", "last_probe_time"), serialization_alias="lastProbeTime", description="lastProbeTime is the time we probed the condition.")
    last_transition_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastTransitionTime", "last_transition_time"), serialization_alias="lastTransitionTime", description="lastTransitionTime is the time the condition transitioned from one status to another.")
