...
class V1alpha1StorageVersionCondition(BaseModel):
    ...
    """ # noqa: E501
    last_transition_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastTransitionTime", "last_transition_time"), serialization_alias="lastTransitionTime", description="lastTransitionTime is the last time the condition transitioned from one status to another.")
    message: StrictStr = Field(description="message is a human readable string indicating details about the transition.")
    observed_generation: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("observedGeneration", "observed_generation"), serialization_alias="observedGeneration", description="observedGeneration represents the .metadata.generation that the condition was set based upon, if field is set.")
    reason: StrictStr = Field(description="reason for the condition's last transition.")
