...
class V1RoleRef(BaseModel):
    ...
    """ # noqa: E501
    api_group: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("apiGroup", "api_group"), serialization_alias="apiGroup", description="APIGroup is the group for the resource being referenced")
