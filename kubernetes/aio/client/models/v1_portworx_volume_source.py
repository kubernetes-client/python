...
class V1PortworxVolumeSource(BaseModel):
    ...
    """ # noqa: E501
    fs_type: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("fsType", "fs_type"), serialization_alias="fsType", description="fSType represents the filesystem type to mount Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\". Implicitly inferred to be \"ext4\" if unspecified.")
    ...
    volume_id: StrictStr = Field(validation_alias=AliasChoices("volumeID", "volume_id"), serialization_alias="volumeID", description="volumeID uniquely identifies a Portworx volume")
