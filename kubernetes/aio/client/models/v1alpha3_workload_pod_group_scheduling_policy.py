...
class V1alpha3WorkloadPodGroupSchedulingPolicy(BaseModel):
    """
    ...
    """ # noqa: E501
    basic: Optional[Dict[str, Any]] = Field(default=None, description="basic specifies that standard, pod-by-pod Kubernetes scheduling behavior should be used.")
    gang: Optional[V1alpha3WorkloadPodGroupGangSchedulingPolicy] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3WorkloadPodGroupSchedulingPolicy):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic": obj.get("basic"),
            "gang": V1alpha3WorkloadPodGroupGangSchedulingPolicy.from_dict(obj["gang"]) if obj.get("gang") is not None else None
        })
        return _obj
