...
class V1alpha1EvictionSpec(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1EvictionSpec):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "target": V1alpha1EvictionTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
