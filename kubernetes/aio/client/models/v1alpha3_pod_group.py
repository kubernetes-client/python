...
class V1alpha3PodGroup(BaseModel):
    """
    ...
    status: Optional[V1alpha3PodGroupStatus] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3PodGroup):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha3PodGroupSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1alpha3PodGroupStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
