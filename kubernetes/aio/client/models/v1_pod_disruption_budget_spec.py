...
class V1PodDisruptionBudgetSpec(BaseModel):
    ...
    """ # noqa: E501
    max_unavailable: Optional[StrictInt | StrictStr] = Field(default=None, validation_alias=AliasChoices("maxUnavailable", "max_unavailable"), serialization_alias="maxUnavailable", description="maxUnavailable indicates that an eviction is allowed if at most \"maxUnavailable\" pods selected by \"selector\" are unavailable after the eviction, i.e. even in absence of the evicted pod. For example, one can prevent all voluntary evictions by specifying 0. This is a mutually exclusive setting with \"minAvailable\".")
