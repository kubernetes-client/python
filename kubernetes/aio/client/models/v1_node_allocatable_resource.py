...
class V1NodeAllocatableResource(BaseModel):
    """
    ...
    """ # noqa: E501
    mapping: Optional[V1NodeAllocatableMapping] = None
    overhead: Optional[V1NodeAllocatableOverhead] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1NodeAllocatableResource):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mapping": V1NodeAllocatableMapping.from_dict(obj["mapping"]) if obj.get("mapping") is not None else None,
            "overhead": V1NodeAllocatableOverhead.from_dict(obj["overhead"]) if obj.get("overhead") is not None else None
        })
        return _obj
