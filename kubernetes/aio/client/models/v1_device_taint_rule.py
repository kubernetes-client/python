...
class V1DeviceTaintRule(BaseModel):
    """
    ...
    status: Optional[V1DeviceTaintRuleStatus] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1DeviceTaintRule):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1DeviceTaintRuleSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1DeviceTaintRuleStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
