...
class V1DeviceTaintRuleSpec(BaseModel):
    """
    ...
    """ # noqa: E501
    device_selector: Optional[V1DeviceTaintSelector] = Field(default=None, validation_alias=AliasChoices("deviceSelector", "device_selector"), serialization_alias="deviceSelector")
    taint: V1DeviceTaint
    openapi_types: ClassVar[Dict[str, str]] = {
        "device_selector": "V1DeviceTaintSelector",
        "taint": "V1DeviceTaint"
    }
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "deviceSelector" not in obj and "device_selector" in obj:
            obj["deviceSelector"] = obj["device_selector"]
        obj.pop("device_selector", None)
        return obj
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1DeviceTaintRuleSpec):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("deviceSelector" if serialize else "device_selector"): _to_legacy_value(getattr(self, "device_selector", None), serialize),
            ("taint" if serialize else "taint"): _to_legacy_value(getattr(self, "taint", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.taint:
            _dict['taint'] = _to_openapi_value(self.taint)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deviceSelector": V1DeviceTaintSelector.from_dict(obj["deviceSelector"]) if obj.get("deviceSelector") is not None else None,
            "taint": V1DeviceTaint.from_dict(obj["taint"]) if obj.get("taint") is not None else None
        })
        return _obj
