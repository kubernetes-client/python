...
class V1ContainerStateRunning(BaseModel):
    ...
    """ # noqa: E501
    started_at: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("startedAt", "started_at"), serialization_alias="startedAt", description="Time at which the container was last (re-)started")
