...
class V1beta1PodGroupStatus(BaseModel):
    """
    ...
    resource_claim_statuses: Optional[List[V1beta1PodGroupResourceClaimStatus]] = Field(default=None, validation_alias=AliasChoices("resourceClaimStatuses", "resource_claim_statuses"), serialization_alias="resourceClaimStatuses", description="resourceClaimStatuses is status of resource claims.")
    openapi_types: ClassVar[Dict[str, str]] = {
        "conditions": "List[V1Condition]",
        "resource_claim_statuses": "List[V1beta1PodGroupResourceClaimStatus]"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1PodGroupStatus):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resourceClaimStatuses": [V1beta1PodGroupResourceClaimStatus.from_dict(_item) for _item in obj["resourceClaimStatuses"]] if obj.get("resourceClaimStatuses") is not None else None
        })
        return _obj
