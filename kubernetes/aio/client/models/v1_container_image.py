...
class V1ContainerImage(BaseModel):
    ...
    size_bytes: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("sizeBytes", "size_bytes"), serialization_alias="sizeBytes", description="The size of the image in bytes.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "sizeBytes" not in obj and "size_bytes" in obj:
            obj["sizeBytes"] = obj["size_bytes"]
        obj.pop("size_bytes", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("sizeBytes" if serialize else "size_bytes"): _to_legacy_value(getattr(self, "size_bytes", None), serialize),
        }
