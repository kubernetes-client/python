...
class V1alpha3PodGroupSchedulingPolicy(BaseModel):
    """
    ...
    """ # noqa: E501
    basic: Optional[Dict[str, Any]] = Field(default=None, description="basic specifies that the pods in this group should be scheduled using standard Kubernetes scheduling behavior. Setting this field at group creation time opts this group to basic scheduling; this field cannot be changed afterward.")
    gang: Optional[V1alpha3GangSchedulingPolicy] = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3PodGroupSchedulingPolicy):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("basic" if serialize else "basic"): _to_legacy_value(getattr(self, "basic", None), serialize),
            ("gang" if serialize else "gang"): _to_legacy_value(getattr(self, "gang", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.gang:
            _dict['gang'] = _to_openapi_value(self.gang)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic": obj.get("basic"),
            "gang": V1alpha3GangSchedulingPolicy.from_dict(obj["gang"]) if obj.get("gang") is not None else None
        })
        return _obj
