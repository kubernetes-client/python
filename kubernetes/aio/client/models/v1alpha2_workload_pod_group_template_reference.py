...
class V1alpha2WorkloadPodGroupTemplateReference(BaseModel):
    """
    ...
    """ # noqa: E501
    pod_group_template_name: StrictStr = Field(validation_alias=AliasChoices("podGroupTemplateName", "pod_group_template_name"), serialization_alias="podGroupTemplateName", description="PodGroupTemplateName defines the PodGroupTemplate name within the Workload object.")
    workload_name: StrictStr = Field(validation_alias=AliasChoices("workloadName", "workload_name"), serialization_alias="workloadName", description="WorkloadName defines the name of the Workload object.")
    ...
    __properties: ClassVar[List[str]] = ["podGroupTemplateName", "workloadName"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "podGroupTemplateName" not in obj and "pod_group_template_name" in obj:
            obj["podGroupTemplateName"] = obj["pod_group_template_name"]
        obj.pop("pod_group_template_name", None)
        if "workloadName" not in obj and "workload_name" in obj:
            obj["workloadName"] = obj["workload_name"]
        obj.pop("workload_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("podGroupTemplateName" if serialize else "pod_group_template_name"): _to_legacy_value(getattr(self, "pod_group_template_name", None), serialize),
            ("workloadName" if serialize else "workload_name"): _to_legacy_value(getattr(self, "workload_name", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "podGroupTemplateName": obj.get("podGroupTemplateName"),
            "workloadName": obj.get("workloadName")
        })
        return _obj
