...
class V1DeviceCounterConsumption(BaseModel):
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "compatibilityGroups" not in obj and "compatibility_groups" in obj:
            obj["compatibilityGroups"] = obj["compatibility_groups"]
        obj.pop("compatibility_groups", None)
        if "counterSet" not in obj and "counter_set" in obj:
            obj["counterSet"] = obj["counter_set"]
        obj.pop("counter_set", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("compatibilityGroups" if serialize else "compatibility_groups"): _to_legacy_value(getattr(self, "compatibility_groups", None), serialize),
            ("counterSet" if serialize else "counter_set"): _to_legacy_value(getattr(self, "counter_set", None), serialize),
            ("counters" if serialize else "counters"): _to_legacy_value(getattr(self, "counters", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compatibilityGroups": obj.get("compatibilityGroups"),
            "counterSet": obj.get("counterSet"),
            "counters": dict(
                (_k, V1Counter.from_dict(_v))
