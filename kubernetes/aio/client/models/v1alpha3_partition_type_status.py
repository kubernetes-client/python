...
class V1alpha3PartitionTypeStatus(BaseModel):
    """
    ...
    """ # noqa: E501
    allocatable: StrictInt = Field(description="Allocatable is the number of additional devices of this partition type that could still be allocated given current shared-counter consumption.")
    attribute: StrictStr = Field(description="Attribute is the fully qualified name of the device attribute whose value groups this entry. It is the PartitionTypeAttribute declared by the devices' own slice, or the default named in the request when their slice declares none.")
    total: StrictInt = Field(description="Total is the number of devices of this partition type in the pool.")
    type: StrictStr = Field(description="Type is the partition type value (e.g. \"Full\" or \"Half\").")
    ...
    __properties: ClassVar[List[str]] = ["allocatable", "attribute", "total", "type"]
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3PartitionTypeStatus):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("attribute" if serialize else "attribute"): _to_legacy_value(getattr(self, "attribute", None), serialize),
            ("total" if serialize else "total"): _to_legacy_value(getattr(self, "total", None), serialize),
