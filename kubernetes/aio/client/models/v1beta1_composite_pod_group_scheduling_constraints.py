...
class V1beta1CompositePodGroupSchedulingConstraints(BaseModel):
    """
    ...
    """ # noqa: E501
    topology: Optional[List[V1beta1TopologyConstraint]] = Field(default=None, description="topology defines the topology constraints for the composite pod group. Currently only a single topology constraint can be specified. This may change in the future.")
    openapi_types: ClassVar[Dict[str, str]] = {
        "topology": "List[V1beta1TopologyConstraint]"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1beta1CompositePodGroupSchedulingConstraints):
            return False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "topology": [V1beta1TopologyConstraint.from_dict(_item) for _item in obj["topology"]] if obj.get("topology") is not None else None
        })
        return _obj
