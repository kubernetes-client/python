...
class V1PodCondition(BaseModel):
    ...
    """ # noqa: E501
    last_probe_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastProbeTime", "last_probe_time"), serialization_alias="lastProbeTime", description="Last time we probed the condition.")
    last_transition_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastTransitionTime", "last_transition_time"), serialization_alias="lastTransitionTime", description="Last time the condition transitioned from one status to another.")
    ...
    observed_generation: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("observedGeneration", "observed_generation"), serialization_alias="observedGeneration", description="If set, this represents the .metadata.generation that the pod condition was set based upon.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "lastProbeTime" not in obj and "last_probe_time" in obj:
            obj["lastProbeTime"] = obj["last_probe_time"]
        obj.pop("last_probe_time", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("lastProbeTime" if serialize else "last_probe_time"): _to_legacy_value(getattr(self, "last_probe_time", None), serialize),
