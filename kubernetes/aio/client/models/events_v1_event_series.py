...
class EventsV1EventSeries(BaseModel):
    ...
    last_observed_time: datetime = Field(validation_alias=AliasChoices("lastObservedTime", "last_observed_time"), serialization_alias="lastObservedTime", description="lastObservedTime is the time when last Event from the series was seen before last heartbeat.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "lastObservedTime" not in obj and "last_observed_time" in obj:
            obj["lastObservedTime"] = obj["last_observed_time"]
        obj.pop("last_observed_time", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("lastObservedTime" if serialize else "last_observed_time"): _to_legacy_value(getattr(self, "last_observed_time", None), serialize),
        }
