...
class V1alpha1Requester(BaseModel):
    """
    ...
    name: StrictStr = Field(description="name allows you to identify the entity, that requested the eviction of the target.  It must be a valid domain-prefixed key (such as \"acme.io/foo\"). This field must be unique for each requester. This field is required.")
    ...
    __properties: ClassVar[List[str]] = ["intent", "name"]
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1Requester):
            return False
