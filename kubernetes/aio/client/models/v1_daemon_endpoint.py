...
class V1DaemonEndpoint(BaseModel):
    ...
    """ # noqa: E501
    port: StrictInt = Field(validation_alias=AliasChoices("Port", "port"), serialization_alias="Port", description="Port number of the given endpoint.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "Port" not in obj and "port" in obj:
            obj["Port"] = obj["port"]
        obj.pop("port", None)
        return obj
