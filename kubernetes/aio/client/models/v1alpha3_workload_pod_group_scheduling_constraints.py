...
class V1alpha3WorkloadPodGroupSchedulingConstraints(BaseModel):
    """
    ...
    """ # noqa: E501
    topology: Optional[List[V1alpha3TopologyConstraint]] = Field(default=None, description="topology specifies desired topological placements for all pods within the pod group. If unset, no topology placement is requested.")
    openapi_types: ClassVar[Dict[str, str]] = {
        "topology": "List[V1alpha3TopologyConstraint]"
    }
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha3WorkloadPodGroupSchedulingConstraints):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("topology" if serialize else "topology"): _to_legacy_value(getattr(self, "topology", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "topology": [V1alpha3TopologyConstraint.from_dict(_item) for _item in obj["topology"]] if obj.get("topology") is not None else None
        })
        return _obj
