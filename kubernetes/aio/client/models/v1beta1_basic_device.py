...
class V1beta1BasicDevice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allNodes", "allowMultipleAllocations", "attributes", "bindingConditions", "bindingFailureConditions", "bindsToNode", "capacity", "consumesCounters", "nodeAllocatableResources", "nodeName", "nodeSelector", "taints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodeAllocatableResources": dict(
                (_k, V1beta1NodeAllocatableResource.from_dict(_v))
