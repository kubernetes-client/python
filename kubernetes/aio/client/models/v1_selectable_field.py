...
class V1SelectableField(BaseModel):
    ...
    """ # noqa: E501
    json_path: StrictStr = Field(validation_alias=AliasChoices("jsonPath", "json_path"), serialization_alias="jsonPath", description="jsonPath is a simple JSON path which is evaluated against each custom resource to produce a field selector value. Only JSON paths without the array notation are allowed. Must point to a field of type string, boolean or integer. Types with enum values and strings with formats are allowed. If jsonPath refers to absent field in a resource, the jsonPath evaluates to an empty string. Must not point to metdata fields. Required.")
