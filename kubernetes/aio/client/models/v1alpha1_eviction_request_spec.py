...
class V1alpha1EvictionRequestSpec(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["intent", "requester", "target"]
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, V1alpha1EvictionRequestSpec):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("intent" if serialize else "intent"): _to_legacy_value(getattr(self, "intent", None), serialize),
            ("requester" if serialize else "requester"): _to_legacy_value(getattr(self, "requester", None), serialize),
            ("target" if serialize else "target"): _to_legacy_value(getattr(self, "target", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.target:
            _dict['target'] = _to_openapi_value(self.target)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target": V1alpha1EvictionRequestTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
