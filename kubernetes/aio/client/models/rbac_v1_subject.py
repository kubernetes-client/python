...
class RbacV1Subject(BaseModel):
    ...
    """ # noqa: E501
    api_group: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("apiGroup", "api_group"), serialization_alias="apiGroup", description="APIGroup holds the API group of the referenced subject. Defaults to \"\" for ServiceAccount subjects. Defaults to \"rbac.authorization.k8s.io\" for User and Group subjects.")
