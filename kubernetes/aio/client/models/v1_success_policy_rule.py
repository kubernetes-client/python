...
class V1SuccessPolicyRule(BaseModel):
    ...
    """ # noqa: E501
    succeeded_count: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("succeededCount", "succeeded_count"), serialization_alias="succeededCount", description="succeededCount specifies the minimal required size of the actual set of the succeeded indexes for the Job. When succeededCount is used along with succeededIndexes, the check is constrained only to the set of indexes specified by succeededIndexes. For example, given that succeededIndexes is \"1-4\", succeededCount is \"3\", and completed indexes are \"1\", \"3\", and \"5\", the Job isn't declared as succeeded because only \"1\" and \"3\" indexes are considered in that rules. When this field is null, this doesn't default to any value and is never evaluated at any time. When specified it needs to be a positive integer.")
    succeeded_indexes: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("succeededIndexes", "succeeded_indexes"), serialization_alias="succeededIndexes", description="succeededIndexes specifies the set of indexes which need to be contained in the actual set of the succeeded indexes for the Job. The list of indexes must be within 0 to \".spec.completions-1\" and must not contain duplicates. At least one element is required. The indexes are represented as intervals separated by commas. The intervals can be a decimal integer or a pair of decimal integers separated by a hyphen. The number are listed in represented by the first and last element of the series, separated by a hyphen. For example, if the completed indexes are 1, 3, 4, 5 and 7, they are represented as \"1,3-5,7\". When this field is null, this field doesn't default to any value and is never evaluated at any time.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "succeededCount" not in obj and "succeeded_count" in obj:
            obj["succeededCount"] = obj["succeeded_count"]
        obj.pop("succeeded_count", None)
        if "succeededIndexes" not in obj and "succeeded_indexes" in obj:
            obj["succeededIndexes"] = obj["succeeded_indexes"]
        obj.pop("succeeded_indexes", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("succeededCount" if serialize else "succeeded_count"): _to_legacy_value(getattr(self, "succeeded_count", None), serialize),
            ("succeededIndexes" if serialize else "succeeded_indexes"): _to_legacy_value(getattr(self, "succeeded_indexes", None), serialize),
        }
