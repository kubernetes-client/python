...
class V1NodeCondition(BaseModel):
    ...
    """ # noqa: E501
    last_heartbeat_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastHeartbeatTime", "last_heartbeat_time"), serialization_alias="lastHeartbeatTime", description="Last time we got an update on a given condition.")
    last_transition_time: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("lastTransitionTime", "last_transition_time"), serialization_alias="lastTransitionTime", description="Last time the condition transit from one status to another.")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "lastHeartbeatTime" not in obj and "last_heartbeat_time" in obj:
            obj["lastHeartbeatTime"] = obj["last_heartbeat_time"]
        obj.pop("last_heartbeat_time", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("lastHeartbeatTime" if serialize else "last_heartbeat_time"): _to_legacy_value(getattr(self, "last_heartbeat_time", None), serialize),
