# kubernetes.aio.client.StorageV1beta1Api
...
with kubernetes.aio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.aio.client.StorageV1beta1Api(api_client)
    body = kubernetes.aio.client.V1beta1VolumeAttributesClass() # V1beta1VolumeAttributesClass | 
