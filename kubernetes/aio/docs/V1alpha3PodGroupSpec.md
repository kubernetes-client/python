...
**workload_ref** | [**V1alpha3WorkloadReference**](V1alpha3WorkloadReference.md) |  | [optional]

## Example

```python
from kubernetes.aio.client.models.v1alpha3_pod_group_spec import V1alpha3PodGroupSpec

# TODO update the JSON string below
json = "{}"
# create an instance of V1alpha3PodGroupSpec from a JSON string
v1alpha3_pod_group_spec_instance = V1alpha3PodGroupSpec.from_json(json)
# print the JSON string representation of the object
print(V1alpha3PodGroupSpec.to_json())

# convert the object into a dict
v1alpha3_pod_group_spec_dict = v1alpha3_pod_group_spec_instance.to_dict()
# create an instance of V1alpha3PodGroupSpec from a dict
v1alpha3_pod_group_spec_from_dict = V1alpha3PodGroupSpec.from_dict(v1alpha3_pod_group_spec_dict)
```
