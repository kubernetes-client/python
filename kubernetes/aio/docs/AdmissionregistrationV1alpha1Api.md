# kubernetes.aio.client.AdmissionregistrationV1alpha1Api
...
async with kubernetes.aio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.aio.client.AdmissionregistrationV1alpha1Api(api_client)
    body = kubernetes.aio.client.V1alpha1MutatingAdmissionPolicy() # V1alpha1MutatingAdmissionPolicy |
