...
from kubernetes.aio.client.api.coordination_v1_api import CoordinationV1Api  # noqa: E501
...
class TestCoordinationV1Api(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self):
        self.api = kubernetes.aio.client.api.coordination_v1_api.CoordinationV1Api()  # noqa: E501
