...
with kubernetes_aio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_aio.client.AdmissionregistrationV1alpha1Api(api_client)
    body = kubernetes_aio.client.V1alpha1MutatingAdmissionPolicy() # V1alpha1MutatingAdmissionPolicy | 
