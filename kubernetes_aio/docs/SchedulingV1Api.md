# kubernetes_aio.client.SchedulingV1Api
...
with kubernetes_aio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_aio.client.SchedulingV1Api(api_client)
    body = kubernetes_aio.client.V1PriorityClass() # V1PriorityClass | 
