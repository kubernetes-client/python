# kubernetes_aio.client.CertificatesV1Api
...
with kubernetes_aio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_aio.client.CertificatesV1Api(api_client)
    body = kubernetes_aio.client.V1CertificateSigningRequest() # V1CertificateSigningRequest | 
