# kubernetes_aio.client.StorageV1beta1Api
...
with kubernetes_aio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_aio.client.StorageV1beta1Api(api_client)
    body = kubernetes_aio.client.V1beta1VolumeAttributesClass() # V1beta1VolumeAttributesClass | 
