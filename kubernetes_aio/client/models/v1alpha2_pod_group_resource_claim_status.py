...
class V1alpha2PodGroupResourceClaimStatus(object):
    ...
    def __init__(self, name=None, resource_claim_name=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha2PodGroupResourceClaimStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def name(self):
        ...
        :return: The name of this V1alpha2PodGroupResourceClaimStatus.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1alpha2PodGroupResourceClaimStatus.

        Name uniquely identifies this resource claim inside the PodGroup. This must match the name of an entry in podgroup.spec.resourceClaims, which implies that the string must be a DNS_LABEL.  # noqa: E501

        :param name: The name of this V1alpha2PodGroupResourceClaimStatus.  # noqa: E501
        :type name: str
        """
    ...
    def resource_claim_name(self):
        ...
        :return: The resource_claim_name of this V1alpha2PodGroupResourceClaimStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_claim_name(self, resource_claim_name):
        """Sets the resource_claim_name of this V1alpha2PodGroupResourceClaimStatus.

        ResourceClaimName is the name of the ResourceClaim that was generated for the PodGroup in the namespace of the PodGroup. If this is unset, then generating a ResourceClaim was not necessary. The podgroup.spec.resourceClaims entry can be ignored in this case.  # noqa: E501

        :param resource_claim_name: The resource_claim_name of this V1alpha2PodGroupResourceClaimStatus.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha2PodGroupResourceClaimStatus):
            return False
