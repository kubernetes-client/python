...
class V1alpha2TopologyConstraint(object):
    ...
    def __init__(self, key=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha2TopologyConstraint - a model defined in OpenAPI"""  # noqa: E501
    ...
    def key(self):
        ...
        :return: The key of this V1alpha2TopologyConstraint.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this V1alpha2TopologyConstraint.

        Key specifies the key of the node label representing the topology domain. All pods within the PodGroup must be colocated within the same domain instance. Different PodGroups can land on different domain instances even if they derive from the same PodGroupTemplate. Examples: \"topology.kubernetes.io/rack\"  # noqa: E501

        :param key: The key of this V1alpha2TopologyConstraint.  # noqa: E501
        :type key: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha2TopologyConstraint):
            return False
