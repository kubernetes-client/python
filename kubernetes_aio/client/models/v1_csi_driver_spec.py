...
class V1CSIDriverSpec(object):
    ...
    def __init__(self, attach_required=None, fs_group_policy=None, node_allocatable_update_period_seconds=None, pod_info_on_mount=None, prevent_pod_scheduling_if_missing=None, requires_republish=None, se_linux_mount=None, service_account_token_in_secrets=None, storage_capacity=None, token_requests=None, volume_lifecycle_modes=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._prevent_pod_scheduling_if_missing = None
        ...
        if prevent_pod_scheduling_if_missing is not None:
            self.prevent_pod_scheduling_if_missing = prevent_pod_scheduling_if_missing
    ...
    def node_allocatable_update_period_seconds(self):
        ...
        nodeAllocatableUpdatePeriodSeconds specifies the interval between periodic updates of the CSINode allocatable capacity for this driver. When set, both periodic updates and updates triggered by capacity-related failures are enabled. If not set, no updates occur (neither periodic nor upon detecting capacity-related failures), and the allocatable.count remains static. The minimum allowed value for this field is 10 seconds.  This feature requires the MutableCSINodeAllocatableCount feature gate to be enabled.  This field is mutable.  # noqa: E501
    ...
    def service_account_token_in_secrets(self, service_account_token_in_secrets):
        ...
        :type service_account_token_in_secrets: bool
        """
