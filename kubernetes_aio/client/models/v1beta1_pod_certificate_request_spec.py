...
class V1beta1PodCertificateRequestSpec(object):
    ...
    def __init__(self, max_expiration_seconds=None, node_name=None, node_uid=None, pkix_public_key=None, pod_name=None, pod_uid=None, proof_of_possession=None, service_account_name=None, service_account_uid=None, signer_name=None, stub_pkcs10_request=None, unverified_user_annotations=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._stub_pkcs10_request = None
        ...
        self.stub_pkcs10_request = stub_pkcs10_request
    ...
    def stub_pkcs10_request(self):
        ...
        :return: The stub_pkcs10_request of this V1beta1PodCertificateRequestSpec.  # noqa: E501
        :rtype: str
        """
        return self._stub_pkcs10_request

    @stub_pkcs10_request.setter
    def stub_pkcs10_request(self, stub_pkcs10_request):
        """Sets the stub_pkcs10_request of this V1beta1PodCertificateRequestSpec.

        A PKCS#10 certificate signing request (DER-serialized) generated by Kubelet using the subject private key.  Most signer implementations will ignore the contents of the CSR except to extract the subject public key. The API server automatically verifies the CSR signature during admission, so the signer does not need to repeat the verification.  CSRs generated by kubelet are completely empty.  The subject public key must be one of RSA3072, RSA4096, ECDSAP256, ECDSAP384, ECDSAP521, or ED25519. Note that this list may be expanded in the future.  Signer implementations do not need to support all key types supported by kube-apiserver and kubelet.  If a signer does not support the key type used for a given PodCertificateRequest, it must deny the request by setting a status.conditions entry with a type of \"Denied\" and a reason of \"UnsupportedKeyType\". It may also suggest a key type that it does support in the message field.  # noqa: E501

        :param stub_pkcs10_request: The stub_pkcs10_request of this V1beta1PodCertificateRequestSpec.  # noqa: E501
        :type stub_pkcs10_request: str
        """
        if self.local_vars_configuration.client_side_validation and stub_pkcs10_request is None:  # noqa: E501
            raise ValueError("Invalid value for `stub_pkcs10_request`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                stub_pkcs10_request is not None and not re.search(r'^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', stub_pkcs10_request)):  # noqa: E501
            raise ValueError(r"Invalid value for `stub_pkcs10_request`, must be a follow pattern or equal to `/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/`")  # noqa: E501

        self._stub_pkcs10_request = stub_pkcs10_request
