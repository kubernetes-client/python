...
class V1ResourceHealth(object):
    ...
    def __init__(self, health=None, message=None, resource_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def message(self):
        ...
        :return: The message of this V1ResourceHealth.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this V1ResourceHealth.

        Message provides human-readable context for Health (e.g. \"ECC error count exceeded threshold\"). This field is populated by the kubelet when ResourceHealthStatusMessage is enabled if the DRA plugin returns a message, and is null otherwise.  # noqa: E501

        :param message: The message of this V1ResourceHealth.  # noqa: E501
        :type message: str
        """
