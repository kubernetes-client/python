...
class V1ValidatingAdmissionPolicyBindingSpec(object):
    ...
    def validation_actions(self, validation_actions):
        ...
        """
        if self.local_vars_configuration.client_side_validation and validation_actions is None:  # noqa: E501
            raise ValueError("Invalid value for `validation_actions`, must not be `None`")  # noqa: E501
