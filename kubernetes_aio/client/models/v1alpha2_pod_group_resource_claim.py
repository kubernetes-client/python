...
class V1alpha2PodGroupResourceClaim(object):
    ...
    def __init__(self, name=None, resource_claim_name=None, resource_claim_template_name=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha2PodGroupResourceClaim - a model defined in OpenAPI"""  # noqa: E501
    ...
    def name(self):
        ...
        :return: The name of this V1alpha2PodGroupResourceClaim.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1alpha2PodGroupResourceClaim.

        Name uniquely identifies this resource claim inside the PodGroup. This must be a DNS_LABEL.  # noqa: E501

        :param name: The name of this V1alpha2PodGroupResourceClaim.  # noqa: E501
        :type name: str
        """
    ...
    def resource_claim_name(self):
        ...
        :return: The resource_claim_name of this V1alpha2PodGroupResourceClaim.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_claim_name(self, resource_claim_name):
        """Sets the resource_claim_name of this V1alpha2PodGroupResourceClaim.

        ResourceClaimName is the name of a ResourceClaim object in the same namespace as this PodGroup. The ResourceClaim will be reserved for the PodGroup instead of its individual pods.  Exactly one of ResourceClaimName and ResourceClaimTemplateName must be set.  # noqa: E501

        :param resource_claim_name: The resource_claim_name of this V1alpha2PodGroupResourceClaim.  # noqa: E501
    ...
    def resource_claim_template_name(self):
        ...
        :return: The resource_claim_template_name of this V1alpha2PodGroupResourceClaim.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_claim_template_name(self, resource_claim_template_name):
        """Sets the resource_claim_template_name of this V1alpha2PodGroupResourceClaim.

        ResourceClaimTemplateName is the name of a ResourceClaimTemplate object in the same namespace as this PodGroup.  The template will be used to create a new ResourceClaim, which will be bound to this PodGroup. When this PodGroup is deleted, the ResourceClaim will also be deleted. The PodGroup name and resource name, along with a generated component, will be used to form a unique name for the ResourceClaim, which will be recorded in podgroup.status.resourceClaimStatuses.  This field is immutable and no changes will be made to the corresponding ResourceClaim by the control plane after creating the ResourceClaim.  Exactly one of ResourceClaimName and ResourceClaimTemplateName must be set.  # noqa: E501

        :param resource_claim_template_name: The resource_claim_template_name of this V1alpha2PodGroupResourceClaim.  # noqa: E501
