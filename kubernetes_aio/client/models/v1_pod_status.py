...
class V1PodStatus(object):
    ...
    def __init__(self, allocated_resources=None, conditions=None, container_statuses=None, ephemeral_container_statuses=None, extended_resource_claim_status=None, host_ip=None, host_ips=None, init_container_statuses=None, message=None, node_allocatable_resource_claim_statuses=None, nominated_node_name=None, observed_generation=None, phase=None, pod_ip=None, pod_ips=None, qos_class=None, reason=None, resize=None, resource_claim_statuses=None, resources=None, start_time=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._message = None
        self._node_allocatable_resource_claim_statuses = None
        ...
        if node_allocatable_resource_claim_statuses is not None:
            self.node_allocatable_resource_claim_statuses = node_allocatable_resource_claim_statuses
    ...
    @property
    def node_allocatable_resource_claim_statuses(self):
        """Gets the node_allocatable_resource_claim_statuses of this V1PodStatus.  # noqa: E501
        ...
        """
        return self._node_allocatable_resource_claim_statuses

    @node_allocatable_resource_claim_statuses.setter
    def node_allocatable_resource_claim_statuses(self, node_allocatable_resource_claim_statuses):
        """Sets the node_allocatable_resource_claim_statuses of this V1PodStatus.
        ...
        self._node_allocatable_resource_claim_statuses = node_allocatable_resource_claim_statuses
