...
from kubernetes_aio.utils import create_from_dict, create_from_yaml
...
class CreateFromYamlTest(IsolatedAsyncioTestCase):
    ...
    async def test_create_from_yaml(self):
        ...
        created = await create_from_yaml(api_client, 'kubernetes_aio/utils/nginx-deployment.yaml')
