...
[**watch_storage_class**](StorageV1beta1Api.md#watch_storage_class) | **GET** /apis/storage.k8s.io/v1beta1/watch/storageclasses/{name} | 
[**watch_storage_class_list**](StorageV1beta1Api.md#watch_storage_class_list) | **GET** /apis/storage.k8s.io/v1beta1/watch/storageclasses | 
...
try: 
    ...
    print("Exception when calling StorageV1beta1Api->watch_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling StorageV1beta1Api->watch_storage_class_list: %s\n" % e)
```
