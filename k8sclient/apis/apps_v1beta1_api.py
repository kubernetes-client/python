...
class AppsV1beta1Api(object):
    ...
    def watch_namespaced_stateful_set(self, name, namespace, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_stateful_set(name, namespace, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.watch_namespaced_stateful_set_with_http_info(name, namespace, **kwargs)
        else:
            (data) = self.watch_namespaced_stateful_set_with_http_info(name, namespace, **kwargs)
            return data

    def watch_namespaced_stateful_set_with_http_info(self, name, namespace, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_stateful_set_with_http_info(name, namespace, callback=callback_function)
