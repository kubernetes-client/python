...
def main():
    ...
    controller_revisions = list_controller_revision(apps_v1_api, "default", "statefulset-redis")
    # Output: [('statefulset-redis-7c98754f6f', 2), ('statefulset-redis-567b94b5c', 3)]
    # Current revision is 'statefulset-redis-567b94b5c', so chosing 'statefulset-redis-7c98754f6f'
    # as the target revision to perform rollout.
    # Please set the target revision based on your actual output!
    rollout_namespaced_stateful_set(apps_v1_api, "statefulset-redis", "default", controller_revisions[0][0])
